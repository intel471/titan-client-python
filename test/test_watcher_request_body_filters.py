...
import titan_client
from titan_client.models.watcher_request_body_filters import WatcherRequestBodyFilters  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherRequestBodyFilters(unittest.TestCase):
    """WatcherRequestBodyFilters unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherRequestBodyFilters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_request_body_filters.WatcherRequestBodyFilters()  # noqa: E501
        if include_optional :
            return WatcherRequestBodyFilters(
                filter = '', 
                type = ''
            )
        else :
    ...
    def testWatcherRequestBodyFilters(self):
        """Test WatcherRequestBodyFilters"""
