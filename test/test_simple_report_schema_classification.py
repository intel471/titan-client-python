...
import titan_client
from titan_client.models.simple_report_schema_classification import SimpleReportSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaClassification(unittest.TestCase):
    """SimpleReportSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_classification.SimpleReportSchemaClassification()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testSimpleReportSchemaClassification(self):
        """Test SimpleReportSchemaClassification"""
