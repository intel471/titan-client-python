...
import titan_client
from titan_client.models.simple_breach_alert_response import SimpleBreachAlertResponse  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertResponse(unittest.TestCase):
    """SimpleBreachAlertResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_response.SimpleBreachAlertResponse()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertResponse(
                breach_alerts = [
    ...
    def testSimpleBreachAlertResponse(self):
        """Test SimpleBreachAlertResponse"""
