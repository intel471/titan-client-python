...
class TestSimpleSpotReportSchemaData(unittest.TestCase):
    """SimpleSpotReportSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSpotReportSchemaData:
        """Test SimpleSpotReportSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSpotReportSchemaData`
        """
        model = SimpleSpotReportSchemaData()
        if include_optional:
            return SimpleSpotReportSchemaData(
                entities = [
    ...
    def testSimpleSpotReportSchemaData(self):
        """Test SimpleSpotReportSchemaData"""
