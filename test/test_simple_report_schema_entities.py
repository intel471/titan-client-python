...
import titan_client
from titan_client.models.simple_report_schema_entities import SimpleReportSchemaEntities  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaEntities(unittest.TestCase):
    """SimpleReportSchemaEntities unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaEntities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_entities.SimpleReportSchemaEntities()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaEntities(
                type = '', 
                value = ''
            )
        else :
    ...
    def testSimpleReportSchemaEntities(self):
        """Test SimpleReportSchemaEntities"""
