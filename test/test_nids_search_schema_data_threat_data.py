...
import titan_client
from titan_client.models.nids_search_schema_data_threat_data import NIDSSearchSchemaDataThreatData  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchSchemaDataThreatData(unittest.TestCase):
    """NIDSSearchSchemaDataThreatData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchSchemaDataThreatData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_schema_data_threat_data.NIDSSearchSchemaDataThreatData()  # noqa: E501
        if include_optional :
            return NIDSSearchSchemaDataThreatData(
                family = '', 
    ...
    def testNIDSSearchSchemaDataThreatData(self):
        """Test NIDSSearchSchemaDataThreatData"""
