...
import titan_client
from titan_client.models.simple_reports_response import SimpleReportsResponse  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportsResponse(unittest.TestCase):
    """SimpleReportsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_reports_response.SimpleReportsResponse()  # noqa: E501
        if include_optional :
            return SimpleReportsResponse(
                report_partial_result = True, 
    ...
    def testSimpleReportsResponse(self):
        """Test SimpleReportsResponse"""
