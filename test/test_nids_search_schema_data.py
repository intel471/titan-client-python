...
import titan_client
from titan_client.models.nids_search_schema_data import NIDSSearchSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchSchemaData(unittest.TestCase):
    """NIDSSearchSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_schema_data.NIDSSearchSchemaData()  # noqa: E501
        if include_optional :
            return NIDSSearchSchemaData(
                confidence = '', 
                intel_requirements = [
                    ''
                    ], 
    ...
    def testNIDSSearchSchemaData(self):
        """Test NIDSSearchSchemaData"""
