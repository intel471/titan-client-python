...
import titan_client
from titan_client.models.instant_message_schema_data_server import InstantMessageSchemaDataServer  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaDataServer(unittest.TestCase):
    """InstantMessageSchemaDataServer unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaDataServer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_data_server.InstantMessageSchemaDataServer()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaDataServer(
                name = '', 
                service_type = '', 
                uid = ''
            )
    ...
    def testInstantMessageSchemaDataServer(self):
        """Test InstantMessageSchemaDataServer"""
