...
import titan_client
from titan_client.models.instant_message_schema import InstantMessageSchema  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchema(unittest.TestCase):
    """InstantMessageSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema.InstantMessageSchema()  # noqa: E501
        if include_optional :
            return InstantMessageSchema(
    ...
    def testInstantMessageSchema(self):
        """Test InstantMessageSchema"""
