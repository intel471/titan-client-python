...
import titan_client
from titan_client.models.yara_search_schema_data import YARASearchSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchSchemaData(unittest.TestCase):
    """YARASearchSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_schema_data.YARASearchSchemaData()  # noqa: E501
        if include_optional :
            return YARASearchSchemaData(
                confidence = '', 
                intel_requirements = [
                    ''
                    ], 
    ...
    def testYARASearchSchemaData(self):
        """Test YARASearchSchemaData"""
