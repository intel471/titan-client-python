...
class TestFullWatcherGroupSchema(unittest.TestCase):
    """FullWatcherGroupSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullWatcherGroupSchema:
        """Test FullWatcherGroupSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullWatcherGroupSchema`
        """
        model = FullWatcherGroupSchema()
        if include_optional:
            return FullWatcherGroupSchema(
                description = '',
                muted = True,
                name = '',
                owner = '',
    ...
    def testFullWatcherGroupSchema(self):
        """Test FullWatcherGroupSchema"""
