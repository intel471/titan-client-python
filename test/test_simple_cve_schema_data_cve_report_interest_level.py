...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_interest_level import SimpleCveSchemaDataCveReportInterestLevel  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportInterestLevel(unittest.TestCase):
    """SimpleCveSchemaDataCveReportInterestLevel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportInterestLevel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_interest_level.SimpleCveSchemaDataCveReportInterestLevel()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportInterestLevel(
    ...
    def testSimpleCveSchemaDataCveReportInterestLevel(self):
        """Test SimpleCveSchemaDataCveReportInterestLevel"""
