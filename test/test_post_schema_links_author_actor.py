...
import titan_client
from titan_client.models.post_schema_links_author_actor import PostSchemaLinksAuthorActor  # noqa: E501
from titan_client.rest import ApiException

class TestPostSchemaLinksAuthorActor(unittest.TestCase):
    """PostSchemaLinksAuthorActor unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostSchemaLinksAuthorActor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.post_schema_links_author_actor.PostSchemaLinksAuthorActor()  # noqa: E501
        if include_optional :
            return PostSchemaLinksAuthorActor(
                handle = '', 
                uid = ''
            )
        else :
    ...
    def testPostSchemaLinksAuthorActor(self):
        """Test PostSchemaLinksAuthorActor"""
