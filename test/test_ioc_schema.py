...
class TestIocSchema(unittest.TestCase):
    """IocSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IocSchema:
        """Test IocSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IocSchema`
        """
        model = IocSchema()
        if include_optional:
            return IocSchema(
