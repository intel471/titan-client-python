...
import titan_client
from titan_client.models.simple_spot_report_schema_activity import SimpleSpotReportSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleSpotReportSchemaActivity(unittest.TestCase):
    """SimpleSpotReportSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleSpotReportSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_spot_report_schema_activity.SimpleSpotReportSchemaActivity()  # noqa: E501
        if include_optional :
            return SimpleSpotReportSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testSimpleSpotReportSchemaActivity(self):
        """Test SimpleSpotReportSchemaActivity"""
