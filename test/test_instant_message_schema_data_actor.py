...
import titan_client
from titan_client.models.instant_message_schema_data_actor import InstantMessageSchemaDataActor  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaDataActor(unittest.TestCase):
    """InstantMessageSchemaDataActor unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaDataActor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_data_actor.InstantMessageSchemaDataActor()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaDataActor(
                handle = '', 
                uid = ''
            )
        else :
    ...
    def testInstantMessageSchemaDataActor(self):
        """Test InstantMessageSchemaDataActor"""
