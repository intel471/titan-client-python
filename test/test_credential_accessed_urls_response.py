...
import titan_client
from titan_client.models.credential_accessed_urls_response import CredentialAccessedUrlsResponse  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialAccessedUrlsResponse(unittest.TestCase):
    """CredentialAccessedUrlsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialAccessedUrlsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_accessed_urls_response.CredentialAccessedUrlsResponse()  # noqa: E501
        if include_optional :
            return CredentialAccessedUrlsResponse(
                credential_accessed_urls = [
                    titan_client.models.credential_accessed_url_schema.CredentialAccessedUrlSchema(
    ...
    def testCredentialAccessedUrlsResponse(self):
        """Test CredentialAccessedUrlsResponse"""
