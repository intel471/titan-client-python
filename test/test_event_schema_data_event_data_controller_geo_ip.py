...
import titan_client
from titan_client.models.event_schema_data_event_data_controller_geo_ip import EventSchemaDataEventDataControllerGeoIp  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataControllerGeoIp(unittest.TestCase):
    """EventSchemaDataEventDataControllerGeoIp unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataControllerGeoIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_controller_geo_ip.EventSchemaDataEventDataControllerGeoIp()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataControllerGeoIp(
                city = '', 
                country = '', 
                country_code = '', 
    ...
    def testEventSchemaDataEventDataControllerGeoIp(self):
        """Test EventSchemaDataEventDataControllerGeoIp"""
