...
import titan_client
from titan_client.models.event_schema_data_event_data_file import EventSchemaDataEventDataFile  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataFile(unittest.TestCase):
    """EventSchemaDataEventDataFile unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_file.EventSchemaDataEventDataFile()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataFile(
                download_url = '', 
                md5 = '', 
                sha1 = '', 
                sha256 = '', 
    ...
    def testEventSchemaDataEventDataFile(self):
        """Test EventSchemaDataEventDataFile"""
