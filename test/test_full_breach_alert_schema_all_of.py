...
import titan_client
from titan_client.models.full_breach_alert_schema_all_of import FullBreachAlertSchemaAllOf  # noqa: E501
from titan_client.rest import ApiException

class TestFullBreachAlertSchemaAllOf(unittest.TestCase):
    """FullBreachAlertSchemaAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullBreachAlertSchemaAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_breach_alert_schema_all_of.FullBreachAlertSchemaAllOf()  # noqa: E501
        if include_optional :
            return FullBreachAlertSchemaAllOf(
                data = None
            )
        else :
            return FullBreachAlertSchemaAllOf(
    ...
    def testFullBreachAlertSchemaAllOf(self):
        """Test FullBreachAlertSchemaAllOf"""
