...
class TestMarketplacesApi(unittest.TestCase):
    ...
    def test_marketplaces_get(self) -> None:
        """Test case for marketplaces_get

        Search Marketplaces
        """
        pass

    def test_marketplaces_products_get(self) -> None:
        """Test case for marketplaces_products_get

        Search Products
        """
        pass

    def test_marketplaces_products_stream_get(self) -> None:
        """Test case for marketplaces_products_stream_get

        Products stream
        """
        pass

    def test_marketplaces_resources_get(self) -> None:
        """Test case for marketplaces_resources_get

        Search Resources
        """
        pass

    def test_marketplaces_resources_stream_get(self) -> None:
        """Test case for marketplaces_resources_stream_get

        Resources stream
        """
        pass

    def test_marketplaces_vendors_get(self) -> None:
        """Test case for marketplaces_vendors_get

        Search Vendors
        """
        pass

    def test_marketplaces_vendors_stream_get(self) -> None:
        """Test case for marketplaces_vendors_stream_get
