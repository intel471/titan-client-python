...
import titan_client
from titan_client.models.indicator_search_schema_meta import IndicatorSearchSchemaMeta  # noqa: E501
from titan_client.rest import ApiException

class TestIndicatorSearchSchemaMeta(unittest.TestCase):
    """IndicatorSearchSchemaMeta unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IndicatorSearchSchemaMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.indicator_search_schema_meta.IndicatorSearchSchemaMeta()  # noqa: E501
        if include_optional :
            return IndicatorSearchSchemaMeta(
                version = ''
            )
        else :
            return IndicatorSearchSchemaMeta(
    ...
    def testIndicatorSearchSchemaMeta(self):
        """Test IndicatorSearchSchemaMeta"""
