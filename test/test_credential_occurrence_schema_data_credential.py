...
import titan_client
from titan_client.models.credential_occurrence_schema_data_credential import CredentialOccurrenceSchemaDataCredential  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialOccurrenceSchemaDataCredential(unittest.TestCase):
    """CredentialOccurrenceSchemaDataCredential unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialOccurrenceSchemaDataCredential
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_occurrence_schema_data_credential.CredentialOccurrenceSchemaDataCredential()  # noqa: E501
        if include_optional :
            return CredentialOccurrenceSchemaDataCredential(
                affiliations = [
                    ''
                    ], 
                credential_domain = '', 
    ...
    def testCredentialOccurrenceSchemaDataCredential(self):
        """Test CredentialOccurrenceSchemaDataCredential"""
