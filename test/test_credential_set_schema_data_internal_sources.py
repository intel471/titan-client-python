...
import titan_client
from titan_client.models.credential_set_schema_data_internal_sources import CredentialSetSchemaDataInternalSources  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetSchemaDataInternalSources(unittest.TestCase):
    """CredentialSetSchemaDataInternalSources unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetSchemaDataInternalSources
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_schema_data_internal_sources.CredentialSetSchemaDataInternalSources()  # noqa: E501
        if include_optional :
            return CredentialSetSchemaDataInternalSources(
                title = '', 
                url = ''
            )
        else :
    ...
    def testCredentialSetSchemaDataInternalSources(self):
        """Test CredentialSetSchemaDataInternalSources"""
