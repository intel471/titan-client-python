...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_poc_links import SimpleCveSchemaDataCveReportPocLinks  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportPocLinks(unittest.TestCase):
    """SimpleCveSchemaDataCveReportPocLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportPocLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_poc_links.SimpleCveSchemaDataCveReportPocLinks()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportPocLinks(
                title = '', 
                url = ''
            )
        else :
    ...
    def testSimpleCveSchemaDataCveReportPocLinks(self):
        """Test SimpleCveSchemaDataCveReportPocLinks"""
