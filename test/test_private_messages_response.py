...
import titan_client
from titan_client.models.private_messages_response import PrivateMessagesResponse  # noqa: E501
from titan_client.rest import ApiException

class TestPrivateMessagesResponse(unittest.TestCase):
    """PrivateMessagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PrivateMessagesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.private_messages_response.PrivateMessagesResponse()  # noqa: E501
        if include_optional :
            return PrivateMessagesResponse(
                private_message_partial_result = True, 
    ...
    def testPrivateMessagesResponse(self):
        """Test PrivateMessagesResponse"""
