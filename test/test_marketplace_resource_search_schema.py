...
class TestMarketplaceResourceSearchSchema(unittest.TestCase):
    """MarketplaceResourceSearchSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketplaceResourceSearchSchema:
        """Test MarketplaceResourceSearchSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketplaceResourceSearchSchema`
        """
        model = MarketplaceResourceSearchSchema()
        if include_optional:
            return MarketplaceResourceSearchSchema(
                activity = titan_client.models.marketplace_resource_search_schema_activity.MarketplaceResourceSearchSchema_activity(
                    first = 1662656016000, 
                    last = 1664366859000, ),
                data = titan_client.models.marketplace_resource_search_schema_data.MarketplaceResourceSearchSchema_data(
                    browser = 'Firefox', 
                    contains = [
                        ''
                        ], 
                    grabbed_at = 1582970577000, 
                    name = 'https://zoom.us/signin', 
                    package = 'AD223BA823249F88CCE332FB0D6028F8', 
                    source = 'Saved Logins', 
                    url = 'https://zoom.us/signin', ),
                last_updated = 1663656016000,
                uid = 'f667cf8514516a9de2d60f7014292326'
            )
        else:
            return MarketplaceResourceSearchSchema(
                activity = titan_client.models.marketplace_resource_search_schema_activity.MarketplaceResourceSearchSchema_activity(
    ...
    def testMarketplaceResourceSearchSchema(self):
        """Test MarketplaceResourceSearchSchema"""
