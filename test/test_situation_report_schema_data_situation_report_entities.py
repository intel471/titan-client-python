...
import titan_client
from titan_client.models.situation_report_schema_data_situation_report_entities import SituationReportSchemaDataSituationReportEntities  # noqa: E501
from titan_client.rest import ApiException

class TestSituationReportSchemaDataSituationReportEntities(unittest.TestCase):
    """SituationReportSchemaDataSituationReportEntities unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SituationReportSchemaDataSituationReportEntities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.situation_report_schema_data_situation_report_entities.SituationReportSchemaDataSituationReportEntities()  # noqa: E501
        if include_optional :
            return SituationReportSchemaDataSituationReportEntities(
                type = '', 
                value = ''
            )
        else :
    ...
    def testSituationReportSchemaDataSituationReportEntities(self):
        """Test SituationReportSchemaDataSituationReportEntities"""
