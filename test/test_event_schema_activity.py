...
import titan_client
from titan_client.models.event_schema_activity import EventSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaActivity(unittest.TestCase):
    """EventSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_activity.EventSchemaActivity()  # noqa: E501
        if include_optional :
            return EventSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testEventSchemaActivity(self):
        """Test EventSchemaActivity"""
