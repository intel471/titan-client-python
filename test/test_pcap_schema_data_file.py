...
import titan_client
from titan_client.models.pcap_schema_data_file import PCAPSchemaDataFile  # noqa: E501
from titan_client.rest import ApiException

class TestPCAPSchemaDataFile(unittest.TestCase):
    """PCAPSchemaDataFile unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PCAPSchemaDataFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.pcap_schema_data_file.PCAPSchemaDataFile()  # noqa: E501
        if include_optional :
            return PCAPSchemaDataFile(
                download_url = '', 
                sha256 = ''
            )
        else :
    ...
    def testPCAPSchemaDataFile(self):
        """Test PCAPSchemaDataFile"""
