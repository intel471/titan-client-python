...
import titan_client
from titan_client.models.entities_schema_links_reports import EntitiesSchemaLinksReports  # noqa: E501
from titan_client.rest import ApiException

class TestEntitiesSchemaLinksReports(unittest.TestCase):
    """EntitiesSchemaLinksReports unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EntitiesSchemaLinksReports
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.entities_schema_links_reports.EntitiesSchemaLinksReports()  # noqa: E501
        if include_optional :
            return EntitiesSchemaLinksReports(
                admiralty_code = 'C3', 
    ...
    def testEntitiesSchemaLinksReports(self):
        """Test EntitiesSchemaLinksReports"""
