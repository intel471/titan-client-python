...
import titan_client
from titan_client.models.watcher_request_body import WatcherRequestBody  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherRequestBody(unittest.TestCase):
    """WatcherRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherRequestBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_request_body.WatcherRequestBody()  # noqa: E501
        if include_optional :
            return WatcherRequestBody(
                data_sets = [
                    'reports'
                    ], 
                description = '', 
                ...
                filters = [
                    titan_client.models.watcher_request_body_filters.WatcherRequestBody_filters(
                        filter = '', 
                        type = '', )
                    ], 
                free_text_pattern = '', 
                ...
                notification_channel = 'website', 
                notification_frequency = 'immediately', 
                patterns = [
                    titan_client.models.watcher_request_body_patterns.WatcherRequestBody_patterns(
                        pattern = '', 
                        types = '', )
                    ], 
                thread_uid = ''
    ...
    def testWatcherRequestBody(self):
        """Test WatcherRequestBody"""
