...
import titan_client
from titan_client.models.event_schema_data_threat_data import EventSchemaDataThreatData  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataThreatData(unittest.TestCase):
    """EventSchemaDataThreatData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataThreatData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_threat_data.EventSchemaDataThreatData()  # noqa: E501
        if include_optional :
            return EventSchemaDataThreatData(
                family = '', 
    ...
    def testEventSchemaDataThreatData(self):
        """Test EventSchemaDataThreatData"""
