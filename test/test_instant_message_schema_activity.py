...
import titan_client
from titan_client.models.instant_message_schema_activity import InstantMessageSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaActivity(unittest.TestCase):
    """InstantMessageSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_activity.InstantMessageSchemaActivity()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testInstantMessageSchemaActivity(self):
        """Test InstantMessageSchemaActivity"""
