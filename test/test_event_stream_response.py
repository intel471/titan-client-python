...
import titan_client
from titan_client.models.event_stream_response import EventStreamResponse  # noqa: E501
from titan_client.rest import ApiException

class TestEventStreamResponse(unittest.TestCase):
    """EventStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_stream_response.EventStreamResponse()  # noqa: E501
        if include_optional :
            return EventStreamResponse(
                cursor_next = '', 
                event_partial_result = True, 
    ...
    def testEventStreamResponse(self):
        """Test EventStreamResponse"""
