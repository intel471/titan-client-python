...
import titan_client
from titan_client.models.private_message_schema import PrivateMessageSchema  # noqa: E501
from titan_client.rest import ApiException

class TestPrivateMessageSchema(unittest.TestCase):
    """PrivateMessageSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PrivateMessageSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.private_message_schema.PrivateMessageSchema()  # noqa: E501
        if include_optional :
            return PrivateMessageSchema(
                date = 56, 
                last_updated = 56, 
    ...
    def testPrivateMessageSchema(self):
        """Test PrivateMessageSchema"""
