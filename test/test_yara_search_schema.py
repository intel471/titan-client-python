...
import titan_client
from titan_client.models.yara_search_schema import YARASearchSchema  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchSchema(unittest.TestCase):
    """YARASearchSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_schema.YARASearchSchema()  # noqa: E501
        if include_optional :
            return YARASearchSchema(
