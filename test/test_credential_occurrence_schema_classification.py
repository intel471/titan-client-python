...
import titan_client
from titan_client.models.credential_occurrence_schema_classification import CredentialOccurrenceSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialOccurrenceSchemaClassification(unittest.TestCase):
    """CredentialOccurrenceSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialOccurrenceSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_occurrence_schema_classification.CredentialOccurrenceSchemaClassification()  # noqa: E501
        if include_optional :
            return CredentialOccurrenceSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testCredentialOccurrenceSchemaClassification(self):
        """Test CredentialOccurrenceSchemaClassification"""
