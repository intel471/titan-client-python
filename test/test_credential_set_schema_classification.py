...
import titan_client
from titan_client.models.credential_set_schema_classification import CredentialSetSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetSchemaClassification(unittest.TestCase):
    """CredentialSetSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_schema_classification.CredentialSetSchemaClassification()  # noqa: E501
        if include_optional :
            return CredentialSetSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testCredentialSetSchemaClassification(self):
        """Test CredentialSetSchemaClassification"""
