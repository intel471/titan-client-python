...
import titan_client
from titan_client.models.simple_breach_alert_schema import SimpleBreachAlertSchema  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchema(unittest.TestCase):
    """SimpleBreachAlertSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema.SimpleBreachAlertSchema()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchema(
    ...
    def testSimpleBreachAlertSchema(self):
        """Test SimpleBreachAlertSchema"""
