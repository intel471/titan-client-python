...
class TestSimpleBreachAlertSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleBreachAlertSchema:
        """Test SimpleBreachAlertSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleBreachAlertSchema`
        """
        model = SimpleBreachAlertSchema()
        if include_optional:
