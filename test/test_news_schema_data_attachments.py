...
import titan_client
from titan_client.models.news_schema_data_attachments import NewsSchemaDataAttachments  # noqa: E501
from titan_client.rest import ApiException

class TestNewsSchemaDataAttachments(unittest.TestCase):
    """NewsSchemaDataAttachments unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NewsSchemaDataAttachments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.news_schema_data_attachments.NewsSchemaDataAttachments()  # noqa: E501
        if include_optional :
            return NewsSchemaDataAttachments(
                malicious = True, 
                mime_type = '', 
                name = '', 
                size = 56, 
    ...
    def testNewsSchemaDataAttachments(self):
        """Test NewsSchemaDataAttachments"""
