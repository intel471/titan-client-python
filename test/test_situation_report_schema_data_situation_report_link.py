...
import titan_client
from titan_client.models.situation_report_schema_data_situation_report_link import SituationReportSchemaDataSituationReportLink  # noqa: E501
from titan_client.rest import ApiException

class TestSituationReportSchemaDataSituationReportLink(unittest.TestCase):
    """SituationReportSchemaDataSituationReportLink unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SituationReportSchemaDataSituationReportLink
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.situation_report_schema_data_situation_report_link.SituationReportSchemaDataSituationReportLink()  # noqa: E501
        if include_optional :
            return SituationReportSchemaDataSituationReportLink(
    ...
    def testSituationReportSchemaDataSituationReportLink(self):
        """Test SituationReportSchemaDataSituationReportLink"""
