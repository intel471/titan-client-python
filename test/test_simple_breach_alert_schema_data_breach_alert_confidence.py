...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_breach_alert_confidence import SimpleBreachAlertSchemaDataBreachAlertConfidence  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataBreachAlertConfidence(unittest.TestCase):
    """SimpleBreachAlertSchemaDataBreachAlertConfidence unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataBreachAlertConfidence
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_breach_alert_confidence.SimpleBreachAlertSchemaDataBreachAlertConfidence()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataBreachAlertConfidence(
                description = '', 
                level = 'low'
            )
        else :
    ...
    def testSimpleBreachAlertSchemaDataBreachAlertConfidence(self):
        """Test SimpleBreachAlertSchemaDataBreachAlertConfidence"""
