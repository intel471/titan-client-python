...
import titan_client
from titan_client.models.alert_subscription_schema import AlertSubscriptionSchema  # noqa: E501
from titan_client.rest import ApiException

class TestAlertSubscriptionSchema(unittest.TestCase):
    """AlertSubscriptionSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AlertSubscriptionSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.alert_subscription_schema.AlertSubscriptionSchema()  # noqa: E501
        if include_optional :
    ...
    def testAlertSubscriptionSchema(self):
        """Test AlertSubscriptionSchema"""
