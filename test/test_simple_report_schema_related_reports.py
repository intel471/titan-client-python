...
import titan_client
from titan_client.models.simple_report_schema_related_reports import SimpleReportSchemaRelatedReports  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaRelatedReports(unittest.TestCase):
    """SimpleReportSchemaRelatedReports unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaRelatedReports
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_related_reports.SimpleReportSchemaRelatedReports()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaRelatedReports(
                document_family = '', 
                uid = ''
            )
        else :
    ...
    def testSimpleReportSchemaRelatedReports(self):
        """Test SimpleReportSchemaRelatedReports"""
