...
import titan_client
from titan_client.models.credential_set_accessed_url_schema_activity import CredentialSetAccessedUrlSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetAccessedUrlSchemaActivity(unittest.TestCase):
    """CredentialSetAccessedUrlSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetAccessedUrlSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_accessed_url_schema_activity.CredentialSetAccessedUrlSchemaActivity()  # noqa: E501
        if include_optional :
            return CredentialSetAccessedUrlSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testCredentialSetAccessedUrlSchemaActivity(self):
        """Test CredentialSetAccessedUrlSchemaActivity"""
