...
import titan_client
from titan_client.models.yara_search_schema_data_threat_data import YARASearchSchemaDataThreatData  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchSchemaDataThreatData(unittest.TestCase):
    """YARASearchSchemaDataThreatData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchSchemaDataThreatData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_schema_data_threat_data.YARASearchSchemaDataThreatData()  # noqa: E501
        if include_optional :
            return YARASearchSchemaDataThreatData(
                family = '', 
    ...
    def testYARASearchSchemaDataThreatData(self):
        """Test YARASearchSchemaDataThreatData"""
