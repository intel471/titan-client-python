...
import titan_client
from titan_client.models.yara_search_schema_data_yara_data import YARASearchSchemaDataYaraData  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchSchemaDataYaraData(unittest.TestCase):
    """YARASearchSchemaDataYaraData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchSchemaDataYaraData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_schema_data_yara_data.YARASearchSchemaDataYaraData()  # noqa: E501
        if include_optional :
            return YARASearchSchemaDataYaraData(
                signature = '', 
                title = ''
            )
        else :
    ...
    def testYARASearchSchemaDataYaraData(self):
        """Test YARASearchSchemaDataYaraData"""
