...
class TestWatchersApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = WatchersApi()

    def tearDown(self) -> None:
        pass

    def test_watcher_groups_get(self) -> None:
    ...
    def test_watcher_groups_group_uid_delete(self) -> None:
    ...
    def test_watcher_groups_group_uid_get(self) -> None:
    ...
    def test_watcher_groups_group_uid_put(self) -> None:
    ...
    def test_watcher_groups_group_uid_watchers_get(self) -> None:
    ...
    def test_watcher_groups_group_uid_watchers_post(self) -> None:
    ...
    def test_watcher_groups_group_uid_watchers_watcher_uid_delete(self) -> None:
    ...
    def test_watcher_groups_group_uid_watchers_watcher_uid_get(self) -> None:
    ...
    def test_watcher_groups_group_uid_watchers_watcher_uid_put(self) -> None:
    ...
    def test_watcher_groups_post(self) -> None:
