...
import titan_client
from titan_client.models.simple_cve_schema_activity import SimpleCveSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaActivity(unittest.TestCase):
    """SimpleCveSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_activity.SimpleCveSchemaActivity()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testSimpleCveSchemaActivity(self):
        """Test SimpleCveSchemaActivity"""
