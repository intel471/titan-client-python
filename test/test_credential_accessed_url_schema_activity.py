...
import titan_client
from titan_client.models.credential_accessed_url_schema_activity import CredentialAccessedUrlSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialAccessedUrlSchemaActivity(unittest.TestCase):
    """CredentialAccessedUrlSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialAccessedUrlSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_accessed_url_schema_activity.CredentialAccessedUrlSchemaActivity()  # noqa: E501
        if include_optional :
            return CredentialAccessedUrlSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testCredentialAccessedUrlSchemaActivity(self):
        """Test CredentialAccessedUrlSchemaActivity"""
