...
import titan_client
from titan_client.models.event_schema_data_event_data_location import EventSchemaDataEventDataLocation  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataLocation(unittest.TestCase):
    """EventSchemaDataEventDataLocation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_location.EventSchemaDataEventDataLocation()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataLocation(
                ipv4 = '', 
                url = ''
            )
        else :
    ...
    def testEventSchemaDataEventDataLocation(self):
        """Test EventSchemaDataEventDataLocation"""
