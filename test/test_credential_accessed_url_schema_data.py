...
import titan_client
from titan_client.models.credential_accessed_url_schema_data import CredentialAccessedUrlSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialAccessedUrlSchemaData(unittest.TestCase):
    """CredentialAccessedUrlSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialAccessedUrlSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_accessed_url_schema_data.CredentialAccessedUrlSchemaData()  # noqa: E501
        if include_optional :
            return CredentialAccessedUrlSchemaData(
                accessed_domain = '', 
                accessed_url = '', 
    ...
    def testCredentialAccessedUrlSchemaData(self):
        """Test CredentialAccessedUrlSchemaData"""
