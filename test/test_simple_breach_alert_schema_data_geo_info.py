...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_geo_info import SimpleBreachAlertSchemaDataGeoInfo  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataGeoInfo(unittest.TestCase):
    """SimpleBreachAlertSchemaDataGeoInfo unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataGeoInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_geo_info.SimpleBreachAlertSchemaDataGeoInfo()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataGeoInfo(
                country = '', 
                provider = ''
            )
        else :
    ...
    def testSimpleBreachAlertSchemaDataGeoInfo(self):
        """Test SimpleBreachAlertSchemaDataGeoInfo"""
