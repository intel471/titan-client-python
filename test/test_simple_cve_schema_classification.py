...
import titan_client
from titan_client.models.simple_cve_schema_classification import SimpleCveSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaClassification(unittest.TestCase):
    """SimpleCveSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_classification.SimpleCveSchemaClassification()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testSimpleCveSchemaClassification(self):
        """Test SimpleCveSchemaClassification"""
