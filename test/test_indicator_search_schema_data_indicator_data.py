...
import titan_client
from titan_client.models.indicator_search_schema_data_indicator_data import IndicatorSearchSchemaDataIndicatorData  # noqa: E501
from titan_client.rest import ApiException

class TestIndicatorSearchSchemaDataIndicatorData(unittest.TestCase):
    """IndicatorSearchSchemaDataIndicatorData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IndicatorSearchSchemaDataIndicatorData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.indicator_search_schema_data_indicator_data.IndicatorSearchSchemaDataIndicatorData()  # noqa: E501
        if include_optional :
            return IndicatorSearchSchemaDataIndicatorData(
                address = '', 
    ...
    def testIndicatorSearchSchemaDataIndicatorData(self):
        """Test IndicatorSearchSchemaDataIndicatorData"""
