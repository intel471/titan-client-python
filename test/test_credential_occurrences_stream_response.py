...
class TestCredentialOccurrencesStreamResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialOccurrencesStreamResponse:
        """Test CredentialOccurrencesStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialOccurrencesStreamResponse`
        """
        model = CredentialOccurrencesStreamResponse()
        if include_optional:
