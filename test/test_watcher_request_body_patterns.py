...
import titan_client
from titan_client.models.watcher_request_body_patterns import WatcherRequestBodyPatterns  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherRequestBodyPatterns(unittest.TestCase):
    """WatcherRequestBodyPatterns unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherRequestBodyPatterns
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_request_body_patterns.WatcherRequestBodyPatterns()  # noqa: E501
        if include_optional :
            return WatcherRequestBodyPatterns(
                pattern = '', 
                types = ''
            )
        else :
    ...
    def testWatcherRequestBodyPatterns(self):
        """Test WatcherRequestBodyPatterns"""
