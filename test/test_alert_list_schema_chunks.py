...
import titan_client
from titan_client.models.alert_list_schema_chunks import AlertListSchemaChunks  # noqa: E501
from titan_client.rest import ApiException

class TestAlertListSchemaChunks(unittest.TestCase):
    """AlertListSchemaChunks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AlertListSchemaChunks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.alert_list_schema_chunks.AlertListSchemaChunks()  # noqa: E501
        if include_optional :
            return AlertListSchemaChunks(
                hl = '', 
                text = ''
            )
        else :
    ...
    def testAlertListSchemaChunks(self):
        """Test AlertListSchemaChunks"""
