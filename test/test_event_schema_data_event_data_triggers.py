...
import titan_client
from titan_client.models.event_schema_data_event_data_triggers import EventSchemaDataEventDataTriggers  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataTriggers(unittest.TestCase):
    """EventSchemaDataEventDataTriggers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataTriggers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_triggers.EventSchemaDataEventDataTriggers()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataTriggers(
                trigger = ''
            )
        else :
            return EventSchemaDataEventDataTriggers(
    ...
    def testEventSchemaDataEventDataTriggers(self):
        """Test EventSchemaDataEventDataTriggers"""
