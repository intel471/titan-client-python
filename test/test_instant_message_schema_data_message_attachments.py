...
import titan_client
from titan_client.models.instant_message_schema_data_message_attachments import InstantMessageSchemaDataMessageAttachments  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaDataMessageAttachments(unittest.TestCase):
    """InstantMessageSchemaDataMessageAttachments unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaDataMessageAttachments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_data_message_attachments.InstantMessageSchemaDataMessageAttachments()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaDataMessageAttachments(
                height = 1.337, 
                original_url = '', 
                size = 1.337, 
                type = '', 
    ...
    def testInstantMessageSchemaDataMessageAttachments(self):
        """Test InstantMessageSchemaDataMessageAttachments"""
