...
import titan_client
from titan_client.models.tag_response import TagResponse  # noqa: E501
...
class TestTagResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = titan_client.models.tag_response.TagResponse()  # noqa: E501
        if include_optional :
            return TagResponse(
                tag_total_count = 56, 
                tags = [
                    titan_client.models.tag_schema.TagSchema(
                        report_count = 56, 
                        tag = '', 
                        use_count = 56, )
                    ], 
