...
import titan_client
from titan_client.models.private_message_schema_links import PrivateMessageSchemaLinks  # noqa: E501
from titan_client.rest import ApiException

class TestPrivateMessageSchemaLinks(unittest.TestCase):
    """PrivateMessageSchemaLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PrivateMessageSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.private_message_schema_links.PrivateMessageSchemaLinks()  # noqa: E501
        if include_optional :
            return PrivateMessageSchemaLinks(
    ...
    def testPrivateMessageSchemaLinks(self):
        """Test PrivateMessageSchemaLinks"""
