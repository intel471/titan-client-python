...
import titan_client
from titan_client.models.credential_schema_statistics import CredentialSchemaStatistics  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSchemaStatistics(unittest.TestCase):
    """CredentialSchemaStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSchemaStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_schema_statistics.CredentialSchemaStatistics()  # noqa: E501
        if include_optional :
            return CredentialSchemaStatistics(
    ...
    def testCredentialSchemaStatistics(self):
        """Test CredentialSchemaStatistics"""
