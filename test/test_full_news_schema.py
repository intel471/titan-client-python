...
class TestFullNewsSchema(unittest.TestCase):
    """FullNewsSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullNewsSchema:
        """Test FullNewsSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullNewsSchema`
        """
        model = FullNewsSchema()
        if include_optional:
            return FullNewsSchema(
