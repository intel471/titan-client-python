...
import titan_client
from titan_client.models.simple_report_schema import SimpleReportSchema  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchema(unittest.TestCase):
    """SimpleReportSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema.SimpleReportSchema()  # noqa: E501
        if include_optional :
            return SimpleReportSchema(
                actor_handle = '', 
    ...
    def testSimpleReportSchema(self):
        """Test SimpleReportSchema"""
