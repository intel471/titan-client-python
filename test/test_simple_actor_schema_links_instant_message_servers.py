...
import titan_client
from titan_client.models.simple_actor_schema_links_instant_message_servers import SimpleActorSchemaLinksInstantMessageServers  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleActorSchemaLinksInstantMessageServers(unittest.TestCase):
    """SimpleActorSchemaLinksInstantMessageServers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleActorSchemaLinksInstantMessageServers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_actor_schema_links_instant_message_servers.SimpleActorSchemaLinksInstantMessageServers()  # noqa: E501
        if include_optional :
            return SimpleActorSchemaLinksInstantMessageServers(
                name = '', 
                service_type = '', 
                uid = ''
            )
    ...
    def testSimpleActorSchemaLinksInstantMessageServers(self):
        """Test SimpleActorSchemaLinksInstantMessageServers"""
