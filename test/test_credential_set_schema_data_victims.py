...
import titan_client
from titan_client.models.credential_set_schema_data_victims import CredentialSetSchemaDataVictims  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetSchemaDataVictims(unittest.TestCase):
    """CredentialSetSchemaDataVictims unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetSchemaDataVictims
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_schema_data_victims.CredentialSetSchemaDataVictims()  # noqa: E501
        if include_optional :
            return CredentialSetSchemaDataVictims(
                name = '', 
                urls = [
                    ''
                    ]
    ...
    def testCredentialSetSchemaDataVictims(self):
        """Test CredentialSetSchemaDataVictims"""
