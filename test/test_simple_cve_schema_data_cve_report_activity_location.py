...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_activity_location import SimpleCveSchemaDataCveReportActivityLocation  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportActivityLocation(unittest.TestCase):
    """SimpleCveSchemaDataCveReportActivityLocation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportActivityLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_activity_location.SimpleCveSchemaDataCveReportActivityLocation()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportActivityLocation(
    ...
    def testSimpleCveSchemaDataCveReportActivityLocation(self):
        """Test SimpleCveSchemaDataCveReportActivityLocation"""
