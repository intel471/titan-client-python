...
import titan_client
from titan_client.models.watcher_request_body_put_all_of import WatcherRequestBodyPutAllOf  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherRequestBodyPutAllOf(unittest.TestCase):
    """WatcherRequestBodyPutAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherRequestBodyPutAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_request_body_put_all_of.WatcherRequestBodyPutAllOf()  # noqa: E501
        if include_optional :
            return WatcherRequestBodyPutAllOf(
                type = 'search'
            )
        else :
            return WatcherRequestBodyPutAllOf(
    ...
    def testWatcherRequestBodyPutAllOf(self):
        """Test WatcherRequestBodyPutAllOf"""
