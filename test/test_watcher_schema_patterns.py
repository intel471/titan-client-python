...
import titan_client
from titan_client.models.watcher_schema_patterns import WatcherSchemaPatterns  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherSchemaPatterns(unittest.TestCase):
    """WatcherSchemaPatterns unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherSchemaPatterns
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_schema_patterns.WatcherSchemaPatterns()  # noqa: E501
        if include_optional :
            return WatcherSchemaPatterns(
                pattern = '', 
                types = ''
            )
        else :
    ...
    def testWatcherSchemaPatterns(self):
        """Test WatcherSchemaPatterns"""
