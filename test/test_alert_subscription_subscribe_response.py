...
import titan_client
from titan_client.models.alert_subscription_subscribe_response import AlertSubscriptionSubscribeResponse  # noqa: E501
from titan_client.rest import ApiException

class TestAlertSubscriptionSubscribeResponse(unittest.TestCase):
    """AlertSubscriptionSubscribeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AlertSubscriptionSubscribeResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.alert_subscription_subscribe_response.AlertSubscriptionSubscribeResponse()  # noqa: E501
        if include_optional :
            return AlertSubscriptionSubscribeResponse(
                alert_subscriptions = [
                    titan_client.models.alert_subscription_schema.AlertSubscriptionSchema(
                        endpoint = '', 
                        status = '', )
                    ]
            )
    ...
    def testAlertSubscriptionSubscribeResponse(self):
        """Test AlertSubscriptionSubscribeResponse"""
