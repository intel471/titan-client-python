...
import titan_client
from titan_client.models.ioc_schema_links_reports import IocSchemaLinksReports  # noqa: E501
from titan_client.rest import ApiException

class TestIocSchemaLinksReports(unittest.TestCase):
    """IocSchemaLinksReports unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IocSchemaLinksReports
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.ioc_schema_links_reports.IocSchemaLinksReports()  # noqa: E501
        if include_optional :
            return IocSchemaLinksReports(
                admiralty_code = 'C3', 
    ...
    def testIocSchemaLinksReports(self):
        """Test IocSchemaLinksReports"""
