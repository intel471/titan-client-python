...
import titan_client
from titan_client.api.indicators_api import IndicatorsApi  # noqa: E501
...
class TestIndicatorsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = titan_client.api.indicators_api.IndicatorsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_indicators_get(self):
    ...
    def test_indicators_stream_get(self):
        """Test case for indicators_stream_get
