...
import titan_client
from titan_client.models.nids_search_schema_data_threat import NIDSSearchSchemaDataThreat  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchSchemaDataThreat(unittest.TestCase):
    """NIDSSearchSchemaDataThreat unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchSchemaDataThreat
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_schema_data_threat.NIDSSearchSchemaDataThreat()  # noqa: E501
        if include_optional :
            return NIDSSearchSchemaDataThreat(
    ...
    def testNIDSSearchSchemaDataThreat(self):
        """Test NIDSSearchSchemaDataThreat"""
