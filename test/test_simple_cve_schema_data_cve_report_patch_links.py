...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_patch_links import SimpleCveSchemaDataCveReportPatchLinks  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportPatchLinks(unittest.TestCase):
    """SimpleCveSchemaDataCveReportPatchLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportPatchLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_patch_links.SimpleCveSchemaDataCveReportPatchLinks()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportPatchLinks(
                title = '', 
                url = ''
            )
        else :
    ...
    def testSimpleCveSchemaDataCveReportPatchLinks(self):
        """Test SimpleCveSchemaDataCveReportPatchLinks"""
