...
import titan_client
from titan_client.models.simple_report_schema_actor_subject_of_report import SimpleReportSchemaActorSubjectOfReport  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaActorSubjectOfReport(unittest.TestCase):
    """SimpleReportSchemaActorSubjectOfReport unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaActorSubjectOfReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_actor_subject_of_report.SimpleReportSchemaActorSubjectOfReport()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaActorSubjectOfReport(
                aliases = [
                    ''
                    ], 
                handle = ''
    ...
    def testSimpleReportSchemaActorSubjectOfReport(self):
        """Test SimpleReportSchemaActorSubjectOfReport"""
