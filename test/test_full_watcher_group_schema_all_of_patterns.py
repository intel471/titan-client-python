...
import titan_client
from titan_client.models.full_watcher_group_schema_all_of_patterns import FullWatcherGroupSchemaAllOfPatterns  # noqa: E501
from titan_client.rest import ApiException

class TestFullWatcherGroupSchemaAllOfPatterns(unittest.TestCase):
    """FullWatcherGroupSchemaAllOfPatterns unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullWatcherGroupSchemaAllOfPatterns
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_watcher_group_schema_all_of_patterns.FullWatcherGroupSchemaAllOfPatterns()  # noqa: E501
        if include_optional :
            return FullWatcherGroupSchemaAllOfPatterns(
                pattern = '', 
                types = ''
            )
        else :
    ...
    def testFullWatcherGroupSchemaAllOfPatterns(self):
        """Test FullWatcherGroupSchemaAllOfPatterns"""
