...
import titan_client
from titan_client.models.pcap_schema_data_pcap import PCAPSchemaDataPcap  # noqa: E501
from titan_client.rest import ApiException

class TestPCAPSchemaDataPcap(unittest.TestCase):
    """PCAPSchemaDataPcap unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PCAPSchemaDataPcap
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.pcap_schema_data_pcap.PCAPSchemaDataPcap()  # noqa: E501
        if include_optional :
            return PCAPSchemaDataPcap(
                date = 56, 
                exit_country = ''
            )
        else :
    ...
    def testPCAPSchemaDataPcap(self):
        """Test PCAPSchemaDataPcap"""
