...
import titan_client
from titan_client.models.event_schema_data import EventSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaData(unittest.TestCase):
    """EventSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data.EventSchemaData()  # noqa: E501
        if include_optional :
