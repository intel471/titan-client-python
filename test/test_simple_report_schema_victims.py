...
import titan_client
from titan_client.models.simple_report_schema_victims import SimpleReportSchemaVictims  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaVictims(unittest.TestCase):
    """SimpleReportSchemaVictims unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaVictims
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_victims.SimpleReportSchemaVictims()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaVictims(
                name = '', 
                urls = [
                    ''
                    ]
    ...
    def testSimpleReportSchemaVictims(self):
        """Test SimpleReportSchemaVictims"""
