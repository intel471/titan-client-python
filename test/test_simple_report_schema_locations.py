...
import titan_client
from titan_client.models.simple_report_schema_locations import SimpleReportSchemaLocations  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaLocations(unittest.TestCase):
    """SimpleReportSchemaLocations unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaLocations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_locations.SimpleReportSchemaLocations()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaLocations(
                country = '', 
                link = '', 
                region = ''
            )
    ...
    def testSimpleReportSchemaLocations(self):
        """Test SimpleReportSchemaLocations"""
