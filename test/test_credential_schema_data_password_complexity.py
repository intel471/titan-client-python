...
import titan_client
from titan_client.models.credential_schema_data_password_complexity import CredentialSchemaDataPasswordComplexity  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSchemaDataPasswordComplexity(unittest.TestCase):
    """CredentialSchemaDataPasswordComplexity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSchemaDataPasswordComplexity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_schema_data_password_complexity.CredentialSchemaDataPasswordComplexity()  # noqa: E501
        if include_optional :
            return CredentialSchemaDataPasswordComplexity(
                entropy = 1.337, 
                length = 1.337, 
                lowercase = 1.337, 
                numbers = 1.337, 
    ...
    def testCredentialSchemaDataPasswordComplexity(self):
        """Test CredentialSchemaDataPasswordComplexity"""
