...
import titan_client
from titan_client.models.event_schema_data_event_data_controller_geo_ip_isp import EventSchemaDataEventDataControllerGeoIpIsp  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataControllerGeoIpIsp(unittest.TestCase):
    """EventSchemaDataEventDataControllerGeoIpIsp unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataControllerGeoIpIsp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_controller_geo_ip_isp.EventSchemaDataEventDataControllerGeoIpIsp()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataControllerGeoIpIsp(
                autonomous_system = '', 
                isp = '', 
                network = '', 
                organization = ''
    ...
    def testEventSchemaDataEventDataControllerGeoIpIsp(self):
        """Test EventSchemaDataEventDataControllerGeoIpIsp"""
