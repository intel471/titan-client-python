...
import titan_client
from titan_client.models.indicator_search_schema_activity import IndicatorSearchSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestIndicatorSearchSchemaActivity(unittest.TestCase):
    """IndicatorSearchSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IndicatorSearchSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.indicator_search_schema_activity.IndicatorSearchSchemaActivity()  # noqa: E501
        if include_optional :
            return IndicatorSearchSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testIndicatorSearchSchemaActivity(self):
        """Test IndicatorSearchSchemaActivity"""
