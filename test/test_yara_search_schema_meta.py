...
import titan_client
from titan_client.models.yara_search_schema_meta import YARASearchSchemaMeta  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchSchemaMeta(unittest.TestCase):
    """YARASearchSchemaMeta unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchSchemaMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_schema_meta.YARASearchSchemaMeta()  # noqa: E501
        if include_optional :
            return YARASearchSchemaMeta(
                version = ''
            )
        else :
            return YARASearchSchemaMeta(
    ...
    def testYARASearchSchemaMeta(self):
        """Test YARASearchSchemaMeta"""
