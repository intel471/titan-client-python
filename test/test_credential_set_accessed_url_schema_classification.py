...
import titan_client
from titan_client.models.credential_set_accessed_url_schema_classification import CredentialSetAccessedUrlSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetAccessedUrlSchemaClassification(unittest.TestCase):
    """CredentialSetAccessedUrlSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetAccessedUrlSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_accessed_url_schema_classification.CredentialSetAccessedUrlSchemaClassification()  # noqa: E501
        if include_optional :
            return CredentialSetAccessedUrlSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testCredentialSetAccessedUrlSchemaClassification(self):
        """Test CredentialSetAccessedUrlSchemaClassification"""
