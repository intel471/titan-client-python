...
import titan_client
from titan_client.models.credential_accessed_url_schema_classification import CredentialAccessedUrlSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialAccessedUrlSchemaClassification(unittest.TestCase):
    """CredentialAccessedUrlSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialAccessedUrlSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_accessed_url_schema_classification.CredentialAccessedUrlSchemaClassification()  # noqa: E501
        if include_optional :
            return CredentialAccessedUrlSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testCredentialAccessedUrlSchemaClassification(self):
        """Test CredentialAccessedUrlSchemaClassification"""
