...
import titan_client
from titan_client.models.simple_cve_schema_data import SimpleCveSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaData(unittest.TestCase):
    """SimpleCveSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data.SimpleCveSchemaData()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaData(
    ...
    def testSimpleCveSchemaData(self):
        """Test SimpleCveSchemaData"""
