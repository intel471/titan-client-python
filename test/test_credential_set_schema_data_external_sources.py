...
import titan_client
from titan_client.models.credential_set_schema_data_external_sources import CredentialSetSchemaDataExternalSources  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetSchemaDataExternalSources(unittest.TestCase):
    """CredentialSetSchemaDataExternalSources unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetSchemaDataExternalSources
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_schema_data_external_sources.CredentialSetSchemaDataExternalSources()  # noqa: E501
        if include_optional :
            return CredentialSetSchemaDataExternalSources(
                title = '', 
                url = ''
            )
        else :
    ...
    def testCredentialSetSchemaDataExternalSources(self):
        """Test CredentialSetSchemaDataExternalSources"""
