...
import titan_client
from titan_client.api.forums_api import ForumsApi  # noqa: E501
...
class TestForumsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = titan_client.api.forums_api.ForumsApi()  # noqa: E501
    ...
    def test_private_messages_get(self):
        """Test case for private_messages_get
