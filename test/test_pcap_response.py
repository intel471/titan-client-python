...
import titan_client
from titan_client.models.pcap_response import PCAPResponse  # noqa: E501
from titan_client.rest import ApiException

class TestPCAPResponse(unittest.TestCase):
    """PCAPResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = titan_client.models.pcap_response.PCAPResponse()  # noqa: E501
        if include_optional :
            return PCAPResponse(
                pcap_total_count = 56, 
                pcaps = [
                    titan_client.models.pcap_schema.PCAPSchema(
                        data = titan_client.models.pcap_schema_data.PCAPSchema_data(
                            file = titan_client.models.pcap_schema_data_file.PCAPSchema_data_file(
                                download_url = '', 
                                sha256 = '', ), 
                            malware_family = titan_client.models.pcap_schema_data_malware_family.PCAPSchema_data_malware_family(
                                family = '', 
                                uid = '', ), 
                            pcap = titan_client.models.pcap_schema_data_pcap.PCAPSchema_data_pcap(
                                date = 56, 
                                exit_country = '', ), ), 
                        last_updated = 56, 
                        uid = '', )
