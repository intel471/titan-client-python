...
import titan_client
from titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data_victims import SimpleSpotReportSchemaDataSpotReportSpotReportDataVictims  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleSpotReportSchemaDataSpotReportSpotReportDataVictims(unittest.TestCase):
    """SimpleSpotReportSchemaDataSpotReportSpotReportDataVictims unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleSpotReportSchemaDataSpotReportSpotReportDataVictims
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data_victims.SimpleSpotReportSchemaDataSpotReportSpotReportDataVictims()  # noqa: E501
        if include_optional :
            return SimpleSpotReportSchemaDataSpotReportSpotReportDataVictims(
                name = '', 
                urls = [
                    ''
                    ]
    ...
    def testSimpleSpotReportSchemaDataSpotReportSpotReportDataVictims(self):
        """Test SimpleSpotReportSchemaDataSpotReportSpotReportDataVictims"""
