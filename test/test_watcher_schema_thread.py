...
import titan_client
from titan_client.models.watcher_schema_thread import WatcherSchemaThread  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherSchemaThread(unittest.TestCase):
    """WatcherSchemaThread unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherSchemaThread
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_schema_thread.WatcherSchemaThread()  # noqa: E501
        if include_optional :
            return WatcherSchemaThread(
                topic = '', 
                uid = ''
            )
        else :
    ...
    def testWatcherSchemaThread(self):
        """Test WatcherSchemaThread"""
