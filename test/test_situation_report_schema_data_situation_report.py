...
import titan_client
from titan_client.models.situation_report_schema_data_situation_report import SituationReportSchemaDataSituationReport  # noqa: E501
from titan_client.rest import ApiException

class TestSituationReportSchemaDataSituationReport(unittest.TestCase):
    """SituationReportSchemaDataSituationReport unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SituationReportSchemaDataSituationReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.situation_report_schema_data_situation_report.SituationReportSchemaDataSituationReport()  # noqa: E501
        if include_optional :
            return SituationReportSchemaDataSituationReport(
                entities = [
    ...
    def testSituationReportSchemaDataSituationReport(self):
        """Test SituationReportSchemaDataSituationReport"""
