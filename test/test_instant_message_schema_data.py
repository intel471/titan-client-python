...
import titan_client
from titan_client.models.instant_message_schema_data import InstantMessageSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaData(unittest.TestCase):
    """InstantMessageSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_data.InstantMessageSchemaData()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaData(
    ...
    def testInstantMessageSchemaData(self):
        """Test InstantMessageSchemaData"""
