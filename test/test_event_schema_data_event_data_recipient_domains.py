...
import titan_client
from titan_client.models.event_schema_data_event_data_recipient_domains import EventSchemaDataEventDataRecipientDomains  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataRecipientDomains(unittest.TestCase):
    """EventSchemaDataEventDataRecipientDomains unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataRecipientDomains
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_recipient_domains.EventSchemaDataEventDataRecipientDomains()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataRecipientDomains(
                count = 56, 
                domain = ''
            )
        else :
    ...
    def testEventSchemaDataEventDataRecipientDomains(self):
        """Test EventSchemaDataEventDataRecipientDomains"""
