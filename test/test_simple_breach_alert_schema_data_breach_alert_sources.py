...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_breach_alert_sources import SimpleBreachAlertSchemaDataBreachAlertSources  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataBreachAlertSources(unittest.TestCase):
    """SimpleBreachAlertSchemaDataBreachAlertSources unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataBreachAlertSources
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_breach_alert_sources.SimpleBreachAlertSchemaDataBreachAlertSources()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataBreachAlertSources(
                date = 56, 
                source_type = '', 
                title = '', 
                type = 'internal', 
    ...
    def testSimpleBreachAlertSchemaDataBreachAlertSources(self):
        """Test SimpleBreachAlertSchemaDataBreachAlertSources"""
