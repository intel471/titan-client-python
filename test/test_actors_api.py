...
import titan_client
from titan_client.api.actors_api import ActorsApi  # noqa: E501
...
class TestActorsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = titan_client.api.actors_api.ActorsApi()  # noqa: E501
    ...
    def test_actors_uid_get(self):
        """Test case for actors_uid_get
