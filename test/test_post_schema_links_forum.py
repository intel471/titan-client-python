...
import titan_client
from titan_client.models.post_schema_links_forum import PostSchemaLinksForum  # noqa: E501
from titan_client.rest import ApiException

class TestPostSchemaLinksForum(unittest.TestCase):
    """PostSchemaLinksForum unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostSchemaLinksForum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.post_schema_links_forum.PostSchemaLinksForum()  # noqa: E501
        if include_optional :
            return PostSchemaLinksForum(
                description = '', 
                name = '', 
                uid = ''
            )
    ...
    def testPostSchemaLinksForum(self):
        """Test PostSchemaLinksForum"""
