...
import titan_client
from titan_client.models.entities_schema_links import EntitiesSchemaLinks  # noqa: E501
from titan_client.rest import ApiException

class TestEntitiesSchemaLinks(unittest.TestCase):
    """EntitiesSchemaLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EntitiesSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.entities_schema_links.EntitiesSchemaLinks()  # noqa: E501
        if include_optional :
            return EntitiesSchemaLinks(
    ...
    def testEntitiesSchemaLinks(self):
        """Test EntitiesSchemaLinks"""
