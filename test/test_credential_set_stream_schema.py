...
class TestCredentialSetStreamSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialSetStreamSchema:
        """Test CredentialSetStreamSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialSetStreamSchema`
        """
        model = CredentialSetStreamSchema()
        if include_optional:
