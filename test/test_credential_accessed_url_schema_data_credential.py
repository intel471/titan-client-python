...
import titan_client
from titan_client.models.credential_accessed_url_schema_data_credential import CredentialAccessedUrlSchemaDataCredential  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialAccessedUrlSchemaDataCredential(unittest.TestCase):
    """CredentialAccessedUrlSchemaDataCredential unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialAccessedUrlSchemaDataCredential
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_accessed_url_schema_data_credential.CredentialAccessedUrlSchemaDataCredential()  # noqa: E501
        if include_optional :
            return CredentialAccessedUrlSchemaDataCredential(
                affiliations = [
                    ''
                    ], 
                credential_domain = '', 
    ...
    def testCredentialAccessedUrlSchemaDataCredential(self):
        """Test CredentialAccessedUrlSchemaDataCredential"""
