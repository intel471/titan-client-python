...
import titan_client
from titan_client.models.yara_search_schema_activity import YARASearchSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchSchemaActivity(unittest.TestCase):
    """YARASearchSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_schema_activity.YARASearchSchemaActivity()  # noqa: E501
        if include_optional :
            return YARASearchSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testYARASearchSchemaActivity(self):
        """Test YARASearchSchemaActivity"""
