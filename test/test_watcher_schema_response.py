...
import titan_client
from titan_client.models.watcher_schema_response import WatcherSchemaResponse  # noqa: E501
...
class TestWatcherSchemaResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = titan_client.models.watcher_schema_response.WatcherSchemaResponse()  # noqa: E501
        if include_optional :
            return WatcherSchemaResponse(
                ...
                watchers = [
                    titan_client.models.watcher_schema.WatcherSchema(
                        ...
                        filters = [
                            titan_client.models.watcher_schema_filters.WatcherSchema_filters(
                                filter = '', 
                                type = '', )
                            ], 
                        girs = [
                        ...
                        links = [
                            titan_client.models.watcher_schema_links.WatcherSchema_links(
                                forum = titan_client.models.watcher_schema_forum.WatcherSchema_forum(
                                    description = '', 
                                    name = '', 
                                    uid = '', ), 
                                thread = titan_client.models.watcher_schema_thread.WatcherSchema_thread(
                                    topic = '', 
                                    uid = '', ), )
                            ], 
                        ...
                        patterns = [
                            titan_client.models.watcher_schema_patterns.WatcherSchema_patterns(
                                pattern = '', 
                                types = '', )
                            ], 
                        type = 'search', 
