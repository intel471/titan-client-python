...
class TestWatcherSchemaResponse(unittest.TestCase):
    """WatcherSchemaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatcherSchemaResponse:
        """Test WatcherSchemaResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatcherSchemaResponse`
        """
        model = WatcherSchemaResponse()
        if include_optional:
            return WatcherSchemaResponse(
                watcher_total_count = 56,
                watchers = [
                    titan_client.models.watcher_schema.WatcherSchema(
                        data_sets = [
                            ''
                            ], 
                        description = '', 
                        filter_by_gir_set = 'my_girs', 
                        filters = [
                            titan_client.models.watcher_schema_filters_inner.WatcherSchema_filters_inner(
                                filter = '', 
                                type = '', )
                            ], 
                        girs = [
                        ...
                        links = [
                            titan_client.models.watcher_schema_links_inner.WatcherSchema_links_inner(
                                forum = titan_client.models.watcher_schema_links_inner_forum.WatcherSchema_links_inner_forum(
                                    description = '', 
                                    name = '', 
                                    uid = '', ), 
                                thread = titan_client.models.watcher_schema_links_inner_thread.WatcherSchema_links_inner_thread(
                                    topic = '', 
                                    uid = '', ), )
                            ], 
                        muted = True, 
                        ...
                        patterns = [
                            titan_client.models.watcher_schema_patterns_inner.WatcherSchema_patterns_inner(
                                pattern = '', 
                                types = '', )
                            ], 
                        thread_type = 'forums', 
    ...
    def testWatcherSchemaResponse(self):
        """Test WatcherSchemaResponse"""
