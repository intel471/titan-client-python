...
import titan_client
from titan_client.models.simple_actor_schema_links_forums import SimpleActorSchemaLinksForums  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleActorSchemaLinksForums(unittest.TestCase):
    """SimpleActorSchemaLinksForums unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleActorSchemaLinksForums
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_actor_schema_links_forums.SimpleActorSchemaLinksForums()  # noqa: E501
        if include_optional :
            return SimpleActorSchemaLinksForums(
                actor_handle = '', 
                contact_info = [
    ...
    def testSimpleActorSchemaLinksForums(self):
        """Test SimpleActorSchemaLinksForums"""
