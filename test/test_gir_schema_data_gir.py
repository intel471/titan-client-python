...
import titan_client
from titan_client.models.gir_schema_data_gir import GirSchemaDataGir  # noqa: E501
from titan_client.rest import ApiException

class TestGirSchemaDataGir(unittest.TestCase):
    """GirSchemaDataGir unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GirSchemaDataGir
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.gir_schema_data_gir.GirSchemaDataGir()  # noqa: E501
        if include_optional :
            return GirSchemaDataGir(
                description = '', 
                name = '', 
