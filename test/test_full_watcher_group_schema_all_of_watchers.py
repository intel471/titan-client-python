...
import titan_client
from titan_client.models.full_watcher_group_schema_all_of_watchers import FullWatcherGroupSchemaAllOfWatchers  # noqa: E501
from titan_client.rest import ApiException

class TestFullWatcherGroupSchemaAllOfWatchers(unittest.TestCase):
    """FullWatcherGroupSchemaAllOfWatchers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullWatcherGroupSchemaAllOfWatchers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_watcher_group_schema_all_of_watchers.FullWatcherGroupSchemaAllOfWatchers()  # noqa: E501
        if include_optional :
            return FullWatcherGroupSchemaAllOfWatchers(
                description = '', 
    ...
    def testFullWatcherGroupSchemaAllOfWatchers(self):
        """Test FullWatcherGroupSchemaAllOfWatchers"""
