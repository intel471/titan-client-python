...
import titan_client
from titan_client.models.messaging_services_response import MessagingServicesResponse  # noqa: E501
from titan_client.rest import ApiException

class TestMessagingServicesResponse(unittest.TestCase):
    """MessagingServicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MessagingServicesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.messaging_services_response.MessagingServicesResponse()  # noqa: E501
        if include_optional :
            return MessagingServicesResponse(
                instant_message_partial_result = True, 
    ...
    def testMessagingServicesResponse(self):
        """Test MessagingServicesResponse"""
