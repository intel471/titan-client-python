...
class TestMessagingServicesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessagingServicesResponse:
        """Test MessagingServicesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessagingServicesResponse`
        """
        model = MessagingServicesResponse()
        if include_optional:
