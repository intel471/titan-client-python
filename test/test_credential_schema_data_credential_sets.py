...
import titan_client
from titan_client.models.credential_schema_data_credential_sets import CredentialSchemaDataCredentialSets  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSchemaDataCredentialSets(unittest.TestCase):
    """CredentialSchemaDataCredentialSets unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSchemaDataCredentialSets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_schema_data_credential_sets.CredentialSchemaDataCredentialSets()  # noqa: E501
        if include_optional :
            return CredentialSchemaDataCredentialSets(
                name = '', 
                uid = ''
            )
        else :
    ...
    def testCredentialSchemaDataCredentialSets(self):
        """Test CredentialSchemaDataCredentialSets"""
