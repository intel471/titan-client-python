...
import titan_client
from titan_client.models.simple_cves_response import SimpleCvesResponse  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCvesResponse(unittest.TestCase):
    """SimpleCvesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCvesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cves_response.SimpleCvesResponse()  # noqa: E501
        if include_optional :
            return SimpleCvesResponse(
                cve_reports = [
    ...
    def testSimpleCvesResponse(self):
        """Test SimpleCvesResponse"""
