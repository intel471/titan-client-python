...
import titan_client
from titan_client.models.entities_schema_links_actors import EntitiesSchemaLinksActors  # noqa: E501
from titan_client.rest import ApiException

class TestEntitiesSchemaLinksActors(unittest.TestCase):
    """EntitiesSchemaLinksActors unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EntitiesSchemaLinksActors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.entities_schema_links_actors.EntitiesSchemaLinksActors()  # noqa: E501
        if include_optional :
            return EntitiesSchemaLinksActors(
                handles = [
                    ''
                    ], 
                uid = ''
    ...
    def testEntitiesSchemaLinksActors(self):
        """Test EntitiesSchemaLinksActors"""
