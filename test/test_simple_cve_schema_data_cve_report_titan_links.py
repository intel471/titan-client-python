...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_titan_links import SimpleCveSchemaDataCveReportTitanLinks  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportTitanLinks(unittest.TestCase):
    """SimpleCveSchemaDataCveReportTitanLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportTitanLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_titan_links.SimpleCveSchemaDataCveReportTitanLinks()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportTitanLinks(
                title = '', 
                url = ''
            )
        else :
    ...
    def testSimpleCveSchemaDataCveReportTitanLinks(self):
        """Test SimpleCveSchemaDataCveReportTitanLinks"""
