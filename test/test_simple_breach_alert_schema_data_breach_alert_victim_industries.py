...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_breach_alert_victim_industries import SimpleBreachAlertSchemaDataBreachAlertVictimIndustries  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataBreachAlertVictimIndustries(unittest.TestCase):
    """SimpleBreachAlertSchemaDataBreachAlertVictimIndustries unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataBreachAlertVictimIndustries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_breach_alert_victim_industries.SimpleBreachAlertSchemaDataBreachAlertVictimIndustries()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataBreachAlertVictimIndustries(
                industry = '', 
                sector = ''
            )
        else :
    ...
    def testSimpleBreachAlertSchemaDataBreachAlertVictimIndustries(self):
        """Test SimpleBreachAlertSchemaDataBreachAlertVictimIndustries"""
