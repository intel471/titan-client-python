...
import titan_client
from titan_client.models.credential_schema_classification import CredentialSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSchemaClassification(unittest.TestCase):
    """CredentialSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_schema_classification.CredentialSchemaClassification()  # noqa: E501
        if include_optional :
            return CredentialSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testCredentialSchemaClassification(self):
        """Test CredentialSchemaClassification"""
