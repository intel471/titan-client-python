...
class TestSituationReportResponse(unittest.TestCase):
    """SituationReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SituationReportResponse:
        """Test SituationReportResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SituationReportResponse`
        """
        model = SituationReportResponse()
        if include_optional:
    ...
    def testSituationReportResponse(self):
        """Test SituationReportResponse"""
