...
import titan_client
from titan_client.models.post_schema_links import PostSchemaLinks  # noqa: E501
from titan_client.rest import ApiException

class TestPostSchemaLinks(unittest.TestCase):
    """PostSchemaLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.post_schema_links.PostSchemaLinks()  # noqa: E501
        if include_optional :
            return PostSchemaLinks(
