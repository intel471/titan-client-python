...
import titan_client
from titan_client.models.credential_sets_accessed_urls_response import CredentialSetsAccessedUrlsResponse  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetsAccessedUrlsResponse(unittest.TestCase):
    """CredentialSetsAccessedUrlsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetsAccessedUrlsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_sets_accessed_urls_response.CredentialSetsAccessedUrlsResponse()  # noqa: E501
        if include_optional :
            return CredentialSetsAccessedUrlsResponse(
                credential_sets_accessed_urls = [
                    titan_client.models.credential_set_accessed_url_schema.CredentialSetAccessedUrlSchema(
                        ...
                        data = titan_client.models.credential_set_accessed_url_schema_data.CredentialSetAccessedUrlSchema_data(
                            accessed_domain = '', 
                            accessed_url = '', 
    ...
    def testCredentialSetsAccessedUrlsResponse(self):
        """Test CredentialSetsAccessedUrlsResponse"""
