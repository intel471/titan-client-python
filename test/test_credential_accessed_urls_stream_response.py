...
import titan_client
from titan_client.models.credential_accessed_urls_stream_response import CredentialAccessedUrlsStreamResponse  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialAccessedUrlsStreamResponse(unittest.TestCase):
    """CredentialAccessedUrlsStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialAccessedUrlsStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_accessed_urls_stream_response.CredentialAccessedUrlsStreamResponse()  # noqa: E501
        if include_optional :
            return CredentialAccessedUrlsStreamResponse(
                credential_accessed_urls = [
                    titan_client.models.credential_accessed_url_stream_schema.CredentialAccessedUrlStreamSchema(
                        activity = titan_client.models.credential_accessed_url_schema_activity.CredentialAccessedUrlSchema_activity(
                            first = 56, 
                            last = 56, ), 
                        classification = titan_client.models.credential_accessed_url_schema_classification.CredentialAccessedUrlSchema_classification(
                            intel_requirements = [
                                ''
                                ], ), 
                        data = titan_client.models.credential_accessed_url_schema_data.CredentialAccessedUrlSchema_data(
                            accessed_domain = '', 
                            accessed_url = '', 
                            credential = titan_client.models.credential_accessed_url_schema_data_credential.CredentialAccessedUrlSchema_data_credential(
                                affiliations = [
                                    ''
                                    ], 
                                credential_domain = '', 
                ...
                credential_accessed_urls_partial_result = True, 
                credential_accessed_urls_total_count = 56, 
                cursor_next = ''
            )
        else :
            return CredentialAccessedUrlsStreamResponse(
    ...
    def testCredentialAccessedUrlsStreamResponse(self):
        """Test CredentialAccessedUrlsStreamResponse"""
