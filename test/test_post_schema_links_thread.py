...
import titan_client
from titan_client.models.post_schema_links_thread import PostSchemaLinksThread  # noqa: E501
from titan_client.rest import ApiException

class TestPostSchemaLinksThread(unittest.TestCase):
    """PostSchemaLinksThread unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostSchemaLinksThread
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.post_schema_links_thread.PostSchemaLinksThread()  # noqa: E501
        if include_optional :
            return PostSchemaLinksThread(
                count = 56, 
                topic = '', 
                topic_original = '', 
                uid = ''
    ...
    def testPostSchemaLinksThread(self):
        """Test PostSchemaLinksThread"""
