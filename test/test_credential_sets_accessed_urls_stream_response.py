...
import titan_client
from titan_client.models.credential_sets_accessed_urls_stream_response import CredentialSetsAccessedUrlsStreamResponse  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetsAccessedUrlsStreamResponse(unittest.TestCase):
    """CredentialSetsAccessedUrlsStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetsAccessedUrlsStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_sets_accessed_urls_stream_response.CredentialSetsAccessedUrlsStreamResponse()  # noqa: E501
        if include_optional :
            return CredentialSetsAccessedUrlsStreamResponse(
                credential_sets_accessed_urls = [
                    titan_client.models.credential_set_accessed_url_stream_schema.CredentialSetAccessedUrlStreamSchema(
                        activity = titan_client.models.credential_set_accessed_url_schema_activity.CredentialSetAccessedUrlSchema_activity(
                            first = 56, 
                            last = 56, ), 
                        classification = titan_client.models.credential_set_accessed_url_schema_classification.CredentialSetAccessedUrlSchema_classification(
                            intel_requirements = [
                                ''
                                ], ), 
                        data = titan_client.models.credential_set_accessed_url_stream_schema_data.CredentialSetAccessedUrlStreamSchema_data(
                            accessed_domain = '', 
                            accessed_url = '', 
                            credential_set = titan_client.models.credential_set_accessed_url_schema_data_credential_set.CredentialSetAccessedUrlSchema_data_credential_set(
                                name = '', 
                                uid = '', ), ), 
                        last_updated = 56, 
                        uid = '', )
                    ], 
                credential_sets_accessed_urls_partial_result = True, 
                credential_sets_accessed_urls_total_count = 56, 
                cursor_next = ''
            )
        else :
            return CredentialSetsAccessedUrlsStreamResponse(
    ...
    def testCredentialSetsAccessedUrlsStreamResponse(self):
        """Test CredentialSetsAccessedUrlsStreamResponse"""
