...
import titan_client
from titan_client.models.credential_set_stream_schema_data import CredentialSetStreamSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetStreamSchemaData(unittest.TestCase):
    """CredentialSetStreamSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetStreamSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_stream_schema_data.CredentialSetStreamSchemaData()  # noqa: E501
        if include_optional :
            return CredentialSetStreamSchemaData(
                breach_date = 56, 
                collection_date = 56, 
                description = '', 
                disclosure_date = 56, 
    ...
    def testCredentialSetStreamSchemaData(self):
        """Test CredentialSetStreamSchemaData"""
