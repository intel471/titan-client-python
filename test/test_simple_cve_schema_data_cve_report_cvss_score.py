...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_cvss_score import SimpleCveSchemaDataCveReportCvssScore  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportCvssScore(unittest.TestCase):
    """SimpleCveSchemaDataCveReportCvssScore unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportCvssScore
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_cvss_score.SimpleCveSchemaDataCveReportCvssScore()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportCvssScore(
                v2 = 1.337, 
                v3 = 1.337
            )
        else :
    ...
    def testSimpleCveSchemaDataCveReportCvssScore(self):
        """Test SimpleCveSchemaDataCveReportCvssScore"""
