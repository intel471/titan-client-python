...
class TestAlertListSchemaResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AlertListSchemaResponse:
        """Test AlertListSchemaResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertListSchemaResponse`
        """
        model = AlertListSchemaResponse()
        if include_optional:
