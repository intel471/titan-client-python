...
import titan_client
from titan_client.models.watcher_request_body_post_all_of import WatcherRequestBodyPostAllOf  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherRequestBodyPostAllOf(unittest.TestCase):
    """WatcherRequestBodyPostAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherRequestBodyPostAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_request_body_post_all_of.WatcherRequestBodyPostAllOf()  # noqa: E501
        if include_optional :
            return WatcherRequestBodyPostAllOf(
                type = 'search'
            )
        else :
            return WatcherRequestBodyPostAllOf(
    ...
    def testWatcherRequestBodyPostAllOf(self):
        """Test WatcherRequestBodyPostAllOf"""
