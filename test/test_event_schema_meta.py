...
import titan_client
from titan_client.models.event_schema_meta import EventSchemaMeta  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaMeta(unittest.TestCase):
    """EventSchemaMeta unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_meta.EventSchemaMeta()  # noqa: E501
        if include_optional :
            return EventSchemaMeta(
                version = ''
            )
        else :
            return EventSchemaMeta(
