...
import titan_client
from titan_client.models.alert_list_schema_report import AlertListSchemaReport  # noqa: E501
from titan_client.rest import ApiException

class TestAlertListSchemaReport(unittest.TestCase):
    """AlertListSchemaReport unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AlertListSchemaReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.alert_list_schema_report.AlertListSchemaReport()  # noqa: E501
        if include_optional :
            return AlertListSchemaReport(
                admiralty_code = 'C3', 
    ...
    def testAlertListSchemaReport(self):
        """Test AlertListSchemaReport"""
