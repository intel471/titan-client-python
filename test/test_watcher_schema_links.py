...
import titan_client
from titan_client.models.watcher_schema_links import WatcherSchemaLinks  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherSchemaLinks(unittest.TestCase):
    """WatcherSchemaLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_schema_links.WatcherSchemaLinks()  # noqa: E501
        if include_optional :
            return WatcherSchemaLinks(
    ...
    def testWatcherSchemaLinks(self):
        """Test WatcherSchemaLinks"""
