...
import titan_client
from titan_client.models.credential_sets_stream_response import CredentialSetsStreamResponse  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetsStreamResponse(unittest.TestCase):
    """CredentialSetsStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetsStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_sets_stream_response.CredentialSetsStreamResponse()  # noqa: E501
        if include_optional :
            return CredentialSetsStreamResponse(
                credential_sets = [
                    titan_client.models.credential_set_stream_schema.CredentialSetStreamSchema(
                        ...
                        data = titan_client.models.credential_set_stream_schema_data.CredentialSetStreamSchema_data(
                            breach_date = 56, 
                            collection_date = 56, 
                            description = '', 
                            disclosure_date = 56, 
                        ...
                        statistics = titan_client.models.credential_set_schema_statistics.CredentialSetSchema_statistics(
                            accessed_urls_total_count = 1.337, 
                            credential_occurrences_total_count = 1.337, 
                            credentials_total_count = 1.337, ), 
                        uid = '', )
                    ], 
                credential_sets_partial_result = True, 
    ...
    def testCredentialSetsStreamResponse(self):
        """Test CredentialSetsStreamResponse"""
