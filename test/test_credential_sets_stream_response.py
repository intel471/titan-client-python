...
class TestCredentialSetsStreamResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialSetsStreamResponse:
        """Test CredentialSetsStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialSetsStreamResponse`
        """
        model = CredentialSetsStreamResponse()
        if include_optional:
