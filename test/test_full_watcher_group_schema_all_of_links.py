...
import titan_client
from titan_client.models.full_watcher_group_schema_all_of_links import FullWatcherGroupSchemaAllOfLinks  # noqa: E501
from titan_client.rest import ApiException

class TestFullWatcherGroupSchemaAllOfLinks(unittest.TestCase):
    """FullWatcherGroupSchemaAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullWatcherGroupSchemaAllOfLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_watcher_group_schema_all_of_links.FullWatcherGroupSchemaAllOfLinks()  # noqa: E501
        if include_optional :
            return FullWatcherGroupSchemaAllOfLinks(
    ...
    def testFullWatcherGroupSchemaAllOfLinks(self):
        """Test FullWatcherGroupSchemaAllOfLinks"""
