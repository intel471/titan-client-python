...
import titan_client
from titan_client.models.private_message_schema_links_author_actor import PrivateMessageSchemaLinksAuthorActor  # noqa: E501
from titan_client.rest import ApiException

class TestPrivateMessageSchemaLinksAuthorActor(unittest.TestCase):
    """PrivateMessageSchemaLinksAuthorActor unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PrivateMessageSchemaLinksAuthorActor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.private_message_schema_links_author_actor.PrivateMessageSchemaLinksAuthorActor()  # noqa: E501
        if include_optional :
            return PrivateMessageSchemaLinksAuthorActor(
                handle = '', 
                uid = ''
            )
        else :
    ...
    def testPrivateMessageSchemaLinksAuthorActor(self):
        """Test PrivateMessageSchemaLinksAuthorActor"""
