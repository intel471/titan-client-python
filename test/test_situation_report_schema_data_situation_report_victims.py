...
import titan_client
from titan_client.models.situation_report_schema_data_situation_report_victims import SituationReportSchemaDataSituationReportVictims  # noqa: E501
from titan_client.rest import ApiException

class TestSituationReportSchemaDataSituationReportVictims(unittest.TestCase):
    """SituationReportSchemaDataSituationReportVictims unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SituationReportSchemaDataSituationReportVictims
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.situation_report_schema_data_situation_report_victims.SituationReportSchemaDataSituationReportVictims()  # noqa: E501
        if include_optional :
            return SituationReportSchemaDataSituationReportVictims(
                name = '', 
                urls = [
                    ''
                    ]
    ...
    def testSituationReportSchemaDataSituationReportVictims(self):
        """Test SituationReportSchemaDataSituationReportVictims"""
