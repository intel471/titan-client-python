...
import titan_client
from titan_client.models.news_schema_activity import NewsSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestNewsSchemaActivity(unittest.TestCase):
    """NewsSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NewsSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.news_schema_activity.NewsSchemaActivity()  # noqa: E501
        if include_optional :
            return NewsSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testNewsSchemaActivity(self):
        """Test NewsSchemaActivity"""
