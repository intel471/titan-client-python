...
class TestSimpleSpotReportsResponse(unittest.TestCase):
    """SimpleSpotReportsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSpotReportsResponse:
        """Test SimpleSpotReportsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSpotReportsResponse`
        """
        model = SimpleSpotReportsResponse()
        if include_optional:
            return SimpleSpotReportsResponse(
                partial_result = True,
                spot_reports = [
    ...
    def testSimpleSpotReportsResponse(self):
        """Test SimpleSpotReportsResponse"""
