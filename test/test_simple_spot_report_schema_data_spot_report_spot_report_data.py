...
class TestSimpleSpotReportSchemaDataSpotReportSpotReportData(unittest.TestCase):
    """SimpleSpotReportSchemaDataSpotReportSpotReportData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSpotReportSchemaDataSpotReportSpotReportData:
        """Test SimpleSpotReportSchemaDataSpotReportSpotReportData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSpotReportSchemaDataSpotReportSpotReportData`
        """
        model = SimpleSpotReportSchemaDataSpotReportSpotReportData()
        if include_optional:
            return SimpleSpotReportSchemaDataSpotReportSpotReportData(
    ...
    def testSimpleSpotReportSchemaDataSpotReportSpotReportData(self):
        """Test SimpleSpotReportSchemaDataSpotReportSpotReportData"""
