...
class TestSimpleSpotReportSchemaDataSpotReport(unittest.TestCase):
    """SimpleSpotReportSchemaDataSpotReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSpotReportSchemaDataSpotReport:
        """Test SimpleSpotReportSchemaDataSpotReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSpotReportSchemaDataSpotReport`
        """
        model = SimpleSpotReportSchemaDataSpotReport()
        if include_optional:
            return SimpleSpotReportSchemaDataSpotReport(
    ...
    def testSimpleSpotReportSchemaDataSpotReport(self):
        """Test SimpleSpotReportSchemaDataSpotReport"""
