...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_entities import SimpleBreachAlertSchemaDataEntities  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataEntities(unittest.TestCase):
    """SimpleBreachAlertSchemaDataEntities unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataEntities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_entities.SimpleBreachAlertSchemaDataEntities()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataEntities(
                description = '', 
    ...
    def testSimpleBreachAlertSchemaDataEntities(self):
        """Test SimpleBreachAlertSchemaDataEntities"""
