...
import titan_client
from titan_client.models.instant_message_schema_data_channel import InstantMessageSchemaDataChannel  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaDataChannel(unittest.TestCase):
    """InstantMessageSchemaDataChannel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaDataChannel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_data_channel.InstantMessageSchemaDataChannel()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaDataChannel(
                name = '', 
    ...
    def testInstantMessageSchemaDataChannel(self):
        """Test InstantMessageSchemaDataChannel"""
