...
import titan_client
from titan_client.models.ioc_schema_links_actors import IocSchemaLinksActors  # noqa: E501
from titan_client.rest import ApiException

class TestIocSchemaLinksActors(unittest.TestCase):
    """IocSchemaLinksActors unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IocSchemaLinksActors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.ioc_schema_links_actors.IocSchemaLinksActors()  # noqa: E501
        if include_optional :
            return IocSchemaLinksActors(
                handles = [
                    ''
                    ], 
                uid = ''
    ...
    def testIocSchemaLinksActors(self):
        """Test IocSchemaLinksActors"""
