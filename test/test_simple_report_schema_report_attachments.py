...
import titan_client
from titan_client.models.simple_report_schema_report_attachments import SimpleReportSchemaReportAttachments  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaReportAttachments(unittest.TestCase):
    """SimpleReportSchemaReportAttachments unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaReportAttachments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_report_attachments.SimpleReportSchemaReportAttachments()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaReportAttachments(
                description = '', 
                file_name = '', 
                file_size = 56, 
                malicious = True, 
    ...
    def testSimpleReportSchemaReportAttachments(self):
        """Test SimpleReportSchemaReportAttachments"""
