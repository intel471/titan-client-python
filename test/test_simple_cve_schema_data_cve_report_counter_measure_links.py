...
import titan_client
from titan_client.models.simple_cve_schema_data_cve_report_counter_measure_links import SimpleCveSchemaDataCveReportCounterMeasureLinks  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchemaDataCveReportCounterMeasureLinks(unittest.TestCase):
    """SimpleCveSchemaDataCveReportCounterMeasureLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchemaDataCveReportCounterMeasureLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema_data_cve_report_counter_measure_links.SimpleCveSchemaDataCveReportCounterMeasureLinks()  # noqa: E501
        if include_optional :
            return SimpleCveSchemaDataCveReportCounterMeasureLinks(
                title = '', 
                url = ''
            )
        else :
    ...
    def testSimpleCveSchemaDataCveReportCounterMeasureLinks(self):
        """Test SimpleCveSchemaDataCveReportCounterMeasureLinks"""
