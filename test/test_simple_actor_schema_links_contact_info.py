...
import titan_client
from titan_client.models.simple_actor_schema_links_contact_info import SimpleActorSchemaLinksContactInfo  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleActorSchemaLinksContactInfo(unittest.TestCase):
    """SimpleActorSchemaLinksContactInfo unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleActorSchemaLinksContactInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_actor_schema_links_contact_info.SimpleActorSchemaLinksContactInfo()  # noqa: E501
        if include_optional :
            return SimpleActorSchemaLinksContactInfo(
                type = '', 
                value = ''
            )
        else :
    ...
    def testSimpleActorSchemaLinksContactInfo(self):
        """Test SimpleActorSchemaLinksContactInfo"""
