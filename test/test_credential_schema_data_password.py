...
import titan_client
from titan_client.models.credential_schema_data_password import CredentialSchemaDataPassword  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSchemaDataPassword(unittest.TestCase):
    """CredentialSchemaDataPassword unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSchemaDataPassword
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_schema_data_password.CredentialSchemaDataPassword()  # noqa: E501
        if include_optional :
            return CredentialSchemaDataPassword(
    ...
    def testCredentialSchemaDataPassword(self):
        """Test CredentialSchemaDataPassword"""
