...
import titan_client
from titan_client.models.full_watcher_group_schema_all_of_links_forum import FullWatcherGroupSchemaAllOfLinksForum  # noqa: E501
from titan_client.rest import ApiException

class TestFullWatcherGroupSchemaAllOfLinksForum(unittest.TestCase):
    """FullWatcherGroupSchemaAllOfLinksForum unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullWatcherGroupSchemaAllOfLinksForum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_watcher_group_schema_all_of_links_forum.FullWatcherGroupSchemaAllOfLinksForum()  # noqa: E501
        if include_optional :
            return FullWatcherGroupSchemaAllOfLinksForum(
                description = '', 
                name = '', 
                uid = ''
            )
    ...
    def testFullWatcherGroupSchemaAllOfLinksForum(self):
        """Test FullWatcherGroupSchemaAllOfLinksForum"""
