...
import titan_client
from titan_client.models.full_watcher_group_schema_all_of_links_thread import FullWatcherGroupSchemaAllOfLinksThread  # noqa: E501
from titan_client.rest import ApiException

class TestFullWatcherGroupSchemaAllOfLinksThread(unittest.TestCase):
    """FullWatcherGroupSchemaAllOfLinksThread unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullWatcherGroupSchemaAllOfLinksThread
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_watcher_group_schema_all_of_links_thread.FullWatcherGroupSchemaAllOfLinksThread()  # noqa: E501
        if include_optional :
            return FullWatcherGroupSchemaAllOfLinksThread(
                count = 56, 
                topic = '', 
                uid = ''
            )
    ...
    def testFullWatcherGroupSchemaAllOfLinksThread(self):
        """Test FullWatcherGroupSchemaAllOfLinksThread"""
