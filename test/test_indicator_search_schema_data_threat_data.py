...
import titan_client
from titan_client.models.indicator_search_schema_data_threat_data import IndicatorSearchSchemaDataThreatData  # noqa: E501
from titan_client.rest import ApiException

class TestIndicatorSearchSchemaDataThreatData(unittest.TestCase):
    """IndicatorSearchSchemaDataThreatData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IndicatorSearchSchemaDataThreatData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.indicator_search_schema_data_threat_data.IndicatorSearchSchemaDataThreatData()  # noqa: E501
        if include_optional :
            return IndicatorSearchSchemaDataThreatData(
                family = '', 
    ...
    def testIndicatorSearchSchemaDataThreatData(self):
        """Test IndicatorSearchSchemaDataThreatData"""
