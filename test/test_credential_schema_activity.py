...
import titan_client
from titan_client.models.credential_schema_activity import CredentialSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSchemaActivity(unittest.TestCase):
    """CredentialSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_schema_activity.CredentialSchemaActivity()  # noqa: E501
        if include_optional :
            return CredentialSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testCredentialSchemaActivity(self):
        """Test CredentialSchemaActivity"""
