...
import titan_client
from titan_client.models.private_message_schema_links_forum import PrivateMessageSchemaLinksForum  # noqa: E501
from titan_client.rest import ApiException

class TestPrivateMessageSchemaLinksForum(unittest.TestCase):
    """PrivateMessageSchemaLinksForum unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PrivateMessageSchemaLinksForum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.private_message_schema_links_forum.PrivateMessageSchemaLinksForum()  # noqa: E501
        if include_optional :
            return PrivateMessageSchemaLinksForum(
                description = '', 
                name = '', 
                uid = ''
            )
    ...
    def testPrivateMessageSchemaLinksForum(self):
        """Test PrivateMessageSchemaLinksForum"""
