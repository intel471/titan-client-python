...
import titan_client
from titan_client.models.event_schema_data_event_data_controllers import EventSchemaDataEventDataControllers  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataControllers(unittest.TestCase):
    """EventSchemaDataEventDataControllers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataControllers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_controllers.EventSchemaDataEventDataControllers()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataControllers(
                url = ''
            )
        else :
            return EventSchemaDataEventDataControllers(
    ...
    def testEventSchemaDataEventDataControllers(self):
        """Test EventSchemaDataEventDataControllers"""
