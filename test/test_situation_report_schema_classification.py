...
import titan_client
from titan_client.models.situation_report_schema_classification import SituationReportSchemaClassification  # noqa: E501
from titan_client.rest import ApiException

class TestSituationReportSchemaClassification(unittest.TestCase):
    """SituationReportSchemaClassification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SituationReportSchemaClassification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.situation_report_schema_classification.SituationReportSchemaClassification()  # noqa: E501
        if include_optional :
            return SituationReportSchemaClassification(
                intel_requirements = [
                    ''
                    ]
            )
    ...
    def testSituationReportSchemaClassification(self):
        """Test SituationReportSchemaClassification"""
