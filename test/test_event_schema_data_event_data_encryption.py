...
import titan_client
from titan_client.models.event_schema_data_event_data_encryption import EventSchemaDataEventDataEncryption  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataEventDataEncryption(unittest.TestCase):
    """EventSchemaDataEventDataEncryption unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataEventDataEncryption
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_event_data_encryption.EventSchemaDataEventDataEncryption()  # noqa: E501
        if include_optional :
            return EventSchemaDataEventDataEncryption(
                algorithm = '', 
                context = '', 
                key = ''
            )
    ...
    def testEventSchemaDataEventDataEncryption(self):
        """Test EventSchemaDataEventDataEncryption"""
