...
import titan_client
from titan_client.models.nids_search_schema import NIDSSearchSchema  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchSchema(unittest.TestCase):
    """NIDSSearchSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_schema.NIDSSearchSchema()  # noqa: E501
        if include_optional :
            return NIDSSearchSchema(
