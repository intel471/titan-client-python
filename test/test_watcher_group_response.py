...
import titan_client
from titan_client.models.watcher_group_response import WatcherGroupResponse  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherGroupResponse(unittest.TestCase):
    """WatcherGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherGroupResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_group_response.WatcherGroupResponse()  # noqa: E501
        if include_optional :
            return WatcherGroupResponse(
                watcher_group_total_count = 56, 
                watcher_groups = [
                    titan_client.models.simple_watcher_group_schema.SimpleWatcherGroupSchema(
                        description = '', 
                        name = '', 
                        owner = '', 
                        type = 'owned_by_me', 
    ...
    def testWatcherGroupResponse(self):
        """Test WatcherGroupResponse"""
