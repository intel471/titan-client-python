...
import titan_client
from titan_client.models.simple_breach_alert_schema_activity import SimpleBreachAlertSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaActivity(unittest.TestCase):
    """SimpleBreachAlertSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_activity.SimpleBreachAlertSchemaActivity()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testSimpleBreachAlertSchemaActivity(self):
        """Test SimpleBreachAlertSchemaActivity"""
