...
import titan_client
from titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data_links import SimpleSpotReportSchemaDataSpotReportSpotReportDataLinks  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleSpotReportSchemaDataSpotReportSpotReportDataLinks(unittest.TestCase):
    """SimpleSpotReportSchemaDataSpotReportSpotReportDataLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleSpotReportSchemaDataSpotReportSpotReportDataLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data_links.SimpleSpotReportSchemaDataSpotReportSpotReportDataLinks()  # noqa: E501
        if include_optional :
            return SimpleSpotReportSchemaDataSpotReportSpotReportDataLinks(
                title = '', 
                type = '', 
                url = ''
            )
    ...
    def testSimpleSpotReportSchemaDataSpotReportSpotReportDataLinks(self):
        """Test SimpleSpotReportSchemaDataSpotReportSpotReportDataLinks"""
