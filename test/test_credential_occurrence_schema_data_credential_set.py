...
import titan_client
from titan_client.models.credential_occurrence_schema_data_credential_set import CredentialOccurrenceSchemaDataCredentialSet  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialOccurrenceSchemaDataCredentialSet(unittest.TestCase):
    """CredentialOccurrenceSchemaDataCredentialSet unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialOccurrenceSchemaDataCredentialSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_occurrence_schema_data_credential_set.CredentialOccurrenceSchemaDataCredentialSet()  # noqa: E501
        if include_optional :
            return CredentialOccurrenceSchemaDataCredentialSet(
                name = '', 
                uid = ''
            )
        else :
    ...
    def testCredentialOccurrenceSchemaDataCredentialSet(self):
        """Test CredentialOccurrenceSchemaDataCredentialSet"""
