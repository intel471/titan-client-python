...
import titan_client
from titan_client.models.full_watcher_group_schema_all_of import FullWatcherGroupSchemaAllOf  # noqa: E501
from titan_client.rest import ApiException

class TestFullWatcherGroupSchemaAllOf(unittest.TestCase):
    """FullWatcherGroupSchemaAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullWatcherGroupSchemaAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.full_watcher_group_schema_all_of.FullWatcherGroupSchemaAllOf()  # noqa: E501
        if include_optional :
            return FullWatcherGroupSchemaAllOf(
                watchers = [
                    titan_client.models.full_watcher_group_schema_all_of_watchers.FullWatcherGroupSchema_allOf_watchers(
                        description = '', 
                        links = titan_client.models.full_watcher_group_schema_all_of_links.FullWatcherGroupSchema_allOf_links(
                            forum = titan_client.models.full_watcher_group_schema_all_of_links_forum.FullWatcherGroupSchema_allOf_links_forum(
                                description = '', 
                                name = '', 
                                uid = '', ), 
                            thread = titan_client.models.full_watcher_group_schema_all_of_links_thread.FullWatcherGroupSchema_allOf_links_thread(
                                count = 56, 
                                topic = '', 
                                uid = '', ), ), 
                        patterns = [
                            titan_client.models.full_watcher_group_schema_all_of_patterns.FullWatcherGroupSchema_allOf_patterns(
                                pattern = '', 
                                types = '', )
                            ], 
                        type = '', 
    ...
    def testFullWatcherGroupSchemaAllOf(self):
        """Test FullWatcherGroupSchemaAllOf"""
