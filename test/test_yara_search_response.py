...
import titan_client
from titan_client.models.yara_search_response import YARASearchResponse  # noqa: E501
from titan_client.rest import ApiException

class TestYARASearchResponse(unittest.TestCase):
    """YARASearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test YARASearchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.yara_search_response.YARASearchResponse()  # noqa: E501
        if include_optional :
            return YARASearchResponse(
                yara_partial_result = True, 
                yara_total_count = 56, 
                yaras = [
    ...
    def testYARASearchResponse(self):
        """Test YARASearchResponse"""
