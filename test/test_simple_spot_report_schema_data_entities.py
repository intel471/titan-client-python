...
import titan_client
from titan_client.models.simple_spot_report_schema_data_entities import SimpleSpotReportSchemaDataEntities  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleSpotReportSchemaDataEntities(unittest.TestCase):
    """SimpleSpotReportSchemaDataEntities unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleSpotReportSchemaDataEntities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_spot_report_schema_data_entities.SimpleSpotReportSchemaDataEntities()  # noqa: E501
        if include_optional :
            return SimpleSpotReportSchemaDataEntities(
                type = '', 
                value = ''
            )
        else :
    ...
    def testSimpleSpotReportSchemaDataEntities(self):
        """Test SimpleSpotReportSchemaDataEntities"""
