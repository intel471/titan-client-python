...
import titan_client
from titan_client.models.indicator_search_schema_data_indicator_data_file import IndicatorSearchSchemaDataIndicatorDataFile  # noqa: E501
from titan_client.rest import ApiException

class TestIndicatorSearchSchemaDataIndicatorDataFile(unittest.TestCase):
    """IndicatorSearchSchemaDataIndicatorDataFile unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IndicatorSearchSchemaDataIndicatorDataFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.indicator_search_schema_data_indicator_data_file.IndicatorSearchSchemaDataIndicatorDataFile()  # noqa: E501
        if include_optional :
            return IndicatorSearchSchemaDataIndicatorDataFile(
                download_url = '', 
                md5 = '', 
                sha1 = '', 
                sha256 = '', 
    ...
    def testIndicatorSearchSchemaDataIndicatorDataFile(self):
        """Test IndicatorSearchSchemaDataIndicatorDataFile"""
