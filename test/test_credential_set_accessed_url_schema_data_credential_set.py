...
import titan_client
from titan_client.models.credential_set_accessed_url_schema_data_credential_set import CredentialSetAccessedUrlSchemaDataCredentialSet  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetAccessedUrlSchemaDataCredentialSet(unittest.TestCase):
    """CredentialSetAccessedUrlSchemaDataCredentialSet unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetAccessedUrlSchemaDataCredentialSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_accessed_url_schema_data_credential_set.CredentialSetAccessedUrlSchemaDataCredentialSet()  # noqa: E501
        if include_optional :
            return CredentialSetAccessedUrlSchemaDataCredentialSet(
                name = '', 
                uid = ''
            )
        else :
    ...
    def testCredentialSetAccessedUrlSchemaDataCredentialSet(self):
        """Test CredentialSetAccessedUrlSchemaDataCredentialSet"""
