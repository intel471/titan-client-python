...
import titan_client
from titan_client.models.credential_occurrence_schema_activity import CredentialOccurrenceSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialOccurrenceSchemaActivity(unittest.TestCase):
    """CredentialOccurrenceSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialOccurrenceSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_occurrence_schema_activity.CredentialOccurrenceSchemaActivity()  # noqa: E501
        if include_optional :
            return CredentialOccurrenceSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testCredentialOccurrenceSchemaActivity(self):
        """Test CredentialOccurrenceSchemaActivity"""
