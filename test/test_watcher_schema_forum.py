...
import titan_client
from titan_client.models.watcher_schema_forum import WatcherSchemaForum  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherSchemaForum(unittest.TestCase):
    """WatcherSchemaForum unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherSchemaForum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_schema_forum.WatcherSchemaForum()  # noqa: E501
        if include_optional :
            return WatcherSchemaForum(
                description = '', 
                name = '', 
                uid = ''
            )
    ...
    def testWatcherSchemaForum(self):
        """Test WatcherSchemaForum"""
