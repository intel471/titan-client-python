...
import titan_client
from titan_client.models.credential_set_accessed_url_schema_data import CredentialSetAccessedUrlSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetAccessedUrlSchemaData(unittest.TestCase):
    """CredentialSetAccessedUrlSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetAccessedUrlSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_accessed_url_schema_data.CredentialSetAccessedUrlSchemaData()  # noqa: E501
        if include_optional :
            return CredentialSetAccessedUrlSchemaData(
                accessed_domain = '', 
                accessed_url = '', 
    ...
    def testCredentialSetAccessedUrlSchemaData(self):
        """Test CredentialSetAccessedUrlSchemaData"""
