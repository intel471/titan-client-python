...
import titan_client
from titan_client.models.girs_response import GirsResponse  # noqa: E501
from titan_client.rest import ApiException

class TestGirsResponse(unittest.TestCase):
    """GirsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = titan_client.models.girs_response.GirsResponse()  # noqa: E501
        if include_optional :
            return GirsResponse(
                gir_total_count = 56, 
                girs = [
                    titan_client.models.gir_schema.GirSchema(
                        data = titan_client.models.gir_schema_data.GirSchema_data(
                            gir = titan_client.models.gir_schema_data_gir.GirSchema_data_gir(
                                description = '', 
                                name = '', 
                                parent = titan_client.models.parent.parent(), 
                                path = '', ), ), 
                        uid = '', )
                    ], 
                partial_result = True
