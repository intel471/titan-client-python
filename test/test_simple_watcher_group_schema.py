...
import titan_client
from titan_client.models.simple_watcher_group_schema import SimpleWatcherGroupSchema  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleWatcherGroupSchema(unittest.TestCase):
    """SimpleWatcherGroupSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleWatcherGroupSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_watcher_group_schema.SimpleWatcherGroupSchema()  # noqa: E501
        if include_optional :
            return SimpleWatcherGroupSchema(
                description = '', 
                name = '', 
                owner = '', 
                type = 'owned_by_me', 
    ...
    def testSimpleWatcherGroupSchema(self):
        """Test SimpleWatcherGroupSchema"""
