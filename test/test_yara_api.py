...
import titan_client
from titan_client.api.yara_api import YARAApi  # noqa: E501
...
class TestYARAApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = titan_client.api.yara_api.YARAApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_yara_get(self):
        """Test case for yara_get
