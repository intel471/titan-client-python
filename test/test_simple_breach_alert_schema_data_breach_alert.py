...
class TestSimpleBreachAlertSchemaDataBreachAlert(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleBreachAlertSchemaDataBreachAlert:
        """Test SimpleBreachAlertSchemaDataBreachAlert
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleBreachAlertSchemaDataBreachAlert`
        """
        model = SimpleBreachAlertSchemaDataBreachAlert()
        if include_optional:
