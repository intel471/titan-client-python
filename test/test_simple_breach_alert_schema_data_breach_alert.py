...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_breach_alert import SimpleBreachAlertSchemaDataBreachAlert  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataBreachAlert(unittest.TestCase):
    """SimpleBreachAlertSchemaDataBreachAlert unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataBreachAlert
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_breach_alert.SimpleBreachAlertSchemaDataBreachAlert()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataBreachAlert(
                actor_or_group = '', 
    ...
    def testSimpleBreachAlertSchemaDataBreachAlert(self):
        """Test SimpleBreachAlertSchemaDataBreachAlert"""
