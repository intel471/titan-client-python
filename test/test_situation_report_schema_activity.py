...
import titan_client
from titan_client.models.situation_report_schema_activity import SituationReportSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestSituationReportSchemaActivity(unittest.TestCase):
    """SituationReportSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SituationReportSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.situation_report_schema_activity.SituationReportSchemaActivity()  # noqa: E501
        if include_optional :
            return SituationReportSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testSituationReportSchemaActivity(self):
        """Test SituationReportSchemaActivity"""
