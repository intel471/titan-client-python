...
import titan_client
from titan_client.models.credential_set_accessed_url_stream_schema import CredentialSetAccessedUrlStreamSchema  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetAccessedUrlStreamSchema(unittest.TestCase):
    """CredentialSetAccessedUrlStreamSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetAccessedUrlStreamSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_accessed_url_stream_schema.CredentialSetAccessedUrlStreamSchema()  # noqa: E501
        if include_optional :
            return CredentialSetAccessedUrlStreamSchema(
    ...
    def testCredentialSetAccessedUrlStreamSchema(self):
        """Test CredentialSetAccessedUrlStreamSchema"""
