...
class TestReportsApi(unittest.TestCase):
    ...
    def test_breach_alerts_get(self) -> None:
    ...
    def test_breach_alerts_uid_get(self) -> None:
    ...
    def test_malware_reports_get(self) -> None:
    ...
    def test_malware_reports_uid_get(self) -> None:
    ...
    def test_reports_uid_get(self) -> None:
    ...
    def test_situation_reports_get(self) -> None:
    ...
    def test_situation_reports_report_uid_get(self) -> None:
    ...
    def test_spot_reports_get(self) -> None:
    ...
    def test_spot_reports_uid_get(self) -> None:
