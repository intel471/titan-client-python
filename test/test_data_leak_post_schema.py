...
class TestDataLeakPostSchema(unittest.TestCase):
    """DataLeakPostSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataLeakPostSchema:
        """Test DataLeakPostSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataLeakPostSchema`
        """
        model = DataLeakPostSchema()
        if include_optional:
            return DataLeakPostSchema(
                chunk_number = 56,
                var_date = 56,
    ...
    def testDataLeakPostSchema(self):
        """Test DataLeakPostSchema"""
