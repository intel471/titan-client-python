...
import titan_client
from titan_client.models.nids_search_response import NIDSSearchResponse  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchResponse(unittest.TestCase):
    """NIDSSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_response.NIDSSearchResponse()  # noqa: E501
        if include_optional :
            return NIDSSearchResponse(
                nids_list = [
                    titan_client.models.nids_search_schema.NIDSSearchSchema(
    ...
    def testNIDSSearchResponse(self):
        """Test NIDSSearchResponse"""
