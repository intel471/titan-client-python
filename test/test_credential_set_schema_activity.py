...
import titan_client
from titan_client.models.credential_set_schema_activity import CredentialSetSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetSchemaActivity(unittest.TestCase):
    """CredentialSetSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_schema_activity.CredentialSetSchemaActivity()  # noqa: E501
        if include_optional :
            return CredentialSetSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testCredentialSetSchemaActivity(self):
        """Test CredentialSetSchemaActivity"""
