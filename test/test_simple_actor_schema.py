...
import titan_client
from titan_client.models.simple_actor_schema import SimpleActorSchema  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleActorSchema(unittest.TestCase):
    """SimpleActorSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleActorSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_actor_schema.SimpleActorSchema()  # noqa: E501
        if include_optional :
            return SimpleActorSchema(
                active_from = 56, 
                active_until = 56, 
                handles = [
                    ''
    ...
    def testSimpleActorSchema(self):
        """Test SimpleActorSchema"""
