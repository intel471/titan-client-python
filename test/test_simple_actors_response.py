...
import titan_client
from titan_client.models.simple_actors_response import SimpleActorsResponse  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleActorsResponse(unittest.TestCase):
    """SimpleActorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleActorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_actors_response.SimpleActorsResponse()  # noqa: E501
        if include_optional :
            return SimpleActorsResponse(
                actor_partial_result = True, 
    ...
    def testSimpleActorsResponse(self):
        """Test SimpleActorsResponse"""
