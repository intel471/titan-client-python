...
import titan_client
from titan_client.models.private_message_schema_links_recipient_actor import PrivateMessageSchemaLinksRecipientActor  # noqa: E501
from titan_client.rest import ApiException

class TestPrivateMessageSchemaLinksRecipientActor(unittest.TestCase):
    """PrivateMessageSchemaLinksRecipientActor unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PrivateMessageSchemaLinksRecipientActor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.private_message_schema_links_recipient_actor.PrivateMessageSchemaLinksRecipientActor()  # noqa: E501
        if include_optional :
            return PrivateMessageSchemaLinksRecipientActor(
                handle = '', 
                uid = ''
            )
        else :
    ...
    def testPrivateMessageSchemaLinksRecipientActor(self):
        """Test PrivateMessageSchemaLinksRecipientActor"""
