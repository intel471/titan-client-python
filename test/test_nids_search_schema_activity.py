...
import titan_client
from titan_client.models.nids_search_schema_activity import NIDSSearchSchemaActivity  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchSchemaActivity(unittest.TestCase):
    """NIDSSearchSchemaActivity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchSchemaActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_schema_activity.NIDSSearchSchemaActivity()  # noqa: E501
        if include_optional :
            return NIDSSearchSchemaActivity(
                first = 56, 
                last = 56
            )
        else :
    ...
    def testNIDSSearchSchemaActivity(self):
        """Test NIDSSearchSchemaActivity"""
