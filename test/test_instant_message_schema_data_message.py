...
import titan_client
from titan_client.models.instant_message_schema_data_message import InstantMessageSchemaDataMessage  # noqa: E501
from titan_client.rest import ApiException

class TestInstantMessageSchemaDataMessage(unittest.TestCase):
    """InstantMessageSchemaDataMessage unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InstantMessageSchemaDataMessage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.instant_message_schema_data_message.InstantMessageSchemaDataMessage()  # noqa: E501
        if include_optional :
            return InstantMessageSchemaDataMessage(
                attachments = [
    ...
    def testInstantMessageSchemaDataMessage(self):
        """Test InstantMessageSchemaDataMessage"""
