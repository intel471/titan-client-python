...
class TestDataLeakPostsResponse(unittest.TestCase):
    """DataLeakPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataLeakPostsResponse:
        """Test DataLeakPostsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataLeakPostsResponse`
        """
        model = DataLeakPostsResponse()
        if include_optional:
            return DataLeakPostsResponse(
                data_leak_post_partial_result = True,
    ...
    def testDataLeakPostsResponse(self):
        """Test DataLeakPostsResponse"""
