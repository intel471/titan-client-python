...
import titan_client
from titan_client.models.simple_report_schema_sources import SimpleReportSchemaSources  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleReportSchemaSources(unittest.TestCase):
    """SimpleReportSchemaSources unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleReportSchemaSources
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_report_schema_sources.SimpleReportSchemaSources()  # noqa: E501
        if include_optional :
            return SimpleReportSchemaSources(
                index = 56, 
                title = '', 
                type = '', 
                url = ''
    ...
    def testSimpleReportSchemaSources(self):
        """Test SimpleReportSchemaSources"""
