...
import titan_client
from titan_client.models.simple_breach_alert_schema_data_breach_alert_victim import SimpleBreachAlertSchemaDataBreachAlertVictim  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleBreachAlertSchemaDataBreachAlertVictim(unittest.TestCase):
    """SimpleBreachAlertSchemaDataBreachAlertVictim unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleBreachAlertSchemaDataBreachAlertVictim
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_breach_alert_schema_data_breach_alert_victim.SimpleBreachAlertSchemaDataBreachAlertVictim()  # noqa: E501
        if include_optional :
            return SimpleBreachAlertSchemaDataBreachAlertVictim(
                industry = '', 
                name = '', 
                region = '', 
                revenue = '', 
    ...
    def testSimpleBreachAlertSchemaDataBreachAlertVictim(self):
        """Test SimpleBreachAlertSchemaDataBreachAlertVictim"""
