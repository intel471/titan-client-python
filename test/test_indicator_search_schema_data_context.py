...
import titan_client
from titan_client.models.indicator_search_schema_data_context import IndicatorSearchSchemaDataContext  # noqa: E501
from titan_client.rest import ApiException

class TestIndicatorSearchSchemaDataContext(unittest.TestCase):
    """IndicatorSearchSchemaDataContext unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IndicatorSearchSchemaDataContext
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.indicator_search_schema_data_context.IndicatorSearchSchemaDataContext()  # noqa: E501
        if include_optional :
            return IndicatorSearchSchemaDataContext(
                description = ''
            )
        else :
            return IndicatorSearchSchemaDataContext(
    ...
    def testIndicatorSearchSchemaDataContext(self):
        """Test IndicatorSearchSchemaDataContext"""
