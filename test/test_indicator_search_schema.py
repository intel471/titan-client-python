...
class TestIndicatorSearchSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndicatorSearchSchema:
        """Test IndicatorSearchSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndicatorSearchSchema`
        """
        model = IndicatorSearchSchema()
        if include_optional:
