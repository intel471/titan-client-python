...
import titan_client
from titan_client.models.simple_actor_schema_links import SimpleActorSchemaLinks  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleActorSchemaLinks(unittest.TestCase):
    """SimpleActorSchemaLinks unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleActorSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_actor_schema_links.SimpleActorSchemaLinks()  # noqa: E501
        if include_optional :
            return SimpleActorSchemaLinks(
    ...
    def testSimpleActorSchemaLinks(self):
        """Test SimpleActorSchemaLinks"""
