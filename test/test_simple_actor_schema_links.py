...
class TestSimpleActorSchemaLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleActorSchemaLinks:
        """Test SimpleActorSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleActorSchemaLinks`
        """
        model = SimpleActorSchemaLinks()
        if include_optional:
