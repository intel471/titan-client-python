...
import titan_client
from titan_client.models.credential_set_schema_data import CredentialSetSchemaData  # noqa: E501
from titan_client.rest import ApiException

class TestCredentialSetSchemaData(unittest.TestCase):
    """CredentialSetSchemaData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CredentialSetSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.credential_set_schema_data.CredentialSetSchemaData()  # noqa: E501
        if include_optional :
            return CredentialSetSchemaData(
                breach_date = 56, 
                collection_date = 56, 
                description = '', 
                disclosure_date = 56, 
    ...
    def testCredentialSetSchemaData(self):
        """Test CredentialSetSchemaData"""
