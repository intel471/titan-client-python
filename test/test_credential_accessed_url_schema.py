...
class TestCredentialAccessedUrlSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialAccessedUrlSchema:
        """Test CredentialAccessedUrlSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialAccessedUrlSchema`
        """
        model = CredentialAccessedUrlSchema()
        if include_optional:
