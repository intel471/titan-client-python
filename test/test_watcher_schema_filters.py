...
import titan_client
from titan_client.models.watcher_schema_filters import WatcherSchemaFilters  # noqa: E501
from titan_client.rest import ApiException

class TestWatcherSchemaFilters(unittest.TestCase):
    """WatcherSchemaFilters unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WatcherSchemaFilters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.watcher_schema_filters.WatcherSchemaFilters()  # noqa: E501
        if include_optional :
            return WatcherSchemaFilters(
                filter = '', 
                type = ''
            )
        else :
    ...
    def testWatcherSchemaFilters(self):
        """Test WatcherSchemaFilters"""
