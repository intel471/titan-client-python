...
import titan_client
from titan_client.models.simple_cve_schema import SimpleCveSchema  # noqa: E501
from titan_client.rest import ApiException

class TestSimpleCveSchema(unittest.TestCase):
    """SimpleCveSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SimpleCveSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.simple_cve_schema.SimpleCveSchema()  # noqa: E501
        if include_optional :
            return SimpleCveSchema(
