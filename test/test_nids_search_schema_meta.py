...
import titan_client
from titan_client.models.nids_search_schema_meta import NIDSSearchSchemaMeta  # noqa: E501
from titan_client.rest import ApiException

class TestNIDSSearchSchemaMeta(unittest.TestCase):
    """NIDSSearchSchemaMeta unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test NIDSSearchSchemaMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.nids_search_schema_meta.NIDSSearchSchemaMeta()  # noqa: E501
        if include_optional :
            return NIDSSearchSchemaMeta(
                version = ''
            )
        else :
            return NIDSSearchSchemaMeta(
    ...
    def testNIDSSearchSchemaMeta(self):
        """Test NIDSSearchSchemaMeta"""
