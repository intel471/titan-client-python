...
import titan_client
from titan_client.models.event_schema_data_threat import EventSchemaDataThreat  # noqa: E501
from titan_client.rest import ApiException

class TestEventSchemaDataThreat(unittest.TestCase):
    """EventSchemaDataThreat unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EventSchemaDataThreat
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = titan_client.models.event_schema_data_threat.EventSchemaDataThreat()  # noqa: E501
        if include_optional :
            return EventSchemaDataThreat(
    ...
    def testEventSchemaDataThreat(self):
        """Test EventSchemaDataThreat"""
