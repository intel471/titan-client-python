...
class NewsApi(object):
    ...
    def news_get(self, **kwargs):  # noqa: E501
        """Search News  # noqa: E501

        Returns list of `News` matching filter criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.news_get(async_req=True)
        >>> result = thread.get()

        :param news: Free text News search.
        :type news: str
        :param news_type: Search News by news type.
        :type news_type: str
        ...
        :rtype: SimpleNewsResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.news_get_with_http_info(**kwargs)  # noqa: E501

    def news_get_with_http_info(self, **kwargs):  # noqa: E501
        """Search News  # noqa: E501
        ...
        >>> thread = api.news_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SimpleNewsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `news_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `news_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `news_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `news_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def news_uid_get(self, uid, **kwargs):  # noqa: E501
        """Get News  # noqa: E501

        Returns single `News` object  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.news_uid_get(uid, async_req=True)
        >>> result = thread.get()

        :param uid: News report identifier. (required)
        :type uid: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: FullNewsSchema
        """
        kwargs['_return_http_data_only'] = True
        return self.news_uid_get_with_http_info(uid, **kwargs)  # noqa: E501

    def news_uid_get_with_http_info(self, uid, **kwargs):  # noqa: E501
        """Get News  # noqa: E501
        ...
        >>> thread = api.news_uid_get_with_http_info(uid, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(FullNewsSchema, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method news_uid_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'uid' is set
        if self.api_client.client_side_validation and local_var_params.get('uid') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `uid` when calling `news_uid_get`")  # noqa: E501
