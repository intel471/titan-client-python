...
class PCAPApi(object):
    ...
    def malware_pcaps_get(self, **kwargs):  # noqa: E501
        """List of files  # noqa: E501

        Returns a list of JSON documents. Document contains all relevant data like date, exit country, file download url. Endpoint allows to consume files on a daily basis (by specifying `lastUpdatedFrom=<the last request time>`) or full historical information (by specifying `from`/`until` range).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.malware_pcaps_get(async_req=True)
        >>> result = thread.get()

        :param malware_family: Filter by malware family name. To get information about all malware families provide `*` as a value. At least one of `malwareFamily`, `malwareFamilyProfileUid` parameter is required.
        :type malware_family: str
        :param malware_family_profile_uid: Filter by malware family profile uid..
        ...
        return self.malware_pcaps_get_with_http_info(**kwargs)  # noqa: E501

    def malware_pcaps_get_with_http_info(self, **kwargs):  # noqa: E501
        """List of files  # noqa: E501
        ...
        >>> thread = api.malware_pcaps_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PCAPResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method malware_pcaps_get" % key
                )
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `malware_pcaps_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `malware_pcaps_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `malware_pcaps_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `malware_pcaps_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        response_types_map = {
            200: "PCAPResponse",
            412: "MalwarePcapsGet412Response",
        }
