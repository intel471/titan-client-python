...
class IndicatorsApi(object):
    ...
    def indicators_get(self, **kwargs):  # noqa: E501
        """Search Malware Intelligence Indicators  # noqa: E501

        Returns list of `Indicators` matching filter criteria. Malware Intelligence is a different product from Intel 471 to adversary intelligence.  # noqa: E501
        ...
        :param confidence: Search indicators by confidence. See detailed description of confidence levels below.
        :type confidence: str
        ...
        :rtype: IndicatorSearchResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.indicators_get_with_http_info(**kwargs)  # noqa: E501

    def indicators_get_with_http_info(self, **kwargs):  # noqa: E501
        """Search Malware Intelligence Indicators  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IndicatorSearchResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `indicators_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `indicators_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `indicators_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `indicators_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def indicators_stream_get(self, **kwargs):  # noqa: E501
        """Stream Malware Intelligence Indicators  # noqa: E501

        Returns list of `Indicators` matching filter criteria. Stream pagination is based on a cursor. The response is the same as for the `/indicators` endpoint but with the additional “cursorNext” field. Results are sorted by ascending order of the last_updated field. <br />Two indications of the end of the stream are possible: the result list is empty or its size is less than the requested items count. <br />Malware Intelligence is a different product from Intel 471 to adversary intelligence.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IndicatorStreamResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.indicators_stream_get_with_http_info(**kwargs)  # noqa: E501

    def indicators_stream_get_with_http_info(self, **kwargs):  # noqa: E501
        """Stream Malware Intelligence Indicators  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IndicatorStreamResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method indicators_stream_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `indicators_stream_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `indicators_stream_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `indicators_stream_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `indicators_stream_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        response_types_map = {
            200: "IndicatorStreamResponse",
            412: "EventsStreamGet412Response",
        }

        return self.api_client.call_api(
            '/indicators/stream', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
