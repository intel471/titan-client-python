...
class NIDsApi(object):
    ...
    def nids_get(self, **kwargs):  # noqa: E501
        """Search Malware Intelligence NIDS  # noqa: E501

        Returns list of `NIDS` matching filter criteria. Malware Intelligence is a different product from Intel 471 to adversary intelligence.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.nids_get(async_req=True)
        >>> result = thread.get()

        :param nids: Free text NIDS search (all fields included). At least one of `nids`, `nidsType`, `threatType`, `threatUid`, `malwareFamily`, `malwareFamilyProfileUid`, `confidence` is required.
        :type nids: str
        :param nids_type: Search NIDS by type (e.g. `suricata`, `sagan`, `samhain`, `snort`)
        :type nids_type: str
        :param threat_type: Search NIDS by threat type (e.g. `malware`, `bulletproof_hosting`, `proxy_service`)
        :type threat_type: str
        :param threat_uid: Search NIDS by threat UID
        :type threat_uid: str
        :param malware_family: Search NIDS by malware family (e.g. `gozi_isfb`, `smokeloader`, `trickbot`)
        :type malware_family: str
        :param malware_family_profile_uid: Search NIDS by malware family profile UID. Useful for getting context for everything we have around specific malware family, for instance https://api.intel471.com/v1/search?malwareFamilyProfileUid=d073f7352b82c1b8eedda381590adced
        :type malware_family_profile_uid: str
        :param confidence: Search NIDS by confidence. See detailed description of confidence levels below.
        :type confidence: str
        ...
        :rtype: NIDSSearchResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.nids_get_with_http_info(**kwargs)  # noqa: E501

    def nids_get_with_http_info(self, **kwargs):  # noqa: E501
        """Search Malware Intelligence NIDS  # noqa: E501
        ...
        >>> thread = api.nids_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NIDSSearchResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `nids_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `nids_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `nids_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `nids_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
