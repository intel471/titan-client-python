...
class YARAApi:
    ...
    def yara_get(
        self,
        yara: Annotated[Optional[StrictStr], Field(description="Free text YARA search (all fields included). At least one of `yara`, `threatType`, `threatUid`, `malwareFamily`, `malwareFamilyProfileUid` or `confidence` is required.")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search `YARA` by threat type")] = None,
        threat_uid: Annotated[Optional[StrictStr], Field(description="Search YARA by threat UID")] = None,
        malware_family: Annotated[Optional[StrictStr], Field(description="Search YARA by malware family (e.g. `gozi_isfb`, `smokeloader`, `trickbot`)")] = None,
        malware_family_profile_uid: Annotated[Optional[StrictStr], Field(description="Search YARA by malware family profile UID. Useful for getting context for everything we have around specific malware family, for instance https://api.intel471.com/v1/search?malwareFamilyProfileUid=d073f7352b82c1b8eedda381590adced")] = None,
        confidence: Annotated[Optional[StrictStr], Field(description="Search YARA by confidence. See detailed description of confidence levels below.")] = None,
        ...
        _param = self._yara_get_serialize(
            yara=yara,
    ...
    def yara_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[YARASearchResponse]:
        """Search Malware Intelligence YARA
    ...
    @validate_call
    def yara_get_without_preload_content(
        self,
        yara: Annotated[Optional[StrictStr], Field(description="Free text YARA search (all fields included). At least one of `yara`, `threatType`, `threatUid`, `malwareFamily`, `malwareFamilyProfileUid` or `confidence` is required.")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search `YARA` by threat type")] = None,
        threat_uid: Annotated[Optional[StrictStr], Field(description="Search YARA by threat UID")] = None,
