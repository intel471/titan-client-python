...
class DataLeakBlogsApi(object):
    ...
    def dataleak_posts_get(self, **kwargs):  # noqa: E501
        """Search Data Leak Posts  # noqa: E501

        Returns list of `Data Leak Posts` matching filter criteria. At least one of `dataLeakPost`, `dataLeakPostsByThreadUid`, `dataLeakBlog` is required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.dataleak_posts_get(async_req=True)
        >>> result = thread.get()
        ...
        :rtype: DataLeakPostsResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.dataleak_posts_get_with_http_info(**kwargs)  # noqa: E501

    def dataleak_posts_get_with_http_info(self, **kwargs):  # noqa: E501
        """Search Data Leak Posts  # noqa: E501
        ...
        >>> thread = api.dataleak_posts_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DataLeakPostsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method dataleak_posts_get" % key
                )
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `dataleak_posts_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `dataleak_posts_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `dataleak_posts_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `dataleak_posts_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}

        path_params = {}

        query_params = []
        if local_var_params.get('data_leak_post') is not None:  # noqa: E501
            query_params.append(('dataLeakPost', local_var_params['data_leak_post']))  # noqa: E501
        if local_var_params.get('data_leak_posts_by_thread_uid') is not None:  # noqa: E501
            query_params.append(('dataLeakPostsByThreadUid', local_var_params['data_leak_posts_by_thread_uid']))  # noqa: E501
        if local_var_params.get('data_leak_blog') is not None:  # noqa: E501
            query_params.append(('dataLeakBlog', local_var_params['data_leak_blog']))  # noqa: E501
