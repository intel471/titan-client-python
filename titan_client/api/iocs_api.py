...
class IOCsApi(object):
    ...
    def iocs_get(self, ioc, **kwargs):  # noqa: E501
        """Search Indicator of Compromise (IoC)  # noqa: E501

        Returns list of `Indicators of compromise` matching filter criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.iocs_get(ioc, async_req=True)
        >>> result = thread.get()

        :param ioc: Search for all IOCs. (required)
        :type ioc: str
        ...
        return self.iocs_get_with_http_info(ioc, **kwargs)  # noqa: E501

    def iocs_get_with_http_info(self, ioc, **kwargs):  # noqa: E501
        """Search Indicator of Compromise (IoC)  # noqa: E501
        ...
        >>> thread = api.iocs_get_with_http_info(ioc, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IocsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `iocs_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `iocs_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `iocs_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `iocs_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
