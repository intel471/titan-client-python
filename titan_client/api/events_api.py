...
class EventsApi(object):
    ...
    def events_get(self, **kwargs):  # noqa: E501
        """Search Malware Intelligence Events  # noqa: E501

        Returns list of `Events` matching filter criteria. Malware Intelligence is a different product from Intel 471 to adversary intelligence.  # noqa: E501
        ...
        :type event_type: str
        :param threat_type: Search events by threat type.
        :type threat_type: str
        :param threat_uid: Search events by threat uid
        :type threat_uid: str
        :param malware_family: Search events by malware family (e.g. gozi_isfb, smokeloader, trickbot).
        :type malware_family: str
        :param malware_family_profile_uid: Search events by malware family profile UID. Useful for getting context for everything we have around specific malware family, for instance https://api.intel471.com/v1/search?malwareFamilyProfileUid=d073f7352b82c1b8eedda381590adced
    ...
    def events_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `events_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `events_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `events_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `events_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def events_stream_get(self, **kwargs):  # noqa: E501
        """Stream Malware Intelligence Events  # noqa: E501
        ...
        >>> thread = api.events_stream_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: EventStreamResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.events_stream_get_with_http_info(**kwargs)  # noqa: E501

    def events_stream_get_with_http_info(self, **kwargs):  # noqa: E501
        """Stream Malware Intelligence Events  # noqa: E501
        ...
        >>> thread = api.events_stream_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(EventStreamResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method events_stream_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `events_stream_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `events_stream_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
