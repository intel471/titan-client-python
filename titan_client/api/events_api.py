...
class EventsApi:
    ...
    def events_get(
        self,
        event: Annotated[Optional[StrictStr], Field(description="Free text event search (all fields included).")] = None,
        event_type: Annotated[Optional[StrictStr], Field(description="Search events by type.")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search events by threat type.")] = None,
        threat_uid: Annotated[Optional[StrictStr], Field(description="Search events by threat uid")] = None,
        malware_family: Annotated[Optional[StrictStr], Field(description="Search events by malware family (e.g. gozi_isfb, smokeloader, trickbot).")] = None,
        malware_family_profile_uid: Annotated[Optional[StrictStr], Field(description="Search events by malware family profile UID. Useful for getting context for everything we have around specific malware family, for instance https://api.intel471.com/v1/search?malwareFamilyProfileUid=d073f7352b82c1b8eedda381590adced")] = None,
    ...
    def events_stream_get(
        ...
        _param = self._events_stream_get_serialize(
            event=event,
            event_type=event_type,
            threat_type=threat_type,
            threat_uid=threat_uid,
    ...
    @validate_call
    def events_stream_get_with_http_info(
        self,
        event: Annotated[Optional[StrictStr], Field(description="Free text event search (all fields included).")] = None,
        event_type: Annotated[Optional[StrictStr], Field(description="Search events by type.")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search events by threat type.")] = None,
    ...
    @validate_call
    def events_stream_get_without_preload_content(
        self,
        event: Annotated[Optional[StrictStr], Field(description="Free text event search (all fields included).")] = None,
        event_type: Annotated[Optional[StrictStr], Field(description="Search events by type.")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search events by threat type.")] = None,
    ...
    def _events_stream_get_serialize(
        self,
        event,
        event_type,
        threat_type,
