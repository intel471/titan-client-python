...
class GIRsApi:
    ...
    def girs_get(
        self,
        gir_path: Annotated[Optional[StrictStr], Field(description="Search GIRs by path.")] = None,
        gir_name: Annotated[Optional[StrictStr], Field(description="Search GIRs by name")] = None,
        gir_description: Annotated[Optional[StrictStr], Field(description="Search GIRs description")] = None,
        ...
        _param = self._girs_get_serialize(
            gir_path=gir_path,
            gir_name=gir_name,
            gir_description=gir_description,
            offset=offset,
            count=count,
    ...
    @validate_call
    def girs_get_without_preload_content(
        self,
        gir_path: Annotated[Optional[StrictStr], Field(description="Search GIRs by path.")] = None,
        gir_name: Annotated[Optional[StrictStr], Field(description="Search GIRs by name")] = None,
        gir_description: Annotated[Optional[StrictStr], Field(description="Search GIRs description")] = None,
    ...
    def _girs_get_serialize(
        ...
        if gir_path is not None:
            
            _query_params.append(('girPath', gir_path))
            
        if gir_name is not None:
            
            _query_params.append(('girName', gir_name))
            
        if gir_description is not None:
            
            _query_params.append(('girDescription', gir_description))
