...
class ActorsApi:
    ...
    def actors_get(
        self,
        actor: Annotated[Optional[StrictStr], Field(description="Search for handles only. At least one of `actor`, `forum` parameter is required.")] = None,
        forum: Annotated[Optional[StrictStr], Field(description="Search for actors active on given forum.")] = None,
        ...
        _param = self._actors_get_serialize(
            actor=actor,
            forum=forum,
            var_from=var_from,
            until=until,
    ...
    def actors_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SimpleActorsResponse]:
        """Search Actors
    ...
    @validate_call
    def actors_get_without_preload_content(
        self,
        actor: Annotated[Optional[StrictStr], Field(description="Search for handles only. At least one of `actor`, `forum` parameter is required.")] = None,
        forum: Annotated[Optional[StrictStr], Field(description="Search for actors active on given forum.")] = None,
        var_from: Annotated[Optional[StrictStr], Field(description="Long unix time or string time range. Search data starting from given creation time (including).")] = None,
    ...
    def actors_uid_get(
        self,
        uid: Annotated[StrictStr, Field(description="Actor identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._actors_uid_get_serialize(
            uid=uid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def actors_uid_get_with_http_info(
        self,
        uid: Annotated[StrictStr, Field(description="Actor identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def actors_uid_get_without_preload_content(
        self,
        uid: Annotated[StrictStr, Field(description="Actor identifier.")],
        _request_timeout: Union[
            None,
