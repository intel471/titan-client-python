...
class MessagingServicesApi:
    ...
    @validate_call
    def messaging_services_instant_messages_get(
        self,
        instant_message: Annotated[Optional[StrictStr], Field(description="Free text instant messages search (including images via OCR). At least one of `instantMessage`, `instantMessageActor`, `instantMessageService`, `instantMessageServer`, `instantMessageChannel` is required.")] = None,
        instant_message_actor: Annotated[Optional[StrictStr], Field(description="Search instant messages by actor name (actual for the moment message was written).")] = None,
        instant_message_service: Annotated[Optional[StrictStr], Field(description="Search instant messages by service.")] = None,
        instant_message_server: Annotated[Optional[StrictStr], Field(description="Search instant messages by server.")] = None,
        instant_message_channel: Annotated[Optional[StrictStr], Field(description="Search instant messages by channel.")] = None,
        ...
        _param = self._messaging_services_instant_messages_get_serialize(
    ...
    @validate_call
    def messaging_services_instant_messages_get_with_http_info(
        self,
        instant_message: Annotated[Optional[StrictStr], Field(description="Free text instant messages search (including images via OCR). At least one of `instantMessage`, `instantMessageActor`, `instantMessageService`, `instantMessageServer`, `instantMessageChannel` is required.")] = None,
        instant_message_actor: Annotated[Optional[StrictStr], Field(description="Search instant messages by actor name (actual for the moment message was written).")] = None,
        instant_message_service: Annotated[Optional[StrictStr], Field(description="Search instant messages by service.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MessagingServicesResponse]:
        """Search Instant Messages
    ...
    @validate_call
    def messaging_services_instant_messages_get_without_preload_content(
        self,
        instant_message: Annotated[Optional[StrictStr], Field(description="Free text instant messages search (including images via OCR). At least one of `instantMessage`, `instantMessageActor`, `instantMessageService`, `instantMessageServer`, `instantMessageChannel` is required.")] = None,
        instant_message_actor: Annotated[Optional[StrictStr], Field(description="Search instant messages by actor name (actual for the moment message was written).")] = None,
        instant_message_service: Annotated[Optional[StrictStr], Field(description="Search instant messages by service.")] = None,
    ...
    def _messaging_services_instant_messages_get_serialize(
        self,
        instant_message,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/messagingServices/instantMessages',
