...
class EntitiesApi(object):
    ...
    def entities_get(self, entity, **kwargs):  # noqa: E501
        """Search Entities.  # noqa: E501

        Returns list of `Entities` matching filter criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.entities_get(entity, async_req=True)
        >>> result = thread.get()

        :param entity: Search for all entities. (required)
        :type entity: str
        :param entity_type: Search for all entities by entity type.
        ...
        return self.entities_get_with_http_info(entity, **kwargs)  # noqa: E501

    def entities_get_with_http_info(self, entity, **kwargs):  # noqa: E501
        """Search Entities.  # noqa: E501
        ...
        >>> thread = api.entities_get_with_http_info(entity, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `entities_get`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `entities_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `entities_get`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'count' in local_var_params and local_var_params['count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `count` when calling `entities_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
