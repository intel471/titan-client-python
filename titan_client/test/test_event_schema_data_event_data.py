...
class TestEventSchemaDataEventData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventSchemaDataEventData:
        """Test EventSchemaDataEventData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventSchemaDataEventData`
        """
        model = EventSchemaDataEventData()
        if include_optional:
