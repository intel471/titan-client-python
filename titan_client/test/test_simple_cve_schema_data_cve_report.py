...
class TestSimpleCveSchemaDataCveReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleCveSchemaDataCveReport:
        """Test SimpleCveSchemaDataCveReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleCveSchemaDataCveReport`
        """
        model = SimpleCveSchemaDataCveReport()
        if include_optional:
