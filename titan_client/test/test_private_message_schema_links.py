...
class TestPrivateMessageSchemaLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateMessageSchemaLinks:
        """Test PrivateMessageSchemaLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateMessageSchemaLinks`
        """
        model = PrivateMessageSchemaLinks()
        if include_optional:
