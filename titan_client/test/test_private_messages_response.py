...
class TestPrivateMessagesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateMessagesResponse:
        """Test PrivateMessagesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateMessagesResponse`
        """
        model = PrivateMessagesResponse()
        if include_optional:
