...
class TestSimpleBreachAlertSchemaData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleBreachAlertSchemaData:
        """Test SimpleBreachAlertSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleBreachAlertSchemaData`
        """
        model = SimpleBreachAlertSchemaData()
        if include_optional:
