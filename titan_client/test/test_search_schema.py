...
class TestSearchSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchSchema:
        """Test SearchSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSchema`
        """
        model = SearchSchema()
        if include_optional:
            return SearchSchema(
                ...
                data_leak_post_total_count = 56,
                data_leak_posts = [
                    titan_client.models.data_leak_post_schema.DataLeakPostSchema(
                        chunk_number = 56, 
                        date = 56, 
                ...
                iocs = [
                    titan_client.models.ioc_schema.IocSchema(
                        ...
                        links = titan_client.models.ioc_schema_links.IocSchema_links(
                            actor_total_count = 56, 
                            actors = [
                                titan_client.models.ioc_schema_links_actors_inner.IocSchema_links_actors_inner(
                                    handles = [
                                        ''
                                        ], 
                                    uid = '', )
                            ...
                            report_total_count = 56, 
                            reports = [
                                titan_client.models.ioc_schema_links_reports_inner.IocSchema_links_reports_inner(
                                    admiralty_code = 'C3', 
                                    date_of_information = 56, 
                                    motivation = [
                                        ''
                    ...
                    titan_client.models.malware_reports_search_schema.MalwareReportsSearchSchema(
                        ...
                        data = titan_client.models.malware_reports_search_schema_data.MalwareReportsSearchSchema_data(
                            malware_report_data = titan_client.models.malware_reports_search_schema_data_malware_report_data.MalwareReportsSearchSchema_data_malware_report_data(
                                attachments = [
                                    titan_client.models.malware_reports_search_schema_data_malware_report_data_attachments_inner.MalwareReportsSearchSchema_data_malware_report_data_attachments_inner(
                                        malicious = True, 
                                        mime_type = '', 
                                        name = '', 
                                        size = 56, 
                ...
                news = [
                    titan_client.models.news_schema.NewsSchema(
                        ...
                        data = titan_client.models.news_schema_data.NewsSchema_data(
                            attachments = [
                                titan_client.models.news_schema_data_attachments_inner.NewsSchema_data_attachments_inner(
                                    malicious = True, 
                                    mime_type = '', 
                                    name = '', 
                                    size = 56, 
                    ...
                    titan_client.models.situation_report_schema.SituationReportSchema(
                        ...
                        data = titan_client.models.situation_report_schema_data.SituationReportSchema_data(
                            situation_report = titan_client.models.situation_report_schema_data_situation_report.SituationReportSchema_data_situation_report(
                                entities = [
                                    titan_client.models.situation_report_schema_data_situation_report_entities_inner.SituationReportSchema_data_situation_report_entities_inner(
                                        type = '', 
                                        value = '', )
                                    ], 
                                ...
                                title = '', 
                                victims = [
                                    titan_client.models.situation_report_schema_data_situation_report_victims_inner.SituationReportSchema_data_situation_report_victims_inner(
                                        name = '', 
                                        urls = [
                                            ''
                                            ], )
                ...
                spot_reports = [
                    titan_client.models.simple_spot_report_schema.SimpleSpotReportSchema(
                        ...
                        data = titan_client.models.simple_spot_report_schema_data.SimpleSpotReportSchema_data(
                            entities = [
                                titan_client.models.simple_spot_report_schema_data_entities_inner.SimpleSpotReportSchema_data_entities_inner(
                                    type = '', 
                                    value = '', )
                                ], 
                            spot_report = titan_client.models.simple_spot_report_schema_data_spot_report.SimpleSpotReportSchema_data_spot_report(
                                spot_report_data = titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data.SimpleSpotReportSchema_data_spot_report_spot_report_data(
                                    ...
                                    links = [
                                        titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data_links_inner.SimpleSpotReportSchema_data_spot_report_spot_report_data_links_inner(
                                            title = '', 
                                            type = '', 
                                            url = '', )
                                        ], 
                                    ...
                                    version = '', 
                                    victims = [
                                        titan_client.models.simple_spot_report_schema_data_spot_report_spot_report_data_victims_inner.SimpleSpotReportSchema_data_spot_report_spot_report_data_victims_inner(
                                            name = '', 
                                            urls = [
                                                ''
                                                ], )
