...
class TestIocsResponse(unittest.TestCase):
    """IocsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IocsResponse:
        """Test IocsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IocsResponse`
        """
        model = IocsResponse()
        if include_optional:
            return IocsResponse(
                ioc_partial_result = True,
                ioc_total_count = 56,
                iocs = [
