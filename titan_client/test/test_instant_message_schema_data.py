...
class TestInstantMessageSchemaData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InstantMessageSchemaData:
        """Test InstantMessageSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstantMessageSchemaData`
        """
        model = InstantMessageSchemaData()
        if include_optional:
