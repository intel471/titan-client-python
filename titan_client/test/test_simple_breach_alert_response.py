...
class TestSimpleBreachAlertResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleBreachAlertResponse:
        """Test SimpleBreachAlertResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleBreachAlertResponse`
        """
        model = SimpleBreachAlertResponse()
        if include_optional:
