...
class TestCredentialSetsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialSetsResponse:
        """Test CredentialSetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialSetsResponse`
        """
        model = CredentialSetsResponse()
        if include_optional:
