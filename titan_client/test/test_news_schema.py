...
class TestNewsSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NewsSchema:
        """Test NewsSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewsSchema`
        """
        model = NewsSchema()
        if include_optional:
            return NewsSchema(
