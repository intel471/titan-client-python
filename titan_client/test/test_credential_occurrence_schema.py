...
class TestCredentialOccurrenceSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialOccurrenceSchema:
        """Test CredentialOccurrenceSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialOccurrenceSchema`
        """
        model = CredentialOccurrenceSchema()
        if include_optional:
