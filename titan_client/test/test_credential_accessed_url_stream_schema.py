...
class TestCredentialAccessedUrlStreamSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialAccessedUrlStreamSchema:
        """Test CredentialAccessedUrlStreamSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialAccessedUrlStreamSchema`
        """
        model = CredentialAccessedUrlStreamSchema()
        if include_optional:
