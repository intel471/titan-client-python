...
class TestFullReportSchema(unittest.TestCase):
    """FullReportSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullReportSchema:
        """Test FullReportSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullReportSchema`
        """
        model = FullReportSchema()
        if include_optional:
