...
class TestSimpleSpotReportSchema(unittest.TestCase):
    """SimpleSpotReportSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSpotReportSchema:
        """Test SimpleSpotReportSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSpotReportSchema`
        """
        model = SimpleSpotReportSchema()
        if include_optional:
            return SimpleSpotReportSchema(
    ...
    def testSimpleSpotReportSchema(self):
        """Test SimpleSpotReportSchema"""
