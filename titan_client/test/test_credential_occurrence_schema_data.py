...
class TestCredentialOccurrenceSchemaData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialOccurrenceSchemaData:
        """Test CredentialOccurrenceSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialOccurrenceSchemaData`
        """
        model = CredentialOccurrenceSchemaData()
        if include_optional:
