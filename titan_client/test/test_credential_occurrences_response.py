...
class TestCredentialOccurrencesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialOccurrencesResponse:
        """Test CredentialOccurrencesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialOccurrencesResponse`
        """
        model = CredentialOccurrencesResponse()
        if include_optional:
