...
class TestFullSpotReportSchema(unittest.TestCase):
    """FullSpotReportSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullSpotReportSchema:
        """Test FullSpotReportSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullSpotReportSchema`
        """
        model = FullSpotReportSchema()
        if include_optional:
            return FullSpotReportSchema(
    ...
    def testFullSpotReportSchema(self):
        """Test FullSpotReportSchema"""
