...
class TestSituationReportSchema(unittest.TestCase):
    """SituationReportSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SituationReportSchema:
        """Test SituationReportSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SituationReportSchema`
        """
        model = SituationReportSchema()
        if include_optional:
            return SituationReportSchema(
    ...
    def testSituationReportSchema(self):
        """Test SituationReportSchema"""
