...
class TestCredentialsStreamResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialsStreamResponse:
        """Test CredentialsStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialsStreamResponse`
        """
        model = CredentialsStreamResponse()
        if include_optional:
