...
class TestFullCveSchema(unittest.TestCase):
    """FullCveSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullCveSchema:
        """Test FullCveSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullCveSchema`
        """
        model = FullCveSchema()
        if include_optional:
            return FullCveSchema(
