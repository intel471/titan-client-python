...
class TestWatcherSchema(unittest.TestCase):
    """WatcherSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatcherSchema:
        """Test WatcherSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatcherSchema`
        """
        model = WatcherSchema()
        if include_optional:
            return WatcherSchema(
                data_sets = [
                    ''
                    ],
                description = '',
