...
class TestIndicatorStreamResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndicatorStreamResponse:
        """Test IndicatorStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndicatorStreamResponse`
        """
        model = IndicatorStreamResponse()
        if include_optional:
