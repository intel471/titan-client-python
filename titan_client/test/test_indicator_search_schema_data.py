...
class TestIndicatorSearchSchemaData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndicatorSearchSchemaData:
        """Test IndicatorSearchSchemaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndicatorSearchSchemaData`
        """
        model = IndicatorSearchSchemaData()
        if include_optional:
