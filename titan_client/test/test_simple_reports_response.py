...
class TestSimpleReportsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleReportsResponse:
        """Test SimpleReportsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleReportsResponse`
        """
        model = SimpleReportsResponse()
        if include_optional:
