...
class SimpleReportSchemaActorSubjectOfReport(object):
    ...
    def __init__(self, aliases=None, handle=None, local_vars_configuration=None):  # noqa: E501
        """SimpleReportSchemaActorSubjectOfReport - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def aliases(self):
        """Gets the aliases of this SimpleReportSchemaActorSubjectOfReport.  # noqa: E501

        Actor `aliases` (also known as).  # noqa: E501

        :return: The aliases of this SimpleReportSchemaActorSubjectOfReport.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def aliases(self, aliases):
        """Sets the aliases of this SimpleReportSchemaActorSubjectOfReport.

        Actor `aliases` (also known as).  # noqa: E501

        :param aliases: The aliases of this SimpleReportSchemaActorSubjectOfReport.  # noqa: E501
    ...
    @property
    def handle(self):
        """Gets the handle of this SimpleReportSchemaActorSubjectOfReport.  # noqa: E501

        Actor `handle`.  # noqa: E501

        :return: The handle of this SimpleReportSchemaActorSubjectOfReport.  # noqa: E501
        :rtype: str
        """
        return self._handle
    ...
    def handle(self, handle):
        """Sets the handle of this SimpleReportSchemaActorSubjectOfReport.

        Actor `handle`.  # noqa: E501

        :param handle: The handle of this SimpleReportSchemaActorSubjectOfReport.  # noqa: E501
        :type handle: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleReportSchemaActorSubjectOfReport):
            return False
