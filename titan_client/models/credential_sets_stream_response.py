...
class CredentialSetsStreamResponse(BaseModel):
    """
    CredentialSetsStreamResponse
    """ # noqa: E501
    credential_sets: Optional[List[CredentialSetStreamSchema]] = Field(default=None, description="List of `Credential sets`.")
    credential_sets_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.")
    ...
    __properties: ClassVar[List[str]] = ["credential_sets", "credential_sets_partial_result", "credential_sets_total_count", "cursor_next"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credential_sets": [CredentialSetStreamSchema.from_dict(_item) for _item in obj["credential_sets"]] if obj.get("credential_sets") is not None else None,
            "credential_sets_partial_result": obj.get("credential_sets_partial_result"),
