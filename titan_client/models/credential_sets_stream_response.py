...
class CredentialSetsStreamResponse(object):
    ...
    """
    openapi_types = {
        'credential_sets': 'list[CredentialSetStreamSchema]',
        'credential_sets_partial_result': 'bool',
    ...
    attribute_map = {
        ...
        'credential_sets_partial_result': 'credential_sets_partial_result',
        'credential_sets_total_count': 'credential_sets_total_count',
        'cursor_next': 'cursor_next'
    }

    def __init__(self, credential_sets=None, credential_sets_partial_result=None, credential_sets_total_count=None, cursor_next=None, local_vars_configuration=None):  # noqa: E501
        """CredentialSetsStreamResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._credential_sets = None
        self._credential_sets_partial_result = None
        ...
        if credential_sets_partial_result is not None:
            self.credential_sets_partial_result = credential_sets_partial_result
    ...
    def credential_sets(self):
        """Gets the credential_sets of this CredentialSetsStreamResponse.  # noqa: E501

        List of `Credential sets`.  # noqa: E501

        :return: The credential_sets of this CredentialSetsStreamResponse.  # noqa: E501
        :rtype: list[CredentialSetStreamSchema]
        """
        return self._credential_sets

    @credential_sets.setter
    def credential_sets(self, credential_sets):
        """Sets the credential_sets of this CredentialSetsStreamResponse.

        List of `Credential sets`.  # noqa: E501

        :param credential_sets: The credential_sets of this CredentialSetsStreamResponse.  # noqa: E501
        :type credential_sets: list[CredentialSetStreamSchema]
        """

        self._credential_sets = credential_sets

    @property
    def credential_sets_partial_result(self):
        """Gets the credential_sets_partial_result of this CredentialSetsStreamResponse.  # noqa: E501
        ...
        :return: The credential_sets_partial_result of this CredentialSetsStreamResponse.  # noqa: E501
        :rtype: bool
        """
        return self._credential_sets_partial_result

    @credential_sets_partial_result.setter
    def credential_sets_partial_result(self, credential_sets_partial_result):
        """Sets the credential_sets_partial_result of this CredentialSetsStreamResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param credential_sets_partial_result: The credential_sets_partial_result of this CredentialSetsStreamResponse.  # noqa: E501
        :type credential_sets_partial_result: bool
        """

        self._credential_sets_partial_result = credential_sets_partial_result

    @property
    def credential_sets_total_count(self):
        """Gets the credential_sets_total_count of this CredentialSetsStreamResponse.  # noqa: E501

        Total count of matched credential sets.  # noqa: E501

        :return: The credential_sets_total_count of this CredentialSetsStreamResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def credential_sets_total_count(self, credential_sets_total_count):
        """Sets the credential_sets_total_count of this CredentialSetsStreamResponse.

        Total count of matched credential sets.  # noqa: E501

        :param credential_sets_total_count: The credential_sets_total_count of this CredentialSetsStreamResponse.  # noqa: E501
    ...
    def cursor_next(self):
        """Gets the cursor_next of this CredentialSetsStreamResponse.  # noqa: E501

        Stream position identifier to continue scrolling from.  # noqa: E501

        :return: The cursor_next of this CredentialSetsStreamResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cursor_next(self, cursor_next):
        """Sets the cursor_next of this CredentialSetsStreamResponse.

        Stream position identifier to continue scrolling from.  # noqa: E501

        :param cursor_next: The cursor_next of this CredentialSetsStreamResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialSetsStreamResponse):
            return False
