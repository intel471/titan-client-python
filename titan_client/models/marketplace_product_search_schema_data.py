...
class MarketplaceProductSearchSchemaData(object):
    ...
    def __init__(self, availability=None, card_number=None, card_type=None, expiration=None, marketplace=None, product_type=None, victim=None, installed_at=None, stolen_by_form_stealers=None, title=None, categories=None, description=None, local_vars_configuration=None):  # noqa: E501
