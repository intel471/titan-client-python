...
MARKETPLACEPRODUCTSEARCHSCHEMADATA_ONE_OF_SCHEMAS = ["MarketplaceProductCredentialSchema", "MarketplaceProductCreditCardSchema", "MarketplaceProductOtherProductSchema"]

class MarketplaceProductSearchSchemaData(BaseModel):
    """
    MarketplaceProductSearchSchemaData
    """
    # data type: MarketplaceProductCreditCardSchema
    oneof_schema_1_validator: Optional[MarketplaceProductCreditCardSchema] = None
    # data type: MarketplaceProductCredentialSchema
    oneof_schema_2_validator: Optional[MarketplaceProductCredentialSchema] = None
    # data type: MarketplaceProductOtherProductSchema
    oneof_schema_3_validator: Optional[MarketplaceProductOtherProductSchema] = None
    actual_instance: Optional[Union[MarketplaceProductCredentialSchema, MarketplaceProductCreditCardSchema, MarketplaceProductOtherProductSchema]] = None
    one_of_schemas: Set[str] = { "MarketplaceProductCredentialSchema", "MarketplaceProductCreditCardSchema", "MarketplaceProductOtherProductSchema" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = MarketplaceProductSearchSchemaData.model_construct()
        error_messages = []
        match = 0
        # validate data type: MarketplaceProductCreditCardSchema
        if not isinstance(v, MarketplaceProductCreditCardSchema):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MarketplaceProductCreditCardSchema`")
        else:
            match += 1
        # validate data type: MarketplaceProductCredentialSchema
        if not isinstance(v, MarketplaceProductCredentialSchema):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MarketplaceProductCredentialSchema`")
        else:
            match += 1
        # validate data type: MarketplaceProductOtherProductSchema
        if not isinstance(v, MarketplaceProductOtherProductSchema):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MarketplaceProductOtherProductSchema`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in MarketplaceProductSearchSchemaData with oneOf schemas: MarketplaceProductCredentialSchema, MarketplaceProductCreditCardSchema, MarketplaceProductOtherProductSchema. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in MarketplaceProductSearchSchemaData with oneOf schemas: MarketplaceProductCredentialSchema, MarketplaceProductCreditCardSchema, MarketplaceProductOtherProductSchema. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into MarketplaceProductCreditCardSchema
        try:
            instance.actual_instance = MarketplaceProductCreditCardSchema.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MarketplaceProductCredentialSchema
        try:
            instance.actual_instance = MarketplaceProductCredentialSchema.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MarketplaceProductOtherProductSchema
        try:
            instance.actual_instance = MarketplaceProductOtherProductSchema.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into MarketplaceProductSearchSchemaData with oneOf schemas: MarketplaceProductCredentialSchema, MarketplaceProductCreditCardSchema, MarketplaceProductOtherProductSchema. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MarketplaceProductSearchSchemaData with oneOf schemas: MarketplaceProductCredentialSchema, MarketplaceProductCreditCardSchema, MarketplaceProductOtherProductSchema. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MarketplaceProductCredentialSchema, MarketplaceProductCreditCardSchema, MarketplaceProductOtherProductSchema]]:
