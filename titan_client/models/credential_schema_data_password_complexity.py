...
class CredentialSchemaDataPasswordComplexity(BaseModel):
    """
    ...
    uppercase: Optional[StrictInt] = Field(default=None, description="The number of uppercase characters in the password.")
