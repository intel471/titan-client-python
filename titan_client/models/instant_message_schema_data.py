...
class InstantMessageSchemaData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["actor", "channel", "message", "server"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actor": InstantMessageSchemaDataActor.from_dict(obj["actor"]) if obj.get("actor") is not None else None,
            "channel": InstantMessageSchemaDataChannel.from_dict(obj["channel"]) if obj.get("channel") is not None else None,
            "message": InstantMessageSchemaDataMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "server": InstantMessageSchemaDataServer.from_dict(obj["server"]) if obj.get("server") is not None else None
        })
        return _obj
