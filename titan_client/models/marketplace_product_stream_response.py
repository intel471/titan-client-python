...
class MarketplaceProductStreamResponse(object):
    ...
    def __init__(self, cursor_next=None, products=None, products_count=None, products_partial_result=None, statistics=None, local_vars_configuration=None):  # noqa: E501
