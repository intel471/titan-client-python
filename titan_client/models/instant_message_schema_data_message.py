...
class InstantMessageSchemaDataMessage(object):
    ...
    def __init__(self, attachments=None, original_images=None, reply_uid=None, text=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """InstantMessageSchemaDataMessage - a model defined in OpenAPI"""  # noqa: E501
    ...
    def attachments(self):
        """Gets the attachments of this InstantMessageSchemaDataMessage.  # noqa: E501
    ...
    def attachments(self, attachments):
        """Sets the attachments of this InstantMessageSchemaDataMessage.
    ...
    def original_images(self):
        """Gets the original_images of this InstantMessageSchemaDataMessage.  # noqa: E501

        Array of original image urls (if present).  # noqa: E501

        :return: The original_images of this InstantMessageSchemaDataMessage.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def original_images(self, original_images):
        """Sets the original_images of this InstantMessageSchemaDataMessage.

        Array of original image urls (if present).  # noqa: E501

        :param original_images: The original_images of this InstantMessageSchemaDataMessage.  # noqa: E501
    ...
    @property
    def reply_uid(self):
        """Gets the reply_uid of this InstantMessageSchemaDataMessage.  # noqa: E501

        Unique identifier of message this message is replying to.  # noqa: E501

        :return: The reply_uid of this InstantMessageSchemaDataMessage.  # noqa: E501
        :rtype: str
        """
        return self._reply_uid

    @reply_uid.setter
    def reply_uid(self, reply_uid):
        """Sets the reply_uid of this InstantMessageSchemaDataMessage.

        Unique identifier of message this message is replying to.  # noqa: E501

        :param reply_uid: The reply_uid of this InstantMessageSchemaDataMessage.  # noqa: E501
        :type reply_uid: str
        """

        self._reply_uid = reply_uid

    @property
    def text(self):
        """Gets the text of this InstantMessageSchemaDataMessage.  # noqa: E501

        HTML message content.  # noqa: E501

        :return: The text of this InstantMessageSchemaDataMessage.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this InstantMessageSchemaDataMessage.

        HTML message content.  # noqa: E501

        :param text: The text of this InstantMessageSchemaDataMessage.  # noqa: E501
        :type text: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this InstantMessageSchemaDataMessage.  # noqa: E501

        Unique message identifier.  # noqa: E501

        :return: The uid of this InstantMessageSchemaDataMessage.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this InstantMessageSchemaDataMessage.

        Unique message identifier.  # noqa: E501

        :param uid: The uid of this InstantMessageSchemaDataMessage.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstantMessageSchemaDataMessage):
            return False
