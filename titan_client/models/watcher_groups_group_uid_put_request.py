...
class WatcherGroupsGroupUidPutRequest(BaseModel):
    """
    WatcherGroupsGroupUidPutRequest
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="`Description` of Watcher Group to be created")
    muted: Optional[StrictBool] = Field(default=None, description="Watcher's mute status")
    name: Optional[StrictStr] = Field(default=None, description="`Name` of Watcher Group to be created")
    __properties: ClassVar[List[str]] = ["description", "muted", "name"]
