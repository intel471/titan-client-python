...
class WatcherGroupsGroupUidPutRequest(object):
    ...
    def __init__(self, description=None, muted=None, name=None, local_vars_configuration=None):  # noqa: E501
        """WatcherGroupsGroupUidPutRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this WatcherGroupsGroupUidPutRequest.  # noqa: E501

        `Description` of Watcher Group to be created  # noqa: E501

        :return: The description of this WatcherGroupsGroupUidPutRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this WatcherGroupsGroupUidPutRequest.

        `Description` of Watcher Group to be created  # noqa: E501

        :param description: The description of this WatcherGroupsGroupUidPutRequest.  # noqa: E501
    ...
    @property
    def muted(self):
        """Gets the muted of this WatcherGroupsGroupUidPutRequest.  # noqa: E501

        Watcher's mute status  # noqa: E501

        :return: The muted of this WatcherGroupsGroupUidPutRequest.  # noqa: E501
        :rtype: bool
        """
        return self._muted
    ...
    def muted(self, muted):
        """Sets the muted of this WatcherGroupsGroupUidPutRequest.

        Watcher's mute status  # noqa: E501

        :param muted: The muted of this WatcherGroupsGroupUidPutRequest.  # noqa: E501
        :type muted: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this WatcherGroupsGroupUidPutRequest.  # noqa: E501

        `Name` of Watcher Group to be created  # noqa: E501

        :return: The name of this WatcherGroupsGroupUidPutRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WatcherGroupsGroupUidPutRequest.

        `Name` of Watcher Group to be created  # noqa: E501

        :param name: The name of this WatcherGroupsGroupUidPutRequest.  # noqa: E501
        :type name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherGroupsGroupUidPutRequest):
            return False
