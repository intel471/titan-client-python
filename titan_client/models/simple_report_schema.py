...
class SimpleReportSchema(BaseModel):
    """
    SimpleReportSchema
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["actorHandle", "actorSubjectOfReport", "admiraltyCode", "classification", "created", "dateOfInformation", "documentFamily", "documentType", "entities", "lastUpdated", "locations", "motivation", "portalReportUrl", "relatedReports", "released", "reportAttachments", "sensitiveSource", "sourceCharacterization", "sources", "subject", "tags", "uid", "victims"]
