...
class ImageSnakeCaseSchema(object):
    ...
    attribute_map = {
        ...
        'image_sanitized': 'image_sanitized',
        'ocr': 'ocr',
    ...
    def __init__(self, dimension=None, hash=None, hash_type=None, image_original=None, image_sanitized=None, ocr=None, original_url=None, size=None, status=None, local_vars_configuration=None):  # noqa: E501
        """ImageSnakeCaseSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def dimension(self):
        """Gets the dimension of this ImageSnakeCaseSchema.  # noqa: E501

        Dimension of the image.  # noqa: E501

        :return: The dimension of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def dimension(self, dimension):
        """Sets the dimension of this ImageSnakeCaseSchema.

        Dimension of the image.  # noqa: E501

        :param dimension: The dimension of this ImageSnakeCaseSchema.  # noqa: E501
        :type dimension: str
        """
    ...
    @property
    def hash(self):
        """Gets the hash of this ImageSnakeCaseSchema.  # noqa: E501

        Hash value of the image.  # noqa: E501

        :return: The hash of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
        return self._hash
    ...
    @hash.setter
    def hash(self, hash):
        """Sets the hash of this ImageSnakeCaseSchema.

        Hash value of the image.  # noqa: E501

        :param hash: The hash of this ImageSnakeCaseSchema.  # noqa: E501
        :type hash: str
        """
    ...
    @property
    def hash_type(self):
        """Gets the hash_type of this ImageSnakeCaseSchema.  # noqa: E501

        Type of hash function to produce hash.  # noqa: E501

        :return: The hash_type of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def hash_type(self, hash_type):
        """Sets the hash_type of this ImageSnakeCaseSchema.

        Type of hash function to produce hash.  # noqa: E501

        :param hash_type: The hash_type of this ImageSnakeCaseSchema.  # noqa: E501
        :type hash_type: str
        """
    ...
    def image_original(self):
        """Gets the image_original of this ImageSnakeCaseSchema.  # noqa: E501
        ...
        :return: The image_original of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def image_original(self, image_original):
        """Sets the image_original of this ImageSnakeCaseSchema.

        Original image download url. Note: It's just an example. The actual path depends on specific API endpoint like posts, instant messages, etc.  # noqa: E501

        :param image_original: The image_original of this ImageSnakeCaseSchema.  # noqa: E501
    ...
    def image_sanitized(self):
        """Gets the image_sanitized of this ImageSnakeCaseSchema.  # noqa: E501
        ...
        :return: The image_sanitized of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def image_sanitized(self, image_sanitized):
        """Sets the image_sanitized of this ImageSnakeCaseSchema.

        Sanitised image download url. Note: It's just an example. The actual path depends on specific API endpoint like posts, instant messages, etc.  # noqa: E501

        :param image_sanitized: The image_sanitized of this ImageSnakeCaseSchema.  # noqa: E501
    ...
    @property
    def ocr(self):
        """Gets the ocr of this ImageSnakeCaseSchema.  # noqa: E501

        Recognized text from image.  # noqa: E501

        :return: The ocr of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
        return self._ocr
    ...
    @ocr.setter
    def ocr(self, ocr):
        """Sets the ocr of this ImageSnakeCaseSchema.

        Recognized text from image.  # noqa: E501

        :param ocr: The ocr of this ImageSnakeCaseSchema.  # noqa: E501
        :type ocr: str
        """
    ...
    def original_url(self):
        """Gets the original_url of this ImageSnakeCaseSchema.  # noqa: E501

        Image original url.  # noqa: E501

        :return: The original_url of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def original_url(self, original_url):
        """Sets the original_url of this ImageSnakeCaseSchema.

        Image original url.  # noqa: E501

        :param original_url: The original_url of this ImageSnakeCaseSchema.  # noqa: E501
    ...
    @property
    def size(self):
        """Gets the size of this ImageSnakeCaseSchema.  # noqa: E501

        Size of the image in bytes.  # noqa: E501

        :return: The size of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this ImageSnakeCaseSchema.

        Size of the image in bytes.  # noqa: E501

        :param size: The size of this ImageSnakeCaseSchema.  # noqa: E501
        :type size: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ImageSnakeCaseSchema.  # noqa: E501

        Image status. If image has no status this field will not be displayed.  # noqa: E501

        :return: The status of this ImageSnakeCaseSchema.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ImageSnakeCaseSchema.

        Image status. If image has no status this field will not be displayed.  # noqa: E501

        :param status: The status of this ImageSnakeCaseSchema.  # noqa: E501
        :type status: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImageSnakeCaseSchema):
            return False
