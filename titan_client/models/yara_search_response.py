...
class YARASearchResponse(BaseModel):
    """
    YARASearchResponse
    """ # noqa: E501
    yara_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="yaraPartialResult")
    yara_total_count: StrictInt = Field(description="Total count of matched results.", alias="yaraTotalCount")
    yaras: Optional[List[YARASearchSchema]] = Field(default=None, description="List of `YARA`.")
    __properties: ClassVar[List[str]] = ["yaraPartialResult", "yaraTotalCount", "yaras"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "yaraPartialResult": obj.get("yaraPartialResult"),
