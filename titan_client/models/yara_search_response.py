...
class YARASearchResponse(object):
    ...
    """
    openapi_types = {
        'yara_partial_result': 'bool',
        'yara_total_count': 'int',
        'yaras': 'list[YARASearchSchema]'
    }

    attribute_map = {
        'yara_partial_result': 'yaraPartialResult',
        'yara_total_count': 'yaraTotalCount',
        'yaras': 'yaras'
    }

    def __init__(self, yara_partial_result=None, yara_total_count=None, yaras=None, local_vars_configuration=None):  # noqa: E501
        """YARASearchResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._yara_partial_result = None
        self._yara_total_count = None
        self._yaras = None
        self.discriminator = None

        if yara_partial_result is not None:
            self.yara_partial_result = yara_partial_result
        self.yara_total_count = yara_total_count
        if yaras is not None:
            self.yaras = yaras

    @property
    def yara_partial_result(self):
        """Gets the yara_partial_result of this YARASearchResponse.  # noqa: E501
        ...
        :return: The yara_partial_result of this YARASearchResponse.  # noqa: E501
        :rtype: bool
        """
        return self._yara_partial_result

    @yara_partial_result.setter
    def yara_partial_result(self, yara_partial_result):
        """Sets the yara_partial_result of this YARASearchResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param yara_partial_result: The yara_partial_result of this YARASearchResponse.  # noqa: E501
        :type yara_partial_result: bool
        """

        self._yara_partial_result = yara_partial_result

    @property
    def yara_total_count(self):
        """Gets the yara_total_count of this YARASearchResponse.  # noqa: E501

        Total count of matched results.  # noqa: E501

        :return: The yara_total_count of this YARASearchResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def yara_total_count(self, yara_total_count):
        """Sets the yara_total_count of this YARASearchResponse.

        Total count of matched results.  # noqa: E501

        :param yara_total_count: The yara_total_count of this YARASearchResponse.  # noqa: E501
    ...
    @property
    def yaras(self):
        """Gets the yaras of this YARASearchResponse.  # noqa: E501

        List of `YARA`.  # noqa: E501

        :return: The yaras of this YARASearchResponse.  # noqa: E501
    ...
    def yaras(self, yaras):
        """Sets the yaras of this YARASearchResponse.

        List of `YARA`.  # noqa: E501

        :param yaras: The yaras of this YARASearchResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, YARASearchResponse):
            return False
