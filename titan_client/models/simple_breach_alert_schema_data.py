...
class SimpleBreachAlertSchemaData(object):
    ...
    def __init__(self, breach_alert=None, entities=None, local_vars_configuration=None):  # noqa: E501
        """SimpleBreachAlertSchemaData - a model defined in OpenAPI"""  # noqa: E501
    ...
    def breach_alert(self):
        """Gets the breach_alert of this SimpleBreachAlertSchemaData.  # noqa: E501


        :return: The breach_alert of this SimpleBreachAlertSchemaData.  # noqa: E501
        :rtype: SimpleBreachAlertSchemaDataBreachAlert
        """
        return self._breach_alert

    @breach_alert.setter
    def breach_alert(self, breach_alert):
        """Sets the breach_alert of this SimpleBreachAlertSchemaData.


        :param breach_alert: The breach_alert of this SimpleBreachAlertSchemaData.  # noqa: E501
        :type breach_alert: SimpleBreachAlertSchemaDataBreachAlert
        """
        if self.local_vars_configuration.client_side_validation and breach_alert is None:  # noqa: E501
            raise ValueError("Invalid value for `breach_alert`, must not be `None`")  # noqa: E501

        self._breach_alert = breach_alert

    @property
    def entities(self):
        """Gets the entities of this SimpleBreachAlertSchemaData.  # noqa: E501
    ...
    def entities(self, entities):
        """Sets the entities of this SimpleBreachAlertSchemaData.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleBreachAlertSchemaData):
            return False
