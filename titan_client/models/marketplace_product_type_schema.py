...
class MarketplaceProductTypeSchema(object):
    ...
    allowable_values = [CREDIT_CARD, CREDENTIAL, OTHER_PRODUCT]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MarketplaceProductTypeSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceProductTypeSchema):
            return False
