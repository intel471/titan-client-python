...
class CredentialSetAccessedUrlStreamSchemaData(object):
    ...
    openapi_types = {
        'accessed_domain': 'str',
        'accessed_url': 'str',
        'credential_set': 'CredentialSetAccessedUrlSchemaDataCredentialSet'
    }
    ...
    def __init__(self, accessed_domain=None, accessed_url=None, credential_set=None, local_vars_configuration=None):  # noqa: E501
        """CredentialSetAccessedUrlStreamSchemaData - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._accessed_domain = None
        self._accessed_url = None
        self._credential_set = None
        self.discriminator = None

        self.accessed_domain = accessed_domain
        self.accessed_url = accessed_url
        if credential_set is not None:
            self.credential_set = credential_set

    @property
    def accessed_domain(self):
        """Gets the accessed_domain of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501

        Accessed domain.  # noqa: E501

        :return: The accessed_domain of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501
        :rtype: str
        """
        return self._accessed_domain

    @accessed_domain.setter
    def accessed_domain(self, accessed_domain):
        """Sets the accessed_domain of this CredentialSetAccessedUrlStreamSchemaData.

        Accessed domain.  # noqa: E501

        :param accessed_domain: The accessed_domain of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501
        :type accessed_domain: str
        """
        if self.local_vars_configuration.client_side_validation and accessed_domain is None:  # noqa: E501
            raise ValueError("Invalid value for `accessed_domain`, must not be `None`")  # noqa: E501

        self._accessed_domain = accessed_domain

    @property
    def accessed_url(self):
        """Gets the accessed_url of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501

        Accessed URL.  # noqa: E501

        :return: The accessed_url of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501
        :rtype: str
        """
    ...
    def accessed_url(self, accessed_url):
        """Sets the accessed_url of this CredentialSetAccessedUrlStreamSchemaData.

        Accessed URL.  # noqa: E501

        :param accessed_url: The accessed_url of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501
        :type accessed_url: str
        """
        if self.local_vars_configuration.client_side_validation and accessed_url is None:  # noqa: E501
            raise ValueError("Invalid value for `accessed_url`, must not be `None`")  # noqa: E501

        self._accessed_url = accessed_url

    @property
    def credential_set(self):
        """Gets the credential_set of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501


        :return: The credential_set of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501
        :rtype: CredentialSetAccessedUrlSchemaDataCredentialSet
        """
        return self._credential_set

    @credential_set.setter
    def credential_set(self, credential_set):
        """Sets the credential_set of this CredentialSetAccessedUrlStreamSchemaData.


        :param credential_set: The credential_set of this CredentialSetAccessedUrlStreamSchemaData.  # noqa: E501
        :type credential_set: CredentialSetAccessedUrlSchemaDataCredentialSet
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialSetAccessedUrlStreamSchemaData):
            return False
