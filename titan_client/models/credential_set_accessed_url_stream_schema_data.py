...
class CredentialSetAccessedUrlStreamSchemaData(BaseModel):
    """
    ...
    credential_set: Optional[CredentialSetAccessedUrlSchemaDataCredentialSet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credential_set": CredentialSetAccessedUrlSchemaDataCredentialSet.from_dict(obj["credential_set"]) if obj.get("credential_set") is not None else None
        })
        return _obj
