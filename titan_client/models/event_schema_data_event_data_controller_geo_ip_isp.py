...
class EventSchemaDataEventDataControllerGeoIpIsp(BaseModel):
    """
    ISP details
    """ # noqa: E501
    autonomous_system: Optional[StrictStr] = Field(default=None, description="Autonomous System")
    isp: Optional[StrictStr] = Field(default=None, description="ISP name")
