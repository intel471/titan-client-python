...
class SimpleCvesResponse(object):
    ...
    openapi_types = {
        ...
        'post_partial_result': 'bool'
    }

    attribute_map = {
        'cve_reports': 'cveReports',
        'cve_reports_total_count': 'cveReportsTotalCount',
        'post_partial_result': 'postPartialResult'
    }

    def __init__(self, cve_reports=None, cve_reports_total_count=None, post_partial_result=None, local_vars_configuration=None):  # noqa: E501
        """SimpleCvesResponse - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._post_partial_result = None
        self.discriminator = None

        if cve_reports is not None:
            self.cve_reports = cve_reports
        self.cve_reports_total_count = cve_reports_total_count
        if post_partial_result is not None:
            self.post_partial_result = post_partial_result

    @property
    def cve_reports(self):
        """Gets the cve_reports of this SimpleCvesResponse.  # noqa: E501

        List of `Reports`.  # noqa: E501

        :return: The cve_reports of this SimpleCvesResponse.  # noqa: E501
    ...
    def cve_reports(self, cve_reports):
        """Sets the cve_reports of this SimpleCvesResponse.

        List of `Reports`.  # noqa: E501

        :param cve_reports: The cve_reports of this SimpleCvesResponse.  # noqa: E501
    ...
    def cve_reports_total_count(self):
        """Gets the cve_reports_total_count of this SimpleCvesResponse.  # noqa: E501

        Total count of matched reports.  # noqa: E501

        :return: The cve_reports_total_count of this SimpleCvesResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def cve_reports_total_count(self, cve_reports_total_count):
        """Sets the cve_reports_total_count of this SimpleCvesResponse.

        Total count of matched reports.  # noqa: E501

        :param cve_reports_total_count: The cve_reports_total_count of this SimpleCvesResponse.  # noqa: E501
    ...
    @property
    def post_partial_result(self):
        """Gets the post_partial_result of this SimpleCvesResponse.  # noqa: E501
        ...
        :return: The post_partial_result of this SimpleCvesResponse.  # noqa: E501
        :rtype: bool
        """
        return self._post_partial_result

    @post_partial_result.setter
    def post_partial_result(self, post_partial_result):
        """Sets the post_partial_result of this SimpleCvesResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param post_partial_result: The post_partial_result of this SimpleCvesResponse.  # noqa: E501
        :type post_partial_result: bool
        """

        self._post_partial_result = post_partial_result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleCvesResponse):
            return False
