...
class SimpleCvesResponse(BaseModel):
    """
    SimpleCvesResponse
    """ # noqa: E501
    cve_reports: Optional[List[SimpleCveSchema]] = Field(default=None, description="List of `Reports`.", alias="cveReports")
    cve_reports_total_count: StrictInt = Field(description="Total count of matched reports.", alias="cveReportsTotalCount")
    post_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="postPartialResult")
    __properties: ClassVar[List[str]] = ["cveReports", "cveReportsTotalCount", "postPartialResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "postPartialResult": obj.get("postPartialResult")
        })
        return _obj
