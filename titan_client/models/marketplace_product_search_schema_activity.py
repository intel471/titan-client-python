...
class MarketplaceProductSearchSchemaActivity(BaseModel):
    """
    Period when credit card was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the credit card activity range.")
    last: StrictInt = Field(description="End of the credit card activity range.")
