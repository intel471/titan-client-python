...
class DataLeakPostSchemaLinksBlog(BaseModel):
    """
    Data leak blog on which the post was found.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Data leak blog `description`.")
    name: StrictStr = Field(description="Data leak blog `name`.")
    uid: StrictStr = Field(description="Unique data leak blog identifier.")
