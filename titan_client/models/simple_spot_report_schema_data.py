...
class SimpleSpotReportSchemaData(object):
    ...
    def __init__(self, entities=None, spot_report=None, local_vars_configuration=None):  # noqa: E501
        """SimpleSpotReportSchemaData - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._entities = None
        self._spot_report = None
        self.discriminator = None

        if entities is not None:
            self.entities = entities
        self.spot_report = spot_report

    @property
    def entities(self):
        """Gets the entities of this SimpleSpotReportSchemaData.  # noqa: E501
    ...
    def entities(self, entities):
        """Sets the entities of this SimpleSpotReportSchemaData.
    ...
    def spot_report(self):
        """Gets the spot_report of this SimpleSpotReportSchemaData.  # noqa: E501


        :return: The spot_report of this SimpleSpotReportSchemaData.  # noqa: E501
        :rtype: SimpleSpotReportSchemaDataSpotReport
        """
        return self._spot_report

    @spot_report.setter
    def spot_report(self, spot_report):
        """Sets the spot_report of this SimpleSpotReportSchemaData.


        :param spot_report: The spot_report of this SimpleSpotReportSchemaData.  # noqa: E501
        :type spot_report: SimpleSpotReportSchemaDataSpotReport
        """
        if self.local_vars_configuration.client_side_validation and spot_report is None:  # noqa: E501
            raise ValueError("Invalid value for `spot_report`, must not be `None`")  # noqa: E501

        self._spot_report = spot_report
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleSpotReportSchemaData):
            return False
