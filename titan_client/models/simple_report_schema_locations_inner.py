...
class SimpleReportSchemaLocationsInner(BaseModel):
    """
    SimpleReportSchemaLocationsInner
    """ # noqa: E501
    country: Optional[StrictStr] = Field(default=None, description="Name of `country`.")
    link: StrictStr = Field(description="Linkage type.")
    region: StrictStr = Field(description="Name of `region`.")
    __properties: ClassVar[List[str]] = ["country", "link", "region"]
