...
class SimpleReportsResponse(BaseModel):
    """
    SimpleReportsResponse
    """ # noqa: E501
    report_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="reportPartialResult")
    report_total_count: StrictInt = Field(description="Total count of matched reports.", alias="reportTotalCount")
    reports: Optional[List[SimpleReportSchema]] = Field(default=None, description="List of Information Reports or Fintel Reports excluding researcherComments, rawText, rawTextTranslated fields.")
    __properties: ClassVar[List[str]] = ["reportPartialResult", "reportTotalCount", "reports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reportPartialResult": obj.get("reportPartialResult"),
