...
class SimpleReportsResponse(object):
    ...
    """
    openapi_types = {
        'report_partial_result': 'bool',
        'report_total_count': 'int',
        'reports': 'list[SimpleReportSchema]'
    }

    attribute_map = {
        'report_partial_result': 'reportPartialResult',
        'report_total_count': 'reportTotalCount',
        'reports': 'reports'
    }

    def __init__(self, report_partial_result=None, report_total_count=None, reports=None, local_vars_configuration=None):  # noqa: E501
        """SimpleReportsResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._report_partial_result = None
        self._report_total_count = None
        self._reports = None
        self.discriminator = None

        if report_partial_result is not None:
            self.report_partial_result = report_partial_result
        self.report_total_count = report_total_count
        if reports is not None:
            self.reports = reports

    @property
    def report_partial_result(self):
        """Gets the report_partial_result of this SimpleReportsResponse.  # noqa: E501
        ...
        :return: The report_partial_result of this SimpleReportsResponse.  # noqa: E501
        :rtype: bool
        """
        return self._report_partial_result

    @report_partial_result.setter
    def report_partial_result(self, report_partial_result):
        """Sets the report_partial_result of this SimpleReportsResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param report_partial_result: The report_partial_result of this SimpleReportsResponse.  # noqa: E501
        :type report_partial_result: bool
        """
    ...
    def report_total_count(self):
        """Gets the report_total_count of this SimpleReportsResponse.  # noqa: E501

        Total count of matched reports.  # noqa: E501

        :return: The report_total_count of this SimpleReportsResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def report_total_count(self, report_total_count):
        """Sets the report_total_count of this SimpleReportsResponse.

        Total count of matched reports.  # noqa: E501

        :param report_total_count: The report_total_count of this SimpleReportsResponse.  # noqa: E501
    ...
    @property
    def reports(self):
        """Gets the reports of this SimpleReportsResponse.  # noqa: E501

        List of Information Reports or Fintel Reports excluding researcherComments, rawText, rawTextTranslated fields.  # noqa: E501

        :return: The reports of this SimpleReportsResponse.  # noqa: E501
    ...
    def reports(self, reports):
        """Sets the reports of this SimpleReportsResponse.

        List of Information Reports or Fintel Reports excluding researcherComments, rawText, rawTextTranslated fields.  # noqa: E501

        :param reports: The reports of this SimpleReportsResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleReportsResponse):
            return False
