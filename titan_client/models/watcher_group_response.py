...
class WatcherGroupResponse(object):
    ...
    """
    openapi_types = {
        'watcher_group_total_count': 'int',
        'watcher_groups': 'list[SimpleWatcherGroupSchema]'
    }

    attribute_map = {
        'watcher_group_total_count': 'watcherGroupTotalCount',
        'watcher_groups': 'watcherGroups'
    }

    def __init__(self, watcher_group_total_count=None, watcher_groups=None, local_vars_configuration=None):  # noqa: E501
        """WatcherGroupResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._watcher_group_total_count = None
        self._watcher_groups = None
        self.discriminator = None

        self.watcher_group_total_count = watcher_group_total_count
        if watcher_groups is not None:
            self.watcher_groups = watcher_groups

    @property
    def watcher_group_total_count(self):
        """Gets the watcher_group_total_count of this WatcherGroupResponse.  # noqa: E501

        Total count of watcher groups.  # noqa: E501

        :return: The watcher_group_total_count of this WatcherGroupResponse.  # noqa: E501
        :rtype: int
        """
        return self._watcher_group_total_count

    @watcher_group_total_count.setter
    def watcher_group_total_count(self, watcher_group_total_count):
        """Sets the watcher_group_total_count of this WatcherGroupResponse.

        Total count of watcher groups.  # noqa: E501

        :param watcher_group_total_count: The watcher_group_total_count of this WatcherGroupResponse.  # noqa: E501
        :type watcher_group_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and watcher_group_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `watcher_group_total_count`, must not be `None`")  # noqa: E501

        self._watcher_group_total_count = watcher_group_total_count

    @property
    def watcher_groups(self):
        """Gets the watcher_groups of this WatcherGroupResponse.  # noqa: E501

        List of watcher groups.  # noqa: E501

        :return: The watcher_groups of this WatcherGroupResponse.  # noqa: E501
        :rtype: list[SimpleWatcherGroupSchema]
        """
        return self._watcher_groups

    @watcher_groups.setter
    def watcher_groups(self, watcher_groups):
        """Sets the watcher_groups of this WatcherGroupResponse.

        List of watcher groups.  # noqa: E501

        :param watcher_groups: The watcher_groups of this WatcherGroupResponse.  # noqa: E501
        :type watcher_groups: list[SimpleWatcherGroupSchema]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherGroupResponse):
            return False
