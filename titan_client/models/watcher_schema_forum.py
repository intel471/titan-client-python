...
class WatcherSchemaForum(object):
    ...
    def __init__(self, description=None, name=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """WatcherSchemaForum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this WatcherSchemaForum.  # noqa: E501

        Forum `description`.  # noqa: E501

        :return: The description of this WatcherSchemaForum.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this WatcherSchemaForum.

        Forum `description`.  # noqa: E501

        :param description: The description of this WatcherSchemaForum.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this WatcherSchemaForum.  # noqa: E501

        Forum `name`.  # noqa: E501

        :return: The name of this WatcherSchemaForum.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WatcherSchemaForum.

        Forum `name`.  # noqa: E501

        :param name: The name of this WatcherSchemaForum.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this WatcherSchemaForum.  # noqa: E501

        Forum identifier.  # noqa: E501

        :return: The uid of this WatcherSchemaForum.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this WatcherSchemaForum.

        Forum identifier.  # noqa: E501

        :param uid: The uid of this WatcherSchemaForum.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherSchemaForum):
            return False
