...
class MarketplaceSearchSchemaStatistics(object):
    ...
    openapi_types = {
        ...
        'vendors_total_count': 'int'
    }

    attribute_map = {
        'products_total_count': 'products_total_count',
        'vendors_total_count': 'vendors_total_count'
    }

    def __init__(self, products_total_count=None, vendors_total_count=None, local_vars_configuration=None):  # noqa: E501
        """MarketplaceSearchSchemaStatistics - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._products_total_count = None
        self._vendors_total_count = None
        self.discriminator = None

        self.products_total_count = products_total_count
        self.vendors_total_count = vendors_total_count

    @property
    def products_total_count(self):
        """Gets the products_total_count of this MarketplaceSearchSchemaStatistics.  # noqa: E501

        Total count of marketplace's products.  # noqa: E501

        :return: The products_total_count of this MarketplaceSearchSchemaStatistics.  # noqa: E501
        :rtype: int
        """
        return self._products_total_count

    @products_total_count.setter
    def products_total_count(self, products_total_count):
        """Sets the products_total_count of this MarketplaceSearchSchemaStatistics.

        Total count of marketplace's products.  # noqa: E501

        :param products_total_count: The products_total_count of this MarketplaceSearchSchemaStatistics.  # noqa: E501
        :type products_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and products_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `products_total_count`, must not be `None`")  # noqa: E501

        self._products_total_count = products_total_count

    @property
    def vendors_total_count(self):
        """Gets the vendors_total_count of this MarketplaceSearchSchemaStatistics.  # noqa: E501

        Total count of marketplace's vendors.  # noqa: E501

        :return: The vendors_total_count of this MarketplaceSearchSchemaStatistics.  # noqa: E501
        :rtype: int
        """
        return self._vendors_total_count

    @vendors_total_count.setter
    def vendors_total_count(self, vendors_total_count):
        """Sets the vendors_total_count of this MarketplaceSearchSchemaStatistics.

        Total count of marketplace's vendors.  # noqa: E501

        :param vendors_total_count: The vendors_total_count of this MarketplaceSearchSchemaStatistics.  # noqa: E501
        :type vendors_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and vendors_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `vendors_total_count`, must not be `None`")  # noqa: E501

        self._vendors_total_count = vendors_total_count
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceSearchSchemaStatistics):
            return False
