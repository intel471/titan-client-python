...
class CredentialSchema(BaseModel):
    ...
    classification: Optional[CredentialSchemaClassification] = None
    data: CredentialSchemaData
    last_updated: StrictInt = Field(description="Credential last modification date.")
    statistics: Optional[CredentialSchemaStatistics] = None
    uid: StrictStr = Field(description="Unique credential identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": CredentialSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "classification": CredentialSchemaClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None,
            "data": CredentialSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "statistics": CredentialSchemaStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
