...
class WatcherRequestBodyPutAllOf(object):
    ...
    def __init__(self, muted=None, type=None, local_vars_configuration=None):  # noqa: E501
        """WatcherRequestBodyPutAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def muted(self):
        """Gets the muted of this WatcherRequestBodyPutAllOf.  # noqa: E501

        Watcher's mute status (if a watcher is muted, no alerts are received during its mute period)  # noqa: E501

        :return: The muted of this WatcherRequestBodyPutAllOf.  # noqa: E501
        :rtype: bool
        """
        return self._muted
    ...
    def muted(self, muted):
        """Sets the muted of this WatcherRequestBodyPutAllOf.

        Watcher's mute status (if a watcher is muted, no alerts are received during its mute period)  # noqa: E501

        :param muted: The muted of this WatcherRequestBodyPutAllOf.  # noqa: E501
        :type muted: bool
        """
    ...
    @property
    def type(self):
        """Gets the type of this WatcherRequestBodyPutAllOf.  # noqa: E501

        Watcher type.<br />Only watchers of type `search` can be edited.  # noqa: E501

        :return: The type of this WatcherRequestBodyPutAllOf.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WatcherRequestBodyPutAllOf.

        Watcher type.<br />Only watchers of type `search` can be edited.  # noqa: E501

        :param type: The type of this WatcherRequestBodyPutAllOf.  # noqa: E501
        :type type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherRequestBodyPutAllOf):
            return False
