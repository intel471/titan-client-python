...
class WatcherRequestBodyFiltersInner(BaseModel):
    """
    WatcherRequestBodyFiltersInner
    """ # noqa: E501
    filter: Optional[StrictStr] = Field(default=None, description="Search filter.")
    type: Optional[StrictStr] = Field(default=None, description="Search filter type. Any mismatch with search pattern type will remove filters.")
