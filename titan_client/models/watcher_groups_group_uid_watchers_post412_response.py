...
WATCHERGROUPSGROUPUIDWATCHERSPOST412RESPONSE_ONE_OF_SCHEMAS = ["str"]

class WatcherGroupsGroupUidWatchersPost412Response(BaseModel):
    """
    WatcherGroupsGroupUidWatchersPost412Response
    """
    # data type: str
    oneof_schema_1_validator: Optional[StrictStr] = Field(default=None, description="InaccessibleDataRequestError: User has no permission to access requested data")
    # data type: str
    oneof_schema_2_validator: Optional[StrictStr] = Field(default=None, description="WatcherTypeError: Watcher type should be `search` or `thread`")
    # data type: str
    oneof_schema_3_validator: Optional[StrictStr] = Field(default=None, description="UnknownDataSetError: Attempt to create a watcher with unknown data set")
    # data type: str
    oneof_schema_4_validator: Optional[StrictStr] = Field(default=None, description="InvalidWatcherConfigError: Watcher with existing configuration cannot be saved")
    # data type: str
    oneof_schema_5_validator: Optional[StrictStr] = Field(default=None, description="NoSearchPatternError: At least one search pattern or gir set should be specified")
    # data type: str
    oneof_schema_6_validator: Optional[StrictStr] = Field(default=None, description="UnknownSearchFilterError: Search filter with specified type and value cannot be created")
    # data type: str
    oneof_schema_7_validator: Optional[StrictStr] = Field(default=None, description="ThreadUidError: Thread uid for thread watcher should be specified")
    # data type: str
    oneof_schema_8_validator: Optional[StrictStr] = Field(default=None, description="NotificationChannelError: Notification channel should be `email` or `website`")
    # data type: str
    oneof_schema_9_validator: Optional[StrictStr] = Field(default=None, description="NotificationFrequencyError: Notification frequency should be `immediately` or `daily`")
    # data type: str
    oneof_schema_10_validator: Optional[StrictStr] = Field(default=None, description="EmptyJsonBodyError: Received request with empty JSON body")
    # data type: str
    oneof_schema_11_validator: Optional[StrictStr] = Field(default=None, description="JsonBodyParsingError: JSON body is corrupted")
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = WatcherGroupsGroupUidWatchersPost412Response.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in WatcherGroupsGroupUidWatchersPost412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in WatcherGroupsGroupUidWatchersPost412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into WatcherGroupsGroupUidWatchersPost412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WatcherGroupsGroupUidWatchersPost412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
