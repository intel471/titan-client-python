...
class MarketplaceProductCredentialSchema(BaseModel):
    """
    MarketplaceProductCredentialSchema
    """ # noqa: E501
    availability: Optional[MarketplaceProductAvailabilitySchema] = None
    installed_at: Optional[StrictInt] = Field(default=None, description="Timestamp when bot was installed.")
    ...
    stolen_by_form_stealers: Optional[StrictInt] = Field(default=None, description="Count of stolen credentials in this package.")
    title: Optional[StrictStr] = Field(default=None, description="Credential title.")
    victim: Optional[MarketplaceProductCredentialSchemaVictim] = None
    __properties: ClassVar[List[str]] = ["availability", "installed_at", "marketplace", "product_type", "stolen_by_form_stealers", "title", "victim"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stolen_by_form_stealers": obj.get("stolen_by_form_stealers"),
            "title": obj.get("title"),
            "victim": MarketplaceProductCredentialSchemaVictim.from_dict(obj["victim"]) if obj.get("victim") is not None else None
        })
        return _obj
