...
class EntitiesSchemaLinksReportsInner(object):
    ...
    def __init__(self, admiralty_code=None, date_of_information=None, motivation=None, portal_report_url=None, released=None, source_characterization=None, subject=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """EntitiesSchemaLinksReportsInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    def admiralty_code(self):
        """Gets the admiralty_code of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Code as described [here](http://en.wikipedia.org/wiki/Admiralty_code). All Fintel reports have admiraltyCode=`A1`.  # noqa: E501

        :return: The admiralty_code of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def admiralty_code(self, admiralty_code):
        """Sets the admiralty_code of this EntitiesSchemaLinksReportsInner.

        Code as described [here](http://en.wikipedia.org/wiki/Admiralty_code). All Fintel reports have admiraltyCode=`A1`.  # noqa: E501

        :param admiralty_code: The admiralty_code of this EntitiesSchemaLinksReportsInner.  # noqa: E501
    ...
    def date_of_information(self):
        """Gets the date_of_information of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Date of information as Epoch Time.  # noqa: E501

        :return: The date_of_information of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: int
        """
    ...
    def date_of_information(self, date_of_information):
        """Sets the date_of_information of this EntitiesSchemaLinksReportsInner.

        Date of information as Epoch Time.  # noqa: E501

        :param date_of_information: The date_of_information of this EntitiesSchemaLinksReportsInner.  # noqa: E501
    ...
    @property
    def motivation(self):
        """Gets the motivation of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Actor's `motivation`. `CC` for Cyber Crime, `CE` for Cyber Espionage, `HA` for Hacktivism.  # noqa: E501

        :return: The motivation of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def motivation(self, motivation):
        """Sets the motivation of this EntitiesSchemaLinksReportsInner.

        Actor's `motivation`. `CC` for Cyber Crime, `CE` for Cyber Espionage, `HA` for Hacktivism.  # noqa: E501

        :param motivation: The motivation of this EntitiesSchemaLinksReportsInner.  # noqa: E501
    ...
    def portal_report_url(self):
        """Gets the portal_report_url of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        URL to the report on the portal.  # noqa: E501

        :return: The portal_report_url of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def portal_report_url(self, portal_report_url):
        """Sets the portal_report_url of this EntitiesSchemaLinksReportsInner.

        URL to the report on the portal.  # noqa: E501

        :param portal_report_url: The portal_report_url of this EntitiesSchemaLinksReportsInner.  # noqa: E501
    ...
    @property
    def released(self):
        """Gets the released of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Date the `report` was `released.  # noqa: E501

        :return: The released of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: int
        """
    ...
    def released(self, released):
        """Sets the released of this EntitiesSchemaLinksReportsInner.

        Date the `report` was `released.  # noqa: E501

        :param released: The released of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :type released: int
        """
    ...
    def source_characterization(self):
        """Gets the source_characterization of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Characterization of the reports source.  # noqa: E501

        :return: The source_characterization of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def source_characterization(self, source_characterization):
        """Sets the source_characterization of this EntitiesSchemaLinksReportsInner.

        Characterization of the reports source.  # noqa: E501

        :param source_characterization: The source_characterization of this EntitiesSchemaLinksReportsInner.  # noqa: E501
    ...
    @property
    def subject(self):
        """Gets the subject of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Report's `subject`.  # noqa: E501

        :return: The subject of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def subject(self, subject):
        """Sets the subject of this EntitiesSchemaLinksReportsInner.

        Report's `subject`.  # noqa: E501

        :param subject: The subject of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :type subject: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this EntitiesSchemaLinksReportsInner.  # noqa: E501

        Unique report identifier.  # noqa: E501

        :return: The uid of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this EntitiesSchemaLinksReportsInner.

        Unique report identifier.  # noqa: E501

        :param uid: The uid of this EntitiesSchemaLinksReportsInner.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntitiesSchemaLinksReportsInner):
            return False
