...
class CredentialSetSchemaStatistics(object):
    ...
    attribute_map = {
        'accessed_urls_total_count': 'accessed_urls_total_count',
        'credential_occurrences_total_count': 'credential_occurrences_total_count',
        'credentials_total_count': 'credentials_total_count'
    }

    def __init__(self, accessed_urls_total_count=None, credential_occurrences_total_count=None, credentials_total_count=None, local_vars_configuration=None):  # noqa: E501
        """CredentialSetSchemaStatistics - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._accessed_urls_total_count = None
        self._credential_occurrences_total_count = None
        self._credentials_total_count = None
        self.discriminator = None

        if accessed_urls_total_count is not None:
            self.accessed_urls_total_count = accessed_urls_total_count
    ...
    @property
    def accessed_urls_total_count(self):
        """Gets the accessed_urls_total_count of this CredentialSetSchemaStatistics.  # noqa: E501
    ...
    @accessed_urls_total_count.setter
    def accessed_urls_total_count(self, accessed_urls_total_count):
        """Sets the accessed_urls_total_count of this CredentialSetSchemaStatistics.
    ...
    def credential_occurrences_total_count(self):
        """Gets the credential_occurrences_total_count of this CredentialSetSchemaStatistics.  # noqa: E501
    ...
    def credential_occurrences_total_count(self, credential_occurrences_total_count):
        """Sets the credential_occurrences_total_count of this CredentialSetSchemaStatistics.
    ...
    def credentials_total_count(self):
        """Gets the credentials_total_count of this CredentialSetSchemaStatistics.  # noqa: E501
    ...
    def credentials_total_count(self, credentials_total_count):
        """Sets the credentials_total_count of this CredentialSetSchemaStatistics.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialSetSchemaStatistics):
            return False
