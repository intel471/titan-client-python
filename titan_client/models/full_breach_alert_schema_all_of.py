...
class FullBreachAlertSchemaAllOf(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """FullBreachAlertSchemaAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this FullBreachAlertSchemaAllOf.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this FullBreachAlertSchemaAllOf.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FullBreachAlertSchemaAllOf):
            return False
