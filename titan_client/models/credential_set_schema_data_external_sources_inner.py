...
class CredentialSetSchemaDataExternalSourcesInner(BaseModel):
    """
    CredentialSetSchemaDataExternalSourcesInner
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="External source title.")
    url: Optional[StrictStr] = Field(default=None, description="External source URL.")
