...
class SimpleSpotReportSchemaDataSpotReport(BaseModel):
    """
    Sub-document containing Spot report information.
    """ # noqa: E501
    spot_report_data: SimpleSpotReportSchemaDataSpotReportSpotReportData
    uid: Optional[StrictStr] = Field(default=None, description="Spot report's IDw.")
    __properties: ClassVar[List[str]] = ["spot_report_data", "uid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spot_report_data
        if self.spot_report_data:
            _dict['spot_report_data'] = self.spot_report_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spot_report_data": SimpleSpotReportSchemaDataSpotReportSpotReportData.from_dict(obj["spot_report_data"]) if obj.get("spot_report_data") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
