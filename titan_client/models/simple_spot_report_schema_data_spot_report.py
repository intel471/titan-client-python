...
class SimpleSpotReportSchemaDataSpotReport(object):
    ...
    """
    openapi_types = {
        'spot_report_data': 'SimpleSpotReportSchemaDataSpotReportSpotReportData',
        'uid': 'str'
    }

    attribute_map = {
        'spot_report_data': 'spot_report_data',
        'uid': 'uid'
    }

    def __init__(self, spot_report_data=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """SimpleSpotReportSchemaDataSpotReport - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._spot_report_data = None
        self._uid = None
        self.discriminator = None

        self.spot_report_data = spot_report_data
        if uid is not None:
            self.uid = uid

    @property
    def spot_report_data(self):
        """Gets the spot_report_data of this SimpleSpotReportSchemaDataSpotReport.  # noqa: E501


        :return: The spot_report_data of this SimpleSpotReportSchemaDataSpotReport.  # noqa: E501
        :rtype: SimpleSpotReportSchemaDataSpotReportSpotReportData
        """
        return self._spot_report_data

    @spot_report_data.setter
    def spot_report_data(self, spot_report_data):
        """Sets the spot_report_data of this SimpleSpotReportSchemaDataSpotReport.


        :param spot_report_data: The spot_report_data of this SimpleSpotReportSchemaDataSpotReport.  # noqa: E501
        :type spot_report_data: SimpleSpotReportSchemaDataSpotReportSpotReportData
        """
        if self.local_vars_configuration.client_side_validation and spot_report_data is None:  # noqa: E501
            raise ValueError("Invalid value for `spot_report_data`, must not be `None`")  # noqa: E501

        self._spot_report_data = spot_report_data

    @property
    def uid(self):
        """Gets the uid of this SimpleSpotReportSchemaDataSpotReport.  # noqa: E501

        Spot report's IDw.  # noqa: E501

        :return: The uid of this SimpleSpotReportSchemaDataSpotReport.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this SimpleSpotReportSchemaDataSpotReport.

        Spot report's IDw.  # noqa: E501

        :param uid: The uid of this SimpleSpotReportSchemaDataSpotReport.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleSpotReportSchemaDataSpotReport):
            return False
