...
class SimpleReportSchemaRelatedReportsInner(object):
    ...
    def __init__(self, document_family=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """SimpleReportSchemaRelatedReportsInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    def document_family(self):
        """Gets the document_family of this SimpleReportSchemaRelatedReportsInner.  # noqa: E501

        Related report document family.  # noqa: E501

        :return: The document_family of this SimpleReportSchemaRelatedReportsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def document_family(self, document_family):
        """Sets the document_family of this SimpleReportSchemaRelatedReportsInner.

        Related report document family.  # noqa: E501

        :param document_family: The document_family of this SimpleReportSchemaRelatedReportsInner.  # noqa: E501
        :type document_family: str
        """
        if self.local_vars_configuration.client_side_validation and document_family is None:  # noqa: E501
            raise ValueError("Invalid value for `document_family`, must not be `None`")  # noqa: E501

        self._document_family = document_family

    @property
    def uid(self):
        """Gets the uid of this SimpleReportSchemaRelatedReportsInner.  # noqa: E501

        Related report unique identifier.  # noqa: E501

        :return: The uid of this SimpleReportSchemaRelatedReportsInner.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this SimpleReportSchemaRelatedReportsInner.

        Related report unique identifier.  # noqa: E501

        :param uid: The uid of this SimpleReportSchemaRelatedReportsInner.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleReportSchemaRelatedReportsInner):
            return False
