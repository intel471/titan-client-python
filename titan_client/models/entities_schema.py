...
class EntitiesSchema(BaseModel):
    ...
    uid: StrictStr = Field(description="Unique entity identifier.")
    value: StrictStr = Field(description="Entity `value`.")
    __properties: ClassVar[List[str]] = ["activeFrom", "activeTill", "lastUpdated", "links", "type", "uid", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": EntitiesSchemaLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "type": obj.get("type"),
            "uid": obj.get("uid"),
            "value": obj.get("value")
        })
