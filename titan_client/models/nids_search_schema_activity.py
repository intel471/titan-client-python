...
class NIDSSearchSchemaActivity(object):
    ...
    def __init__(self, first=None, last=None, local_vars_configuration=None):  # noqa: E501
        """NIDSSearchSchemaActivity - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def first(self):
        """Gets the first of this NIDSSearchSchemaActivity.  # noqa: E501

        Start of the NIDS activity range.  # noqa: E501

        :return: The first of this NIDSSearchSchemaActivity.  # noqa: E501
        :rtype: int
        """
        return self._first
    ...
    def first(self, first):
        """Sets the first of this NIDSSearchSchemaActivity.

        Start of the NIDS activity range.  # noqa: E501

        :param first: The first of this NIDSSearchSchemaActivity.  # noqa: E501
        :type first: int
        """
    ...
    @property
    def last(self):
        """Gets the last of this NIDSSearchSchemaActivity.  # noqa: E501

        End of the NIDS activity range.  # noqa: E501

        :return: The last of this NIDSSearchSchemaActivity.  # noqa: E501
        :rtype: int
        """
        return self._last
    ...
    @last.setter
    def last(self, last):
        """Sets the last of this NIDSSearchSchemaActivity.

        End of the NIDS activity range.  # noqa: E501

        :param last: The last of this NIDSSearchSchemaActivity.  # noqa: E501
        :type last: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NIDSSearchSchemaActivity):
            return False
