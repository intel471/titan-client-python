...
class SimpleBreachAlertSchemaDataBreachAlertSources(object):
    ...
    def __init__(self, date=None, source_type=None, title=None, type=None, url=None, local_vars_configuration=None):  # noqa: E501
        """SimpleBreachAlertSchemaDataBreachAlertSources - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def date(self):
        """Gets the date of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501

        Date of source publication or information acquisition.  # noqa: E501

        :return: The date of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :rtype: int
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this SimpleBreachAlertSchemaDataBreachAlertSources.

        Date of source publication or information acquisition.  # noqa: E501

        :param date: The date of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :type date: int
        """
    ...
    def source_type(self):
        """Gets the source_type of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501

        Description of source information's type.  # noqa: E501

        :return: The source_type of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :rtype: str
        """
    ...
    def source_type(self, source_type):
        """Sets the source_type of this SimpleBreachAlertSchemaDataBreachAlertSources.

        Description of source information's type.  # noqa: E501

        :param source_type: The source_type of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501

        The `title` of the source.  # noqa: E501

        :return: The title of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this SimpleBreachAlertSchemaDataBreachAlertSources.

        The `title` of the source.  # noqa: E501

        :param title: The title of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :type title: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501

        Source `type`, external or internal.  # noqa: E501

        :return: The type of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SimpleBreachAlertSchemaDataBreachAlertSources.

        Source `type`, external or internal.  # noqa: E501

        :param type: The type of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :type type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501

        Source link, an absolute `url`.  # noqa: E501

        :return: The url of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SimpleBreachAlertSchemaDataBreachAlertSources.

        Source link, an absolute `url`.  # noqa: E501

        :param url: The url of this SimpleBreachAlertSchemaDataBreachAlertSources.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleBreachAlertSchemaDataBreachAlertSources):
            return False
