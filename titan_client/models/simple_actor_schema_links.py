...
class SimpleActorSchemaLinks(BaseModel):
    """
    Linked data
    """ # noqa: E501
    forum_post_total_count: StrictInt = Field(description="Total count of linked posts.", alias="forumPostTotalCount")
    forum_private_message_total_count: StrictInt = Field(description="Total count of linked private messages.", alias="forumPrivateMessageTotalCount")
    forum_total_count: StrictInt = Field(description="Total count of linked forums.", alias="forumTotalCount")
    forums: Optional[List[SimpleActorSchemaLinksForumsInner]] = Field(default=None, description="Linked forums.")
    instant_message_channel_total_count: StrictInt = Field(description="Total count of instant messaging channels of particular server actor participated in.", alias="instantMessageChannelTotalCount")
    instant_message_server_total_count: StrictInt = Field(description="Total count of linked instant messaging servers.", alias="instantMessageServerTotalCount")
    instant_message_servers: Optional[List[SimpleActorSchemaLinksInstantMessageServersInner]] = Field(default=None, description="Linked instant messaging servers.", alias="instantMessageServers")
    instant_message_total_count: StrictInt = Field(description="Total count of instant messages actor has written on particular server.", alias="instantMessageTotalCount")
    report_total_count: StrictInt = Field(description="Total count of linked reports.", alias="reportTotalCount")
    reports: Optional[List[SimpleReportSchema]] = Field(default=None, description="Linked reports. Array of simplified version of one of the following: `Information Report`, `Fintel Report`, `Malware Report`, `Spot Report`, `Situation Report`, `Breach Alert`.")
    __properties: ClassVar[List[str]] = ["forumPostTotalCount", "forumPrivateMessageTotalCount", "forumTotalCount", "forums", "instantMessageChannelTotalCount", "instantMessageServerTotalCount", "instantMessageServers", "instantMessageTotalCount", "reportTotalCount", "reports"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in forums (list)
        _items = []
        if self.forums:
            for _item in self.forums:
                if _item:
                    _items.append(_item.to_dict())
            _dict['forums'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in instant_message_servers (list)
        _items = []
        if self.instant_message_servers:
            for _item in self.instant_message_servers:
                if _item:
                    _items.append(_item.to_dict())
            _dict['instantMessageServers'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "forumPostTotalCount": obj.get("forumPostTotalCount"),
            "forumPrivateMessageTotalCount": obj.get("forumPrivateMessageTotalCount"),
            "forumTotalCount": obj.get("forumTotalCount"),
            "forums": [SimpleActorSchemaLinksForumsInner.from_dict(_item) for _item in obj["forums"]] if obj.get("forums") is not None else None,
            "instantMessageChannelTotalCount": obj.get("instantMessageChannelTotalCount"),
            "instantMessageServerTotalCount": obj.get("instantMessageServerTotalCount"),
            "instantMessageServers": [SimpleActorSchemaLinksInstantMessageServersInner.from_dict(_item) for _item in obj["instantMessageServers"]] if obj.get("instantMessageServers") is not None else None,
