...
class PrivateMessageSchemaLinksRecipientActor(BaseModel):
    """
    Message recipient.
    """ # noqa: E501
    handle: Optional[StrictStr] = Field(default=None, description="Recipient `handle`.")
    uid: StrictStr = Field(description="Unique recipient identifier.")
