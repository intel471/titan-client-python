...
class IndicatorSearchSchemaDataThreat(BaseModel):
    """
    Detailed information about a threat.
    """ # noqa: E501
    data: IndicatorSearchSchemaDataThreatData
    type: StrictStr = Field(description="Threat type: `malware`, `proxy_service` etc.")
    uid: StrictStr = Field(description="Unique threat identifier.")
    __properties: ClassVar[List[str]] = ["data", "type", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": IndicatorSearchSchemaDataThreatData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type"),
            "uid": obj.get("uid")
        })
        return _obj
