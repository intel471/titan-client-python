...
class SimpleReportSchemaReportAttachments(object):
    ...
    def __init__(self, description=None, file_name=None, file_size=None, malicious=None, mime_type=None, url=None, local_vars_configuration=None):  # noqa: E501
        """SimpleReportSchemaReportAttachments - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this SimpleReportSchemaReportAttachments.  # noqa: E501

        A `description` of attachment.  # noqa: E501

        :return: The description of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this SimpleReportSchemaReportAttachments.

        A `description` of attachment.  # noqa: E501

        :param description: The description of this SimpleReportSchemaReportAttachments.  # noqa: E501
    ...
    @property
    def file_name(self):
        """Gets the file_name of this SimpleReportSchemaReportAttachments.  # noqa: E501

        Attachment file's name.  # noqa: E501

        :return: The file_name of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :rtype: str
        """
    ...
    def file_name(self, file_name):
        """Sets the file_name of this SimpleReportSchemaReportAttachments.

        Attachment file's name.  # noqa: E501

        :param file_name: The file_name of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :type file_name: str
        """
    ...
    @property
    def file_size(self):
        """Gets the file_size of this SimpleReportSchemaReportAttachments.  # noqa: E501

        Attachment file size in bytes.  # noqa: E501

        :return: The file_size of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :rtype: int
        """
    ...
    def file_size(self, file_size):
        """Sets the file_size of this SimpleReportSchemaReportAttachments.

        Attachment file size in bytes.  # noqa: E501

        :param file_size: The file_size of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :type file_size: int
        """
    ...
    @property
    def malicious(self):
        """Gets the malicious of this SimpleReportSchemaReportAttachments.  # noqa: E501

        Indicates if attachment is `malicious`. If malicious=`true`, attachment will be an archive with password `infected`.  # noqa: E501

        :return: The malicious of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :rtype: bool
        """
    ...
    def malicious(self, malicious):
        """Sets the malicious of this SimpleReportSchemaReportAttachments.

        Indicates if attachment is `malicious`. If malicious=`true`, attachment will be an archive with password `infected`.  # noqa: E501

        :param malicious: The malicious of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :type malicious: bool
        """
    ...
    @property
    def mime_type(self):
        """Gets the mime_type of this SimpleReportSchemaReportAttachments.  # noqa: E501

        Mime type.  # noqa: E501

        :return: The mime_type of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :rtype: str
        """
    ...
    def mime_type(self, mime_type):
        """Sets the mime_type of this SimpleReportSchemaReportAttachments.

        Mime type.  # noqa: E501

        :param mime_type: The mime_type of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :type mime_type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this SimpleReportSchemaReportAttachments.  # noqa: E501

        `Url` to download attachment.  # noqa: E501

        :return: The url of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SimpleReportSchemaReportAttachments.

        `Url` to download attachment.  # noqa: E501

        :param url: The url of this SimpleReportSchemaReportAttachments.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleReportSchemaReportAttachments):
            return False
