...
class CredentialOccurrencesResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["credential_occurrences", "credential_occurrences_partial_result", "credential_occurrences_total_count"]
