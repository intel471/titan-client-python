...
class SimpleBreachAlertSchema(BaseModel):
    """
    SimpleBreachAlertSchema
    """ # noqa: E501
    activity: SimpleBreachAlertSchemaActivity
    data: SimpleBreachAlertSchemaData
    last_updated: StrictInt = Field(description="Breach Alert last modification date.")
    uid: StrictStr = Field(description="Unique Breach Alert identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": SimpleBreachAlertSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": SimpleBreachAlertSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
