...
class CredentialOccurrenceSchemaClassification(BaseModel):
    """
    Classification of credential occurrence.
    """ # noqa: E501
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intelligence Requirements that match the credential occurrence.")
