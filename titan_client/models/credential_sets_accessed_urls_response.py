...
class CredentialSetsAccessedUrlsResponse(BaseModel):
    """
    CredentialSetsAccessedUrlsResponse
    """ # noqa: E501
    credential_sets_accessed_urls: Optional[List[CredentialSetAccessedUrlSchema]] = Field(default=None, description="List of `Credential set accessed urls`.")
    ...
    __properties: ClassVar[List[str]] = ["credential_sets_accessed_urls", "credential_sets_accessed_urls_partial_result", "credential_sets_accessed_urls_total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credential_sets_accessed_urls": [CredentialSetAccessedUrlSchema.from_dict(_item) for _item in obj["credential_sets_accessed_urls"]] if obj.get("credential_sets_accessed_urls") is not None else None,
