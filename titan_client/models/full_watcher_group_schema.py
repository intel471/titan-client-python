...
class FullWatcherGroupSchema(object):
    ...
    openapi_types = {
        ...
        'type': 'str',
        'uid': 'str',
        'watchers': 'list[FullWatcherGroupSchemaAllOfWatchers]'
    }
    ...
    def __init__(self, description=None, muted=None, name=None, owner=None, type=None, uid=None, watchers=None, local_vars_configuration=None):  # noqa: E501
        """FullWatcherGroupSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this FullWatcherGroupSchema.  # noqa: E501

        Type of watcher group ownership.  # noqa: E501

        :return: The description of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FullWatcherGroupSchema.

        Type of watcher group ownership.  # noqa: E501

        :param description: The description of this FullWatcherGroupSchema.  # noqa: E501
    ...
    @property
    def muted(self):
        """Gets the muted of this FullWatcherGroupSchema.  # noqa: E501

        Watcher's mute status (a watcher group is muted if all of its watchers are muted)  # noqa: E501

        :return: The muted of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: bool
        """
        return self._muted
    ...
    def muted(self, muted):
        """Sets the muted of this FullWatcherGroupSchema.

        Watcher's mute status (a watcher group is muted if all of its watchers are muted)  # noqa: E501

        :param muted: The muted of this FullWatcherGroupSchema.  # noqa: E501
        :type muted: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this FullWatcherGroupSchema.  # noqa: E501

        Name of watcher group.  # noqa: E501

        :return: The name of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FullWatcherGroupSchema.

        Name of watcher group.  # noqa: E501

        :param name: The name of this FullWatcherGroupSchema.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def owner(self):
        """Gets the owner of this FullWatcherGroupSchema.  # noqa: E501

        Watcher group owner's name.  # noqa: E501

        :return: The owner of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        """Sets the owner of this FullWatcherGroupSchema.

        Watcher group owner's name.  # noqa: E501

        :param owner: The owner of this FullWatcherGroupSchema.  # noqa: E501
        :type owner: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this FullWatcherGroupSchema.  # noqa: E501

        Type of watcher group ownership.  # noqa: E501

        :return: The type of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this FullWatcherGroupSchema.

        Type of watcher group ownership.  # noqa: E501

        :param type: The type of this FullWatcherGroupSchema.  # noqa: E501
        :type type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["owned_by_me", "public_or_shared_with_me", "subscribed_to", "my_ungrouped"]  # noqa: E501
    ...
    @property
    def uid(self):
        """Gets the uid of this FullWatcherGroupSchema.  # noqa: E501

        Unique watcher group identifier.  # noqa: E501

        :return: The uid of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this FullWatcherGroupSchema.

        Unique watcher group identifier.  # noqa: E501

        :param uid: The uid of this FullWatcherGroupSchema.  # noqa: E501
        :type uid: str
        """
    ...
    @property
    def watchers(self):
        """Gets the watchers of this FullWatcherGroupSchema.  # noqa: E501

        List of Watchers. Watchers are displayed only for alerts included in results.  # noqa: E501

        :return: The watchers of this FullWatcherGroupSchema.  # noqa: E501
        :rtype: list[FullWatcherGroupSchemaAllOfWatchers]
        """
        return self._watchers

    @watchers.setter
    def watchers(self, watchers):
        """Sets the watchers of this FullWatcherGroupSchema.

        List of Watchers. Watchers are displayed only for alerts included in results.  # noqa: E501

        :param watchers: The watchers of this FullWatcherGroupSchema.  # noqa: E501
        :type watchers: list[FullWatcherGroupSchemaAllOfWatchers]
        """
        if self.local_vars_configuration.client_side_validation and watchers is None:  # noqa: E501
            raise ValueError("Invalid value for `watchers`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FullWatcherGroupSchema):
            return False
