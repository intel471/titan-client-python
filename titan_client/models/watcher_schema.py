...
class WatcherSchema(object):
    ...
    def __init__(self, data_sets=None, description=None, filter_by_gir_set=None, filters=None, girs=None, links=None, notification_channel=None, notification_frequency=None, patterns=None, type=None, uid=None, local_vars_configuration=None):  # noqa: E501
