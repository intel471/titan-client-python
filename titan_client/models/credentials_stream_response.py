...
class CredentialsStreamResponse(object):
    ...
    openapi_types = {
        ...
        'credentials_partial_result': 'bool',
    ...
    attribute_map = {
        ...
        'credentials_partial_result': 'credentials_partial_result',
        'credentials_total_count': 'credentials_total_count',
        'cursor_next': 'cursor_next'
    }

    def __init__(self, credentials=None, credentials_partial_result=None, credentials_total_count=None, cursor_next=None, local_vars_configuration=None):  # noqa: E501
        """CredentialsStreamResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._credentials = None
        self._credentials_partial_result = None
        ...
        if credentials_partial_result is not None:
            self.credentials_partial_result = credentials_partial_result
    ...
    def credentials(self):
        """Gets the credentials of this CredentialsStreamResponse.  # noqa: E501

        List of `Credentials`.  # noqa: E501

        :return: The credentials of this CredentialsStreamResponse.  # noqa: E501
    ...
    def credentials(self, credentials):
        """Sets the credentials of this CredentialsStreamResponse.

        List of `Credentials`.  # noqa: E501

        :param credentials: The credentials of this CredentialsStreamResponse.  # noqa: E501
    ...
    @property
    def credentials_partial_result(self):
        """Gets the credentials_partial_result of this CredentialsStreamResponse.  # noqa: E501
        ...
        :return: The credentials_partial_result of this CredentialsStreamResponse.  # noqa: E501
        :rtype: bool
        """
        return self._credentials_partial_result

    @credentials_partial_result.setter
    def credentials_partial_result(self, credentials_partial_result):
        """Sets the credentials_partial_result of this CredentialsStreamResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param credentials_partial_result: The credentials_partial_result of this CredentialsStreamResponse.  # noqa: E501
        :type credentials_partial_result: bool
        """

        self._credentials_partial_result = credentials_partial_result

    @property
    def credentials_total_count(self):
        """Gets the credentials_total_count of this CredentialsStreamResponse.  # noqa: E501

        Total count of matched credentials.  # noqa: E501

        :return: The credentials_total_count of this CredentialsStreamResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def credentials_total_count(self, credentials_total_count):
        """Sets the credentials_total_count of this CredentialsStreamResponse.

        Total count of matched credentials.  # noqa: E501

        :param credentials_total_count: The credentials_total_count of this CredentialsStreamResponse.  # noqa: E501
    ...
    def cursor_next(self):
        """Gets the cursor_next of this CredentialsStreamResponse.  # noqa: E501

        Stream position identifier to continue scrolling from.  # noqa: E501

        :return: The cursor_next of this CredentialsStreamResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cursor_next(self, cursor_next):
        """Sets the cursor_next of this CredentialsStreamResponse.

        Stream position identifier to continue scrolling from.  # noqa: E501

        :param cursor_next: The cursor_next of this CredentialsStreamResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialsStreamResponse):
            return False
