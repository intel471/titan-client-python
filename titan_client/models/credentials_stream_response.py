...
class CredentialsStreamResponse(BaseModel):
    """
    CredentialsStreamResponse
    """ # noqa: E501
    credentials: Optional[List[CredentialSchema]] = Field(default=None, description="List of `Credentials`.")
    credentials_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.")
    ...
    __properties: ClassVar[List[str]] = ["credentials", "credentials_partial_result", "credentials_total_count", "cursor_next"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials_partial_result": obj.get("credentials_partial_result"),
