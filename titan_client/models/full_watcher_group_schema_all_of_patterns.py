...
class FullWatcherGroupSchemaAllOfPatterns(BaseModel):
    """
    FullWatcherGroupSchemaAllOfPatterns
    """ # noqa: E501
    pattern: StrictStr = Field(description="Search pattern.")
    types: StrictStr = Field(description="List of search patterns types.")
