...
class AlertListSchemaHighlightsInner(BaseModel):
    """
    AlertListSchemaHighlightsInner
    """ # noqa: E501
    chunks: List[AlertListSchemaHighlightsInnerChunksInner] = Field(description="Text snippet `chunks` with highlights.")
    var_field: StrictStr = Field(description="Document `field` which was highlighted.", alias="field")
    __properties: ClassVar[List[str]] = ["chunks", "field"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chunks": [AlertListSchemaHighlightsInnerChunksInner.from_dict(_item) for _item in obj["chunks"]] if obj.get("chunks") is not None else None,
            "field": obj.get("field")
        })
        return _obj
