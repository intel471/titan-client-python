...
class EntitiesResponse(object):
    ...
    openapi_types = {
        ...
        'entity_partial_result': 'bool',
        'entity_total_count': 'int'
    }

    attribute_map = {
        'entities': 'entities',
        'entity_partial_result': 'entityPartialResult',
        'entity_total_count': 'entityTotalCount'
    }

    def __init__(self, entities=None, entity_partial_result=None, entity_total_count=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._entities = None
        self._entity_partial_result = None
        self._entity_total_count = None
        self.discriminator = None

        if entities is not None:
            self.entities = entities
        if entity_partial_result is not None:
            self.entity_partial_result = entity_partial_result
        self.entity_total_count = entity_total_count

    @property
    def entities(self):
        """Gets the entities of this EntitiesResponse.  # noqa: E501

        List of `Enitites`.  # noqa: E501

        :return: The entities of this EntitiesResponse.  # noqa: E501
    ...
    @property
    def entity_partial_result(self):
        """Gets the entity_partial_result of this EntitiesResponse.  # noqa: E501

        Indicates whether response contains partial result. That could be in case when request took to long and was terminated.  # noqa: E501

        :return: The entity_partial_result of this EntitiesResponse.  # noqa: E501
        :rtype: bool
        """
        return self._entity_partial_result

    @entity_partial_result.setter
    def entity_partial_result(self, entity_partial_result):
        """Sets the entity_partial_result of this EntitiesResponse.

        Indicates whether response contains partial result. That could be in case when request took to long and was terminated.  # noqa: E501

        :param entity_partial_result: The entity_partial_result of this EntitiesResponse.  # noqa: E501
        :type entity_partial_result: bool
        """

        self._entity_partial_result = entity_partial_result

    @property
    def entity_total_count(self):
        """Gets the entity_total_count of this EntitiesResponse.  # noqa: E501

        Total count of matched entities.  # noqa: E501

        :return: The entity_total_count of this EntitiesResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def entity_total_count(self, entity_total_count):
        """Sets the entity_total_count of this EntitiesResponse.

        Total count of matched entities.  # noqa: E501

        :param entity_total_count: The entity_total_count of this EntitiesResponse.  # noqa: E501
