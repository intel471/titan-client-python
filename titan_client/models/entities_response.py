...
class EntitiesResponse(BaseModel):
    ...
    EntitiesResponse
    """ # noqa: E501
    entities: Optional[List[EntitiesSchema]] = Field(default=None, description="List of `Enitites`.")
    entity_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. That could be in case when request took to long and was terminated.", alias="entityPartialResult")
    entity_total_count: StrictInt = Field(description="Total count of matched entities.", alias="entityTotalCount")
    __properties: ClassVar[List[str]] = ["entities", "entityPartialResult", "entityTotalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entityPartialResult": obj.get("entityPartialResult"),
