...
class MarketplaceSearchResponse(object):
    ...
    """
    openapi_types = {
        'marketplaces': 'list[MarketplaceSearchSchema]',
        'marketplaces_count': 'int',
        'marketplaces_partial_result': 'bool'
    }

    attribute_map = {
        'marketplaces': 'marketplaces',
        'marketplaces_count': 'marketplaces_count',
        'marketplaces_partial_result': 'marketplaces_partial_result'
    }

    def __init__(self, marketplaces=None, marketplaces_count=None, marketplaces_partial_result=None, local_vars_configuration=None):  # noqa: E501
        """MarketplaceSearchResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._marketplaces = None
        self._marketplaces_count = None
        self._marketplaces_partial_result = None
        self.discriminator = None

        if marketplaces is not None:
            self.marketplaces = marketplaces
        self.marketplaces_count = marketplaces_count
        if marketplaces_partial_result is not None:
            self.marketplaces_partial_result = marketplaces_partial_result

    @property
    def marketplaces(self):
        """Gets the marketplaces of this MarketplaceSearchResponse.  # noqa: E501

        List of marketplaces.  # noqa: E501

        :return: The marketplaces of this MarketplaceSearchResponse.  # noqa: E501
        :rtype: list[MarketplaceSearchSchema]
        """
        return self._marketplaces

    @marketplaces.setter
    def marketplaces(self, marketplaces):
        """Sets the marketplaces of this MarketplaceSearchResponse.

        List of marketplaces.  # noqa: E501

        :param marketplaces: The marketplaces of this MarketplaceSearchResponse.  # noqa: E501
        :type marketplaces: list[MarketplaceSearchSchema]
        """
    ...
    def marketplaces_count(self):
        """Gets the marketplaces_count of this MarketplaceSearchResponse.  # noqa: E501

        Count of matched results.  # noqa: E501

        :return: The marketplaces_count of this MarketplaceSearchResponse.  # noqa: E501
        :rtype: int
        """
        return self._marketplaces_count

    @marketplaces_count.setter
    def marketplaces_count(self, marketplaces_count):
        """Sets the marketplaces_count of this MarketplaceSearchResponse.

        Count of matched results.  # noqa: E501

        :param marketplaces_count: The marketplaces_count of this MarketplaceSearchResponse.  # noqa: E501
        :type marketplaces_count: int
        """
        if self.local_vars_configuration.client_side_validation and marketplaces_count is None:  # noqa: E501
            raise ValueError("Invalid value for `marketplaces_count`, must not be `None`")  # noqa: E501

        self._marketplaces_count = marketplaces_count

    @property
    def marketplaces_partial_result(self):
        """Gets the marketplaces_partial_result of this MarketplaceSearchResponse.  # noqa: E501
        ...
        :return: The marketplaces_partial_result of this MarketplaceSearchResponse.  # noqa: E501
        :rtype: bool
        """
        return self._marketplaces_partial_result

    @marketplaces_partial_result.setter
    def marketplaces_partial_result(self, marketplaces_partial_result):
        """Sets the marketplaces_partial_result of this MarketplaceSearchResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param marketplaces_partial_result: The marketplaces_partial_result of this MarketplaceSearchResponse.  # noqa: E501
        :type marketplaces_partial_result: bool
        """

        self._marketplaces_partial_result = marketplaces_partial_result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceSearchResponse):
            return False
