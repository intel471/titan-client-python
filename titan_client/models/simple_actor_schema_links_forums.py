...
class SimpleActorSchemaLinksForums(object):
    ...
    openapi_types = {
        'actor_handle': 'str',
        'contact_info': 'list[SimpleActorSchemaLinksContactInfo]',
        'name': 'str',
        'time_zone': 'str',
        'uid': 'str'
    }
    ...
    def __init__(self, actor_handle=None, contact_info=None, name=None, time_zone=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """SimpleActorSchemaLinksForums - a model defined in OpenAPI"""  # noqa: E501
    ...
    def actor_handle(self):
        """Gets the actor_handle of this SimpleActorSchemaLinksForums.  # noqa: E501

        Actor handle.  # noqa: E501

        :return: The actor_handle of this SimpleActorSchemaLinksForums.  # noqa: E501
        :rtype: str
        """
    ...
    def actor_handle(self, actor_handle):
        """Sets the actor_handle of this SimpleActorSchemaLinksForums.

        Actor handle.  # noqa: E501

        :param actor_handle: The actor_handle of this SimpleActorSchemaLinksForums.  # noqa: E501
    ...
    def contact_info(self):
        """Gets the contact_info of this SimpleActorSchemaLinksForums.  # noqa: E501

        `Contact Info` objects.  # noqa: E501

        :return: The contact_info of this SimpleActorSchemaLinksForums.  # noqa: E501
        :rtype: list[SimpleActorSchemaLinksContactInfo]
        """
        return self._contact_info

    @contact_info.setter
    def contact_info(self, contact_info):
        """Sets the contact_info of this SimpleActorSchemaLinksForums.

        `Contact Info` objects.  # noqa: E501

        :param contact_info: The contact_info of this SimpleActorSchemaLinksForums.  # noqa: E501
        :type contact_info: list[SimpleActorSchemaLinksContactInfo]
        """
    ...
    @property
    def name(self):
        """Gets the name of this SimpleActorSchemaLinksForums.  # noqa: E501

        Forum `name`.  # noqa: E501

        :return: The name of this SimpleActorSchemaLinksForums.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SimpleActorSchemaLinksForums.

        Forum `name`.  # noqa: E501

        :param name: The name of this SimpleActorSchemaLinksForums.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this SimpleActorSchemaLinksForums.  # noqa: E501

        `Timezone`.  # noqa: E501

        :return: The time_zone of this SimpleActorSchemaLinksForums.  # noqa: E501
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this SimpleActorSchemaLinksForums.

        `Timezone`.  # noqa: E501

        :param time_zone: The time_zone of this SimpleActorSchemaLinksForums.  # noqa: E501
        :type time_zone: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this SimpleActorSchemaLinksForums.  # noqa: E501

        Unique forum identifier.  # noqa: E501

        :return: The uid of this SimpleActorSchemaLinksForums.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this SimpleActorSchemaLinksForums.

        Unique forum identifier.  # noqa: E501

        :param uid: The uid of this SimpleActorSchemaLinksForums.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleActorSchemaLinksForums):
            return False
