...
class NIDSSearchResponse(object):
    ...
    """
    openapi_types = {
        'nids_list': 'list[NIDSSearchSchema]',
        'nids_partial_result': 'bool',
        'nids_total_count': 'int'
    }

    attribute_map = {
        'nids_list': 'nidsList',
        'nids_partial_result': 'nidsPartialResult',
        'nids_total_count': 'nidsTotalCount'
    }

    def __init__(self, nids_list=None, nids_partial_result=None, nids_total_count=None, local_vars_configuration=None):  # noqa: E501
        """NIDSSearchResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._nids_list = None
        self._nids_partial_result = None
        self._nids_total_count = None
        self.discriminator = None

        if nids_list is not None:
            self.nids_list = nids_list
        if nids_partial_result is not None:
            self.nids_partial_result = nids_partial_result
        self.nids_total_count = nids_total_count

    @property
    def nids_list(self):
        """Gets the nids_list of this NIDSSearchResponse.  # noqa: E501

        List of `NIDS`.  # noqa: E501

        :return: The nids_list of this NIDSSearchResponse.  # noqa: E501
        :rtype: list[NIDSSearchSchema]
        """
        return self._nids_list

    @nids_list.setter
    def nids_list(self, nids_list):
        """Sets the nids_list of this NIDSSearchResponse.

        List of `NIDS`.  # noqa: E501

        :param nids_list: The nids_list of this NIDSSearchResponse.  # noqa: E501
        :type nids_list: list[NIDSSearchSchema]
        """

        self._nids_list = nids_list

    @property
    def nids_partial_result(self):
        """Gets the nids_partial_result of this NIDSSearchResponse.  # noqa: E501
        ...
        :return: The nids_partial_result of this NIDSSearchResponse.  # noqa: E501
        :rtype: bool
        """
        return self._nids_partial_result

    @nids_partial_result.setter
    def nids_partial_result(self, nids_partial_result):
        """Sets the nids_partial_result of this NIDSSearchResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param nids_partial_result: The nids_partial_result of this NIDSSearchResponse.  # noqa: E501
        :type nids_partial_result: bool
        """

        self._nids_partial_result = nids_partial_result

    @property
    def nids_total_count(self):
        """Gets the nids_total_count of this NIDSSearchResponse.  # noqa: E501

        Total count of matched results.  # noqa: E501

        :return: The nids_total_count of this NIDSSearchResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def nids_total_count(self, nids_total_count):
        """Sets the nids_total_count of this NIDSSearchResponse.

        Total count of matched results.  # noqa: E501

        :param nids_total_count: The nids_total_count of this NIDSSearchResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NIDSSearchResponse):
            return False
