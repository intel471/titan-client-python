...
class WatcherRequestBodyPost(object):
    ...
    def __init__(self, data_sets=None, description=None, filter_by_gir_set=None, filters=None, free_text_pattern=None, girs=None, notification_channel=None, notification_frequency=None, patterns=None, thread_uid=None, thread_type=None, type=None, local_vars_configuration=None):  # noqa: E501
        """WatcherRequestBodyPost - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data_sets(self):
        """Gets the data_sets of this WatcherRequestBodyPost.  # noqa: E501
        ...
        :return: The data_sets of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def data_sets(self, data_sets):
        """Sets the data_sets of this WatcherRequestBodyPost.

        Limiting watcher by data sets. Defaults to all accessible data sets if empty. Please pay attention, that `Malware Reports` belongs to `malware` data set and `Vulnerability Reports` belong to cve data set.  # noqa: E501

        :param data_sets: The data_sets of this WatcherRequestBodyPost.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this WatcherRequestBodyPost.  # noqa: E501

        Watcher description.  # noqa: E501

        :return: The description of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this WatcherRequestBodyPost.

        Watcher description.  # noqa: E501

        :param description: The description of this WatcherRequestBodyPost.  # noqa: E501
    ...
    def filter_by_gir_set(self):
        """Gets the filter_by_gir_set of this WatcherRequestBodyPost.  # noqa: E501

        GIR set filter.  # noqa: E501

        :return: The filter_by_gir_set of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def filter_by_gir_set(self, filter_by_gir_set):
        """Sets the filter_by_gir_set of this WatcherRequestBodyPost.

        GIR set filter.  # noqa: E501

        :param filter_by_gir_set: The filter_by_gir_set of this WatcherRequestBodyPost.  # noqa: E501
    ...
    @property
    def filters(self):
        """Gets the filters of this WatcherRequestBodyPost.  # noqa: E501
    ...
    def filters(self, filters):
        """Sets the filters of this WatcherRequestBodyPost.
    ...
    def free_text_pattern(self):
        """Gets the free_text_pattern of this WatcherRequestBodyPost.  # noqa: E501
        ...
        :return: The free_text_pattern of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def free_text_pattern(self, free_text_pattern):
        """Sets the free_text_pattern of this WatcherRequestBodyPost.

        Simplified form of adding search pattern. Search type will be automatically set to `FreeText` and pattern will be filled with a given value.  # noqa: E501

        :param free_text_pattern: The free_text_pattern of this WatcherRequestBodyPost.  # noqa: E501
    ...
    @property
    def girs(self):
        """Gets the girs of this WatcherRequestBodyPost.  # noqa: E501

        GIR paths selected by user. Ignored if `filterByGirSet` isn't `custom`.  # noqa: E501

        :return: The girs of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: list[str]
        """
        return self._girs
    ...
    @girs.setter
    def girs(self, girs):
        """Sets the girs of this WatcherRequestBodyPost.

        GIR paths selected by user. Ignored if `filterByGirSet` isn't `custom`.  # noqa: E501

        :param girs: The girs of this WatcherRequestBodyPost.  # noqa: E501
        :type girs: list[str]
        """
    ...
    def notification_channel(self):
        """Gets the notification_channel of this WatcherRequestBodyPost.  # noqa: E501
        ...
        :return: The notification_channel of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def notification_channel(self, notification_channel):
        """Sets the notification_channel of this WatcherRequestBodyPost.

        Notifications channel. email channel will send `email` notifications either `immediately` or `daily` (frequency has to be specified in another field). `website` channel doesn't send emails and keeps all notifications in the website. Regardless of the field value alerts are always accessible via API.  # noqa: E501

        :param notification_channel: The notification_channel of this WatcherRequestBodyPost.  # noqa: E501
    ...
    def notification_frequency(self):
        """Gets the notification_frequency of this WatcherRequestBodyPost.  # noqa: E501

        Notification frequency. Applicable to `email` channel only.  # noqa: E501

        :return: The notification_frequency of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def notification_frequency(self, notification_frequency):
        """Sets the notification_frequency of this WatcherRequestBodyPost.

        Notification frequency. Applicable to `email` channel only.  # noqa: E501

        :param notification_frequency: The notification_frequency of this WatcherRequestBodyPost.  # noqa: E501
    ...
    @property
    def patterns(self):
        """Gets the patterns of this WatcherRequestBodyPost.  # noqa: E501
    ...
    def patterns(self, patterns):
        """Sets the patterns of this WatcherRequestBodyPost.
    ...
    @property
    def thread_uid(self):
        """Gets the thread_uid of this WatcherRequestBodyPost.  # noqa: E501

        Forum thread identifier. Applicable only for `thread` watcher type.  # noqa: E501

        :return: The thread_uid of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def thread_uid(self, thread_uid):
        """Sets the thread_uid of this WatcherRequestBodyPost.

        Forum thread identifier. Applicable only for `thread` watcher type.  # noqa: E501

        :param thread_uid: The thread_uid of this WatcherRequestBodyPost.  # noqa: E501
        :type thread_uid: str
        """
    ...
    def thread_type(self):
        """Gets the thread_type of this WatcherRequestBodyPost.  # noqa: E501

        In case watcher `type` is `thread` the `threadType` must be specified.  # noqa: E501

        :return: The thread_type of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
    ...
    def thread_type(self, thread_type):
        """Sets the thread_type of this WatcherRequestBodyPost.

        In case watcher `type` is `thread` the `threadType` must be specified.  # noqa: E501

        :param thread_type: The thread_type of this WatcherRequestBodyPost.  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this WatcherRequestBodyPost.  # noqa: E501

        Watcher type.<br />`search` type watcher queries search engine with a pattern provided,<br />`thread` watcher monitors given forum thread for a new posts.  # noqa: E501

        :return: The type of this WatcherRequestBodyPost.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WatcherRequestBodyPost.

        Watcher type.<br />`search` type watcher queries search engine with a pattern provided,<br />`thread` watcher monitors given forum thread for a new posts.  # noqa: E501

        :param type: The type of this WatcherRequestBodyPost.  # noqa: E501
        :type type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherRequestBodyPost):
            return False
