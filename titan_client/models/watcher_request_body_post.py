...
class WatcherRequestBodyPost(object):
    ...
    def __init__(self, data_sets=None, description=None, filter_by_gir_set=None, filters=None, free_text_pattern=None, girs=None, notification_channel=None, notification_frequency=None, patterns=None, thread_uid=None, type=None, local_vars_configuration=None):  # noqa: E501
