...
class SimpleActorSchemaLinksInstantMessageServersInner(object):
    ...
    def __init__(self, name=None, service_type=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """SimpleActorSchemaLinksInstantMessageServersInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501

        IM server name.  # noqa: E501

        :return: The name of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SimpleActorSchemaLinksInstantMessageServersInner.

        IM server name.  # noqa: E501

        :param name: The name of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501
        :type name: str
        """
    ...
    def service_type(self):
        """Gets the service_type of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501

        Type of IM service (Telegram, Discord, IRC etc.).  # noqa: E501

        :return: The service_type of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501
        :rtype: str
        """
    ...
    def service_type(self, service_type):
        """Sets the service_type of this SimpleActorSchemaLinksInstantMessageServersInner.

        Type of IM service (Telegram, Discord, IRC etc.).  # noqa: E501

        :param service_type: The service_type of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501
    ...
    @property
    def uid(self):
        """Gets the uid of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501

        Unique IM server identifier.  # noqa: E501

        :return: The uid of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this SimpleActorSchemaLinksInstantMessageServersInner.

        Unique IM server identifier.  # noqa: E501

        :param uid: The uid of this SimpleActorSchemaLinksInstantMessageServersInner.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleActorSchemaLinksInstantMessageServersInner):
            return False
