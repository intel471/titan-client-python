...
class SimpleActorSchemaLinksInstantMessageServersInner(BaseModel):
    """
    SimpleActorSchemaLinksInstantMessageServersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="IM server name.")
    service_type: StrictStr = Field(description="Type of IM service (Telegram, Discord, IRC etc.).", alias="serviceType")
    uid: StrictStr = Field(description="Unique IM server identifier.")
    __properties: ClassVar[List[str]] = ["name", "serviceType", "uid"]
