...
class YARASearchSchema(BaseModel):
    """
    YARASearchSchema
    """ # noqa: E501
    activity: YARASearchSchemaActivity
    data: YARASearchSchemaData
    last_updated: StrictInt = Field(description="YARA last modification date.")
    meta: YARASearchSchemaMeta
    uid: StrictStr = Field(description="Unique YARA identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": YARASearchSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": YARASearchSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "meta": YARASearchSchemaMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
