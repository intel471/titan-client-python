...
class GirsResponse(BaseModel):
    ...
    GirsResponse
    """ # noqa: E501
    gir_total_count: StrictInt = Field(description="Total count of matched results.", alias="girTotalCount")
    girs: Optional[List[GirSchema]] = Field(default=None, description="The array of GIRs.")
    ...
    __properties: ClassVar[List[str]] = ["girTotalCount", "girs", "partialResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "girTotalCount": obj.get("girTotalCount"),
            "girs": [GirSchema.from_dict(_item) for _item in obj["girs"]] if obj.get("girs") is not None else None,
