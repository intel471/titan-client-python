...
class GirsResponse(object):
    ...
    attribute_map = {
        'gir_total_count': 'girTotalCount',
        'girs': 'girs',
        'partial_result': 'partialResult'
    }

    def __init__(self, gir_total_count=None, girs=None, partial_result=None, local_vars_configuration=None):  # noqa: E501
        """GirsResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._gir_total_count = None
        self._girs = None
        self._partial_result = None
        self.discriminator = None

        self.gir_total_count = gir_total_count
        if girs is not None:
            self.girs = girs
    ...
    @property
    def gir_total_count(self):
        """Gets the gir_total_count of this GirsResponse.  # noqa: E501

        Total count of matched results.  # noqa: E501

        :return: The gir_total_count of this GirsResponse.  # noqa: E501
        :rtype: int
        """
        return self._gir_total_count

    @gir_total_count.setter
    def gir_total_count(self, gir_total_count):
        """Sets the gir_total_count of this GirsResponse.

        Total count of matched results.  # noqa: E501

        :param gir_total_count: The gir_total_count of this GirsResponse.  # noqa: E501
        :type gir_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and gir_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `gir_total_count`, must not be `None`")  # noqa: E501

        self._gir_total_count = gir_total_count

    @property
    def girs(self):
        """Gets the girs of this GirsResponse.  # noqa: E501

        The array of GIRs.  # noqa: E501

        :return: The girs of this GirsResponse.  # noqa: E501
        :rtype: list[GirSchema]
        """
        return self._girs

    @girs.setter
    def girs(self, girs):
        """Sets the girs of this GirsResponse.

        The array of GIRs.  # noqa: E501

        :param girs: The girs of this GirsResponse.  # noqa: E501
        :type girs: list[GirSchema]
        """
    ...
    def partial_result(self):
        """Gets the partial_result of this GirsResponse.  # noqa: E501
        ...
        :return: The partial_result of this GirsResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def partial_result(self, partial_result):
        """Sets the partial_result of this GirsResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param partial_result: The partial_result of this GirsResponse.  # noqa: E501
        :type partial_result: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GirsResponse):
            return False
