...
class SimpleActorSchemaLinksForumsInnerContactInfoInner(BaseModel):
    """
    SimpleActorSchemaLinksForumsInnerContactInfoInner
    """ # noqa: E501
    type: StrictStr = Field(description="Contact info `type`. Possible values: `EmailAddress`, `ICQ`, `Jabber`, `MSN`, `YahooIM`, `AIM`, `Skype`, `QQ`, `BitcoinAddress`.")
    value: StrictStr = Field(description="Contact info `value`.")
