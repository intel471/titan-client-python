...
class NewsSchemaActivity(BaseModel):
    """
    Period News was active
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the news activity range")
    last: StrictInt = Field(description="End of the news activity range")
