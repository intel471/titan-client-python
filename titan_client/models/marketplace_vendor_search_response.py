...
class MarketplaceVendorSearchResponse(BaseModel):
    """
    ...
    vendors_count: StrictInt = Field(description="Count of matched results.", alias="vendorsCount")
    ...
    __properties: ClassVar[List[str]] = ["vendors", "vendorsCount", "vendorsPartialResult"]
