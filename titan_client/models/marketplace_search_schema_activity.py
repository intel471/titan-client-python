...
class MarketplaceSearchSchemaActivity(BaseModel):
    """
    Period when marketplace was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the marketplace activity range.")
    last: StrictInt = Field(description="End of the marketplace activity range.")
