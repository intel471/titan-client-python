...
class NewsSchemaDataAttachments(object):
    ...
    def __init__(self, malicious=None, mime_type=None, name=None, size=None, url=None, local_vars_configuration=None):  # noqa: E501
        """NewsSchemaDataAttachments - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def malicious(self):
        """Gets the malicious of this NewsSchemaDataAttachments.  # noqa: E501

        Indicates if attachment is malicious. If `malicious=true`, attachment will be an archive with password `infected`  # noqa: E501

        :return: The malicious of this NewsSchemaDataAttachments.  # noqa: E501
        :rtype: bool
        """
    ...
    def malicious(self, malicious):
        """Sets the malicious of this NewsSchemaDataAttachments.

        Indicates if attachment is malicious. If `malicious=true`, attachment will be an archive with password `infected`  # noqa: E501

        :param malicious: The malicious of this NewsSchemaDataAttachments.  # noqa: E501
        :type malicious: bool
        """
    ...
    @property
    def mime_type(self):
        """Gets the mime_type of this NewsSchemaDataAttachments.  # noqa: E501

        Mimetype  # noqa: E501

        :return: The mime_type of this NewsSchemaDataAttachments.  # noqa: E501
        :rtype: str
        """
    ...
    def mime_type(self, mime_type):
        """Sets the mime_type of this NewsSchemaDataAttachments.

        Mimetype  # noqa: E501

        :param mime_type: The mime_type of this NewsSchemaDataAttachments.  # noqa: E501
        :type mime_type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this NewsSchemaDataAttachments.  # noqa: E501

        Attachment file `name`  # noqa: E501

        :return: The name of this NewsSchemaDataAttachments.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NewsSchemaDataAttachments.

        Attachment file `name`  # noqa: E501

        :param name: The name of this NewsSchemaDataAttachments.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this NewsSchemaDataAttachments.  # noqa: E501

        Attachment fie `size` in bytes  # noqa: E501

        :return: The size of this NewsSchemaDataAttachments.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this NewsSchemaDataAttachments.

        Attachment fie `size` in bytes  # noqa: E501

        :param size: The size of this NewsSchemaDataAttachments.  # noqa: E501
        :type size: int
        """
    ...
    @property
    def url(self):
        """Gets the url of this NewsSchemaDataAttachments.  # noqa: E501

        `Url` to download attachment  # noqa: E501

        :return: The url of this NewsSchemaDataAttachments.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this NewsSchemaDataAttachments.

        `Url` to download attachment  # noqa: E501

        :param url: The url of this NewsSchemaDataAttachments.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewsSchemaDataAttachments):
            return False
