...
class MarketplaceVendorSearchSchemaActivity(BaseModel):
    """
    Period when vendor was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the vendor activity range.")
    last: StrictInt = Field(description="End of the vendor activity range.")
