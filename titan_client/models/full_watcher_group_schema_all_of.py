...
class FullWatcherGroupSchemaAllOf(object):
    ...
    def __init__(self, watchers=None, local_vars_configuration=None):  # noqa: E501
        """FullWatcherGroupSchemaAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def watchers(self):
        """Gets the watchers of this FullWatcherGroupSchemaAllOf.  # noqa: E501

        List of Watchers. Watchers are displayed only for alerts included in results.  # noqa: E501

        :return: The watchers of this FullWatcherGroupSchemaAllOf.  # noqa: E501
    ...
    def watchers(self, watchers):
        """Sets the watchers of this FullWatcherGroupSchemaAllOf.

        List of Watchers. Watchers are displayed only for alerts included in results.  # noqa: E501

        :param watchers: The watchers of this FullWatcherGroupSchemaAllOf.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FullWatcherGroupSchemaAllOf):
            return False
