...
class MarketplaceResourceSearchSchema(BaseModel):
    """
    ...
    uid: StrictStr = Field(description="Unique resource identifier.")
    __properties: ClassVar[List[str]] = ["activity", "data", "last_updated", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": MarketplaceResourceSearchSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": MarketplaceResourceSearchSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
