...
class CredentialSetAccessedUrlSchemaClassification(BaseModel):
    """
    Classification of credential set accessed url.
    """ # noqa: E501
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intelligence Requirements that match the credential set accessed url.")
    __properties: ClassVar[List[str]] = ["intel_requirements"]
