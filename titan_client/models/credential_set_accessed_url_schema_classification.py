...
class CredentialSetAccessedUrlSchemaClassification(object):
    ...
    def __init__(self, intel_requirements=None, local_vars_configuration=None):  # noqa: E501
        """CredentialSetAccessedUrlSchemaClassification - a model defined in OpenAPI"""  # noqa: E501
    ...
    def intel_requirements(self):
        """Gets the intel_requirements of this CredentialSetAccessedUrlSchemaClassification.  # noqa: E501

        General Intelligence Requirements that match the credential set accessed url.  # noqa: E501

        :return: The intel_requirements of this CredentialSetAccessedUrlSchemaClassification.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def intel_requirements(self, intel_requirements):
        """Sets the intel_requirements of this CredentialSetAccessedUrlSchemaClassification.

        General Intelligence Requirements that match the credential set accessed url.  # noqa: E501

        :param intel_requirements: The intel_requirements of this CredentialSetAccessedUrlSchemaClassification.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialSetAccessedUrlSchemaClassification):
            return False
