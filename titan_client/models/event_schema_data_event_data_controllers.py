...
class EventSchemaDataEventDataControllers(object):
    ...
    def __init__(self, url=None, local_vars_configuration=None):  # noqa: E501
        """EventSchemaDataEventDataControllers - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this EventSchemaDataEventDataControllers.  # noqa: E501

        `url` of a controller.  # noqa: E501

        :return: The url of this EventSchemaDataEventDataControllers.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this EventSchemaDataEventDataControllers.

        `url` of a controller.  # noqa: E501

        :param url: The url of this EventSchemaDataEventDataControllers.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventSchemaDataEventDataControllers):
            return False
