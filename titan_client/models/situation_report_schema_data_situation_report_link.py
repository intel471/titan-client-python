...
class SituationReportSchemaDataSituationReportLink(object):
    ...
    """
    openapi_types = {
        'malware_family': 'SituationReportSchemaDataSituationReportLinkMalwareFamily',
        'malware_report': 'SituationReportSchemaDataSituationReportLinkMalwareReport'
    }
    ...
    def __init__(self, malware_family=None, malware_report=None, local_vars_configuration=None):  # noqa: E501
        """SituationReportSchemaDataSituationReportLink - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._malware_family = None
        self._malware_report = None
        self.discriminator = None

        if malware_family is not None:
            self.malware_family = malware_family
        if malware_report is not None:
            self.malware_report = malware_report

    @property
    def malware_family(self):
        """Gets the malware_family of this SituationReportSchemaDataSituationReportLink.  # noqa: E501


        :return: The malware_family of this SituationReportSchemaDataSituationReportLink.  # noqa: E501
        :rtype: SituationReportSchemaDataSituationReportLinkMalwareFamily
        """
        return self._malware_family

    @malware_family.setter
    def malware_family(self, malware_family):
        """Sets the malware_family of this SituationReportSchemaDataSituationReportLink.


        :param malware_family: The malware_family of this SituationReportSchemaDataSituationReportLink.  # noqa: E501
        :type malware_family: SituationReportSchemaDataSituationReportLinkMalwareFamily
        """

        self._malware_family = malware_family

    @property
    def malware_report(self):
        """Gets the malware_report of this SituationReportSchemaDataSituationReportLink.  # noqa: E501


        :return: The malware_report of this SituationReportSchemaDataSituationReportLink.  # noqa: E501
        :rtype: SituationReportSchemaDataSituationReportLinkMalwareReport
        """
        return self._malware_report

    @malware_report.setter
    def malware_report(self, malware_report):
        """Sets the malware_report of this SituationReportSchemaDataSituationReportLink.


        :param malware_report: The malware_report of this SituationReportSchemaDataSituationReportLink.  # noqa: E501
        :type malware_report: SituationReportSchemaDataSituationReportLinkMalwareReport
        """

        self._malware_report = malware_report
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SituationReportSchemaDataSituationReportLink):
            return False
