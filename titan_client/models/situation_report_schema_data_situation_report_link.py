...
class SituationReportSchemaDataSituationReportLink(BaseModel):
    """
    Links to malware family and malware report.
    """ # noqa: E501
    malware_family: Optional[SituationReportSchemaDataSituationReportLinkMalwareFamily] = None
    malware_report: Optional[SituationReportSchemaDataSituationReportLinkMalwareReport] = None
    __properties: ClassVar[List[str]] = ["malware_family", "malware_report"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of malware_report
        if self.malware_report:
            _dict['malware_report'] = self.malware_report.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "malware_family": SituationReportSchemaDataSituationReportLinkMalwareFamily.from_dict(obj["malware_family"]) if obj.get("malware_family") is not None else None,
            "malware_report": SituationReportSchemaDataSituationReportLinkMalwareReport.from_dict(obj["malware_report"]) if obj.get("malware_report") is not None else None
        })
        return _obj
