...
class SituationReportSchemaDataSituationReportVictimsInner(BaseModel):
    """
    SituationReportSchemaDataSituationReportVictimsInner
    """ # noqa: E501
    name: StrictStr = Field(description="Purported victim name.")
    urls: Optional[List[StrictStr]] = Field(default=None, description="Purported victim url list.")
