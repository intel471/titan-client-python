...
class SimpleCveSchemaData(object):
    ...
    """
    openapi_types = {
        'cve_report': 'SimpleCveSchemaDataCveReport'
    }
    ...
    def __init__(self, cve_report=None, local_vars_configuration=None):  # noqa: E501
        """SimpleCveSchemaData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def cve_report(self):
        """Gets the cve_report of this SimpleCveSchemaData.  # noqa: E501


        :return: The cve_report of this SimpleCveSchemaData.  # noqa: E501
        :rtype: SimpleCveSchemaDataCveReport
        """
        return self._cve_report

    @cve_report.setter
    def cve_report(self, cve_report):
        """Sets the cve_report of this SimpleCveSchemaData.


        :param cve_report: The cve_report of this SimpleCveSchemaData.  # noqa: E501
        :type cve_report: SimpleCveSchemaDataCveReport
        """
        if self.local_vars_configuration.client_side_validation and cve_report is None:  # noqa: E501
            raise ValueError("Invalid value for `cve_report`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleCveSchemaData):
            return False
