...
class AlertSubscriptionSchema(object):
    ...
    def __init__(self, endpoint=None, status=None, local_vars_configuration=None):  # noqa: E501
        """AlertSubscriptionSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def endpoint(self):
        """Gets the endpoint of this AlertSubscriptionSchema.  # noqa: E501

        Registered `endpoint`  # noqa: E501

        :return: The endpoint of this AlertSubscriptionSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """Sets the endpoint of this AlertSubscriptionSchema.

        Registered `endpoint`  # noqa: E501

        :param endpoint: The endpoint of this AlertSubscriptionSchema.  # noqa: E501
        :type endpoint: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this AlertSubscriptionSchema.  # noqa: E501

        `Status` of endpoint  # noqa: E501

        :return: The status of this AlertSubscriptionSchema.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AlertSubscriptionSchema.

        `Status` of endpoint  # noqa: E501

        :param status: The status of this AlertSubscriptionSchema.  # noqa: E501
        :type status: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertSubscriptionSchema):
            return False
