...
class PostSchema(object):
    ...
    def __init__(self, date=None, last_updated=None, links=None, message=None, message_original=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """PostSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def date(self):
        """Gets the date of this PostSchema.  # noqa: E501

        The `date` of the post.  # noqa: E501

        :return: The date of this PostSchema.  # noqa: E501
        :rtype: int
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this PostSchema.

        The `date` of the post.  # noqa: E501

        :param date: The date of this PostSchema.  # noqa: E501
        :type date: int
        """
    ...
    def last_updated(self):
        """Gets the last_updated of this PostSchema.  # noqa: E501

        Last modification date.  # noqa: E501

        :return: The last_updated of this PostSchema.  # noqa: E501
        :rtype: int
        """
    ...
    def last_updated(self, last_updated):
        """Sets the last_updated of this PostSchema.

        Last modification date.  # noqa: E501

        :param last_updated: The last_updated of this PostSchema.  # noqa: E501
    ...
    @property
    def links(self):
        """Gets the links of this PostSchema.  # noqa: E501


        :return: The links of this PostSchema.  # noqa: E501
        :rtype: PostSchemaLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this PostSchema.


        :param links: The links of this PostSchema.  # noqa: E501
        :type links: PostSchemaLinks
        """
    ...
    @property
    def message(self):
        """Gets the message of this PostSchema.  # noqa: E501

        HTML post content. If post message is translated, this parameter contains translated text, if not — original. [Markup explained](#forum-post-or-pm-markup).  # noqa: E501

        :return: The message of this PostSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this PostSchema.

        HTML post content. If post message is translated, this parameter contains translated text, if not — original. [Markup explained](#forum-post-or-pm-markup).  # noqa: E501

        :param message: The message of this PostSchema.  # noqa: E501
        :type message: str
        """
    ...
    def message_original(self):
        """Gets the message_original of this PostSchema.  # noqa: E501

        Original HTML post content. This parameter is active if post message is translated. [Markup explained](#forum-post-or-pm-markup).  # noqa: E501

        :return: The message_original of this PostSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def message_original(self, message_original):
        """Sets the message_original of this PostSchema.

        Original HTML post content. This parameter is active if post message is translated. [Markup explained](#forum-post-or-pm-markup).  # noqa: E501

        :param message_original: The message_original of this PostSchema.  # noqa: E501
    ...
    @property
    def uid(self):
        """Gets the uid of this PostSchema.  # noqa: E501

        Unique post identifier.  # noqa: E501

        :return: The uid of this PostSchema.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this PostSchema.

        Unique post identifier.  # noqa: E501

        :param uid: The uid of this PostSchema.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostSchema):
            return False
