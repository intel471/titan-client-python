...
class PostSchema(BaseModel):
    ...
    PostSchema
    """ # noqa: E501
    var_date: StrictInt = Field(description="The `date` of the post.", alias="date")
    ...
    message: StrictStr = Field(description="HTML post content. If post message is translated, this parameter contains translated text, if not — original. [Markup explained](#forum-post-or-pm-markup).")
    message_original: Optional[StrictStr] = Field(default=None, description="Original HTML post content. This parameter is active if post message is translated. [Markup explained](#forum-post-or-pm-markup).", alias="messageOriginal")
    uid: StrictStr = Field(description="Unique post identifier.")
    __properties: ClassVar[List[str]] = ["date", "lastUpdated", "links", "message", "messageOriginal", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": PostSchemaLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
