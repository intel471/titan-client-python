...
class NIDSSearchSchemaData(object):
    ...
    openapi_types = {
        ...
        'nids_data': 'object',
        'nids_type': 'str',
        'threat': 'NIDSSearchSchemaDataThreat'
    }
    ...
    def __init__(self, confidence=None, intel_requirements=None, nids_data=None, nids_type=None, threat=None, local_vars_configuration=None):  # noqa: E501
        """NIDSSearchSchemaData - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._nids_data = None
        self._nids_type = None
        self._threat = None
        ...
        self.nids_data = nids_data
        self.nids_type = nids_type
        self.threat = threat

    @property
    def confidence(self):
        """Gets the confidence of this NIDSSearchSchemaData.  # noqa: E501

        NIDS `confidence` level: `high` — recommended for blocking, `medium` — for alerting, `low` — needs to be verified.  # noqa: E501

        :return: The confidence of this NIDSSearchSchemaData.  # noqa: E501
        :rtype: str
        """
    ...
    def confidence(self, confidence):
        """Sets the confidence of this NIDSSearchSchemaData.

        NIDS `confidence` level: `high` — recommended for blocking, `medium` — for alerting, `low` — needs to be verified.  # noqa: E501

        :param confidence: The confidence of this NIDSSearchSchemaData.  # noqa: E501
        :type confidence: str
        """
    ...
    def intel_requirements(self):
        """Gets the intel_requirements of this NIDSSearchSchemaData.  # noqa: E501

        List of General Intelligence Requirements matching this NIDS.  # noqa: E501

        :return: The intel_requirements of this NIDSSearchSchemaData.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def intel_requirements(self, intel_requirements):
        """Sets the intel_requirements of this NIDSSearchSchemaData.

        List of General Intelligence Requirements matching this NIDS.  # noqa: E501

        :param intel_requirements: The intel_requirements of this NIDSSearchSchemaData.  # noqa: E501
    ...
    @property
    def nids_data(self):
        """Gets the nids_data of this NIDSSearchSchemaData.  # noqa: E501

        Sub-document containing NIDS type and value(s).  # noqa: E501

        :return: The nids_data of this NIDSSearchSchemaData.  # noqa: E501
        :rtype: object
        """
        return self._nids_data

    @nids_data.setter
    def nids_data(self, nids_data):
        """Sets the nids_data of this NIDSSearchSchemaData.

        Sub-document containing NIDS type and value(s).  # noqa: E501

        :param nids_data: The nids_data of this NIDSSearchSchemaData.  # noqa: E501
        :type nids_data: object
        """
        if self.local_vars_configuration.client_side_validation and nids_data is None:  # noqa: E501
            raise ValueError("Invalid value for `nids_data`, must not be `None`")  # noqa: E501

        self._nids_data = nids_data

    @property
    def nids_type(self):
        """Gets the nids_type of this NIDSSearchSchemaData.  # noqa: E501

        Describes the type of NIDS.  # noqa: E501

        :return: The nids_type of this NIDSSearchSchemaData.  # noqa: E501
        :rtype: str
        """
        return self._nids_type

    @nids_type.setter
    def nids_type(self, nids_type):
        """Sets the nids_type of this NIDSSearchSchemaData.

        Describes the type of NIDS.  # noqa: E501

        :param nids_type: The nids_type of this NIDSSearchSchemaData.  # noqa: E501
        :type nids_type: str
        """
        if self.local_vars_configuration.client_side_validation and nids_type is None:  # noqa: E501
            raise ValueError("Invalid value for `nids_type`, must not be `None`")  # noqa: E501

        self._nids_type = nids_type

    @property
    def threat(self):
        """Gets the threat of this NIDSSearchSchemaData.  # noqa: E501


        :return: The threat of this NIDSSearchSchemaData.  # noqa: E501
        :rtype: NIDSSearchSchemaDataThreat
        """
        return self._threat

    @threat.setter
    def threat(self, threat):
        """Sets the threat of this NIDSSearchSchemaData.


        :param threat: The threat of this NIDSSearchSchemaData.  # noqa: E501
        :type threat: NIDSSearchSchemaDataThreat
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NIDSSearchSchemaData):
            return False
