...
class GirSchemaDataGir(object):
    ...
    def __init__(self, description=None, name=None, parent=None, path=None, local_vars_configuration=None):  # noqa: E501
        """GirSchemaDataGir - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this GirSchemaDataGir.  # noqa: E501

        GIR `description`.  # noqa: E501

        :return: The description of this GirSchemaDataGir.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this GirSchemaDataGir.

        GIR `description`.  # noqa: E501

        :param description: The description of this GirSchemaDataGir.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this GirSchemaDataGir.  # noqa: E501

        GIR `name`.  # noqa: E501

        :return: The name of this GirSchemaDataGir.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GirSchemaDataGir.

        GIR `name`.  # noqa: E501

        :param name: The name of this GirSchemaDataGir.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def parent(self):
        """Gets the parent of this GirSchemaDataGir.  # noqa: E501

        `GIR` that is `parent` of the current one. Has the same structure as described above and may also contain `parent` `GIR`s. <br />If GIR has a `parent` object, `parent` will contain a `path` and `name` field and optionally description and another `parent` object.  # noqa: E501

        :return: The parent of this GirSchemaDataGir.  # noqa: E501
        :rtype: object
        """
        return self._parent
    ...
    def parent(self, parent):
        """Sets the parent of this GirSchemaDataGir.

        `GIR` that is `parent` of the current one. Has the same structure as described above and may also contain `parent` `GIR`s. <br />If GIR has a `parent` object, `parent` will contain a `path` and `name` field and optionally description and another `parent` object.  # noqa: E501

        :param parent: The parent of this GirSchemaDataGir.  # noqa: E501
        :type parent: object
        """
    ...
    @property
    def path(self):
        """Gets the path of this GirSchemaDataGir.  # noqa: E501

        GIR `path`.  # noqa: E501

        :return: The path of this GirSchemaDataGir.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this GirSchemaDataGir.

        GIR `path`.  # noqa: E501

        :param path: The path of this GirSchemaDataGir.  # noqa: E501
        :type path: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GirSchemaDataGir):
            return False
