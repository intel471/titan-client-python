...
class SimpleCveSchemaDataCveReportCounterMeasureLinksInner(object):
    ...
    def __init__(self, title=None, url=None, local_vars_configuration=None):  # noqa: E501
        """SimpleCveSchemaDataCveReportCounterMeasureLinksInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.  # noqa: E501

        Countermeasure link `title`.  # noqa: E501

        :return: The title of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.

        Countermeasure link `title`.  # noqa: E501

        :param title: The title of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.  # noqa: E501
        :type title: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.  # noqa: E501

        Countermeasure `URL`.  # noqa: E501

        :return: The url of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.

        Countermeasure `URL`.  # noqa: E501

        :param url: The url of this SimpleCveSchemaDataCveReportCounterMeasureLinksInner.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleCveSchemaDataCveReportCounterMeasureLinksInner):
            return False
