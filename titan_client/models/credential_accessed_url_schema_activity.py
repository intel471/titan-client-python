...
class CredentialAccessedUrlSchemaActivity(object):
    ...
    def __init__(self, first=None, last=None, local_vars_configuration=None):  # noqa: E501
        """CredentialAccessedUrlSchemaActivity - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def first(self):
        """Gets the first of this CredentialAccessedUrlSchemaActivity.  # noqa: E501

        Start of the credential accessed url activity range.  # noqa: E501

        :return: The first of this CredentialAccessedUrlSchemaActivity.  # noqa: E501
        :rtype: int
        """
        return self._first
    ...
    def first(self, first):
        """Sets the first of this CredentialAccessedUrlSchemaActivity.

        Start of the credential accessed url activity range.  # noqa: E501

        :param first: The first of this CredentialAccessedUrlSchemaActivity.  # noqa: E501
        :type first: int
        """
    ...
    @property
    def last(self):
        """Gets the last of this CredentialAccessedUrlSchemaActivity.  # noqa: E501

        End of the credential accessed url activity range.  # noqa: E501

        :return: The last of this CredentialAccessedUrlSchemaActivity.  # noqa: E501
        :rtype: int
        """
        return self._last
    ...
    @last.setter
    def last(self, last):
        """Sets the last of this CredentialAccessedUrlSchemaActivity.

        End of the credential accessed url activity range.  # noqa: E501

        :param last: The last of this CredentialAccessedUrlSchemaActivity.  # noqa: E501
        :type last: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialAccessedUrlSchemaActivity):
            return False
