...
class WatcherRequestBodyPostAllOf(object):
    ...
    def __init__(self, thread_type=None, type=None, local_vars_configuration=None):  # noqa: E501
        """WatcherRequestBodyPostAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def thread_type(self):
        """Gets the thread_type of this WatcherRequestBodyPostAllOf.  # noqa: E501

        In case watcher `type` is `thread` the `threadType` must be specified.  # noqa: E501

        :return: The thread_type of this WatcherRequestBodyPostAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def thread_type(self, thread_type):
        """Sets the thread_type of this WatcherRequestBodyPostAllOf.

        In case watcher `type` is `thread` the `threadType` must be specified.  # noqa: E501

        :param thread_type: The thread_type of this WatcherRequestBodyPostAllOf.  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this WatcherRequestBodyPostAllOf.  # noqa: E501
        ...
        :return: The type of this WatcherRequestBodyPostAllOf.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WatcherRequestBodyPostAllOf.

        Watcher type.<br />`search` type watcher queries search engine with a pattern provided,<br />`thread` watcher monitors given forum thread for a new posts.  # noqa: E501

        :param type: The type of this WatcherRequestBodyPostAllOf.  # noqa: E501
        :type type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherRequestBodyPostAllOf):
            return False
