...
class SimpleBreachAlertSchemaDataEntitiesInnerGeoInfo(BaseModel):
    """
    ...
    """ # noqa: E501
    country: StrictStr = Field(description="Country of the IP's registration")
    provider: StrictStr = Field(description="Registrant for the IP address")
    __properties: ClassVar[List[str]] = ["country", "provider"]
