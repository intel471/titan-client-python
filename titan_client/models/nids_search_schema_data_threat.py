...
class NIDSSearchSchemaDataThreat(object):
    ...
    """
    openapi_types = {
        'data': 'NIDSSearchSchemaDataThreatData',
        'type': 'str',
        'uid': 'str'
    }
    ...
    def __init__(self, data=None, type=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """NIDSSearchSchemaDataThreat - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this NIDSSearchSchemaDataThreat.  # noqa: E501


        :return: The data of this NIDSSearchSchemaDataThreat.  # noqa: E501
        :rtype: NIDSSearchSchemaDataThreatData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this NIDSSearchSchemaDataThreat.


        :param data: The data of this NIDSSearchSchemaDataThreat.  # noqa: E501
        :type data: NIDSSearchSchemaDataThreatData
        """
    ...
    @property
    def type(self):
        """Gets the type of this NIDSSearchSchemaDataThreat.  # noqa: E501

        `Type` of threat: `malware`, `proxy_service` etc.  # noqa: E501

        :return: The type of this NIDSSearchSchemaDataThreat.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NIDSSearchSchemaDataThreat.

        `Type` of threat: `malware`, `proxy_service` etc.  # noqa: E501

        :param type: The type of this NIDSSearchSchemaDataThreat.  # noqa: E501
        :type type: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this NIDSSearchSchemaDataThreat.  # noqa: E501

        Unique threat identifier.  # noqa: E501

        :return: The uid of this NIDSSearchSchemaDataThreat.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this NIDSSearchSchemaDataThreat.

        Unique threat identifier.  # noqa: E501

        :param uid: The uid of this NIDSSearchSchemaDataThreat.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NIDSSearchSchemaDataThreat):
            return False
