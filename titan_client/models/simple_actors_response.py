...
class SimpleActorsResponse(BaseModel):
    """
    SimpleActorsResponse
    """ # noqa: E501
    actor_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="actorPartialResult")
    actor_total_count: StrictInt = Field(description="Total count of matched actors.", alias="actorTotalCount")
    actors: Optional[List[SimpleActorSchema]] = Field(default=None, description="List of `Actors`.")
    __properties: ClassVar[List[str]] = ["actorPartialResult", "actorTotalCount", "actors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actorPartialResult": obj.get("actorPartialResult"),
