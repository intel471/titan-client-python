...
class SimpleActorsResponse(object):
    ...
    """
    openapi_types = {
        'actor_partial_result': 'bool',
        'actor_total_count': 'int',
        'actors': 'list[SimpleActorSchema]'
    }

    attribute_map = {
        'actor_partial_result': 'actorPartialResult',
        'actor_total_count': 'actorTotalCount',
        'actors': 'actors'
    }

    def __init__(self, actor_partial_result=None, actor_total_count=None, actors=None, local_vars_configuration=None):  # noqa: E501
        """SimpleActorsResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._actor_partial_result = None
        self._actor_total_count = None
        self._actors = None
        self.discriminator = None

        if actor_partial_result is not None:
            self.actor_partial_result = actor_partial_result
        self.actor_total_count = actor_total_count
        if actors is not None:
            self.actors = actors

    @property
    def actor_partial_result(self):
        """Gets the actor_partial_result of this SimpleActorsResponse.  # noqa: E501
        ...
        :return: The actor_partial_result of this SimpleActorsResponse.  # noqa: E501
        :rtype: bool
        """
        return self._actor_partial_result

    @actor_partial_result.setter
    def actor_partial_result(self, actor_partial_result):
        """Sets the actor_partial_result of this SimpleActorsResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param actor_partial_result: The actor_partial_result of this SimpleActorsResponse.  # noqa: E501
        :type actor_partial_result: bool
        """

        self._actor_partial_result = actor_partial_result

    @property
    def actor_total_count(self):
        """Gets the actor_total_count of this SimpleActorsResponse.  # noqa: E501

        Total count of matched actors.  # noqa: E501

        :return: The actor_total_count of this SimpleActorsResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def actor_total_count(self, actor_total_count):
        """Sets the actor_total_count of this SimpleActorsResponse.

        Total count of matched actors.  # noqa: E501

        :param actor_total_count: The actor_total_count of this SimpleActorsResponse.  # noqa: E501
    ...
    @property
    def actors(self):
        """Gets the actors of this SimpleActorsResponse.  # noqa: E501

        List of `Actors`.  # noqa: E501

        :return: The actors of this SimpleActorsResponse.  # noqa: E501
    ...
    def actors(self, actors):
        """Sets the actors of this SimpleActorsResponse.

        List of `Actors`.  # noqa: E501

        :param actors: The actors of this SimpleActorsResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleActorsResponse):
            return False
