...
class PrivateMessageSchema(object):
    ...
    openapi_types = {
        'date': 'int',
        'last_updated': 'int',
        'links': 'PrivateMessageSchemaLinks',
        'message': 'str',
    ...
    def __init__(self, date=None, last_updated=None, links=None, message=None, message_original=None, subject=None, subject_original=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """PrivateMessageSchema - a model defined in OpenAPI"""  # noqa: E501
        ...
        if subject_original is not None:
            self.subject_original = subject_original
        self.uid = uid

    @property
    def date(self):
        """Gets the date of this PrivateMessageSchema.  # noqa: E501

        `Date` the message was sent.  # noqa: E501

        :return: The date of this PrivateMessageSchema.  # noqa: E501
        :rtype: int
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this PrivateMessageSchema.

        `Date` the message was sent.  # noqa: E501

        :param date: The date of this PrivateMessageSchema.  # noqa: E501
        :type date: int
        """
    ...
    def last_updated(self):
        """Gets the last_updated of this PrivateMessageSchema.  # noqa: E501

        Event modification date.  # noqa: E501

        :return: The last_updated of this PrivateMessageSchema.  # noqa: E501
        :rtype: int
        """
    ...
    def last_updated(self, last_updated):
        """Sets the last_updated of this PrivateMessageSchema.

        Event modification date.  # noqa: E501

        :param last_updated: The last_updated of this PrivateMessageSchema.  # noqa: E501
    ...
    @property
    def links(self):
        """Gets the links of this PrivateMessageSchema.  # noqa: E501


        :return: The links of this PrivateMessageSchema.  # noqa: E501
        :rtype: PrivateMessageSchemaLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this PrivateMessageSchema.


        :param links: The links of this PrivateMessageSchema.  # noqa: E501
        :type links: PrivateMessageSchemaLinks
        """
    ...
    @property
    def message(self):
        """Gets the message of this PrivateMessageSchema.  # noqa: E501

        HTML `message` content. If message is translated, this parameter contains translated text, if not — original.  # noqa: E501

        :return: The message of this PrivateMessageSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this PrivateMessageSchema.

        HTML `message` content. If message is translated, this parameter contains translated text, if not — original.  # noqa: E501

        :param message: The message of this PrivateMessageSchema.  # noqa: E501
        :type message: str
        """
    ...
    def message_original(self):
        """Gets the message_original of this PrivateMessageSchema.  # noqa: E501

        Original HTML message content. This parameter is active if message is translated.  # noqa: E501

        :return: The message_original of this PrivateMessageSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def message_original(self, message_original):
        """Sets the message_original of this PrivateMessageSchema.

        Original HTML message content. This parameter is active if message is translated.  # noqa: E501

        :param message_original: The message_original of this PrivateMessageSchema.  # noqa: E501
        :type message_original: str
        """
    ...
    @property
    def subject(self):
        """Gets the subject of this PrivateMessageSchema.  # noqa: E501

        Message `subject`. If message subject is translated, this parameter contains translated subject, if not — original.  # noqa: E501

        :return: The subject of this PrivateMessageSchema.  # noqa: E501
        :rtype: str
        """
    ...
    def subject(self, subject):
        """Sets the subject of this PrivateMessageSchema.

        Message `subject`. If message subject is translated, this parameter contains translated subject, if not — original.  # noqa: E501

        :param subject: The subject of this PrivateMessageSchema.  # noqa: E501
        :type subject: str
        """
    ...
    @property
    def subject_original(self):
        """Gets the subject_original of this PrivateMessageSchema.  # noqa: E501

        Original message subject. This parameter is active if message subject is translated.  # noqa: E501

        :return: The subject_original of this PrivateMessageSchema.  # noqa: E501
        :rtype: str
        """
        return self._subject_original

    @subject_original.setter
    def subject_original(self, subject_original):
        """Sets the subject_original of this PrivateMessageSchema.

        Original message subject. This parameter is active if message subject is translated.  # noqa: E501

        :param subject_original: The subject_original of this PrivateMessageSchema.  # noqa: E501
        :type subject_original: str
        """

        self._subject_original = subject_original

    @property
    def uid(self):
        """Gets the uid of this PrivateMessageSchema.  # noqa: E501

        Unique message identifier.  # noqa: E501

        :return: The uid of this PrivateMessageSchema.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this PrivateMessageSchema.

        Unique message identifier.  # noqa: E501

        :param uid: The uid of this PrivateMessageSchema.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrivateMessageSchema):
            return False
