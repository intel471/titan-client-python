...
class PrivateMessageSchema(BaseModel):
    ...
    """ # noqa: E501
    var_date: StrictInt = Field(description="`Date` the message was sent.", alias="date")
    last_updated: Optional[StrictInt] = Field(default=None, description="Event modification date.")
    links: PrivateMessageSchemaLinks
    message: StrictStr = Field(description="HTML `message` content. If message is translated, this parameter contains translated text, if not — original.")
    message_original: Optional[StrictStr] = Field(default=None, description="Original HTML message content. This parameter is active if message is translated.", alias="messageOriginal")
    subject: Optional[StrictStr] = Field(default=None, description="Message `subject`. If message subject is translated, this parameter contains translated subject, if not — original.")
    subject_original: Optional[StrictStr] = Field(default=None, description="Original message subject. This parameter is active if message subject is translated.", alias="subjectOriginal")
    uid: StrictStr = Field(description="Unique message identifier.")
    __properties: ClassVar[List[str]] = ["date", "last_updated", "links", "message", "messageOriginal", "subject", "subjectOriginal", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": PrivateMessageSchemaLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "message": obj.get("message"),
            "messageOriginal": obj.get("messageOriginal"),
            "subject": obj.get("subject"),
            "subjectOriginal": obj.get("subjectOriginal"),
            "uid": obj.get("uid")
        })
        return _obj
