...
class WatcherRequestBodyPatternsInner(object):
    ...
    def __init__(self, pattern=None, types=None, local_vars_configuration=None):  # noqa: E501
        """WatcherRequestBodyPatternsInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def pattern(self):
        """Gets the pattern of this WatcherRequestBodyPatternsInner.  # noqa: E501

        Search pattern.  # noqa: E501

        :return: The pattern of this WatcherRequestBodyPatternsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def pattern(self, pattern):
        """Sets the pattern of this WatcherRequestBodyPatternsInner.

        Search pattern.  # noqa: E501

        :param pattern: The pattern of this WatcherRequestBodyPatternsInner.  # noqa: E501
        :type pattern: str
        """
    ...
    @property
    def types(self):
        """Gets the types of this WatcherRequestBodyPatternsInner.  # noqa: E501

        Search pattern type. Any mismatch will result to `FreeText` value in this field.  # noqa: E501

        :return: The types of this WatcherRequestBodyPatternsInner.  # noqa: E501
        :rtype: str
        """
        return self._types
    ...
    def types(self, types):
        """Sets the types of this WatcherRequestBodyPatternsInner.

        Search pattern type. Any mismatch will result to `FreeText` value in this field.  # noqa: E501

        :param types: The types of this WatcherRequestBodyPatternsInner.  # noqa: E501
        :type types: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatcherRequestBodyPatternsInner):
            return False
