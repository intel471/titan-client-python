...
class MarketplaceVendorStreamResponse(object):
    ...
    openapi_types = {
        'cursor_next': 'str',
        'vendors': 'list[MarketplaceVendorSearchSchema]',
        'vendors_count': 'int',
        'vendors_partial_result': 'bool'
    }
    ...
    attribute_map = {
        ...
        'vendors_partial_result': 'vendorsPartialResult'
    }

    def __init__(self, cursor_next=None, vendors=None, vendors_count=None, vendors_partial_result=None, local_vars_configuration=None):  # noqa: E501
        """MarketplaceVendorStreamResponse - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._vendors = None
        self._vendors_count = None
        self._vendors_partial_result = None
        ...
        self.vendors_count = vendors_count
        if vendors_partial_result is not None:
            self.vendors_partial_result = vendors_partial_result

    @property
    def cursor_next(self):
        """Gets the cursor_next of this MarketplaceVendorStreamResponse.  # noqa: E501

        Stream position identifier to continue scrolling from.  # noqa: E501

        :return: The cursor_next of this MarketplaceVendorStreamResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cursor_next(self, cursor_next):
        """Sets the cursor_next of this MarketplaceVendorStreamResponse.

        Stream position identifier to continue scrolling from.  # noqa: E501

        :param cursor_next: The cursor_next of this MarketplaceVendorStreamResponse.  # noqa: E501
    ...
    @property
    def vendors(self):
        """Gets the vendors of this MarketplaceVendorStreamResponse.  # noqa: E501

        List of `Vendors`.  # noqa: E501

        :return: The vendors of this MarketplaceVendorStreamResponse.  # noqa: E501
        :rtype: list[MarketplaceVendorSearchSchema]
        """
        return self._vendors

    @vendors.setter
    def vendors(self, vendors):
        """Sets the vendors of this MarketplaceVendorStreamResponse.

        List of `Vendors`.  # noqa: E501

        :param vendors: The vendors of this MarketplaceVendorStreamResponse.  # noqa: E501
        :type vendors: list[MarketplaceVendorSearchSchema]
        """
    ...
    def vendors_count(self):
        """Gets the vendors_count of this MarketplaceVendorStreamResponse.  # noqa: E501

        Count of matched vendors.  # noqa: E501

        :return: The vendors_count of this MarketplaceVendorStreamResponse.  # noqa: E501
        :rtype: int
        """
        return self._vendors_count

    @vendors_count.setter
    def vendors_count(self, vendors_count):
        """Sets the vendors_count of this MarketplaceVendorStreamResponse.

        Count of matched vendors.  # noqa: E501

        :param vendors_count: The vendors_count of this MarketplaceVendorStreamResponse.  # noqa: E501
        :type vendors_count: int
        """
        if self.local_vars_configuration.client_side_validation and vendors_count is None:  # noqa: E501
            raise ValueError("Invalid value for `vendors_count`, must not be `None`")  # noqa: E501

        self._vendors_count = vendors_count

    @property
    def vendors_partial_result(self):
        """Gets the vendors_partial_result of this MarketplaceVendorStreamResponse.  # noqa: E501
        ...
        :return: The vendors_partial_result of this MarketplaceVendorStreamResponse.  # noqa: E501
        :rtype: bool
        """
        return self._vendors_partial_result

    @vendors_partial_result.setter
    def vendors_partial_result(self, vendors_partial_result):
        """Sets the vendors_partial_result of this MarketplaceVendorStreamResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param vendors_partial_result: The vendors_partial_result of this MarketplaceVendorStreamResponse.  # noqa: E501
        :type vendors_partial_result: bool
        """

        self._vendors_partial_result = vendors_partial_result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceVendorStreamResponse):
            return False
