...
class MarketplaceVendorStreamResponse(BaseModel):
    """
    ...
    vendors: Optional[List[MarketplaceVendorSearchSchema]] = Field(default=None, description="List of `Vendors`.")
    vendors_count: StrictInt = Field(description="Count of matched vendors.", alias="vendorsCount")
    vendors_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="vendorsPartialResult")
    __properties: ClassVar[List[str]] = ["cursorNext", "vendors", "vendorsCount", "vendorsPartialResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vendors": [MarketplaceVendorSearchSchema.from_dict(_item) for _item in obj["vendors"]] if obj.get("vendors") is not None else None,
            "vendorsCount": obj.get("vendorsCount"),
            "vendorsPartialResult": obj.get("vendorsPartialResult")
        })
        return _obj
