...
class MarketplaceResourceSearchResponse(BaseModel):
    """
    ...
    resources_count: StrictInt = Field(description="Count of matched results.", alias="resourcesCount")
    ...
    __properties: ClassVar[List[str]] = ["resources", "resourcesCount", "resourcesPartialResult"]
