...
class GirSchemaData(object):
    ...
    def __init__(self, gir=None, local_vars_configuration=None):  # noqa: E501
        """GirSchemaData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def gir(self):
        """Gets the gir of this GirSchemaData.  # noqa: E501


        :return: The gir of this GirSchemaData.  # noqa: E501
        :rtype: GirSchemaDataGir
        """
        return self._gir

    @gir.setter
    def gir(self, gir):
        """Sets the gir of this GirSchemaData.


        :param gir: The gir of this GirSchemaData.  # noqa: E501
        :type gir: GirSchemaDataGir
        """
        if self.local_vars_configuration.client_side_validation and gir is None:  # noqa: E501
            raise ValueError("Invalid value for `gir`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GirSchemaData):
            return False
