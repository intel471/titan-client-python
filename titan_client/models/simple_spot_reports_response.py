...
class SimpleSpotReportsResponse(BaseModel):
    """
    ...
    spot_reports: Optional[List[SimpleSpotReportSchema]] = Field(default=None, description="List of `Spot reports`.", alias="spotReports")
    spot_reports_total_count: StrictInt = Field(description="Total count of matched results.", alias="spotReportsTotalCount")
    __properties: ClassVar[List[str]] = ["partialResult", "spotReports", "spotReportsTotalCount"]
