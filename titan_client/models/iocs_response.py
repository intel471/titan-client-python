...
class IocsResponse(object):
    ...
    """
    openapi_types = {
        'ioc_partial_result': 'bool',
        'ioc_total_count': 'int',
        'iocs': 'list[IocSchema]'
    }

    attribute_map = {
        'ioc_partial_result': 'iocPartialResult',
        'ioc_total_count': 'iocTotalCount',
        'iocs': 'iocs'
    }

    def __init__(self, ioc_partial_result=None, ioc_total_count=None, iocs=None, local_vars_configuration=None):  # noqa: E501
        """IocsResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._ioc_partial_result = None
        self._ioc_total_count = None
        self._iocs = None
        self.discriminator = None

        if ioc_partial_result is not None:
            self.ioc_partial_result = ioc_partial_result
        self.ioc_total_count = ioc_total_count
        if iocs is not None:
            self.iocs = iocs

    @property
    def ioc_partial_result(self):
        """Gets the ioc_partial_result of this IocsResponse.  # noqa: E501
        ...
        :return: The ioc_partial_result of this IocsResponse.  # noqa: E501
        :rtype: bool
        """
        return self._ioc_partial_result

    @ioc_partial_result.setter
    def ioc_partial_result(self, ioc_partial_result):
        """Sets the ioc_partial_result of this IocsResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param ioc_partial_result: The ioc_partial_result of this IocsResponse.  # noqa: E501
        :type ioc_partial_result: bool
        """

        self._ioc_partial_result = ioc_partial_result

    @property
    def ioc_total_count(self):
        """Gets the ioc_total_count of this IocsResponse.  # noqa: E501

        Total count of matched entities.  # noqa: E501

        :return: The ioc_total_count of this IocsResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def ioc_total_count(self, ioc_total_count):
        """Sets the ioc_total_count of this IocsResponse.

        Total count of matched entities.  # noqa: E501

        :param ioc_total_count: The ioc_total_count of this IocsResponse.  # noqa: E501
    ...
    @property
    def iocs(self):
        """Gets the iocs of this IocsResponse.  # noqa: E501

        List of `Indicators of compromise`.  # noqa: E501

        :return: The iocs of this IocsResponse.  # noqa: E501
    ...
    @iocs.setter
    def iocs(self, iocs):
        """Sets the iocs of this IocsResponse.

        List of `Indicators of compromise`.  # noqa: E501

        :param iocs: The iocs of this IocsResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IocsResponse):
            return False
