...
class IocsResponse(BaseModel):
    ...
    IocsResponse
    """ # noqa: E501
    ioc_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="iocPartialResult")
    ioc_total_count: StrictInt = Field(description="Total count of matched entities.", alias="iocTotalCount")
    iocs: Optional[List[IocSchema]] = Field(default=None, description="List of `Indicators of compromise`.")
    __properties: ClassVar[List[str]] = ["iocPartialResult", "iocTotalCount", "iocs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iocPartialResult": obj.get("iocPartialResult"),
