...
class SimpleCveSchemaDataCveReportCvssScore(BaseModel):
    """
    Numerical score reflecting CVE severity.
    """ # noqa: E501
    v2: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CVSS score version 2.")
    v3: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CVSS score version 3.")
    __properties: ClassVar[List[str]] = ["v2", "v3"]
