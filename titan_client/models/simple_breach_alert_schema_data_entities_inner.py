...
class SimpleBreachAlertSchemaDataEntitiesInner(BaseModel):
    """
    SimpleBreachAlertSchemaDataEntitiesInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Elaboration on the entity's value")
    geo_info: Optional[SimpleBreachAlertSchemaDataEntitiesInnerGeoInfo] = None
    type: StrictStr = Field(description="Entity `type`.")
    value: StrictStr = Field(description="Entity `value`.")
    __properties: ClassVar[List[str]] = ["description", "geo_info", "type", "value"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of geo_info
        if self.geo_info:
            _dict['geo_info'] = self.geo_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "geo_info": SimpleBreachAlertSchemaDataEntitiesInnerGeoInfo.from_dict(obj["geo_info"]) if obj.get("geo_info") is not None else None,
            "type": obj.get("type"),
            "value": obj.get("value")
        })
        return _obj
