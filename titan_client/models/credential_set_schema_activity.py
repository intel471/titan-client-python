...
class CredentialSetSchemaActivity(BaseModel):
    """
    Period credential set was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the credential set activity range.")
    last: StrictInt = Field(description="End of the credential set activity range.")
