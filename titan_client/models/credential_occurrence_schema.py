...
class CredentialOccurrenceSchema(BaseModel):
    """
    CredentialOccurrenceSchema
    """ # noqa: E501
    activity: CredentialOccurrenceSchemaActivity
    classification: Optional[CredentialOccurrenceSchemaClassification] = None
    data: CredentialOccurrenceSchemaData
    last_updated: StrictInt = Field(description="Credential occurrence last modification date.")
    uid: StrictStr = Field(description="Unique credential occurrence identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": CredentialOccurrenceSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "classification": CredentialOccurrenceSchemaClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None,
            "data": CredentialOccurrenceSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
