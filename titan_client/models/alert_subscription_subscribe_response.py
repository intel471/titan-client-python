...
class AlertSubscriptionSubscribeResponse(object):
    ...
    """
    openapi_types = {
        'alert_subscriptions': 'list[AlertSubscriptionSchema]'
    }
    ...
    def __init__(self, alert_subscriptions=None, local_vars_configuration=None):  # noqa: E501
        """AlertSubscriptionSubscribeResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._alert_subscriptions = None
        self.discriminator = None

        if alert_subscriptions is not None:
            self.alert_subscriptions = alert_subscriptions

    @property
    def alert_subscriptions(self):
        """Gets the alert_subscriptions of this AlertSubscriptionSubscribeResponse.  # noqa: E501

        The `endpoint` and `status` (`active` or `inactive`) of the endpoint from the POST request payload when successfully registered.  # noqa: E501

        :return: The alert_subscriptions of this AlertSubscriptionSubscribeResponse.  # noqa: E501
        :rtype: list[AlertSubscriptionSchema]
        """
        return self._alert_subscriptions

    @alert_subscriptions.setter
    def alert_subscriptions(self, alert_subscriptions):
        """Sets the alert_subscriptions of this AlertSubscriptionSubscribeResponse.

        The `endpoint` and `status` (`active` or `inactive`) of the endpoint from the POST request payload when successfully registered.  # noqa: E501

        :param alert_subscriptions: The alert_subscriptions of this AlertSubscriptionSubscribeResponse.  # noqa: E501
        :type alert_subscriptions: list[AlertSubscriptionSchema]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertSubscriptionSubscribeResponse):
            return False
