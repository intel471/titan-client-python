...
class IndicatorSearchSchemaDataIndicatorData(BaseModel):
    """
    Sub-document containing indicator type and value(s).
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Address")
    file: Optional[IndicatorSearchSchemaDataIndicatorDataFile] = None
    geo_ip: Optional[EventSchemaDataEventDataControllerGeoIp] = None
    url: Optional[StrictStr] = Field(default=None, description="The `url` of the indicator.")
    __properties: ClassVar[List[str]] = ["address", "file", "geo_ip", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file": IndicatorSearchSchemaDataIndicatorDataFile.from_dict(obj["file"]) if obj.get("file") is not None else None,
            "geo_ip": EventSchemaDataEventDataControllerGeoIp.from_dict(obj["geo_ip"]) if obj.get("geo_ip") is not None else None,
            "url": obj.get("url")
        })
        return _obj
