...
class TagSchema(object):
    ...
    def __init__(self, report_count=None, tag=None, use_count=None, local_vars_configuration=None):  # noqa: E501
        """TagSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    def report_count(self):
        """Gets the report_count of this TagSchema.  # noqa: E501

        Count of reports with this tag.  # noqa: E501

        :return: The report_count of this TagSchema.  # noqa: E501
        :rtype: int
        """
    ...
    def report_count(self, report_count):
        """Sets the report_count of this TagSchema.

        Count of reports with this tag.  # noqa: E501

        :param report_count: The report_count of this TagSchema.  # noqa: E501
    ...
    @property
    def tag(self):
        """Gets the tag of this TagSchema.  # noqa: E501

        List of `Tags`.  # noqa: E501

        :return: The tag of this TagSchema.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this TagSchema.

        List of `Tags`.  # noqa: E501

        :param tag: The tag of this TagSchema.  # noqa: E501
        :type tag: str
        """
    ...
    @property
    def use_count(self):
        """Gets the use_count of this TagSchema.  # noqa: E501

        Total usage count. Right now this number is equal to the `report_count` field as only [Information Reports](#../paths/reports.yaml) are tagged.  In future might include other tagged entries.  # noqa: E501

        :return: The use_count of this TagSchema.  # noqa: E501
        :rtype: int
        """
    ...
    def use_count(self, use_count):
        """Sets the use_count of this TagSchema.

        Total usage count. Right now this number is equal to the `report_count` field as only [Information Reports](#../paths/reports.yaml) are tagged.  In future might include other tagged entries.  # noqa: E501

        :param use_count: The use_count of this TagSchema.  # noqa: E501
        :type use_count: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TagSchema):
            return False
