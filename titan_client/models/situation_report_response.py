...
class SituationReportResponse(BaseModel):
    ...
    """ # noqa: E501
    partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="partialResult")
    situation_reports: Optional[List[SituationReportSchema]] = Field(default=None, description="List of Situation reports.", alias="situationReports")
    situation_reports_total_count: StrictInt = Field(description="Total count of matched results.", alias="situationReportsTotalCount")
    __properties: ClassVar[List[str]] = ["partialResult", "situationReports", "situationReportsTotalCount"]
