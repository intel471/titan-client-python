...
class CredentialAccessedUrlSchemaClassification(BaseModel):
    """
    Classification of credential accessed url.
    """ # noqa: E501
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intelligence Requirements that match the credential accessed url.")
