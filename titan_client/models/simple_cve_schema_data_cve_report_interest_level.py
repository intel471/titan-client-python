...
class SimpleCveSchemaDataCveReportInterestLevel(object):
    ...
    def __init__(self, disclosed_publicly=None, exploit_sought=None, researched_publicly=None, local_vars_configuration=None):  # noqa: E501
        """SimpleCveSchemaDataCveReportInterestLevel - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._disclosed_publicly = None
        self._exploit_sought = None
        self._researched_publicly = None
        self.discriminator = None

        if disclosed_publicly is not None:
            self.disclosed_publicly = disclosed_publicly
        if exploit_sought is not None:
            self.exploit_sought = exploit_sought
        if researched_publicly is not None:
            self.researched_publicly = researched_publicly

    @property
    def disclosed_publicly(self):
        """Gets the disclosed_publicly of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501

        The CVE has been `disclosed publicly`.  # noqa: E501

        :return: The disclosed_publicly of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501
        :rtype: bool
        """
        return self._disclosed_publicly

    @disclosed_publicly.setter
    def disclosed_publicly(self, disclosed_publicly):
        """Sets the disclosed_publicly of this SimpleCveSchemaDataCveReportInterestLevel.

        The CVE has been `disclosed publicly`.  # noqa: E501

        :param disclosed_publicly: The disclosed_publicly of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501
        :type disclosed_publicly: bool
        """

        self._disclosed_publicly = disclosed_publicly

    @property
    def exploit_sought(self):
        """Gets the exploit_sought of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501

        An actor is seeking an exploit of the CVE.  # noqa: E501

        :return: The exploit_sought of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501
        :rtype: bool
        """
        return self._exploit_sought

    @exploit_sought.setter
    def exploit_sought(self, exploit_sought):
        """Sets the exploit_sought of this SimpleCveSchemaDataCveReportInterestLevel.

        An actor is seeking an exploit of the CVE.  # noqa: E501

        :param exploit_sought: The exploit_sought of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501
        :type exploit_sought: bool
        """

        self._exploit_sought = exploit_sought

    @property
    def researched_publicly(self):
        """Gets the researched_publicly of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501

        The CVE has been documented `researched publicly`.  # noqa: E501

        :return: The researched_publicly of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501
        :rtype: bool
        """
        return self._researched_publicly

    @researched_publicly.setter
    def researched_publicly(self, researched_publicly):
        """Sets the researched_publicly of this SimpleCveSchemaDataCveReportInterestLevel.

        The CVE has been documented `researched publicly`.  # noqa: E501

        :param researched_publicly: The researched_publicly of this SimpleCveSchemaDataCveReportInterestLevel.  # noqa: E501
        :type researched_publicly: bool
        """

        self._researched_publicly = researched_publicly
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleCveSchemaDataCveReportInterestLevel):
            return False
