...
class SimpleCveSchemaDataCveReportInterestLevel(BaseModel):
    """
    Level of interest for the CVE.
    """ # noqa: E501
    disclosed_publicly: Optional[StrictBool] = Field(default=None, description="The CVE has been `disclosed publicly`.")
    exploit_sought: Optional[StrictBool] = Field(default=None, description="An actor is seeking an exploit of the CVE.")
    researched_publicly: Optional[StrictBool] = Field(default=None, description="The CVE has been documented `researched publicly`.")
    __properties: ClassVar[List[str]] = ["disclosed_publicly", "exploit_sought", "researched_publicly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disclosed_publicly": obj.get("disclosed_publicly"),
            "exploit_sought": obj.get("exploit_sought"),
            "researched_publicly": obj.get("researched_publicly")
        })
        return _obj
