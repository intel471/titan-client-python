...
class SimpleCveSchemaDataCveReportCounterMeasureLinks(object):
    ...
    def __init__(self, title=None, url=None, local_vars_configuration=None):  # noqa: E501
        """SimpleCveSchemaDataCveReportCounterMeasureLinks - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this SimpleCveSchemaDataCveReportCounterMeasureLinks.  # noqa: E501

        Countermeasure link `title`.  # noqa: E501

        :return: The title of this SimpleCveSchemaDataCveReportCounterMeasureLinks.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this SimpleCveSchemaDataCveReportCounterMeasureLinks.

        Countermeasure link `title`.  # noqa: E501

        :param title: The title of this SimpleCveSchemaDataCveReportCounterMeasureLinks.  # noqa: E501
        :type title: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this SimpleCveSchemaDataCveReportCounterMeasureLinks.  # noqa: E501

        Countermeasure `URL`.  # noqa: E501

        :return: The url of this SimpleCveSchemaDataCveReportCounterMeasureLinks.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SimpleCveSchemaDataCveReportCounterMeasureLinks.

        Countermeasure `URL`.  # noqa: E501

        :param url: The url of this SimpleCveSchemaDataCveReportCounterMeasureLinks.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleCveSchemaDataCveReportCounterMeasureLinks):
            return False
