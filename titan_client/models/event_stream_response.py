...
class EventStreamResponse(object):
    ...
    attribute_map = {
        ...
        'event_partial_result': 'eventPartialResult',
        'event_total_count': 'eventTotalCount',
        'events': 'events'
    }

    def __init__(self, cursor_next=None, event_partial_result=None, event_total_count=None, events=None, local_vars_configuration=None):  # noqa: E501
        """EventStreamResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._cursor_next = None
        self._event_partial_result = None
        ...
        if event_partial_result is not None:
            self.event_partial_result = event_partial_result
    ...
    def cursor_next(self):
        """Gets the cursor_next of this EventStreamResponse.  # noqa: E501

        Stream position identifier to continue scrolling from.  # noqa: E501

        :return: The cursor_next of this EventStreamResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cursor_next(self, cursor_next):
        """Sets the cursor_next of this EventStreamResponse.

        Stream position identifier to continue scrolling from.  # noqa: E501

        :param cursor_next: The cursor_next of this EventStreamResponse.  # noqa: E501
    ...
    @property
    def event_partial_result(self):
        """Gets the event_partial_result of this EventStreamResponse.  # noqa: E501
        ...
        :return: The event_partial_result of this EventStreamResponse.  # noqa: E501
        :rtype: bool
        """
        return self._event_partial_result

    @event_partial_result.setter
    def event_partial_result(self, event_partial_result):
        """Sets the event_partial_result of this EventStreamResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param event_partial_result: The event_partial_result of this EventStreamResponse.  # noqa: E501
        :type event_partial_result: bool
        """

        self._event_partial_result = event_partial_result

    @property
    def event_total_count(self):
        """Gets the event_total_count of this EventStreamResponse.  # noqa: E501

        Total count of matched events.  # noqa: E501

        :return: The event_total_count of this EventStreamResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def event_total_count(self, event_total_count):
        """Sets the event_total_count of this EventStreamResponse.

        Total count of matched events.  # noqa: E501

        :param event_total_count: The event_total_count of this EventStreamResponse.  # noqa: E501
    ...
    @property
    def events(self):
        """Gets the events of this EventStreamResponse.  # noqa: E501

        List of `Events`.  # noqa: E501

        :return: The events of this EventStreamResponse.  # noqa: E501
    ...
    def events(self, events):
        """Sets the events of this EventStreamResponse.

        List of `Events`.  # noqa: E501

        :param events: The events of this EventStreamResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventStreamResponse):
            return False
