...
class PCAPResponse(object):
    ...
    """
    openapi_types = {
        'pcap_total_count': 'int',
        'pcaps': 'list[PCAPSchema]'
    }

    attribute_map = {
        'pcap_total_count': 'pcapTotalCount',
        'pcaps': 'pcaps'
    }

    def __init__(self, pcap_total_count=None, pcaps=None, local_vars_configuration=None):  # noqa: E501
        """PCAPResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._pcap_total_count = None
        self._pcaps = None
        self.discriminator = None

        self.pcap_total_count = pcap_total_count
        if pcaps is not None:
            self.pcaps = pcaps

    @property
    def pcap_total_count(self):
        """Gets the pcap_total_count of this PCAPResponse.  # noqa: E501

        Total count of matched PCAPs.  # noqa: E501

        :return: The pcap_total_count of this PCAPResponse.  # noqa: E501
        :rtype: int
        """
        return self._pcap_total_count

    @pcap_total_count.setter
    def pcap_total_count(self, pcap_total_count):
        """Sets the pcap_total_count of this PCAPResponse.

        Total count of matched PCAPs.  # noqa: E501

        :param pcap_total_count: The pcap_total_count of this PCAPResponse.  # noqa: E501
        :type pcap_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and pcap_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `pcap_total_count`, must not be `None`")  # noqa: E501

        self._pcap_total_count = pcap_total_count

    @property
    def pcaps(self):
        """Gets the pcaps of this PCAPResponse.  # noqa: E501

        List of PCAPs.  # noqa: E501

        :return: The pcaps of this PCAPResponse.  # noqa: E501
        :rtype: list[PCAPSchema]
        """
        return self._pcaps

    @pcaps.setter
    def pcaps(self, pcaps):
        """Sets the pcaps of this PCAPResponse.

        List of PCAPs.  # noqa: E501

        :param pcaps: The pcaps of this PCAPResponse.  # noqa: E501
        :type pcaps: list[PCAPSchema]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PCAPResponse):
            return False
