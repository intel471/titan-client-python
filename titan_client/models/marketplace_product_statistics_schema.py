...
class MarketplaceProductStatisticsSchema(object):
    ...
    openapi_types = {
        ...
        'credit_cards_total_count': 'int',
        'other_products_total_count': 'int'
    }

    attribute_map = {
        'credentials_total_count': 'credentialsTotalCount',
        'credit_cards_total_count': 'creditCardsTotalCount',
        'other_products_total_count': 'otherProductsTotalCount'
    }

    def __init__(self, credentials_total_count=None, credit_cards_total_count=None, other_products_total_count=None, local_vars_configuration=None):  # noqa: E501
        """MarketplaceProductStatisticsSchema - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._credentials_total_count = None
        self._credit_cards_total_count = None
        self._other_products_total_count = None
        self.discriminator = None

        self.credentials_total_count = credentials_total_count
        self.credit_cards_total_count = credit_cards_total_count
        self.other_products_total_count = other_products_total_count

    @property
    def credentials_total_count(self):
        """Gets the credentials_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501

        Total count of all credential products  # noqa: E501

        :return: The credentials_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501
        :rtype: int
        """
    ...
    def credentials_total_count(self, credentials_total_count):
        """Sets the credentials_total_count of this MarketplaceProductStatisticsSchema.

        Total count of all credential products  # noqa: E501

        :param credentials_total_count: The credentials_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501
    ...
    @property
    def credit_cards_total_count(self):
        """Gets the credit_cards_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501

        Total count of all credit card products  # noqa: E501

        :return: The credit_cards_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501
        :rtype: int
        """
        return self._credit_cards_total_count

    @credit_cards_total_count.setter
    def credit_cards_total_count(self, credit_cards_total_count):
        """Sets the credit_cards_total_count of this MarketplaceProductStatisticsSchema.

        Total count of all credit card products  # noqa: E501

        :param credit_cards_total_count: The credit_cards_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501
        :type credit_cards_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and credit_cards_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `credit_cards_total_count`, must not be `None`")  # noqa: E501

        self._credit_cards_total_count = credit_cards_total_count

    @property
    def other_products_total_count(self):
        """Gets the other_products_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501

        Total count of all other products  # noqa: E501

        :return: The other_products_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501
        :rtype: int
        """
        return self._other_products_total_count

    @other_products_total_count.setter
    def other_products_total_count(self, other_products_total_count):
        """Sets the other_products_total_count of this MarketplaceProductStatisticsSchema.

        Total count of all other products  # noqa: E501

        :param other_products_total_count: The other_products_total_count of this MarketplaceProductStatisticsSchema.  # noqa: E501
        :type other_products_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and other_products_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `other_products_total_count`, must not be `None`")  # noqa: E501

        self._other_products_total_count = other_products_total_count
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceProductStatisticsSchema):
            return False
