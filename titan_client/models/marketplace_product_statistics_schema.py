...
class MarketplaceProductStatisticsSchema(BaseModel):
    """
    MarketplaceProductStatisticsSchema
    """ # noqa: E501
    credentials_total_count: StrictInt = Field(description="Total count of all credential products")
    credit_cards_total_count: StrictInt = Field(description="Total count of all credit card products")
    other_products_total_count: StrictInt = Field(description="Total count of all other products")
    __properties: ClassVar[List[str]] = ["credentials_total_count", "credit_cards_total_count", "other_products_total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credit_cards_total_count": obj.get("credit_cards_total_count"),
            "other_products_total_count": obj.get("other_products_total_count")
        })
        return _obj
