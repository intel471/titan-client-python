...
class PrivateMessageSchemaLinksAuthorActor(object):
    ...
    def __init__(self, handle=None, uid=None, local_vars_configuration=None):  # noqa: E501
        """PrivateMessageSchemaLinksAuthorActor - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def handle(self):
        """Gets the handle of this PrivateMessageSchemaLinksAuthorActor.  # noqa: E501

        Author `handle`.  # noqa: E501

        :return: The handle of this PrivateMessageSchemaLinksAuthorActor.  # noqa: E501
        :rtype: str
        """
        return self._handle
    ...
    def handle(self, handle):
        """Sets the handle of this PrivateMessageSchemaLinksAuthorActor.

        Author `handle`.  # noqa: E501

        :param handle: The handle of this PrivateMessageSchemaLinksAuthorActor.  # noqa: E501
        :type handle: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this PrivateMessageSchemaLinksAuthorActor.  # noqa: E501

        Unique author identifier.  # noqa: E501

        :return: The uid of this PrivateMessageSchemaLinksAuthorActor.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this PrivateMessageSchemaLinksAuthorActor.

        Unique author identifier.  # noqa: E501

        :param uid: The uid of this PrivateMessageSchemaLinksAuthorActor.  # noqa: E501
        :type uid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrivateMessageSchemaLinksAuthorActor):
            return False
