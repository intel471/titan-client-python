...
class FullWatcherGroupSchemaAllOfLinksThread(BaseModel):
    """
    Watched forum thread data.
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Posts count.")
    topic: Optional[StrictStr] = Field(default=None, description="Subject of forum thread.")
    uid: Optional[StrictStr] = Field(default=None, description="Unique forum thread indentifier.")
