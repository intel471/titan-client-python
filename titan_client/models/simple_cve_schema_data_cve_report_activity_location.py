...
class SimpleCveSchemaDataCveReportActivityLocation(object):
    ...
    """
    openapi_types = {
        'location_opensource': 'bool',
        'location_private': 'bool',
        'location_underground': 'bool'
    }
    ...
    def __init__(self, location_opensource=None, location_private=None, location_underground=None, local_vars_configuration=None):  # noqa: E501
        """SimpleCveSchemaDataCveReportActivityLocation - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._location_opensource = None
        self._location_private = None
        self._location_underground = None
        self.discriminator = None

        if location_opensource is not None:
            self.location_opensource = location_opensource
        if location_private is not None:
            self.location_private = location_private
        if location_underground is not None:
            self.location_underground = location_underground

    @property
    def location_opensource(self):
        """Gets the location_opensource of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501

        The CVE is being discussed in open source.  # noqa: E501

        :return: The location_opensource of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501
        :rtype: bool
        """
        return self._location_opensource

    @location_opensource.setter
    def location_opensource(self, location_opensource):
        """Sets the location_opensource of this SimpleCveSchemaDataCveReportActivityLocation.

        The CVE is being discussed in open source.  # noqa: E501

        :param location_opensource: The location_opensource of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501
        :type location_opensource: bool
        """

        self._location_opensource = location_opensource

    @property
    def location_private(self):
        """Gets the location_private of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501

        The CVE is being discussed in private/direct communications.  # noqa: E501

        :return: The location_private of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501
        :rtype: bool
        """
        return self._location_private

    @location_private.setter
    def location_private(self, location_private):
        """Sets the location_private of this SimpleCveSchemaDataCveReportActivityLocation.

        The CVE is being discussed in private/direct communications.  # noqa: E501

        :param location_private: The location_private of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501
        :type location_private: bool
        """

        self._location_private = location_private

    @property
    def location_underground(self):
        """Gets the location_underground of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501

        The CVE is being discussed in the underground.  # noqa: E501

        :return: The location_underground of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501
        :rtype: bool
        """
        return self._location_underground

    @location_underground.setter
    def location_underground(self, location_underground):
        """Sets the location_underground of this SimpleCveSchemaDataCveReportActivityLocation.

        The CVE is being discussed in the underground.  # noqa: E501

        :param location_underground: The location_underground of this SimpleCveSchemaDataCveReportActivityLocation.  # noqa: E501
        :type location_underground: bool
        """

        self._location_underground = location_underground
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleCveSchemaDataCveReportActivityLocation):
            return False
