...
class SimpleSpotReportSchemaDataSpotReportSpotReportDataLinksInner(BaseModel):
    """
    SimpleSpotReportSchemaDataSpotReportSpotReportDataLinksInner
    """ # noqa: E501
    title: StrictStr = Field(description="The `title` of the link.")
    type: StrictStr = Field(description="Link `type`, external or internal.")
    url: StrictStr = Field(description="Link absolute `url`.")
