...
class MessagingServicesResponse(object):
    ...
    """
    openapi_types = {
        'instant_message_partial_result': 'bool',
        'instant_message_total_count': 'int',
        'instant_messages': 'list[InstantMessageSchema]'
    }

    attribute_map = {
        'instant_message_partial_result': 'instantMessagePartialResult',
        'instant_message_total_count': 'instantMessageTotalCount',
        'instant_messages': 'instantMessages'
    }

    def __init__(self, instant_message_partial_result=None, instant_message_total_count=None, instant_messages=None, local_vars_configuration=None):  # noqa: E501
        """MessagingServicesResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._instant_message_partial_result = None
        self._instant_message_total_count = None
        self._instant_messages = None
        self.discriminator = None

        if instant_message_partial_result is not None:
            self.instant_message_partial_result = instant_message_partial_result
    ...
    @property
    def instant_message_partial_result(self):
        """Gets the instant_message_partial_result of this MessagingServicesResponse.  # noqa: E501
        ...
        :return: The instant_message_partial_result of this MessagingServicesResponse.  # noqa: E501
        :rtype: bool
        """
        return self._instant_message_partial_result

    @instant_message_partial_result.setter
    def instant_message_partial_result(self, instant_message_partial_result):
        """Sets the instant_message_partial_result of this MessagingServicesResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param instant_message_partial_result: The instant_message_partial_result of this MessagingServicesResponse.  # noqa: E501
        :type instant_message_partial_result: bool
        """

        self._instant_message_partial_result = instant_message_partial_result

    @property
    def instant_message_total_count(self):
        """Gets the instant_message_total_count of this MessagingServicesResponse.  # noqa: E501

        Total count of matched instant messages.  # noqa: E501

        :return: The instant_message_total_count of this MessagingServicesResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def instant_message_total_count(self, instant_message_total_count):
        """Sets the instant_message_total_count of this MessagingServicesResponse.

        Total count of matched instant messages.  # noqa: E501

        :param instant_message_total_count: The instant_message_total_count of this MessagingServicesResponse.  # noqa: E501
    ...
    def instant_messages(self):
        """Gets the instant_messages of this MessagingServicesResponse.  # noqa: E501

        List of `Instant messages`.  # noqa: E501

        :return: The instant_messages of this MessagingServicesResponse.  # noqa: E501
    ...
    def instant_messages(self, instant_messages):
        """Sets the instant_messages of this MessagingServicesResponse.

        List of `Instant messages`.  # noqa: E501

        :param instant_messages: The instant_messages of this MessagingServicesResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessagingServicesResponse):
            return False
