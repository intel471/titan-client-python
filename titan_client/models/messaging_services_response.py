...
class MessagingServicesResponse(BaseModel):
    """
    MessagingServicesResponse
    """ # noqa: E501
    instant_message_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="instantMessagePartialResult")
    ...
    instant_messages: Optional[List[InstantMessageSchema]] = Field(default=None, description="List of `Instant messages`.", alias="instantMessages")
    __properties: ClassVar[List[str]] = ["instantMessagePartialResult", "instantMessageTotalCount", "instantMessages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instantMessagePartialResult": obj.get("instantMessagePartialResult"),
