...
class PrivateMessageSchemaLinks(object):
    ...
    def __init__(self, author_actor=None, forum=None, recipient_actor=None, local_vars_configuration=None):  # noqa: E501
    ...
    def recipient_actor(self, recipient_actor):
        ...
        """
        if self.local_vars_configuration.client_side_validation and recipient_actor is None:  # noqa: E501
            raise ValueError("Invalid value for `recipient_actor`, must not be `None`")  # noqa: E501
