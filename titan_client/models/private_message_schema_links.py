...
class PrivateMessageSchemaLinks(object):
    ...
    """
    openapi_types = {
        'author_actor': 'PrivateMessageSchemaLinksAuthorActor',
        'forum': 'PrivateMessageSchemaLinksForum',
        'original_images': 'list[str]',
        'recipient_actor': 'PrivateMessageSchemaLinksRecipientActor',
        'thread': 'PrivateMessageSchemaLinksThread'
    }
    ...
    def __init__(self, author_actor=None, forum=None, original_images=None, recipient_actor=None, thread=None, local_vars_configuration=None):  # noqa: E501
        """PrivateMessageSchemaLinks - a model defined in OpenAPI"""  # noqa: E501
    ...
    def author_actor(self):
        """Gets the author_actor of this PrivateMessageSchemaLinks.  # noqa: E501


        :return: The author_actor of this PrivateMessageSchemaLinks.  # noqa: E501
        :rtype: PrivateMessageSchemaLinksAuthorActor
        """
        return self._author_actor

    @author_actor.setter
    def author_actor(self, author_actor):
        """Sets the author_actor of this PrivateMessageSchemaLinks.


        :param author_actor: The author_actor of this PrivateMessageSchemaLinks.  # noqa: E501
        :type author_actor: PrivateMessageSchemaLinksAuthorActor
        """
        if self.local_vars_configuration.client_side_validation and author_actor is None:  # noqa: E501
            raise ValueError("Invalid value for `author_actor`, must not be `None`")  # noqa: E501

        self._author_actor = author_actor

    @property
    def forum(self):
        """Gets the forum of this PrivateMessageSchemaLinks.  # noqa: E501


        :return: The forum of this PrivateMessageSchemaLinks.  # noqa: E501
        :rtype: PrivateMessageSchemaLinksForum
        """
        return self._forum

    @forum.setter
    def forum(self, forum):
        """Sets the forum of this PrivateMessageSchemaLinks.


        :param forum: The forum of this PrivateMessageSchemaLinks.  # noqa: E501
        :type forum: PrivateMessageSchemaLinksForum
        """
        if self.local_vars_configuration.client_side_validation and forum is None:  # noqa: E501
            raise ValueError("Invalid value for `forum`, must not be `None`")  # noqa: E501

        self._forum = forum

    @property
    def original_images(self):
        """Gets the original_images of this PrivateMessageSchemaLinks.  # noqa: E501

        Array of original image urls (if present).  # noqa: E501

        :return: The original_images of this PrivateMessageSchemaLinks.  # noqa: E501
        :rtype: list[str]
        """
        return self._original_images

    @original_images.setter
    def original_images(self, original_images):
        """Sets the original_images of this PrivateMessageSchemaLinks.

        Array of original image urls (if present).  # noqa: E501

        :param original_images: The original_images of this PrivateMessageSchemaLinks.  # noqa: E501
        :type original_images: list[str]
        """

        self._original_images = original_images

    @property
    def recipient_actor(self):
        """Gets the recipient_actor of this PrivateMessageSchemaLinks.  # noqa: E501


        :return: The recipient_actor of this PrivateMessageSchemaLinks.  # noqa: E501
        :rtype: PrivateMessageSchemaLinksRecipientActor
        """
        return self._recipient_actor

    @recipient_actor.setter
    def recipient_actor(self, recipient_actor):
        """Sets the recipient_actor of this PrivateMessageSchemaLinks.
    ...
    @property
    def thread(self):
        """Gets the thread of this PrivateMessageSchemaLinks.  # noqa: E501


        :return: The thread of this PrivateMessageSchemaLinks.  # noqa: E501
        :rtype: PrivateMessageSchemaLinksThread
        """
        return self._thread

    @thread.setter
    def thread(self, thread):
        """Sets the thread of this PrivateMessageSchemaLinks.


        :param thread: The thread of this PrivateMessageSchemaLinks.  # noqa: E501
        :type thread: PrivateMessageSchemaLinksThread
        """
        if self.local_vars_configuration.client_side_validation and thread is None:  # noqa: E501
            raise ValueError("Invalid value for `thread`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrivateMessageSchemaLinks):
            return False
