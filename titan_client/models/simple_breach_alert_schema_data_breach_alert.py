...
class SimpleBreachAlertSchemaDataBreachAlert(object):
    ...
    def __init__(self, actor_or_group=None, confidence=None, date_of_information=None, intel_requirements=None, released_at=None, sensitive_source=None, sources=None, title=None, victim=None, local_vars_configuration=None):  # noqa: E501
