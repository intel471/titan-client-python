...
class SimpleSpotReportSchemaDataSpotReportSpotReportDataVictimsInner(BaseModel):
    """
    SimpleSpotReportSchemaDataSpotReportSpotReportDataVictimsInner
    """ # noqa: E501
    name: StrictStr = Field(description="Purported victim's `name`.")
    urls: Optional[List[StrictStr]] = Field(default=None, description="List opf purported victim's `urls`.")
