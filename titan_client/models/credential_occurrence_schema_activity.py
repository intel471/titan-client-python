...
class CredentialOccurrenceSchemaActivity(BaseModel):
    """
    Period credential occurrence was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the credential occurrence activity range.")
    last: StrictInt = Field(description="End of the credential occurrence activity range.")
