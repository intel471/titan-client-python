...
class SimpleReportSchemaClassification(BaseModel):
    """
    Classification of reports.
    """ # noqa: E501
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intel Requirements (GIR).", alias="intelRequirements")
    __properties: ClassVar[List[str]] = ["intelRequirements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "intelRequirements": obj.get("intelRequirements")
        })
        return _obj
