...
class YARASearchSchemaDataThreat(BaseModel):
    """
    Detailed information about a `threat`.
    """ # noqa: E501
    data: YARASearchSchemaDataThreatData
    type: StrictStr = Field(description="`Type` of threat: `malware`, `proxy_service` etc.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": YARASearchSchemaDataThreatData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type"),
            "uid": obj.get("uid")
        })
        return _obj
