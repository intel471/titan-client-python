...
class SimpleReportSchemaVictimsInner(object):
    ...
    def __init__(self, name=None, urls=None, local_vars_configuration=None):  # noqa: E501
        """SimpleReportSchemaVictimsInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SimpleReportSchemaVictimsInner.  # noqa: E501

        Purported victim `name`.  # noqa: E501

        :return: The name of this SimpleReportSchemaVictimsInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SimpleReportSchemaVictimsInner.

        Purported victim `name`.  # noqa: E501

        :param name: The name of this SimpleReportSchemaVictimsInner.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def urls(self):
        """Gets the urls of this SimpleReportSchemaVictimsInner.  # noqa: E501

        List of purported victim's `urls`.  # noqa: E501

        :return: The urls of this SimpleReportSchemaVictimsInner.  # noqa: E501
        :rtype: list[str]
        """
        return self._urls
    ...
    @urls.setter
    def urls(self, urls):
        """Sets the urls of this SimpleReportSchemaVictimsInner.

        List of purported victim's `urls`.  # noqa: E501

        :param urls: The urls of this SimpleReportSchemaVictimsInner.  # noqa: E501
        :type urls: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleReportSchemaVictimsInner):
            return False
