...
class SimpleBreachAlertSchemaDataBreachAlertConfidence(BaseModel):
    """
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="Description for the actual level.")
    level: StrictStr = Field(description="Level of confidence")
