...
class InstantMessageSchema(BaseModel):
    ...
    last_updated: StrictInt = Field(description="Instant message last modification date.")
    __properties: ClassVar[List[str]] = ["activity", "data", "last_updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": InstantMessageSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": InstantMessageSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
