...
class AlertListSchemaResponse(object):
    ...
    openapi_types = {
        ...
        'alerts': 'list[AlertListSchema]',
        'watcher_groups': 'list[FullWatcherGroupSchema]'
    }

    attribute_map = {
        'alert_total_count': 'alertTotalCount',
        'alerts': 'alerts',
        'watcher_groups': 'watcherGroups'
    }

    def __init__(self, alert_total_count=None, alerts=None, watcher_groups=None, local_vars_configuration=None):  # noqa: E501
        """AlertListSchemaResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._alert_total_count = None
        self._alerts = None
        self._watcher_groups = None
        self.discriminator = None

        self.alert_total_count = alert_total_count
        if alerts is not None:
            self.alerts = alerts
        if watcher_groups is not None:
            self.watcher_groups = watcher_groups

    @property
    def alert_total_count(self):
        """Gets the alert_total_count of this AlertListSchemaResponse.  # noqa: E501

        Total count of alerts.  # noqa: E501

        :return: The alert_total_count of this AlertListSchemaResponse.  # noqa: E501
        :rtype: int
        """
        return self._alert_total_count

    @alert_total_count.setter
    def alert_total_count(self, alert_total_count):
        """Sets the alert_total_count of this AlertListSchemaResponse.

        Total count of alerts.  # noqa: E501

        :param alert_total_count: The alert_total_count of this AlertListSchemaResponse.  # noqa: E501
        :type alert_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and alert_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `alert_total_count`, must not be `None`")  # noqa: E501

        self._alert_total_count = alert_total_count

    @property
    def alerts(self):
        """Gets the alerts of this AlertListSchemaResponse.  # noqa: E501

        List of Alerts.  # noqa: E501

        :return: The alerts of this AlertListSchemaResponse.  # noqa: E501
        :rtype: list[AlertListSchema]
        """
        return self._alerts

    @alerts.setter
    def alerts(self, alerts):
        """Sets the alerts of this AlertListSchemaResponse.

        List of Alerts.  # noqa: E501

        :param alerts: The alerts of this AlertListSchemaResponse.  # noqa: E501
        :type alerts: list[AlertListSchema]
        """

        self._alerts = alerts

    @property
    def watcher_groups(self):
        """Gets the watcher_groups of this AlertListSchemaResponse.  # noqa: E501

        List of Watcher groups. Groups are displayed only for alerts included in results.  # noqa: E501

        :return: The watcher_groups of this AlertListSchemaResponse.  # noqa: E501
        :rtype: list[FullWatcherGroupSchema]
        """
        return self._watcher_groups

    @watcher_groups.setter
    def watcher_groups(self, watcher_groups):
        """Sets the watcher_groups of this AlertListSchemaResponse.

        List of Watcher groups. Groups are displayed only for alerts included in results.  # noqa: E501

        :param watcher_groups: The watcher_groups of this AlertListSchemaResponse.  # noqa: E501
        :type watcher_groups: list[FullWatcherGroupSchema]
        """

        self._watcher_groups = watcher_groups
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertListSchemaResponse):
            return False
