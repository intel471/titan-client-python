...
class MarketplaceProductCreditCardSchema(object):
    ...
    def __init__(self, availability=None, card_number=None, card_type=None, expiration=None, marketplace=None, product_type=None, victim=None, local_vars_configuration=None):  # noqa: E501
