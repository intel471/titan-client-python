...
class SituationReportSchemaDataSituationReport(object):
    ...
    def __init__(self, entities=None, link=None, related_reports=None, released_at=None, text=None, title=None, victims=None, local_vars_configuration=None):  # noqa: E501
