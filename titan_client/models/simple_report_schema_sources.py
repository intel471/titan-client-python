...
class SimpleReportSchemaSources(object):
    ...
    def __init__(self, index=None, title=None, type=None, url=None, local_vars_configuration=None):  # noqa: E501
        """SimpleReportSchemaSources - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def index(self):
        """Gets the index of this SimpleReportSchemaSources.  # noqa: E501

        Numerical value that the source is denoted by in the text of the report.  # noqa: E501

        :return: The index of this SimpleReportSchemaSources.  # noqa: E501
        :rtype: int
        """
        return self._index
    ...
    def index(self, index):
        """Sets the index of this SimpleReportSchemaSources.

        Numerical value that the source is denoted by in the text of the report.  # noqa: E501

        :param index: The index of this SimpleReportSchemaSources.  # noqa: E501
        :type index: int
        """
    ...
    @property
    def title(self):
        """Gets the title of this SimpleReportSchemaSources.  # noqa: E501

        Source `title`.  # noqa: E501

        :return: The title of this SimpleReportSchemaSources.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this SimpleReportSchemaSources.

        Source `title`.  # noqa: E501

        :param title: The title of this SimpleReportSchemaSources.  # noqa: E501
        :type title: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this SimpleReportSchemaSources.  # noqa: E501

        `Type` of source such as Thread Post, Information Report, etc.  # noqa: E501

        :return: The type of this SimpleReportSchemaSources.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SimpleReportSchemaSources.

        `Type` of source such as Thread Post, Information Report, etc.  # noqa: E501

        :param type: The type of this SimpleReportSchemaSources.  # noqa: E501
        :type type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this SimpleReportSchemaSources.  # noqa: E501

        `Url` to resource where the report information came from.  # noqa: E501

        :return: The url of this SimpleReportSchemaSources.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SimpleReportSchemaSources.

        `Url` to resource where the report information came from.  # noqa: E501

        :param url: The url of this SimpleReportSchemaSources.  # noqa: E501
        :type url: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleReportSchemaSources):
            return False
