...
class MarketplaceProductAvailabilitySchema(object):
    ...
    allowable_values = [PRESENT, ABSENT]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MarketplaceProductAvailabilitySchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceProductAvailabilitySchema):
            return False
