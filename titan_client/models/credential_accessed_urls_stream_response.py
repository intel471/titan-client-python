...
class CredentialAccessedUrlsStreamResponse(object):
    ...
    """
    openapi_types = {
        'credential_accessed_urls': 'list[CredentialAccessedUrlStreamSchema]',
        'credential_accessed_urls_partial_result': 'bool',
        'credential_accessed_urls_total_count': 'int',
        'cursor_next': 'str'
    }

    attribute_map = {
        'credential_accessed_urls': 'credential_accessed_urls',
        'credential_accessed_urls_partial_result': 'credential_accessed_urls_partial_result',
        'credential_accessed_urls_total_count': 'credential_accessed_urls_total_count',
        'cursor_next': 'cursor_next'
    }

    def __init__(self, credential_accessed_urls=None, credential_accessed_urls_partial_result=None, credential_accessed_urls_total_count=None, cursor_next=None, local_vars_configuration=None):  # noqa: E501
        """CredentialAccessedUrlsStreamResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._credential_accessed_urls = None
        self._credential_accessed_urls_partial_result = None
        self._credential_accessed_urls_total_count = None
        self._cursor_next = None
        self.discriminator = None

        if credential_accessed_urls is not None:
            self.credential_accessed_urls = credential_accessed_urls
        if credential_accessed_urls_partial_result is not None:
            self.credential_accessed_urls_partial_result = credential_accessed_urls_partial_result
        self.credential_accessed_urls_total_count = credential_accessed_urls_total_count
        if cursor_next is not None:
            self.cursor_next = cursor_next

    @property
    def credential_accessed_urls(self):
        """Gets the credential_accessed_urls of this CredentialAccessedUrlsStreamResponse.  # noqa: E501

        List of `Credential accessed urls`.  # noqa: E501

        :return: The credential_accessed_urls of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :rtype: list[CredentialAccessedUrlStreamSchema]
        """
        return self._credential_accessed_urls

    @credential_accessed_urls.setter
    def credential_accessed_urls(self, credential_accessed_urls):
        """Sets the credential_accessed_urls of this CredentialAccessedUrlsStreamResponse.

        List of `Credential accessed urls`.  # noqa: E501

        :param credential_accessed_urls: The credential_accessed_urls of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :type credential_accessed_urls: list[CredentialAccessedUrlStreamSchema]
        """

        self._credential_accessed_urls = credential_accessed_urls

    @property
    def credential_accessed_urls_partial_result(self):
        """Gets the credential_accessed_urls_partial_result of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        ...
        :return: The credential_accessed_urls_partial_result of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :rtype: bool
        """
        return self._credential_accessed_urls_partial_result

    @credential_accessed_urls_partial_result.setter
    def credential_accessed_urls_partial_result(self, credential_accessed_urls_partial_result):
        """Sets the credential_accessed_urls_partial_result of this CredentialAccessedUrlsStreamResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param credential_accessed_urls_partial_result: The credential_accessed_urls_partial_result of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :type credential_accessed_urls_partial_result: bool
        """

        self._credential_accessed_urls_partial_result = credential_accessed_urls_partial_result

    @property
    def credential_accessed_urls_total_count(self):
        """Gets the credential_accessed_urls_total_count of this CredentialAccessedUrlsStreamResponse.  # noqa: E501

        Total count of matched credential accessed urls.  # noqa: E501

        :return: The credential_accessed_urls_total_count of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :rtype: int
        """
        return self._credential_accessed_urls_total_count

    @credential_accessed_urls_total_count.setter
    def credential_accessed_urls_total_count(self, credential_accessed_urls_total_count):
        """Sets the credential_accessed_urls_total_count of this CredentialAccessedUrlsStreamResponse.

        Total count of matched credential accessed urls.  # noqa: E501

        :param credential_accessed_urls_total_count: The credential_accessed_urls_total_count of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :type credential_accessed_urls_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and credential_accessed_urls_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `credential_accessed_urls_total_count`, must not be `None`")  # noqa: E501

        self._credential_accessed_urls_total_count = credential_accessed_urls_total_count

    @property
    def cursor_next(self):
        """Gets the cursor_next of this CredentialAccessedUrlsStreamResponse.  # noqa: E501

        Stream position identifier to continue scrolling from.  # noqa: E501

        :return: The cursor_next of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cursor_next(self, cursor_next):
        """Sets the cursor_next of this CredentialAccessedUrlsStreamResponse.

        Stream position identifier to continue scrolling from.  # noqa: E501

        :param cursor_next: The cursor_next of this CredentialAccessedUrlsStreamResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialAccessedUrlsStreamResponse):
            return False
