...
class IocSchema(BaseModel):
    ...
    IocSchema
    """ # noqa: E501
    active_from: Optional[StrictInt] = Field(default=None, description="Date first seen.", alias="activeFrom")
    active_till: Optional[StrictInt] = Field(default=None, description="Date last seen.", alias="activeTill")
    isp_country_code: Optional[StrictStr] = Field(default=None, description="Internet Service Provider country code.", alias="ispCountryCode")
    isp_name: Optional[StrictStr] = Field(default=None, description="Internet Service Provider name.", alias="ispName")
    last_updated: Optional[StrictInt] = Field(default=None, description="Last modification date.", alias="lastUpdated")
    links: IocSchemaLinks
    type: StrictStr = Field(description="IOC `type`, one of `MaliciousDomain`, `IPAddress`, `IPv4Prefix`, `IPv6Prefix`, `AutonomousSystem`, `MaliciousURL`, `MD5`, `SHA1`, `SHA256`, `FileType`, `FileSize`, `FileName`, `SSLCertificate`, `SSLCertificateID`, `SSLCertificateFingerprint`.")
    uid: StrictStr = Field(description="Unique IOC identifier.")
    value: StrictStr = Field(description="`Value` of the indicator.")
    __properties: ClassVar[List[str]] = ["activeFrom", "activeTill", "ispCountryCode", "ispName", "lastUpdated", "links", "type", "uid", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeTill": obj.get("activeTill"),
            "ispCountryCode": obj.get("ispCountryCode"),
            "ispName": obj.get("ispName"),
            "lastUpdated": obj.get("lastUpdated"),
            "links": IocSchemaLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "type": obj.get("type"),
            "uid": obj.get("uid"),
            "value": obj.get("value")
        })
