...
class SituationReportSchemaData(object):
    ...
    """
    openapi_types = {
        'situation_report': 'SituationReportSchemaDataSituationReport'
    }
    ...
    def __init__(self, situation_report=None, local_vars_configuration=None):  # noqa: E501
        """SituationReportSchemaData - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._situation_report = None
    ...
    def situation_report(self):
        """Gets the situation_report of this SituationReportSchemaData.  # noqa: E501


        :return: The situation_report of this SituationReportSchemaData.  # noqa: E501
        :rtype: SituationReportSchemaDataSituationReport
        """
        return self._situation_report

    @situation_report.setter
    def situation_report(self, situation_report):
        """Sets the situation_report of this SituationReportSchemaData.


        :param situation_report: The situation_report of this SituationReportSchemaData.  # noqa: E501
        :type situation_report: SituationReportSchemaDataSituationReport
        """

        self._situation_report = situation_report
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SituationReportSchemaData):
            return False
