...
class SituationReportSchemaData(BaseModel):
    """
    Sub-document containing Situation report and linked to in objects.
    """ # noqa: E501
    situation_report: Optional[SituationReportSchemaDataSituationReport] = None
    __properties: ClassVar[List[str]] = ["situation_report"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of situation_report
        if self.situation_report:
            _dict['situation_report'] = self.situation_report.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "situation_report": SituationReportSchemaDataSituationReport.from_dict(obj["situation_report"]) if obj.get("situation_report") is not None else None
        })
        return _obj
