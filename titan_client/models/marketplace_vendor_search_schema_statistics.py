...
class MarketplaceVendorSearchSchemaStatistics(BaseModel):
    """
    Detailed statistics about vendor.
    """ # noqa: E501
    products_total_count: StrictInt = Field(description="Total count of products related to vendor.")
    __properties: ClassVar[List[str]] = ["products_total_count"]
