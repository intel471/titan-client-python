...
class InstantMessageSchemaDataServer(BaseModel):
    """
    Sub-document containing `server` information.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Server `name`.")
    service_type: StrictStr = Field(description="Server's service type.")
    uid: StrictStr = Field(description="Unique server identifier.")
    __properties: ClassVar[List[str]] = ["name", "service_type", "uid"]
