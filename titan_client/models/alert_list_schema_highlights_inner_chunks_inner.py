...
class AlertListSchemaHighlightsInnerChunksInner(BaseModel):
    """
    AlertListSchemaHighlightsInnerChunksInner
    """ # noqa: E501
    hl: Optional[StrictStr] = Field(default=None, description="Highlighted chunk matching search pattern.")
    text: Optional[StrictStr] = Field(default=None, description="Regular `text` chunk.")
    __properties: ClassVar[List[str]] = ["hl", "text"]
