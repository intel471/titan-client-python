...
class AlertListSchemaHighlightsInnerChunksInner(object):
    ...
    def __init__(self, hl=None, text=None, local_vars_configuration=None):  # noqa: E501
        """AlertListSchemaHighlightsInnerChunksInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def hl(self):
        """Gets the hl of this AlertListSchemaHighlightsInnerChunksInner.  # noqa: E501

        Highlighted chunk matching search pattern.  # noqa: E501

        :return: The hl of this AlertListSchemaHighlightsInnerChunksInner.  # noqa: E501
        :rtype: str
        """
        return self._hl
    ...
    @hl.setter
    def hl(self, hl):
        """Sets the hl of this AlertListSchemaHighlightsInnerChunksInner.

        Highlighted chunk matching search pattern.  # noqa: E501

        :param hl: The hl of this AlertListSchemaHighlightsInnerChunksInner.  # noqa: E501
        :type hl: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this AlertListSchemaHighlightsInnerChunksInner.  # noqa: E501

        Regular `text` chunk.  # noqa: E501

        :return: The text of this AlertListSchemaHighlightsInnerChunksInner.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this AlertListSchemaHighlightsInnerChunksInner.

        Regular `text` chunk.  # noqa: E501

        :param text: The text of this AlertListSchemaHighlightsInnerChunksInner.  # noqa: E501
        :type text: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertListSchemaHighlightsInnerChunksInner):
            return False
