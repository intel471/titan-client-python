...
class SimpleReportSchemaActorSubjectOfReportInner(BaseModel):
    """
    SimpleReportSchemaActorSubjectOfReportInner
    """ # noqa: E501
    aliases: Optional[List[StrictStr]] = Field(default=None, description="Actor `aliases` (also known as).")
    handle: StrictStr = Field(description="Actor `handle`.")
