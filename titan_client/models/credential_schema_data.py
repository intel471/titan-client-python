...
class CredentialSchemaData(BaseModel):
    """
    ...
    credential_sets: Optional[List[CredentialSchemaDataCredentialSetsInner]] = Field(default=None, description="Credential sets associated with the credential.")
    detected_malware: Optional[List[Malware]] = Field(default=None, description="Array of malware family objects.")
    detection_domain: Optional[StrictStr] = Field(default=None, description="Detection domain of the credential.")
    password: Optional[CredentialSchemaDataPassword] = None
    __properties: ClassVar[List[str]] = ["affiliations", "credential_domain", "credential_login", "credential_sets", "detected_malware", "detection_domain", "password"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in detected_malware (list)
        _items = []
        if self.detected_malware:
            for _item in self.detected_malware:
                if _item:
                    _items.append(_item.to_dict())
            _dict['detected_malware'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credential_sets": [CredentialSchemaDataCredentialSetsInner.from_dict(_item) for _item in obj["credential_sets"]] if obj.get("credential_sets") is not None else None,
            "detected_malware": [Malware.from_dict(_item) for _item in obj["detected_malware"]] if obj.get("detected_malware") is not None else None,
            "detection_domain": obj.get("detection_domain"),
            "password": CredentialSchemaDataPassword.from_dict(obj["password"]) if obj.get("password") is not None else None
        })
        return _obj
