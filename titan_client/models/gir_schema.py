...
class GirSchema(BaseModel):
    """
    GirSchema
    """ # noqa: E501
    data: GirSchemaData
    uid: StrictStr = Field(description="Unique GIR identifier.")
    __properties: ClassVar[List[str]] = ["data", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GirSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
