...
class CredentialAccessedUrlsResponse(BaseModel):
    """
    CredentialAccessedUrlsResponse
    """ # noqa: E501
    credential_accessed_urls: Optional[List[CredentialAccessedUrlSchema]] = Field(default=None, description="List of `Credential accessed urls`.")
    ...
    __properties: ClassVar[List[str]] = ["credential_accessed_urls", "credential_accessed_urls_partial_result", "credential_accessed_urls_total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credential_accessed_urls": [CredentialAccessedUrlSchema.from_dict(_item) for _item in obj["credential_accessed_urls"]] if obj.get("credential_accessed_urls") is not None else None,
