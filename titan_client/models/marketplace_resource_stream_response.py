...
class MarketplaceResourceStreamResponse(object):
    ...
    openapi_types = {
        'cursor_next': 'str',
        'resources': 'list[MarketplaceResourceSearchSchema]',
        'resources_count': 'int',
        'resources_partial_result': 'bool'
    }
    ...
    attribute_map = {
        ...
        'resources_partial_result': 'resourcesPartialResult'
    }

    def __init__(self, cursor_next=None, resources=None, resources_count=None, resources_partial_result=None, local_vars_configuration=None):  # noqa: E501
        """MarketplaceResourceStreamResponse - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._resources_partial_result = None
        ...
        if resources_partial_result is not None:
            self.resources_partial_result = resources_partial_result

    @property
    def cursor_next(self):
        """Gets the cursor_next of this MarketplaceResourceStreamResponse.  # noqa: E501

        Stream position identifier to continue scrolling from.  # noqa: E501

        :return: The cursor_next of this MarketplaceResourceStreamResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def cursor_next(self, cursor_next):
        """Sets the cursor_next of this MarketplaceResourceStreamResponse.

        Stream position identifier to continue scrolling from.  # noqa: E501

        :param cursor_next: The cursor_next of this MarketplaceResourceStreamResponse.  # noqa: E501
    ...
    @property
    def resources(self):
        """Gets the resources of this MarketplaceResourceStreamResponse.  # noqa: E501

        List of `Resources`.  # noqa: E501

        :return: The resources of this MarketplaceResourceStreamResponse.  # noqa: E501
        :rtype: list[MarketplaceResourceSearchSchema]
        """
        return self._resources

    @resources.setter
    def resources(self, resources):
        """Sets the resources of this MarketplaceResourceStreamResponse.

        List of `Resources`.  # noqa: E501

        :param resources: The resources of this MarketplaceResourceStreamResponse.  # noqa: E501
        :type resources: list[MarketplaceResourceSearchSchema]
        """
    ...
    def resources_count(self):
        """Gets the resources_count of this MarketplaceResourceStreamResponse.  # noqa: E501

        Count of matched resources.  # noqa: E501

        :return: The resources_count of this MarketplaceResourceStreamResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def resources_count(self, resources_count):
        """Sets the resources_count of this MarketplaceResourceStreamResponse.

        Count of matched resources.  # noqa: E501

        :param resources_count: The resources_count of this MarketplaceResourceStreamResponse.  # noqa: E501
        :type resources_count: int
        """
        if self.local_vars_configuration.client_side_validation and resources_count is None:  # noqa: E501
            raise ValueError("Invalid value for `resources_count`, must not be `None`")  # noqa: E501

        self._resources_count = resources_count

    @property
    def resources_partial_result(self):
        """Gets the resources_partial_result of this MarketplaceResourceStreamResponse.  # noqa: E501
        ...
        :return: The resources_partial_result of this MarketplaceResourceStreamResponse.  # noqa: E501
        :rtype: bool
        """
        return self._resources_partial_result

    @resources_partial_result.setter
    def resources_partial_result(self, resources_partial_result):
        """Sets the resources_partial_result of this MarketplaceResourceStreamResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param resources_partial_result: The resources_partial_result of this MarketplaceResourceStreamResponse.  # noqa: E501
        :type resources_partial_result: bool
        """

        self._resources_partial_result = resources_partial_result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceResourceStreamResponse):
            return False
