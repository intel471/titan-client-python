...
class MarketplaceResourceStreamResponse(BaseModel):
    """
    ...
    resources: Optional[List[MarketplaceResourceSearchSchema]] = Field(default=None, description="List of `Resources`.")
    resources_count: StrictInt = Field(description="Count of matched resources.", alias="resourcesCount")
    resources_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="resourcesPartialResult")
    __properties: ClassVar[List[str]] = ["cursorNext", "resources", "resourcesCount", "resourcesPartialResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": [MarketplaceResourceSearchSchema.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
            "resourcesCount": obj.get("resourcesCount"),
            "resourcesPartialResult": obj.get("resourcesPartialResult")
        })
        return _obj
