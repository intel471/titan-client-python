...
class DataLeakPostsResponse(object):
    ...
    """
    openapi_types = {
        'data_leak_post_partial_result': 'bool',
        'data_leak_post_total_count': 'int',
        'data_leak_posts': 'list[DataLeakPostSchema]'
    }

    attribute_map = {
        'data_leak_post_partial_result': 'data_leak_post_partial_result',
        'data_leak_post_total_count': 'data_leak_post_total_count',
        'data_leak_posts': 'data_leak_posts'
    }

    def __init__(self, data_leak_post_partial_result=None, data_leak_post_total_count=None, data_leak_posts=None, local_vars_configuration=None):  # noqa: E501
        """DataLeakPostsResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._data_leak_post_partial_result = None
        self._data_leak_post_total_count = None
        self._data_leak_posts = None
        self.discriminator = None

        if data_leak_post_partial_result is not None:
            self.data_leak_post_partial_result = data_leak_post_partial_result
    ...
    @property
    def data_leak_post_partial_result(self):
        """Gets the data_leak_post_partial_result of this DataLeakPostsResponse.  # noqa: E501
        ...
        :return: The data_leak_post_partial_result of this DataLeakPostsResponse.  # noqa: E501
        :rtype: bool
        """
        return self._data_leak_post_partial_result

    @data_leak_post_partial_result.setter
    def data_leak_post_partial_result(self, data_leak_post_partial_result):
        """Sets the data_leak_post_partial_result of this DataLeakPostsResponse.

        Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.  # noqa: E501

        :param data_leak_post_partial_result: The data_leak_post_partial_result of this DataLeakPostsResponse.  # noqa: E501
        :type data_leak_post_partial_result: bool
        """

        self._data_leak_post_partial_result = data_leak_post_partial_result

    @property
    def data_leak_post_total_count(self):
        """Gets the data_leak_post_total_count of this DataLeakPostsResponse.  # noqa: E501

        Total count of matched data leak posts.  # noqa: E501

        :return: The data_leak_post_total_count of this DataLeakPostsResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def data_leak_post_total_count(self, data_leak_post_total_count):
        """Sets the data_leak_post_total_count of this DataLeakPostsResponse.

        Total count of matched data leak posts.  # noqa: E501

        :param data_leak_post_total_count: The data_leak_post_total_count of this DataLeakPostsResponse.  # noqa: E501
    ...
    def data_leak_posts(self):
        """Gets the data_leak_posts of this DataLeakPostsResponse.  # noqa: E501

        List of `Data Leak Posts`.  # noqa: E501

        :return: The data_leak_posts of this DataLeakPostsResponse.  # noqa: E501
    ...
    def data_leak_posts(self, data_leak_posts):
        """Sets the data_leak_posts of this DataLeakPostsResponse.

        List of `Data Leak Posts`.  # noqa: E501

        :param data_leak_posts: The data_leak_posts of this DataLeakPostsResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataLeakPostsResponse):
            return False
