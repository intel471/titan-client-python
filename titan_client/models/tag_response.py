...
class TagResponse(object):
    ...
    attribute_map = {
        ...
        'tags': 'tags',
        'used_tag_count': 'usedTagCount'
    }

    def __init__(self, tag_total_count=None, tags=None, used_tag_count=None, local_vars_configuration=None):  # noqa: E501
        """TagResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._tag_total_count = None
        self._tags = None
        self._used_tag_count = None
        self.discriminator = None

        self.tag_total_count = tag_total_count
        if tags is not None:
            self.tags = tags
        self.used_tag_count = used_tag_count

    @property
    def tag_total_count(self):
        """Gets the tag_total_count of this TagResponse.  # noqa: E501

        Total count of all tags including unused.  # noqa: E501

        :return: The tag_total_count of this TagResponse.  # noqa: E501
        :rtype: int
        """
        return self._tag_total_count

    @tag_total_count.setter
    def tag_total_count(self, tag_total_count):
        """Sets the tag_total_count of this TagResponse.

        Total count of all tags including unused.  # noqa: E501

        :param tag_total_count: The tag_total_count of this TagResponse.  # noqa: E501
        :type tag_total_count: int
        """
        if self.local_vars_configuration.client_side_validation and tag_total_count is None:  # noqa: E501
            raise ValueError("Invalid value for `tag_total_count`, must not be `None`")  # noqa: E501

        self._tag_total_count = tag_total_count

    @property
    def tags(self):
        """Gets the tags of this TagResponse.  # noqa: E501

        List of `Tags`.  # noqa: E501

        :return: The tags of this TagResponse.  # noqa: E501
        :rtype: list[TagSchema]
        """
        return self._tags

    @tags.setter
    def tags(self, tags):
        """Sets the tags of this TagResponse.

        List of `Tags`.  # noqa: E501

        :param tags: The tags of this TagResponse.  # noqa: E501
        :type tags: list[TagSchema]
        """

        self._tags = tags

    @property
    def used_tag_count(self):
        """Gets the used_tag_count of this TagResponse.  # noqa: E501

        Count of used tags with `use_count` > 0.  # noqa: E501

        :return: The used_tag_count of this TagResponse.  # noqa: E501
        :rtype: int
        """
        return self._used_tag_count

    @used_tag_count.setter
    def used_tag_count(self, used_tag_count):
        """Sets the used_tag_count of this TagResponse.

        Count of used tags with `use_count` > 0.  # noqa: E501

        :param used_tag_count: The used_tag_count of this TagResponse.  # noqa: E501
        :type used_tag_count: int
        """
        if self.local_vars_configuration.client_side_validation and used_tag_count is None:  # noqa: E501
            raise ValueError("Invalid value for `used_tag_count`, must not be `None`")  # noqa: E501

        self._used_tag_count = used_tag_count
