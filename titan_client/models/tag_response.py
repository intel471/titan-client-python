...
class TagResponse(BaseModel):
    ...
    TagResponse
    """ # noqa: E501
    tag_total_count: StrictInt = Field(description="Total count of all tags including unused.", alias="tagTotalCount")
    tags: Optional[List[TagSchema]] = Field(default=None, description="List of `Tags`.")
    used_tag_count: StrictInt = Field(description="Count of used tags with `use_count` > 0.", alias="usedTagCount")
    __properties: ClassVar[List[str]] = ["tagTotalCount", "tags", "usedTagCount"]
