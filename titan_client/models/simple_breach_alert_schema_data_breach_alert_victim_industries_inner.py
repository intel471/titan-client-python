...
class SimpleBreachAlertSchemaDataBreachAlertVictimIndustriesInner(BaseModel):
    """
    SimpleBreachAlertSchemaDataBreachAlertVictimIndustriesInner
    """ # noqa: E501
    industry: StrictStr = Field(description="Purported victim's `industry`.")
    sector: StrictStr = Field(description="Purported victim's `sector`.")
