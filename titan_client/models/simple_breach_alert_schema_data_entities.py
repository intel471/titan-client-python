...
class SimpleBreachAlertSchemaDataEntities(object):
    ...
    openapi_types = {
        'description': 'str',
        'geo_info': 'SimpleBreachAlertSchemaDataGeoInfo',
        'type': 'str',
        'value': 'str'
    }
    ...
    def __init__(self, description=None, geo_info=None, type=None, value=None, local_vars_configuration=None):  # noqa: E501
        """SimpleBreachAlertSchemaDataEntities - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501

        Elaboration on the entity's value  # noqa: E501

        :return: The description of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this SimpleBreachAlertSchemaDataEntities.

        Elaboration on the entity's value  # noqa: E501

        :param description: The description of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
    ...
    @property
    def geo_info(self):
        """Gets the geo_info of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501


        :return: The geo_info of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :rtype: SimpleBreachAlertSchemaDataGeoInfo
        """
        return self._geo_info

    @geo_info.setter
    def geo_info(self, geo_info):
        """Sets the geo_info of this SimpleBreachAlertSchemaDataEntities.


        :param geo_info: The geo_info of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :type geo_info: SimpleBreachAlertSchemaDataGeoInfo
        """
    ...
    @property
    def type(self):
        """Gets the type of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501

        Entity `type`.  # noqa: E501

        :return: The type of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SimpleBreachAlertSchemaDataEntities.

        Entity `type`.  # noqa: E501

        :param type: The type of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :type type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501

        Entity `value`.  # noqa: E501

        :return: The value of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this SimpleBreachAlertSchemaDataEntities.

        Entity `value`.  # noqa: E501

        :param value: The value of this SimpleBreachAlertSchemaDataEntities.  # noqa: E501
        :type value: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleBreachAlertSchemaDataEntities):
            return False
