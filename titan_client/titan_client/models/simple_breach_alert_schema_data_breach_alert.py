...
class SimpleBreachAlertSchemaDataBreachAlert(BaseModel):
    """
    Sub-document containing Breach Alert information.
    """ # noqa: E501
    actor_or_group: StrictStr = Field(description="Name of the actor or the actor group behind the breach.")
    confidence: SimpleBreachAlertSchemaDataBreachAlertConfidence
    date_of_information: StrictInt = Field(description="Breach Alert's date of information.")
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intel Requirements (GIR).")
    released_at: StrictInt = Field(description="Breach Alert's release date.")
    ...
    sources: Optional[List[SimpleBreachAlertSchemaDataBreachAlertSourcesInner]] = Field(default=None, description="Sources for this alert, either from Titan or external `resources`.")
    summary: Optional[StrictStr] = Field(default=None, description="Breach Alert's summary - raw text in HTML format.")
    title: StrictStr = Field(description="Breach Alert's title.")
    victim: SimpleBreachAlertSchemaDataBreachAlertVictim
    __properties: ClassVar[List[str]] = ["actor_or_group", "confidence", "date_of_information", "intel_requirements", "released_at", "sensitive_source", "sources", "summary", "title", "victim"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "confidence": SimpleBreachAlertSchemaDataBreachAlertConfidence.from_dict(obj["confidence"]) if obj.get("confidence") is not None else None,
            ...
            "sources": [SimpleBreachAlertSchemaDataBreachAlertSourcesInner.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None,
            "summary": obj.get("summary"),
            "title": obj.get("title"),
            "victim": SimpleBreachAlertSchemaDataBreachAlertVictim.from_dict(obj["victim"]) if obj.get("victim") is not None else None
        })
        return _obj
