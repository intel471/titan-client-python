...
class CredentialAccessedUrlSchemaData(BaseModel):
    """
    ...
    credential: Optional[CredentialAccessedUrlSchemaDataCredential] = None
    __properties: ClassVar[List[str]] = ["accessed_domain", "accessed_url", "credential"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credential": CredentialAccessedUrlSchemaDataCredential.from_dict(obj["credential"]) if obj.get("credential") is not None else None
        })
        return _obj
