...
class YARASearchSchemaDataYaraData(BaseModel):
    """
    Sub-document containing YARA type and value(s).
    """ # noqa: E501
    signature: Optional[StrictStr] = Field(default=None, description="`Signature` of YARA rule.")
    title: Optional[StrictStr] = Field(default=None, description="`Title` of YARA rule.")
