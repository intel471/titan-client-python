...
class EventSchemaDataEventDataControllerGeoIp(BaseModel):
    """
    Geo IP
    """ # noqa: E501
    ...
    isp: Optional[EventSchemaDataEventDataControllerGeoIpIsp] = None
    subdivision: Optional[List[StrictStr]] = Field(default=None, description="Subdivision")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isp": EventSchemaDataEventDataControllerGeoIpIsp.from_dict(obj["isp"]) if obj.get("isp") is not None else None,
