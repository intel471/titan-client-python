...
class SimpleActorSchema(BaseModel):
    """
    SimpleActorSchema
    """ # noqa: E501
    active_from: Optional[StrictInt] = Field(default=None, description="Date first seen.", alias="activeFrom")
    active_until: Optional[StrictInt] = Field(default=None, description="Date last seen.", alias="activeUntil")
    handles: Optional[List[StrictStr]] = Field(default=None, description="List of actor's `handles`.")
    ...
    uid: StrictStr = Field(description="Unique actor identifier.")
    __properties: ClassVar[List[str]] = ["activeFrom", "activeUntil", "handles", "lastUpdated", "links", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": SimpleActorSchemaLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
