...
class SimpleCveSchemaData(BaseModel):
    """
    Sub-document containing CVE data.
    """ # noqa: E501
    cve_report: SimpleCveSchemaDataCveReport
    __properties: ClassVar[List[str]] = ["cve_report"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cve_report:
            _dict['cve_report'] = self.cve_report.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cve_report": SimpleCveSchemaDataCveReport.from_dict(obj["cve_report"]) if obj.get("cve_report") is not None else None
        })
        return _obj
