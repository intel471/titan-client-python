...
class SituationReportSchema(BaseModel):
    ...
    last_updated: StrictInt = Field(description="Situation report last modification date.")
    uid: StrictStr = Field(description="Unique Situation report identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": SituationReportSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "classification": SituationReportSchemaClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None,
            "data": SituationReportSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
