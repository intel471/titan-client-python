...
class EventSchema(BaseModel):
    ...
    last_updated: StrictInt = Field(description="Event last modification date.")
    meta: EventSchemaMeta
    uid: StrictStr = Field(description="Unique event identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": EventSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": EventSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "meta": EventSchemaMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
