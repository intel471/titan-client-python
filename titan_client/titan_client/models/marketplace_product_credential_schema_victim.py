...
class MarketplaceProductCredentialSchemaVictim(BaseModel):
    """
    MarketplaceProductCredentialSchemaVictim
    """ # noqa: E501
    country: Optional[StrictStr] = Field(default=None, description="ISO code of country.")
    ...
    __properties: ClassVar[List[str]] = ["country", "ip_address", "os"]
