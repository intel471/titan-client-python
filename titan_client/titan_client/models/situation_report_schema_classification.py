...
class SituationReportSchemaClassification(BaseModel):
    """
    Classification of Situation report.
    """ # noqa: E501
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="List of General Intel Requirements (GIR) linked to Situation report.")
