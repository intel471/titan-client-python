...
class IndicatorSearchSchemaActivity(BaseModel):
    """
    Period an indicator was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the indicator activity range.")
    last: StrictInt = Field(description="End of the indicator activity range.")
