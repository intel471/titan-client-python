...
class InstantMessageSchemaDataActor(BaseModel):
    """
    Sub-document containing actor information.
    """ # noqa: E501
    handle: Optional[StrictStr] = Field(default=None, description="Actor's `handle`. Actual for the moment message was written.")
    uid: StrictStr = Field(description="Unique actor identifier.")
    __properties: ClassVar[List[str]] = ["handle", "uid"]
