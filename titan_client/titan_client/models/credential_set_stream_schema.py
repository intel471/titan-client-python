...
class CredentialSetStreamSchema(BaseModel):
    """
    CredentialSetStreamSchema
    """ # noqa: E501
    activity: CredentialSetSchemaActivity
    classification: Optional[CredentialSetSchemaClassification] = None
    data: CredentialSetStreamSchemaData
    last_updated: StrictInt = Field(description="Credential set last modification date.")
    statistics: Optional[CredentialSetSchemaStatistics] = None
    uid: StrictStr = Field(description="Unique credential set identifier.")
    __properties: ClassVar[List[str]] = ["activity", "classification", "data", "last_updated", "statistics", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": CredentialSetSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "classification": CredentialSetSchemaClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None,
            "data": CredentialSetStreamSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "statistics": CredentialSetSchemaStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
