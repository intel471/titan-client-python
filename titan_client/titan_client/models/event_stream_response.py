...
class EventStreamResponse(BaseModel):
    ...
    event_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="eventPartialResult")
    event_total_count: StrictInt = Field(description="Total count of matched events.", alias="eventTotalCount")
    events: Optional[List[EventSchema]] = Field(default=None, description="List of `Events`.")
    __properties: ClassVar[List[str]] = ["cursorNext", "eventPartialResult", "eventTotalCount", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventPartialResult": obj.get("eventPartialResult"),
