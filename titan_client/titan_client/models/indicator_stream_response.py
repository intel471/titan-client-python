...
class IndicatorStreamResponse(BaseModel):
    """
    IndicatorStreamResponse
    """ # noqa: E501
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from.", alias="cursorNext")
    indicator_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="indicatorPartialResult")
    indicator_total_count: StrictInt = Field(description="Total count of matched indicators.", alias="indicatorTotalCount")
    indicators: Optional[List[IndicatorSearchSchema]] = Field(default=None, description="List of `Indicators`.")
    __properties: ClassVar[List[str]] = ["cursorNext", "indicatorPartialResult", "indicatorTotalCount", "indicators"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cursorNext": obj.get("cursorNext"),
            "indicatorPartialResult": obj.get("indicatorPartialResult"),
