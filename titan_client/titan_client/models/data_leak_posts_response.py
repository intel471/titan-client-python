...
class DataLeakPostsResponse(BaseModel):
    """
    DataLeakPostsResponse
    """ # noqa: E501
    data_leak_post_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.")
    data_leak_post_total_count: StrictInt = Field(description="Total count of matched data leak posts.")
    data_leak_posts: Optional[List[DataLeakPostSchema]] = Field(default=None, description="List of `Data Leak Posts`.")
    __properties: ClassVar[List[str]] = ["data_leak_post_partial_result", "data_leak_post_total_count", "data_leak_posts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data_leak_post_partial_result": obj.get("data_leak_post_partial_result"),
