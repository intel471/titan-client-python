...
class InstantMessageSchemaDataMessageAttachmentsInner(BaseModel):
    """
    InstantMessageSchemaDataMessageAttachmentsInner
    """ # noqa: E501
    height: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Attachment `height`.")
    original_url: StrictStr = Field(description="Attachment url.")
    size: Union[StrictFloat, StrictInt] = Field(description="Attachment `size` in bytes.")
    type: StrictStr = Field(description="Attachment `type`.")
    uid: StrictStr = Field(description="Unique attachment identifier.")
    width: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Attachment `width`.")
    __properties: ClassVar[List[str]] = ["height", "original_url", "size", "type", "uid", "width"]
