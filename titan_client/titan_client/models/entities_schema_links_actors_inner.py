...
class EntitiesSchemaLinksActorsInner(BaseModel):
    """
    EntitiesSchemaLinksActorsInner
    """ # noqa: E501
    handles: Optional[List[StrictStr]] = Field(default=None, description="The actor's `handles`.")
    uid: StrictStr = Field(description="Unique indentifier of linked actor.")
    __properties: ClassVar[List[str]] = ["handles", "uid"]
