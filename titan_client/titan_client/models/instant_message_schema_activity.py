...
class InstantMessageSchemaActivity(BaseModel):
    """
    Period an instant message was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the instant message activity range.")
    last: StrictInt = Field(description="End of the instant message activity range.")
