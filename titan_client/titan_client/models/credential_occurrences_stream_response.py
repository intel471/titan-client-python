...
class CredentialOccurrencesStreamResponse(BaseModel):
    """
    CredentialOccurrencesStreamResponse
    """ # noqa: E501
    credential_occurrences: Optional[List[CredentialOccurrenceSchema]] = Field(default=None, description="List of `Credential occurrences`.")
    credential_occurrences_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.")
    credential_occurrences_total_count: StrictInt = Field(description="Total count of matched credential occurrences.")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from.")
    __properties: ClassVar[List[str]] = ["credential_occurrences", "credential_occurrences_partial_result", "credential_occurrences_total_count", "cursor_next"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credential_occurrences_partial_result": obj.get("credential_occurrences_partial_result"),
