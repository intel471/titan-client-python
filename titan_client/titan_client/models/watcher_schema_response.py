...
class WatcherSchemaResponse(BaseModel):
    """
    WatcherSchemaResponse
    """ # noqa: E501
    watcher_total_count: StrictInt = Field(description="Watcher count.", alias="watcherTotalCount")
    watchers: Optional[List[WatcherSchema]] = Field(default=None, description="List of `watchers`.")
    __properties: ClassVar[List[str]] = ["watcherTotalCount", "watchers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "watcherTotalCount": obj.get("watcherTotalCount"),
            "watchers": [WatcherSchema.from_dict(_item) for _item in obj["watchers"]] if obj.get("watchers") is not None else None
        })
        return _obj
