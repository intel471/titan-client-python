...
class SimpleBreachAlertSchemaActivity(BaseModel):
    """
    Period Breach Alert was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the Breach Alert activity range.")
    last: StrictInt = Field(description="End of the Breach Alert activity range.")
