...
class CredentialSetSchemaDataInternalSourcesInner(BaseModel):
    """
    CredentialSetSchemaDataInternalSourcesInner
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Internal source title.")
    url: Optional[StrictStr] = Field(default=None, description="Internal source URL.")
