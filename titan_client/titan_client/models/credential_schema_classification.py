...
class CredentialSchemaClassification(BaseModel):
    """
    Classification of credential.
    """ # noqa: E501
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intelligence Requirements that match the credential.")
