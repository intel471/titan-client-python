...
class FullWatcherGroupSchemaAllOfLinksForum(BaseModel):
    """
    Watched forum data.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Forum description.")
    name: Optional[StrictStr] = Field(default=None, description="Forum name.")
    uid: Optional[StrictStr] = Field(default=None, description="Unique forum identifier.")
