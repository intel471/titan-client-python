...
class MarketplaceSearchSchemaStatistics(BaseModel):
    """
    Marketplace statistics.
    """ # noqa: E501
    products_total_count: StrictInt = Field(description="Total count of marketplace's products.")
    vendors_total_count: StrictInt = Field(description="Total count of marketplace's vendors.")
    __properties: ClassVar[List[str]] = ["products_total_count", "vendors_total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products_total_count": obj.get("products_total_count"),
            "vendors_total_count": obj.get("vendors_total_count")
        })
        return _obj
