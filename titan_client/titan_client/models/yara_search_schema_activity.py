...
class YARASearchSchemaActivity(BaseModel):
    """
    Period YARA was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the YARA activity range.")
    last: StrictInt = Field(description="End of the YARA activity range.")
