...
class EventSchemaDataEventDataFile(BaseModel):
    """
    Object containing fields of the `file`'s hashes (`md5`, `sha1`, `sha256`) and file `type`, `size` and `download_url`.
    """ # noqa: E501
    download_url: StrictStr = Field(description="The url where the file can be downloaded.")
    md5: StrictStr = Field(description="An `md5` hash of the file.")
    sha1: StrictStr = Field(description="An `sha1` hash of the file.")
    sha256: StrictStr = Field(description="An `sha256` hash of the file.")
    size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="`Size` of the file.")
    type: Optional[StrictStr] = Field(default=None, description="`Type` of the file.")
    __properties: ClassVar[List[str]] = ["download_url", "md5", "sha1", "sha256", "size", "type"]
