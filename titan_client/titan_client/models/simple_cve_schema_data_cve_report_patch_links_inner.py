...
class SimpleCveSchemaDataCveReportPatchLinksInner(BaseModel):
    """
    SimpleCveSchemaDataCveReportPatchLinksInner
    """ # noqa: E501
    title: StrictStr = Field(description="Patch link `title`.")
    url: StrictStr = Field(description="Patch `URL`.")
