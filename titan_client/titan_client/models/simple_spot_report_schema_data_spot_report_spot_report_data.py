...
class SimpleSpotReportSchemaDataSpotReportSpotReportData(BaseModel):
    """
    Sub-document containing Spot report data.
    """ # noqa: E501
    date_of_information: StrictInt = Field(description="Spot report date of information.")
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intel Requirements (GIR).")
    links: Optional[List[SimpleSpotReportSchemaDataSpotReportSpotReportDataLinksInner]] = Field(default=None, description="Links to any other entity in portal, like Post, Thread or external `resource`.")
    related_reports: Optional[List[StrictStr]] = Field(default=None, description="Spot report links to related reports like \"Information Report\" or \"Malware Report\".")
    released_at: StrictInt = Field(description="Spot report released date.")
    sensitive_source: Optional[StrictBool] = Field(default=None, description="Indicates if the document contains sensitive source derived information.")
    text: StrictStr = Field(description="Spot report text.")
    title: Optional[StrictStr] = Field(default=None, description="Spot report title.")
    version: StrictStr = Field(description="Spot report release `version`.")
    victims: Optional[List[SimpleSpotReportSchemaDataSpotReportSpotReportDataVictimsInner]] = Field(default=None, description="List of purported `victims`.")
    __properties: ClassVar[List[str]] = ["date_of_information", "intel_requirements", "links", "related_reports", "released_at", "sensitive_source", "text", "title", "version", "victims"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date_of_information": obj.get("date_of_information"),
            "intel_requirements": obj.get("intel_requirements"),
            "links": [SimpleSpotReportSchemaDataSpotReportSpotReportDataLinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
            "related_reports": obj.get("related_reports"),
            "released_at": obj.get("released_at"),
            "sensitive_source": obj.get("sensitive_source"),
            "text": obj.get("text"),
            "title": obj.get("title"),
            "version": obj.get("version"),
            "victims": [SimpleSpotReportSchemaDataSpotReportSpotReportDataVictimsInner.from_dict(_item) for _item in obj["victims"]] if obj.get("victims") is not None else None
        })
        return _obj
