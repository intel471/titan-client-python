...
class IndicatorSearchSchemaDataThreatData(BaseModel):
    """
    Additional details about a threat such as service `provider`, `malware family`, `malware family version`, etc.
    """ # noqa: E501
    family: Optional[StrictStr] = Field(default=None, description="Malware family: `gozi_isfb`, `smokeloader`, `trickbot` etc (for `malware` threat type).")
    malware_family_profile_uid: Optional[StrictStr] = Field(default=None, description="Malware family profile UID.")
    variant: Optional[StrictStr] = Field(default=None, description="Variant of the threat.")
    version: Optional[StrictStr] = Field(default=None, description="Version of the threat.")
    __properties: ClassVar[List[str]] = ["family", "malware_family_profile_uid", "variant", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "malware_family_profile_uid": obj.get("malware_family_profile_uid"),
