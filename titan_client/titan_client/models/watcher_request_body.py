...
class WatcherRequestBody(BaseModel):
    """
    WatcherRequestBody
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dataSets", "description", "filterByGirSet", "filters", "freeTextPattern", "girs", "notificationChannel", "notificationFrequency", "patterns", "threadUid"]
