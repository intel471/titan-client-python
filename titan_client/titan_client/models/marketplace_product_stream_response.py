...
class MarketplaceProductStreamResponse(BaseModel):
    """
    ...
    products: Optional[List[MarketplaceProductSearchSchema]] = Field(default=None, description="List of `Products`.")
    products_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="productsPartialResult")
    products_count: StrictInt = Field(description="Count of matched resources.")
    statistics: Optional[MarketplaceProductStatisticsSchema] = None
    __properties: ClassVar[List[str]] = ["cursor_next", "products", "productsPartialResult", "products_count", "statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [MarketplaceProductSearchSchema.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
            "productsPartialResult": obj.get("productsPartialResult"),
            "products_count": obj.get("products_count"),
            "statistics": MarketplaceProductStatisticsSchema.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj
