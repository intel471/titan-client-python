...
class SimpleCveSchema(BaseModel):
    """
    SimpleCveSchema
    """ # noqa: E501
    activity: SimpleCveSchemaActivity
    classification: Optional[SimpleCveSchemaClassification] = None
    data: SimpleCveSchemaData
    last_updated: StrictInt = Field(description="CVE report last modification date.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": SimpleCveSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "classification": SimpleCveSchemaClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None,
            "data": SimpleCveSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
