...
class SimpleActorSchemaLinksForumsInner(BaseModel):
    """
    SimpleActorSchemaLinksForumsInner
    """ # noqa: E501
    actor_handle: Optional[StrictStr] = Field(default=None, description="Actor handle.", alias="actorHandle")
    contact_info: Optional[List[SimpleActorSchemaLinksForumsInnerContactInfoInner]] = Field(default=None, description="`Contact Info` objects.", alias="contactInfo")
    name: StrictStr = Field(description="Forum `name`.")
    time_zone: Optional[StrictStr] = Field(default=None, description="`Timezone`.", alias="timeZone")
    uid: StrictStr = Field(description="Unique forum identifier.")
    __properties: ClassVar[List[str]] = ["actorHandle", "contactInfo", "name", "timeZone", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contactInfo": [SimpleActorSchemaLinksForumsInnerContactInfoInner.from_dict(_item) for _item in obj["contactInfo"]] if obj.get("contactInfo") is not None else None,
            "name": obj.get("name"),
