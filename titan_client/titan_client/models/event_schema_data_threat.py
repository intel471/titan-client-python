...
class EventSchemaDataThreat(BaseModel):
    """
    Detailed information about a `threat`.
    """ # noqa: E501
    data: EventSchemaDataThreatData
    type: Optional[StrictStr] = Field(default=None, description="Threat `type`: `malware`, `proxy_service` etc.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EventSchemaDataThreatData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type"),
            "uid": obj.get("uid")
        })
        return _obj
