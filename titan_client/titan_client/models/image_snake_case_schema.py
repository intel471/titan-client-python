...
class ImageSnakeCaseSchema(BaseModel):
    """
    ...
    hash_type: StrictStr = Field(description="Type of hash function to produce hash.")
    image_original: Optional[StrictStr] = Field(default=None, description="Original image download url. Note: It's just an example. The actual path depends on specific API endpoint like posts, instant messages, etc.")
    image_sanitized: Optional[StrictStr] = Field(default=None, description="Sanitised image download url. Note: It's just an example. The actual path depends on specific API endpoint like posts, instant messages, etc.")
    ocr: Optional[StrictStr] = Field(default=None, description="Recognized text from image.")
    original_url: StrictStr = Field(description="Image original url.")
    ...
    __properties: ClassVar[List[str]] = ["dimension", "hash", "hash_type", "image_original", "image_sanitized", "ocr", "original_url", "size", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image_sanitized": obj.get("image_sanitized"),
            "ocr": obj.get("ocr"),
