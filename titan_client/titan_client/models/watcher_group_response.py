...
class WatcherGroupResponse(BaseModel):
    """
    WatcherGroupResponse
    """ # noqa: E501
    watcher_group_total_count: StrictInt = Field(description="Total count of watcher groups.", alias="watcherGroupTotalCount")
    watcher_groups: Optional[List[SimpleWatcherGroupSchema]] = Field(default=None, description="List of watcher groups.", alias="watcherGroups")
    __properties: ClassVar[List[str]] = ["watcherGroupTotalCount", "watcherGroups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "watcherGroupTotalCount": obj.get("watcherGroupTotalCount"),
            "watcherGroups": [SimpleWatcherGroupSchema.from_dict(_item) for _item in obj["watcherGroups"]] if obj.get("watcherGroups") is not None else None
        })
        return _obj
