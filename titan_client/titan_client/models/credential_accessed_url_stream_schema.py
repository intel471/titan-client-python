...
class CredentialAccessedUrlStreamSchema(BaseModel):
    """
    CredentialAccessedUrlStreamSchema
    """ # noqa: E501
    activity: CredentialAccessedUrlSchemaActivity
    classification: Optional[CredentialAccessedUrlSchemaClassification] = None
    data: CredentialAccessedUrlSchemaData
    last_updated: StrictInt = Field(description="Credential accessed url last modification date.")
    uid: StrictStr = Field(description="Unique credential accessed url identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": CredentialAccessedUrlSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "classification": CredentialAccessedUrlSchemaClassification.from_dict(obj["classification"]) if obj.get("classification") is not None else None,
            "data": CredentialAccessedUrlSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
