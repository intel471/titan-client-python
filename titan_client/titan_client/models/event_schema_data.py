...
class EventSchemaData(BaseModel):
    """
    ...
    event_type: StrictStr = Field(description="Describes the type of event: `download_execute`, `start_ddos`, `execute_command`, `keylog`, `screenshot`, etc.")
    intel_requirements: Optional[List[StrictStr]] = Field(default=None, description="General Intelligence Requirements that match this observed event.")
    mitre_tactics: Optional[StrictStr] = Field(default=None, description="`MITRE ATT&CK` tactic classification.")
    threat: EventSchemaDataThreat
    __properties: ClassVar[List[str]] = ["event_data", "event_type", "intel_requirements", "mitre_tactics", "threat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event_data": EventSchemaDataEventData.from_dict(obj["event_data"]) if obj.get("event_data") is not None else None,
            "event_type": obj.get("event_type"),
            "intel_requirements": obj.get("intel_requirements"),
            "mitre_tactics": obj.get("mitre_tactics"),
            "threat": EventSchemaDataThreat.from_dict(obj["threat"]) if obj.get("threat") is not None else None
        })
        return _obj
