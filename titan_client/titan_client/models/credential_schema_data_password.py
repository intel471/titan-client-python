...
class CredentialSchemaDataPassword(BaseModel):
    """
    Credential password details.
    """ # noqa: E501
    complexity: Optional[CredentialSchemaDataPasswordComplexity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "complexity": CredentialSchemaDataPasswordComplexity.from_dict(obj["complexity"]) if obj.get("complexity") is not None else None,
            "id": obj.get("id"),
