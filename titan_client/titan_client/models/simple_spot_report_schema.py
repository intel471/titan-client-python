...
class SimpleSpotReportSchema(BaseModel):
    """
    SimpleSpotReportSchema
    """ # noqa: E501
    activity: SimpleSpotReportSchemaActivity
    data: SimpleSpotReportSchemaData
    last_updated: StrictInt = Field(description="Spot report last modification date.")
    uid: StrictStr = Field(description="Unique Spot report identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": SimpleSpotReportSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": SimpleSpotReportSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
