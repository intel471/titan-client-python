...
class SituationReportSchemaActivity(BaseModel):
    """
    Period Situation report was active.
    """ # noqa: E501
    first: Optional[StrictInt] = Field(default=None, description="Start of the Situation report activity range.")
    last: Optional[StrictInt] = Field(default=None, description="End of the Situation report activity range.")
