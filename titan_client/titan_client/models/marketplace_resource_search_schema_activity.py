...
class MarketplaceResourceSearchSchemaActivity(BaseModel):
    """
    Period when resource was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the resource activity range.")
    last: StrictInt = Field(description="End of the resource activity range.")
