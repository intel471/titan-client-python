...
class CredentialSetsResponse(BaseModel):
    """
    CredentialSetsResponse
    """ # noqa: E501
    credential_sets: Optional[List[CredentialSetSchema]] = Field(default=None, description="List of `Credential sets`.")
    ...
    __properties: ClassVar[List[str]] = ["credential_sets", "credential_sets_partial_result", "credential_sets_total_count"]
