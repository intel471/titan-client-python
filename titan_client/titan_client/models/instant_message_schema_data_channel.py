...
class InstantMessageSchemaDataChannel(BaseModel):
    """
    Sub-document containing channel information.
    """ # noqa: E501
    name: StrictStr = Field(description="Channel `name`.")
    registration_date: Optional[StrictInt] = Field(default=None, description="Channel registration date.")
    topic: Optional[StrictStr] = Field(default=None, description="Description of channel `topic`.")
    uid: StrictStr = Field(description="Unique channel identifier.")
    url: Optional[StrictStr] = Field(default=None, description="Channel `url`.")
    __properties: ClassVar[List[str]] = ["name", "registration_date", "topic", "uid", "url"]
