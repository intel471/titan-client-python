...
class MarketplaceVendorSearchSchema(BaseModel):
    """
    MarketplaceVendorSearchSchema
    """ # noqa: E501
    activity: MarketplaceVendorSearchSchemaActivity
    data: MarketplaceVendorSearchSchemaData
    last_updated: StrictInt = Field(description="Last modification date.")
    statistics: MarketplaceVendorSearchSchemaStatistics
    uid: StrictStr = Field(description="Unique vendor identifier.")
    __properties: ClassVar[List[str]] = ["activity", "data", "last_updated", "statistics", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": MarketplaceVendorSearchSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": MarketplaceVendorSearchSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "statistics": MarketplaceVendorSearchSchemaStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
