...
class MarketplaceVendorSearchSchemaData(BaseModel):
    """
    MarketplaceVendorSearchSchemaData
    """ # noqa: E501
    name: StrictStr = Field(description="Marketplace's name.")
    profile: StrictStr = Field(description="URL of vendor's profile.")
    rating: Optional[StrictStr] = Field(default=None, description="Normalized rating (out of 10) of vendor.")
    tier: StrictStr = Field(description="Marketplace's tier.")
    __properties: ClassVar[List[str]] = ["name", "profile", "rating", "tier"]
