...
class SimpleBreachAlertResponse(BaseModel):
    """
    SimpleBreachAlertResponse
    """ # noqa: E501
    breach_alerts: Optional[List[SimpleBreachAlertSchema]] = Field(default=None, description="List of `Breach Alerts`.")
    breach_alerts_total_count: StrictInt = Field(description="Total count of matched results.")
    partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.")
    __properties: ClassVar[List[str]] = ["breach_alerts", "breach_alerts_total_count", "partial_result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partial_result": obj.get("partial_result")
        })
        return _obj
