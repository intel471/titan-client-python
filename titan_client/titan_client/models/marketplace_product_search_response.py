...
class MarketplaceProductSearchResponse(BaseModel):
    """
    ...
    products_count: StrictInt = Field(description="Count of matched results.")
    statistics: Optional[MarketplaceProductStatisticsSchema] = None
    __properties: ClassVar[List[str]] = ["products", "productsPartialResult", "products_count", "statistics"]
