...
class CredentialSetSchemaStatistics(BaseModel):
    """
    Statistics regarding returned objects.
    """ # noqa: E501
    accessed_urls_total_count: Optional[StrictInt] = Field(default=None, description="Number of accessed URLs.")
    credential_occurrences_total_count: Optional[StrictInt] = Field(default=None, description="Number of credential occurrences.")
    credentials_total_count: Optional[StrictInt] = Field(default=None, description="Number of credentials.")
    __properties: ClassVar[List[str]] = ["accessed_urls_total_count", "credential_occurrences_total_count", "credentials_total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessed_urls_total_count": obj.get("accessed_urls_total_count"),
