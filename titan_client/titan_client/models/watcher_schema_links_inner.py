...
class WatcherSchemaLinksInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "forum": WatcherSchemaLinksInnerForum.from_dict(obj["forum"]) if obj.get("forum") is not None else None,
            "thread": WatcherSchemaLinksInnerThread.from_dict(obj["thread"]) if obj.get("thread") is not None else None
        })
        return _obj
