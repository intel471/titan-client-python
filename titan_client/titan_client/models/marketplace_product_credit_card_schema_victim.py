...
class MarketplaceProductCreditCardSchemaVictim(BaseModel):
    """
    ...
    dob: Optional[StrictBool] = Field(default=None, description="Availability of dob info.")
    full: Optional[StrictBool] = Field(default=None, description="Availability of full info.")
    pin: Optional[StrictBool] = Field(default=None, description="Availability of pin info.")
    ssn: Optional[StrictBool] = Field(default=None, description="Availability of ssn info.")
    state: Optional[StrictStr] = None
    zip: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["address", "city", "country", "dob", "full", "pin", "ssn", "state", "zip"]
