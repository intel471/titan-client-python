...
class SimpleCveSchemaDataCveReportPocLinksInner(BaseModel):
    """
    SimpleCveSchemaDataCveReportPocLinksInner
    """ # noqa: E501
    title: StrictStr = Field(description="Proof of Concept link `title`.")
    url: StrictStr = Field(description="Proof of Concept `URL`.")
