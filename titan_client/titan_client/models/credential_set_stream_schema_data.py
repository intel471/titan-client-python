...
class CredentialSetStreamSchemaData(BaseModel):
    """
    Credential set with related objects.
    """ # noqa: E501
    breach_date: Optional[StrictInt] = Field(default=None, description="Date of breach.")
    collection_date: Optional[StrictInt] = Field(default=None, description="Date of collection.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the credential set.")
    disclosure_date: Optional[StrictInt] = Field(default=None, description="Date of disclosure.")
    external_sources: Optional[List[CredentialSetSchemaDataExternalSourcesInner]] = Field(default=None, description="List of external sources.")
    internal_sources: Optional[List[CredentialSetSchemaDataInternalSourcesInner]] = Field(default=None, description="List of internal sources.")
    name: StrictStr = Field(description="Name of the credential set.")
    record_count: Optional[StrictInt] = Field(default=None, description="Number of records.")
    victims: Optional[List[CredentialSetSchemaDataVictimsInner]] = Field(default=None, description="List of purported victims.")
    __properties: ClassVar[List[str]] = ["breach_date", "collection_date", "description", "disclosure_date", "external_sources", "internal_sources", "name", "record_count", "victims"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in external_sources (list)
        _items = []
        if self.external_sources:
            for _item in self.external_sources:
                if _item:
                    _items.append(_item.to_dict())
            _dict['external_sources'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in internal_sources (list)
        _items = []
        if self.internal_sources:
            for _item in self.internal_sources:
                if _item:
                    _items.append(_item.to_dict())
            _dict['internal_sources'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "external_sources": [CredentialSetSchemaDataExternalSourcesInner.from_dict(_item) for _item in obj["external_sources"]] if obj.get("external_sources") is not None else None,
            "internal_sources": [CredentialSetSchemaDataInternalSourcesInner.from_dict(_item) for _item in obj["internal_sources"]] if obj.get("internal_sources") is not None else None,
            "name": obj.get("name"),
            "record_count": obj.get("record_count"),
            "victims": [CredentialSetSchemaDataVictimsInner.from_dict(_item) for _item in obj["victims"]] if obj.get("victims") is not None else None
        })
        return _obj
