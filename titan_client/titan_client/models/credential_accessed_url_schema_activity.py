...
class CredentialAccessedUrlSchemaActivity(BaseModel):
    """
    Period credential accessed url was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the credential accessed url activity range.")
    last: StrictInt = Field(description="End of the credential accessed url activity range.")
