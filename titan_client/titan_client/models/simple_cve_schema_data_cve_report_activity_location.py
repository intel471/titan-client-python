...
class SimpleCveSchemaDataCveReportActivityLocation(BaseModel):
    """
    Location of activity/discussion for the CVE.
    """ # noqa: E501
    location_opensource: Optional[StrictBool] = Field(default=None, description="The CVE is being discussed in open source.")
    location_private: Optional[StrictBool] = Field(default=None, description="The CVE is being discussed in private/direct communications.")
    location_underground: Optional[StrictBool] = Field(default=None, description="The CVE is being discussed in the underground.")
    __properties: ClassVar[List[str]] = ["location_opensource", "location_private", "location_underground"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location_opensource": obj.get("location_opensource"),
            "location_private": obj.get("location_private"),
            "location_underground": obj.get("location_underground")
        })
        return _obj
