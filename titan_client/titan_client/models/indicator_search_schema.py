...
class IndicatorSearchSchema(BaseModel):
    """
    IndicatorSearchSchema
    """ # noqa: E501
    activity: Optional[IndicatorSearchSchemaActivity] = None
    data: IndicatorSearchSchemaData
    last_updated: StrictInt = Field(description="Indicator last modification date.")
    meta: Optional[IndicatorSearchSchemaMeta] = None
    uid: Optional[StrictStr] = Field(default=None, description="Unique indicator identifier.")
    __properties: ClassVar[List[str]] = ["activity", "data", "last_updated", "meta", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": IndicatorSearchSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": IndicatorSearchSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "meta": IndicatorSearchSchemaMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
