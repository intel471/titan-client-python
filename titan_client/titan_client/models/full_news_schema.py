...
class FullNewsSchema(BaseModel):
    """
    FullNewsSchema
    """ # noqa: E501
    activity: NewsSchemaActivity
    data: NewsSchemaData
    last_updated: StrictInt = Field(description="News last modification date")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": NewsSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": NewsSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
