...
class SimpleReportSchemaRelatedReportsInner(BaseModel):
    """
    SimpleReportSchemaRelatedReportsInner
    """ # noqa: E501
    document_family: StrictStr = Field(description="Related report document family.", alias="documentFamily")
    uid: StrictStr = Field(description="Related report unique identifier.")
    __properties: ClassVar[List[str]] = ["documentFamily", "uid"]
