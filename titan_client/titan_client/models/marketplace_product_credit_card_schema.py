...
class MarketplaceProductCreditCardSchema(BaseModel):
    """
    MarketplaceProductCreditCardSchema
    """ # noqa: E501
    availability: Optional[MarketplaceProductAvailabilitySchema] = None
    base: Optional[StrictStr] = Field(default=None, description="Base dump name.")
    card_holder: Optional[StrictStr] = Field(default=None, description="Credit card holder.")
    card_number: Optional[StrictStr] = Field(default=None, description="Credit card number.")
    card_type: Optional[StrictStr] = Field(default=None, description="Credit card type.")
    cvv: Optional[StrictStr] = Field(default=None, description="Credit card cvv.")
    expiration: Optional[StrictStr] = Field(default=None, description="Credit card expiration date.")
    issuer: Optional[StrictStr] = Field(default=None, description="Credit card issuer.")
    marketplace: Optional[MarketplaceProductMarketplaceSchema] = None
    obfuscated_number: Optional[StrictStr] = Field(default=None, description="Obfuscated credit card number.")
    product_type: Optional[StrictStr] = Field(default=None, description="Type of product")
    victim: Optional[MarketplaceProductCreditCardSchemaVictim] = None
    __properties: ClassVar[List[str]] = ["availability", "base", "card_holder", "card_number", "card_type", "cvv", "expiration", "issuer", "marketplace", "obfuscated_number", "product_type", "victim"]
    ...
    def product_type_validate_enum(cls, value):
        ...
        if value not in set(['Credit card']):
            raise ValueError("must be one of enum values ('Credit card')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "base": obj.get("base"),
            "card_holder": obj.get("card_holder"),
            "card_number": obj.get("card_number"),
            "card_type": obj.get("card_type"),
            "cvv": obj.get("cvv"),
            "expiration": obj.get("expiration"),
            "issuer": obj.get("issuer"),
            "marketplace": MarketplaceProductMarketplaceSchema.from_dict(obj["marketplace"]) if obj.get("marketplace") is not None else None,
            "obfuscated_number": obj.get("obfuscated_number"),
            "product_type": obj.get("product_type"),
            "victim": MarketplaceProductCreditCardSchemaVictim.from_dict(obj["victim"]) if obj.get("victim") is not None else None
        })
        return _obj
