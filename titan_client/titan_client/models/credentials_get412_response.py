...
CREDENTIALSGET412RESPONSE_ONE_OF_SCHEMAS = ["str"]

class CredentialsGet412Response(BaseModel):
    """
    ...
    # data type: str
    oneof_schema_16_validator: Optional[StrictStr] = Field(default=None, description="InvalidAffiliationGroupError: Only following affiliation group filters are available: `my_employees`, `my_customers`, `third_parties`, `vip_emails`")
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CredentialsGet412Response.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in CredentialsGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in CredentialsGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into CredentialsGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CredentialsGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
