...
class MarketplaceProductMarketplaceSchema(BaseModel):
    """
    MarketplaceProductMarketplaceSchema
    """ # noqa: E501
    name: StrictStr = Field(description="Name of marketplace.")
    price: Optional[StrictStr] = Field(default=None, description="Value and currency.")
    uid: StrictStr = Field(description="Unique marketplace identifier.")
    __properties: ClassVar[List[str]] = ["name", "price", "uid"]
