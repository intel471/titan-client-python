...
EVENTSSTREAMGET412RESPONSE_ONE_OF_SCHEMAS = ["str"]

class EventsStreamGet412Response(BaseModel):
    """
    ...
    # data type: str
    oneof_schema_2_validator: Optional[StrictStr] = Field(default=None, description="InvalidFromRangeError: `from` parameter must be >= 0")
    # data type: str
    oneof_schema_3_validator: Optional[StrictStr] = Field(default=None, description="InvalidUntilRangeError: `until` parameter must be >= 0")
    # data type: str
    oneof_schema_4_validator: Optional[StrictStr] = Field(default=None, description="InvalidLastUpdatedFromRangeError: `lastUpdatedFrom` parameter must be >= 0 or string time range")
    # data type: str
    oneof_schema_5_validator: Optional[StrictStr] = Field(default=None, description="InvalidLastUpdatedUntilRangeError:  `lastUpdatedUntil` parameter must be >= 0 or string time range")
    # data type: str
    oneof_schema_6_validator: Optional[StrictStr] = Field(default=None, description="InvalidCountRangeError: `count` parameter must be in range [1-100]")
    # data type: str
    oneof_schema_7_validator: Optional[StrictStr] = Field(default=None, description="NotANumberError: `<param>` parameter must be a number")
    # data type: str
    oneof_schema_8_validator: Optional[StrictStr] = Field(default=None, description="DuplicatedParamError: `<param>` parameter is duplicated")
    # data type: str
    oneof_schema_9_validator: Optional[StrictStr] = Field(default=None, description="SearchTooComplexError: The number of logic operators (`||`, `OR`, `&&`, `AND`, `-`) is exceeded")
    # data type: str
    oneof_schema_10_validator: Optional[StrictStr] = Field(default=None, description="InvalidGirFilterError: Only following GIR filters are available: `my_girs`, `company_pirs`")
    # data type: str
    oneof_schema_11_validator: Optional[StrictStr] = Field(default=None, description="InaccessibleDataRequestError: User has no permission to access requested data")
    # data type: str
    oneof_schema_12_validator: Optional[StrictStr] = Field(default=None, description="MalformedCursorError: Stream cursor is malformed")
    # data type: str
    oneof_schema_13_validator: Optional[StrictStr] = Field(default=None, description="InvalidDateFormatError: Date format is malformed or not supported")
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = EventsStreamGet412Response.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in EventsStreamGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in EventsStreamGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into EventsStreamGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into EventsStreamGet412Response with oneOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
