...
class MarketplaceResourceSearchSchemaData(BaseModel):
    """
    MarketplaceResourceSearchSchemaData
    """ # noqa: E501
    browser: StrictStr = Field(description="Internet browser.")
    contains: Optional[List[StrictStr]] = Field(default=None, description="Datasets of resource.")
    grabbed_at: StrictInt = Field(description="Timestamp when resource was grabbed.")
    name: StrictStr = Field(description="Name (url) of resource.")
    package: StrictStr = Field(description="Package name of resource.")
    source: StrictStr = Field(description="Source of resource.")
    url: StrictStr = Field(description="Url of resource.")
    __properties: ClassVar[List[str]] = ["browser", "contains", "grabbed_at", "name", "package", "source", "url"]
