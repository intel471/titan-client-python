...
class WatcherRequestBodyPatternsInner(BaseModel):
    """
    WatcherRequestBodyPatternsInner
    """ # noqa: E501
    pattern: Optional[StrictStr] = Field(default=None, description="Search pattern.")
    types: Optional[StrictStr] = Field(default=None, description="Search pattern type. Any mismatch will result to `FreeText` value in this field.")
    __properties: ClassVar[List[str]] = ["pattern", "types"]
