...
class SimpleSpotReportSchemaActivity(BaseModel):
    """
    Period Spot report was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the Spot report activity range.")
    last: StrictInt = Field(description="End of the Spot report activity range.")
