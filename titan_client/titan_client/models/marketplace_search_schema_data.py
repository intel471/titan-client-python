...
class MarketplaceSearchSchemaData(BaseModel):
    """
    Marketplace detailed data.
    """ # noqa: E501
    description: StrictStr = Field(description="Description of marketplace")
    name: StrictStr = Field(description="Name of marketplace.")
    tier: StrictStr = Field(description="Marketplace's tier.")
    url: StrictStr = Field(description="URL of marketplace.")
    __properties: ClassVar[List[str]] = ["description", "name", "tier", "url"]
