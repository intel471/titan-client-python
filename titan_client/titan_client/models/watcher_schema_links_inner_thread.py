...
class WatcherSchemaLinksInnerThread(BaseModel):
    """
    Forum `thread` object.
    """ # noqa: E501
    topic: StrictStr = Field(description="Thread `topic`.")
    uid: StrictStr = Field(description="Thread identifier.")
    __properties: ClassVar[List[str]] = ["topic", "uid"]
