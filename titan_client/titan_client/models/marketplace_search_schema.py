...
class MarketplaceSearchSchema(BaseModel):
    """
    ...
    uid: StrictStr = Field(description="Unique marketplace identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": MarketplaceSearchSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": MarketplaceSearchSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "last_updated": obj.get("last_updated"),
            "statistics": MarketplaceSearchSchemaStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
