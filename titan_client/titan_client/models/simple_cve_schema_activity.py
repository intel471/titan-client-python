...
class SimpleCveSchemaActivity(BaseModel):
    """
    Period an event message was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the event activity range.")
    last: StrictInt = Field(description="End of the event activity range.")
