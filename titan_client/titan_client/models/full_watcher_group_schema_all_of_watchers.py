...
class FullWatcherGroupSchemaAllOfWatchers(BaseModel):
    """
    FullWatcherGroupSchemaAllOfWatchers
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Watcher description.")
    links: Optional[FullWatcherGroupSchemaAllOfLinks] = None
    patterns: Optional[List[FullWatcherGroupSchemaAllOfPatterns]] = Field(default=None, description="List of Search patterns. Applicable for watchers of search type only.")
    type: StrictStr = Field(description="Watcher type — search or thread.")
    uid: StrictStr = Field(description="Unique watcher identifier.")
    __properties: ClassVar[List[str]] = ["description", "links", "patterns", "type", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": FullWatcherGroupSchemaAllOfLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "patterns": [FullWatcherGroupSchemaAllOfPatterns.from_dict(_item) for _item in obj["patterns"]] if obj.get("patterns") is not None else None,
            "type": obj.get("type"),
            "uid": obj.get("uid")
        })
        return _obj
