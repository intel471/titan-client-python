...
class CredentialSetAccessedUrlSchemaActivity(BaseModel):
    """
    Period credential set accessed url was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the credential set accessed url activity range.")
    last: StrictInt = Field(description="End of the credential set accessed url activity range.")
