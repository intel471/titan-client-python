...
class CredentialSchemaActivity(BaseModel):
    """
    Period credential was active.
    """ # noqa: E501
    first: StrictInt = Field(description="Start of the credential activity range.")
    last: StrictInt = Field(description="End of the credential activity range.")
