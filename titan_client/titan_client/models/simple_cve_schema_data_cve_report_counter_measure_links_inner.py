...
class SimpleCveSchemaDataCveReportCounterMeasureLinksInner(BaseModel):
    """
    SimpleCveSchemaDataCveReportCounterMeasureLinksInner
    """ # noqa: E501
    title: StrictStr = Field(description="Countermeasure link `title`.")
    url: StrictStr = Field(description="Countermeasure `URL`.")
