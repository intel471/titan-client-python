...
class PrivateMessageSchemaLinksAuthorActor(BaseModel):
    """
    Message author.
    """ # noqa: E501
    handle: Optional[StrictStr] = Field(default=None, description="Author `handle`.")
    uid: StrictStr = Field(description="Unique author identifier.")
