...
class YARASearchSchemaDataThreatData(BaseModel):
    """
    Additional details about a threat such as service `provider`, `malware family`, `malware family version` etc.
    """ # noqa: E501
    family: Optional[StrictStr] = Field(default=None, description="`Family` of malware `gozi_isfb`, `smokeloader`, `trickbot` etc (for `malware` threat type).")
    malware_family_profile_uid: Optional[StrictStr] = Field(default=None, description="Malware family profile UID.")
    version: Optional[StrictStr] = Field(default=None, description="`Version` of threat.")
    __properties: ClassVar[List[str]] = ["family", "malware_family_profile_uid", "version"]
