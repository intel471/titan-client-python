...
class PrivateMessagesResponse(BaseModel):
    ...
    """ # noqa: E501
    private_message_partial_result: Optional[StrictBool] = Field(default=None, description="Indicates whether response contains partial result. It could be in case when request took too long and was terminated by timeout.", alias="privateMessagePartialResult")
    private_message_total_count: StrictInt = Field(description="Total count of matched messages.", alias="privateMessageTotalCount")
    private_messages: Optional[List[PrivateMessageSchema]] = Field(default=None, description="List of `Private messages`.", alias="privateMessages")
    __properties: ClassVar[List[str]] = ["privateMessagePartialResult", "privateMessageTotalCount", "privateMessages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "privateMessagePartialResult": obj.get("privateMessagePartialResult"),
