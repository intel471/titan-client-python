...
class MarketplaceProductSearchSchema(BaseModel):
    """
    ...
    uid: StrictStr = Field(description="Unique credit card identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": MarketplaceProductSearchSchemaActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "data": MarketplaceProductSearchSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None,
