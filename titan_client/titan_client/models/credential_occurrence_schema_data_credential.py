...
class CredentialOccurrenceSchemaDataCredential(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["affiliations", "credential_domain", "credential_login", "detection_domain", "password", "uid"]
