...
class InstantMessageSchemaDataMessage(BaseModel):
    """
    Sub-document containing instant message information.
    """ # noqa: E501
    attachments: Optional[List[InstantMessageSchemaDataMessageAttachmentsInner]] = Field(default=None, description="Message attachment.")
    images: Optional[List[ImageSchema]] = Field(default=None, description="Array of images (if present).")
    reply_uid: Optional[StrictStr] = Field(default=None, description="Unique identifier of message this message is replying to.", alias="replyUid")
    text: StrictStr = Field(description="HTML message content.")
    uid: StrictStr = Field(description="Unique message identifier.")
    __properties: ClassVar[List[str]] = ["attachments", "images", "replyUid", "text", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attachments": [InstantMessageSchemaDataMessageAttachmentsInner.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
            "images": [ImageSchema.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
            "replyUid": obj.get("replyUid"),
            "text": obj.get("text"),
            "uid": obj.get("uid")
        })
        return _obj
