...
class IndicatorSearchSchemaDataIndicatorDataFile(BaseModel):
    """
    File details
    """ # noqa: E501
    download_url: Optional[StrictStr] = Field(default=None, description="File's download URL")
    md5: Optional[StrictStr] = Field(default=None, description="File's MD5 sum")
    sha1: Optional[StrictStr] = Field(default=None, description="File's SHA1 sum")
    sha256: Optional[StrictStr] = Field(default=None, description="File's SHA256 sum")
    size: Optional[StrictInt] = Field(default=None, description="File's size")
    ssdeep: Optional[StrictStr] = Field(default=None, description="File's ssdeep hash (fuzzy hash)")
    type: Optional[StrictStr] = Field(default=None, description="File's type")
    __properties: ClassVar[List[str]] = ["download_url", "md5", "sha1", "sha256", "size", "ssdeep", "type"]
