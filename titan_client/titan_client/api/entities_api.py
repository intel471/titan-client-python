...
class EntitiesApi:
    ...
    def entities_get(
        self,
        entity: Annotated[StrictStr, Field(description="Search for all entities.")],
        entity_type: Annotated[Optional[StrictStr], Field(description="Search for all entities by entity type.")] = None,
