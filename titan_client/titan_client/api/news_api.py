...
class NewsApi:
    ...
    def news_get(
        ...
        news_type: Annotated[Optional[StrictStr], Field(description="Search News by news type.")] = None,
        ...
        _param = self._news_get_serialize(
            news=news,
            news_type=news_type,
            var_from=var_from,
            until=until,
    ...
    def news_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SimpleNewsResponse]:
        """Search News
    ...
    @validate_call
    def news_get_without_preload_content(
        self,
        news: Annotated[Optional[StrictStr], Field(description="Free text News search.")] = None,
        news_type: Annotated[Optional[StrictStr], Field(description="Search News by news type.")] = None,
        var_from: Annotated[Optional[StrictStr], Field(description="Long unix time or string time range. Search data starting from given creation time (including).")] = None,
    ...
    def news_uid_get(
        self,
        uid: Annotated[StrictStr, Field(description="News report identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._news_uid_get_serialize(
            uid=uid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def news_uid_get_with_http_info(
        self,
        uid: Annotated[StrictStr, Field(description="News report identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def news_uid_get_without_preload_content(
        self,
        uid: Annotated[StrictStr, Field(description="News report identifier.")],
        _request_timeout: Union[
            None,
