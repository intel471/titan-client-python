...
class IndicatorsApi:
    ...
    def indicators_get(
        self,
        indicator: Annotated[Optional[StrictStr], Field(description="Free text indicator search (all fields included).")] = None,
        indicator_type: Annotated[Optional[StrictStr], Field(description="Search indicators by type (e.g. `file`, `ipv4`, `url`).")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search indicators by threat type.")] = None,
        threat_uid: Annotated[Optional[StrictStr], Field(description="Search indicators by threat UID.")] = None,
        malware_family: Annotated[Optional[StrictStr], Field(description="Search indicators by malware family (e.g. `gozi_isfb`, `smokeloader`, `trickbot`).")] = None,
        malware_family_profile_uid: Annotated[Optional[StrictStr], Field(description="Search indicators by malware family profile UID. Useful for getting context for everything we have around specific malware family, for instance https://api.intel471.com/v1/search?malwareFamilyProfileUid=d073f7352b82c1b8eedda381590adced.")] = None,
        confidence: Annotated[Optional[StrictStr], Field(description="Search indicators by confidence. See detailed description of confidence levels below.")] = None,
        ...
        _param = self._indicators_get_serialize(
            indicator=indicator,
    ...
    @validate_call
    def indicators_get_with_http_info(
        self,
        indicator: Annotated[Optional[StrictStr], Field(description="Free text indicator search (all fields included).")] = None,
        indicator_type: Annotated[Optional[StrictStr], Field(description="Search indicators by type (e.g. `file`, `ipv4`, `url`).")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search indicators by threat type.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IndicatorSearchResponse]:
        """Search Malware Intelligence Indicators
    ...
    @validate_call
    def indicators_get_without_preload_content(
        self,
        indicator: Annotated[Optional[StrictStr], Field(description="Free text indicator search (all fields included).")] = None,
        indicator_type: Annotated[Optional[StrictStr], Field(description="Search indicators by type (e.g. `file`, `ipv4`, `url`).")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search indicators by threat type.")] = None,
    ...
    def indicators_stream_get(
        ...
        _param = self._indicators_stream_get_serialize(
            indicator=indicator,
            indicator_type=indicator_type,
            threat_type=threat_type,
            threat_uid=threat_uid,
    ...
    @validate_call
    def indicators_stream_get_with_http_info(
        self,
        indicator: Annotated[Optional[StrictStr], Field(description="Free text indicator search (all fields included).")] = None,
        indicator_type: Annotated[Optional[StrictStr], Field(description="Search indicators by type (e.g. `file`, `ipv4`, `url`).")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search indicators by threat type.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IndicatorStreamResponse]:
        """Stream Malware Intelligence Indicators
    ...
    @validate_call
    def indicators_stream_get_without_preload_content(
        self,
        indicator: Annotated[Optional[StrictStr], Field(description="Free text indicator search (all fields included).")] = None,
        indicator_type: Annotated[Optional[StrictStr], Field(description="Search indicators by type (e.g. `file`, `ipv4`, `url`).")] = None,
        threat_type: Annotated[Optional[StrictStr], Field(description="Search indicators by threat type.")] = None,
    ...
    def _indicators_stream_get_serialize(
        self,
        indicator,
        indicator_type,
        threat_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/indicators/stream',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
