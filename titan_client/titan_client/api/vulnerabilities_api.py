...
class VulnerabilitiesApi:
    ...
    def cve_reports_get(
        ...
        _param = self._cve_reports_get_serialize(
    ...
    @validate_call
    def cve_reports_get_with_http_info(
        self,
        cve_report: Annotated[Optional[StrictStr], Field(description="Free text CVE reports search.")] = None,
        cve_type: Annotated[Optional[StrictStr], Field(description="Search CVE reports by type.")] = None,
        cve_status: Annotated[Optional[StrictStr], Field(description="Search CVE reports by status.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SimpleCvesResponse]:
        """Search Vulnerability Reports (CVE)
    ...
    @validate_call
    def cve_reports_get_without_preload_content(
        self,
        cve_report: Annotated[Optional[StrictStr], Field(description="Free text CVE reports search.")] = None,
        cve_type: Annotated[Optional[StrictStr], Field(description="Search CVE reports by type.")] = None,
        cve_status: Annotated[Optional[StrictStr], Field(description="Search CVE reports by status.")] = None,
    ...
    def _cve_reports_get_serialize(
        self,
        cve_report,
        cve_type,
        cve_status,
    ...
    @validate_call
    def cve_reports_uid_get(
        self,
        uid: Annotated[StrictStr, Field(description="Vulnerability report identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._cve_reports_uid_get_serialize(
            uid=uid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cve_reports_uid_get_with_http_info(
        self,
        uid: Annotated[StrictStr, Field(description="Vulnerability report identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cve_reports_uid_get_without_preload_content(
        self,
        uid: Annotated[StrictStr, Field(description="Vulnerability report identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _cve_reports_uid_get_serialize(
        self,
        uid,
        _request_auth,
        _content_type,
