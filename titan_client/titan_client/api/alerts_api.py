...
class AlertsApi:
    ...
    def alerts_get(
        ...
        offset: Annotated[Optional[StrictStr], Field(description="UID of the latest already acquired alert")] = None,
        watcher_group: Annotated[Optional[StrictStr], Field(description="Show `Alerts` from specified watcher group only. Object field: watcherGroupUid. Multiple values allowed.")] = None,
        show_read: Annotated[Optional[StrictBool], Field(description="Show read alerts.")] = None,
        display_watchers: Annotated[Optional[StrictBool], Field(description="Show watcher groups info.")] = None,
        mark_as_read: Annotated[Optional[StrictBool], Field(description="Mark displayed alerts as read.")] = None,
        ...
        :type count: int
        :param offset: UID of the latest already acquired alert
        :type offset: str
        ...
        _param = self._alerts_get_serialize(
            ...
            show_read=show_read,
            display_watchers=display_watchers,
    ...
    def alerts_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AlertListSchemaResponse]:
        """Get Alerts
    ...
    def _alerts_get_serialize(
        ...
        if watcher_group is not None:
            
            _query_params.append(('watcherGroup', watcher_group))
            
        if show_read is not None:
            
            _query_params.append(('showRead', show_read))
            
        if display_watchers is not None:
            
            _query_params.append(('displayWatchers', display_watchers))
