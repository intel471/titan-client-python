...
class ForumsApi:
    ...
    def posts_get(
        self,
        post: Annotated[Optional[StrictStr], Field(description="Search text in posts and topics (including images via OCR).")] = None,
        posts_by_thread_uid: Annotated[Optional[StrictStr], Field(description="Search posts by thread uid. At least one of `post`, `postsByThreadUid`, `forum` is required.")] = None,
        actor: Annotated[Optional[StrictStr], Field(description="Search posts authored by given actor handle.")] = None,
        forum: Annotated[Optional[StrictStr], Field(description="Search posts in a given forum.")] = None,
        ...
        _param = self._posts_get_serialize(
            post=post,
            posts_by_thread_uid=posts_by_thread_uid,
            actor=actor,
            forum=forum,
            var_from=var_from,
            until=until,
    ...
    @validate_call
    def posts_get_without_preload_content(
        self,
        post: Annotated[Optional[StrictStr], Field(description="Search text in posts and topics (including images via OCR).")] = None,
        posts_by_thread_uid: Annotated[Optional[StrictStr], Field(description="Search posts by thread uid. At least one of `post`, `postsByThreadUid`, `forum` is required.")] = None,
        actor: Annotated[Optional[StrictStr], Field(description="Search posts authored by given actor handle.")] = None,
    ...
    def _posts_get_serialize(
        ...
        if posts_by_thread_uid is not None:
            
            _query_params.append(('postsByThreadUid', posts_by_thread_uid))
    ...
    def private_messages_get(
        self,
        private_message: Annotated[Optional[StrictStr], Field(description="Search text in Private Messages. At least one of `privateMessage`, `privateMessageSubject`, `actor`, `forum` is required.")] = None,
        private_message_subject: Annotated[Optional[StrictStr], Field(description="Search text in subjects of Private Messages.")] = None,
        actor: Annotated[Optional[StrictStr], Field(description="Search messages authored or received by given actor handle.")] = None,
        forum: Annotated[Optional[StrictStr], Field(description="Search messages in a given forum.")] = None,
        var_from: Annotated[Optional[StrictStr], Field(description="Long unix time or string time range. Search data starting from given creation time (including).")] = None,
        until: Annotated[Optional[StrictStr], Field(description="Long unix time or string time range. Search data ending before given creation time (excluding).")] = None,
        last_updated_from: Annotated[Optional[StrictStr], Field(description="Long unix time or string time range. Search data starting from given last updated time (including). Empty indicates unbounded.")] = None,
        last_updated_until: Annotated[Optional[StrictStr], Field(description="Long unix time or string time range. Search data ending before given last updated time (excluding). Empty indicates unbounded.")] = None,
        ...
        _param = self._private_messages_get_serialize(
    ...
    @validate_call
    def private_messages_get_with_http_info(
        self,
        private_message: Annotated[Optional[StrictStr], Field(description="Search text in Private Messages. At least one of `privateMessage`, `privateMessageSubject`, `actor`, `forum` is required.")] = None,
        private_message_subject: Annotated[Optional[StrictStr], Field(description="Search text in subjects of Private Messages.")] = None,
        actor: Annotated[Optional[StrictStr], Field(description="Search messages authored or received by given actor handle.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrivateMessagesResponse]:
        """Search Private Messages
    ...
    @validate_call
    def private_messages_get_without_preload_content(
        self,
        private_message: Annotated[Optional[StrictStr], Field(description="Search text in Private Messages. At least one of `privateMessage`, `privateMessageSubject`, `actor`, `forum` is required.")] = None,
        private_message_subject: Annotated[Optional[StrictStr], Field(description="Search text in subjects of Private Messages.")] = None,
        actor: Annotated[Optional[StrictStr], Field(description="Search messages authored or received by given actor handle.")] = None,
    ...
    def _private_messages_get_serialize(
        self,
        private_message,
